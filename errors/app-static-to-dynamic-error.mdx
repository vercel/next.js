...
- [Static and Dynamic Rendering](/docs/app/getting-started/server-and-client-components#server-rendering-strategies) - Learn more about the differences between static and dynamic rendering in Next.js.
- [Dynamic APIs](/docs/app/getting-started/server-and-client-components#dynamic-apis) - Understand more about the usage of dynamic server functions in your Next.js application.
