...
- [Static and Dynamic Routes](/docs/app/getting-started/caching-and-revalidating#server-side-caching) - Learn more about the differences between static and dynamic rendering in Next.js.
- [Dynamic APIs](/docs/app/getting-started/caching-and-revalidating#dynamic-apis) - Understand more about the usage of dynamic server functions in your Next.js application.
