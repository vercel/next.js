...
- [Static and Dynamic Routes](/docs/app/getting-started/caching-and-revalidating#static-rendering) - Learn more about the differences between static and dynamic rendering in Next.js.
