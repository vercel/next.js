...
- [static/dynamic rendering](/docs/rendering/static-and-dynamic-rendering)
- [dynamic server value methods](/docs/data-fetching/fetching#server-component-functions)
