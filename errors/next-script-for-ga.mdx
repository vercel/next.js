...
> - Using `@next/third-parties` is not required. You can also use the `next/script` component directly. Refer to the [`next/script` documentation](/docs/app/guides/optimizing/scripts) to learn more.

## Useful Links

- [`@next/third-parties` Documentation](/docs/app/guides/third-party-libraries)
- [`next/script` Documentation](/docs/app/guides/optimizing/scripts)
