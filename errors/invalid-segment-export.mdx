...
## `invalid-segment-export`

#### Why This Error Occurred

Your [layout](/docs/api-reference/file-conventions/layout) or [page](/docs/api-reference/file-conventions/page) inside the app directory exports an invalid field. In these files, you're only allowed to export a default React component, or [Segment Configuration Options](/docs/api-reference/segment-config) for layout and pages, such as `revalidate`, `generateStaticParams`, etc.
