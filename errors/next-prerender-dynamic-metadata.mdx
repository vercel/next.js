...
description: How to fix pages where generateMetadata() accesses uncached or request-time data in an otherwise prerenderable route.
---
...
- [Streaming guide](/docs/app/building-your-application/routing/loading-ui-and-streaming)
- [Caching guide](/docs/app/building-your-application/data-fetching/fetching)
