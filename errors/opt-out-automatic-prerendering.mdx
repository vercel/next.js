...
## `opt-out-automatic-prerendering`

#### Why This Warning Occurred

You are using `getInitialProps` in your [Custom `<App>`](/docs/advanced-features/custom-app).

This causes **all pages** to be executed on the server -- disabling [Automatic Static Optimization](/docs/advanced-features/automatic-static-optimization).
