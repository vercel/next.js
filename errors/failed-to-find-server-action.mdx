...
- [Server Actions - Security](/docs/app/getting-started/updating-data#security)
- [Overwriting encryption keys (advanced)](/docs/app/getting-started/updating-data#overwriting-encryption-keys-advanced)
