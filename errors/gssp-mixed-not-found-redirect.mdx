...
- [`getStaticProps` Documentation](/docs/basic-features/data-fetching/get-static-props)
- [`getServerSideProps` Documentation](/docs/basic-features/data-fetching/get-server-side-props)
