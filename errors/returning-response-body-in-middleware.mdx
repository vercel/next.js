...
> Note: In Next.js v13.0.0 you can now respond to Middleware directly by returning a `NextResponse`. For more information, see [Producing a Response](/docs/advanced-features/middleware#producing-a-response).

#### Why This Error Occurred

[Middleware](/docs/advanced-features/middleware) can no longer produce a response body as of `v12.2+`.
