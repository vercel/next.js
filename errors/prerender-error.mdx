...
- If necessary, you can [disable server-side rendering](https://nextjs.org/docs/pages/building-your-application/optimizing/lazy-loading#with-no-ssr) for a specific component that may be attempting to use browser APIs like `window`
