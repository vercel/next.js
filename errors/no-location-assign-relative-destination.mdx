...
Use [`redirect()`](https://nextjs.org/docs/app/api-reference/functions/redirect) from `next/navigation`:
...
Use [`useRouter().push()`](https://nextjs.org/docs/app/api-reference/functions/use-router) from `next/navigation`:
...
- [Redirecting in Next.js](https://nextjs.org/docs/app/guides/redirecting)
- [Linking and Navigating in Next.js](https://nextjs.org/docs/app/building-your-application/routing/linking-and-navigating)
