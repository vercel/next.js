...
- Check for any [higher-order components](https://react.dev/reference/react/Component) that may have added `getInitialProps` to your [Custom `<App>`](/docs/pages/building-your-application/routing/custom-app).
