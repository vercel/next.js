...
- [Built-in CSS Support docs](/docs/app/getting-started/styling-and-assets/css) - Learn more about the built-in CSS/SCSS support in Next.js and how to use it effectively.
