...
- [`unstable_noStore()` function](https://nextjs.org/docs/canary/app/api-reference/legacy-apis/unstable_noStore)
- [`unstable_cache()` function](https://nextjs.org/docs/canary/app/api-reference/legacy-apis/unstable_cache)
