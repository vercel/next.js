...
Likewise, `unstable_prefetch()` and `unstable_navigation()` are not available there because no prefetch or navigation takes place while Next.js generates route parameters.
