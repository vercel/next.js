---
title: Dynamic API was called outside request/render scope
---
...
A Dynamic API was called outside of a request/render scope, I.e. not inside a Route Handler or a React Server Component/Server Action.
(The global scope is the most common place where these APIs won't work).
...
Make sure that all Dynamic API calls happen in a request/render scope.
