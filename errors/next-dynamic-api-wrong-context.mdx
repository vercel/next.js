---
title: Runtime API was called outside request
---

## Why This Error Occurred

A Runtime API was called outside a request scope. (Eg.: Global scope).

Note that Runtime APIs could have been called deep inside other modules/functions (eg.: third-party libraries) that are not immediately visible.

## Possible Ways to Fix It

Make sure that all Runtime API calls happen in a request scope.
