...
Refer to the [Built-In CSS Support](/docs/basic-features/built-in-css-support) documentation to learn about all the ways to include CSS to your application.
