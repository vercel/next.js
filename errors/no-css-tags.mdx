...
Refer to the [Built-In CSS Support](/docs/app/getting-started/styling-and-assets/css) documentation to learn about all the ways to include CSS to your application.
