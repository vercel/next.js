...
Follow the instructions in [CI Build Caching](/docs/pages/getting-started/deploying/ci-build-caching) to ensure your Next.js cache is persisted between builds.
