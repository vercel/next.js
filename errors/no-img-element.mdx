...
> **Note**: If deploying to a [managed hosting provider](/docs/pages/guides/self-hosting), remember to check provider pricing since optimized images might be charged differently than the original images.
>
