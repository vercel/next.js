...
1. Use [`next/image`](/docs/pages/api-reference/components/image) to improve performance with automatic [Image Optimization](/docs/pages/api-reference/components/images).
...
4. You can use a [custom image loader](/docs/pages/api-reference/components/images#loaders) to optimize images. Set [loaderFile](/docs/pages/api-reference/components/image#loaderfile) to the path of your custom loader.
...
- [Image Component and Image Optimization](/docs/pages/api-reference/components/images)
