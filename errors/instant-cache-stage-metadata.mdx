...
For the same insight in the page body or viewport code, see [Cache Stage API outside of Suspense](/docs/messages/instant-cache-stage) or [Cache Stage API in `generateViewport()`](/docs/messages/instant-cache-stage-viewport).
