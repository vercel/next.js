...
For the same insight in metadata or viewport code, see [Cache Stage API in `generateMetadata()`](/docs/messages/instant-cache-stage-metadata) or [Cache Stage API in `generateViewport()`](/docs/messages/instant-cache-stage-viewport).
