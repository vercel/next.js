---
title: Next.js encountered a Navigation Stage API outside of Suspense
kind: insight
---
...
For the same insight in metadata or viewport code, see [Navigation Stage API in `generateMetadata()`](/docs/messages/instant-cache-stage-metadata) or [Navigation Stage API in `generateViewport()`](/docs/messages/instant-cache-stage-viewport).
