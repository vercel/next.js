...
### Opting Into Fully Dynamic Rendering

If your route is intentionally fully dynamic and you do not want to provide granular `Suspense` boundaries, you can wrap your document body in a `Suspense` boundary inside your Root Layout. This signals to Next.js that the entire page may need to load dynamically, opting out of the static shell requirement.

Be aware that this disables prerendering for the route, meaning navigations may be slower because no static shell can be served while dynamic data loads.
