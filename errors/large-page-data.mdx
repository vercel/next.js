...
One of your pages includes a large amount of page data (>= 128kB). This can negatively affect performance since page data must be parsed by the client before the page is hydrated.
