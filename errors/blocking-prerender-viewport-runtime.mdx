...
- [Cache Stage API outside of Suspense](/docs/messages/instant-cache-stage)
- [Cache Stage API in `generateMetadata()`](/docs/messages/instant-cache-stage-metadata)
- [Cache Stage API in `generateViewport()`](/docs/messages/instant-cache-stage-viewport)
