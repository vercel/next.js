...
For the same insight in the page body or metadata code, see [Cache Stage API outside of Suspense](/docs/messages/instant-cache-stage) or [Cache Stage API in `generateMetadata()`](/docs/messages/instant-cache-stage-metadata).
