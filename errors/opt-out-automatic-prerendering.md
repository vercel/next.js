...
You are using `getInitialProps` in your [Custom `<App>`](https://nextjs.org/docs/basic-features/custom-app).
...
If you previously copied the [Custom `<App>`](https://nextjs.org/docs/basic-features/custom-app) example, you may be able to remove your `getInitialProps`.
