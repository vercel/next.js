...
- `instant = false` disables all instant-navigation checks for the route, not only this one. A [runtime data during prerendering](/docs/messages/blocking-prerender-runtime) error and [unrendered segment](/docs/messages/instant-unrendered-segment) warnings for the route are silenced too.
