...
Choose this fix when the page has parts that don't depend on the URL. A [`<Suspense>`](https://react.dev/reference/react/Suspense) boundary lets the shared prefetch ship instantly while the URL-specific region [streams](https://preview.nextjs.org/docs/app/glossary#streaming) in after the navigation.
