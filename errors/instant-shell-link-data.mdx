---
title: Next.js could not extract a reusable shell from this route
kind: insight
---
...
Without a reusable shell, navigations to this route may block until the server responds. Use this only when the route genuinely can't provide one.
