...
1. use `useReportWebVitals` hook as explained [here](https://nextjs.org/docs/app/api-reference/functions/use-report-web-vitals) and send the metrics to any backend of your choice.
2. [install and use](https://vercel.com/docs/speed-insights/quickstart) `@vercel/speed-insights` package into your application
