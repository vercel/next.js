...
Learn more: [Client Components](/docs/app/getting-started/server-and-client-components#client-components), [`Math.random()` in a Client Component](/docs/messages/blocking-prerender-random-client).
