...
- [Custom `_app` Documentation](/docs/advanced-features/custom-app)
- [Custom `_error` Documentation](/docs/advanced-features/custom-error-page)
- [Custom `_document` Documentation](/docs/advanced-features/custom-document)
