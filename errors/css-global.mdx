...
Rename the `styles.css` file to `styles.module.css`. Then [`import`](https://developer.mozilla.org/docs/Web/JavaScript/Reference/Statements/import) the [`styles.module.css` file](/docs/pages/building-your-application/styling/css-modules) in the component or page where you want to use the styles.
