...
3. For each failed job, read the relevant files (recommended order of reading):
   ...
   - `scripts/ci-failures/job-{id}-full-log.txt` - Full raw log (avoid reading unless necessary)
