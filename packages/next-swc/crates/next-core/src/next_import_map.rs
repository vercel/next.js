...
async fn rsc_aliases(
    ...
    if runtime == NextRuntime::Edge && ty.supports_react_server() {
        alias.extend(indexmap! {
            ...
            "react/compiler-runtime" => format!("next/dist/compiled/react{react_channel}/compiler-runtime.react-server"),
            ...
            "next/dist/compiled/react/compiler-runtime" => format!("next/dist/compiled/react{react_channel}/compiler-runtime.react-server"),
