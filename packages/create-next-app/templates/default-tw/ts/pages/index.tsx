    ...
    >
      <main className="row-start-2 flex flex-col items-center gap-8 sm:items-start">
        ...
        <div className="flex flex-col items-center gap-4 sm:flex-row">
          ...
          <a
            className="sm:min-w-44 flex h-10 items-center justify-center rounded-full border border-solid border-black/[.08] px-4 text-sm transition-colors hover:border-transparent hover:bg-[#f2f2f2] dark:border-white/[.145] dark:hover:bg-[#1a1a1a] sm:h-12 sm:px-5 sm:text-base"
