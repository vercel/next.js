    ...
    40: (t, e, r) => {
      ...
      minimatch.defaults = function (t) {
        ...
        var r = function minimatch(r, i, a) {
          return e.minimatch(r, i, ext(t, a))
        }
      ...
      function parse(t, e) {
        ...
        function clearStateChar() {
          if (d) {
            ...
            _.debug('clearStateChar %j %j', d, i)
            d = false
          }
        }
        ...
        for (var I = p.length - 1; I > -1; I--) {
          var M = p[I]
          var C = i.slice(0, M.reStart)
          var L = i.slice(M.reStart, M.reEnd - 8)
          var R = i.slice(M.reEnd - 8, M.reEnd)
          var T = i.slice(M.reEnd)
          R += T
