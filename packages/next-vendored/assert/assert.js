;(function () {
  var e = {
    ...
    176: function (e, t, r) {
      ...
      var u = Number.isNaN ? Number.isNaN : r(992)
    ...
    68: function (e, t, r) {
      ...
      defineProperties.supportsDescriptors = !!f
    ...
    495: function (e, t, r) {
      ...
      var a = function forEachArray(e, t, r) {
      ...
      var c = function forEachString(e, t, r) {
        for (var n = 0, o = e.length; n < o; n++) {
          if (r == null) {
            t(e.charAt(n), n, e)
          } else {
      ...
      var u = function forEachObject(e, t, r) {
        for (var n in e) {
          if (i.call(e, n)) {
            if (r == null) {
              t(e[n], n, e)
    ...
    925: function (e, t, r) {
      ...
      var E = h.call(Function.apply, Array.prototype.splice)
        ...
        for (var y = 1, v = true; y < r.length; y += 1) {
          ...
          if (m(g, f)) {
            ...
            if (c && y + 1 >= r.length) {
              var A = c(s, d)
              v = !!A
              if (v && 'get' in A && !('originalValue' in A.get)) {
                s = A.get
              } else {
                s = s[d]
              }
    ...
    923: function (e, t, r) {
      'use strict'
      var n = r(925)
      var o = n('%Object.defineProperty%', true)
      var i = function hasPropertyDescriptors() {
        if (o) {
          try {
            o({}, 'a', { value: 1 })
            return true
    ...
    743: function (e) {
      ...
      var i = /^\s*class\b/
      var a = function isES6ClassFunction(e) {
        try {
          var r = t.call(e)
          return i.test(r)
        } catch (e) {
      ...
      var c = function tryFunctionToStr(e) {
        try {
          if (a(e)) {
            return false
          }
      ...
      var y = '[object HTML document.all class]'
      ...
      if (typeof document === 'object') {
        var h = document.all
        if (u.call(h) === u.call(document.all)) {
          b = function isDocumentDotAll(e) {
            if (
              (d || !e) &&
    ...
    533: function (e, t, r) {
      ...
      var d = function tryAllTypedArrays(e) {
        var t = false
        n(v, function (r, n) {
          if (!t) {
            try {
    ...
    818: function (e) {
      ...
      var r = typeof globalThis === 'undefined' ? global : globalThis
      e.exports = function availableTypedArrays() {
        var e = []
        for (var n = 0; n < t.length; n++) {
          if (typeof r[t[n]] === 'function') {
            e[e.length] = t[n]
          }
        }
        return e
