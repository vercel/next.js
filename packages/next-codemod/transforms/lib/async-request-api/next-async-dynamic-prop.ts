...
function commentSpreadProps(
  ...
  const comment = ` Next.js Dynamic Async API Codemod: '${propsIdentifierName}' is spread as props. Any asynchronous properties of 'props' must be awaited when accessed. `
