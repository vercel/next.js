const serverExports = {
  ...
  unstable_handleInsightsReport:
    require('next/dist/server/lib/insights-handler').handleInsightsReport,
}
...
exports.unstable_handleInsightsReport =
  serverExports.unstable_handleInsightsReport
