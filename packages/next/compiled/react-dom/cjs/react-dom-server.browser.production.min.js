...
function Pa(a,b,c,d,e){a=void 0===a?"":a;b=void 0===b?Ha:x('<script nonce="'+E(b)+'">');var f=[];void 0!==c&&f.push(b,w((""+c).replace(Na,Oa)),Ia);if(void 0!==d)for(c=0;c<d.length;c++){var h=d[c],g="string"===typeof h?void 0:h.integrity;f.push(Ja,w(E("string"===typeof h?h:h.src)));g&&f.push(La,w(E(g)));f.push(Ma)}if(void 0!==e)for(d=0;d<e.length;d++)c=e[d],h="string"===typeof c?void 0:c.integrity,f.push(Ka,w(E("string"===typeof c?c:c.src))),h&&f.push(La,w(E(h))),f.push(Ma);return{bootstrapChunks:f,
...
function db(a,b,c,d){a.push(P(c));var e=c=null,f;for(f in b)if(y.call(b,f)){var h=b[f];if(null!=h)switch(f){case "children":c=h;break;case "dangerouslySetInnerHTML":e=h;break;default:L(a,d,f,h)}}a.push(M);ab(a,e,c);return"string"===typeof c?(a.push(w(E(c))),null):c}var eb=x("\n"),fb=/^[a-zA-Z][a-zA-Z:_\.\-\d]*$/,gb=new Map;function P(a){var b=gb.get(a);if(void 0===b){if(!fb.test(a))throw Error(k(65,a));b=x("<"+a);gb.set(a,b)}return b}var hb=x("<!DOCTYPE html>");
function ib(a,b,c,d,e,f,h){switch(c){case "select":a.push(P("select"));var g=null,m=null;for(v in d)if(y.call(d,v)){var n=d[v];if(null!=n)switch(v){case "children":g=n;break;case "dangerouslySetInnerHTML":m=n;break;case "defaultValue":case "value":break;default:L(a,e,v,n)}}a.push(M);ab(a,m,g);return g;case "option":m=f.selectedValue;a.push(P("option"));var t=n=null,r=null;var v=null;for(g in d)if(y.call(d,g)){var z=d[g];if(null!=z)switch(g){case "children":n=z;break;case "selected":r=z;break;case "dangerouslySetInnerHTML":v=
z;break;case "value":t=z;default:L(a,e,g,z)}}if(null!=m)if(d=null!==t?""+t:bb(n),ta(m))for(e=0;e<m.length;e++){if(""+m[e]===d){a.push(cb);break}}else""+m===d&&a.push(cb);else r&&a.push(cb);a.push(M);ab(a,v,n);return n;case "textarea":a.push(P("textarea"));v=m=g=null;for(n in d)if(y.call(d,n)&&(t=d[n],null!=t))switch(n){case "children":v=t;break;case "value":g=t;break;case "defaultValue":m=t;break;case "dangerouslySetInnerHTML":throw Error(k(91));default:L(a,e,n,t)}null===g&&null!==m&&(g=m);a.push(M);
if(null!=v){if(null!=g)throw Error(k(92));if(ta(v)&&1<v.length)throw Error(k(93));g=""+v}"string"===typeof g&&"\n"===g[0]&&a.push(eb);null!==g&&a.push(w(E(""+g)));return null;case "input":a.push(P("input"));t=v=n=g=null;for(m in d)if(y.call(d,m)&&(r=d[m],null!=r))switch(m){case "children":case "dangerouslySetInnerHTML":throw Error(k(399,"input"));case "defaultChecked":t=r;break;case "defaultValue":n=r;break;case "checked":v=r;break;case "value":g=r;break;default:L(a,e,m,r)}null!==v?L(a,e,"checked",
v):null!==t&&L(a,e,"checked",t);null!==g?L(a,e,"value",g):null!==n&&L(a,e,"value",n);a.push($a);return null;case "menuitem":a.push(P("menuitem"));for(var C in d)if(y.call(d,C)&&(g=d[C],null!=g))switch(C){case "children":case "dangerouslySetInnerHTML":throw Error(k(400));default:L(a,e,C,g)}a.push(M);return null;case "title":a.push(P("title"));g=null;for(z in d)if(y.call(d,z)&&(m=d[z],null!=m))switch(z){case "children":g=m;break;case "dangerouslySetInnerHTML":throw Error(k(434));default:L(a,e,z,m)}a.push(M);
return g;case "link":return Ea(d)?(h&&a.push(Sa),a=null):a=O(a,d,e),a;case "listing":case "pre":a.push(P(c));m=g=null;for(t in d)if(y.call(d,t)&&(n=d[t],null!=n))switch(t){case "children":g=n;break;case "dangerouslySetInnerHTML":m=n;break;default:L(a,e,t,n)}a.push(M);if(null!=m){if(null!=g)throw Error(k(60));if("object"!==typeof m||!("__html"in m))throw Error(k(61));d=m.__html;null!==d&&void 0!==d&&("string"===typeof d&&0<d.length&&"\n"===d[0]?a.push(eb,w(d)):a.push(w(""+d)))}"string"===typeof g&&
"\n"===g[0]&&a.push(eb);return g;case "area":case "base":case "br":case "col":case "embed":case "hr":case "img":case "keygen":case "meta":case "param":case "source":case "track":case "wbr":a.push(P(c));for(var D in d)if(y.call(d,D)&&(g=d[D],null!=g))switch(D){case "children":case "dangerouslySetInnerHTML":throw Error(k(399,c));default:L(a,e,D,g)}a.push($a);return null;case "annotation-xml":case "color-profile":case "font-face":case "font-face-src":case "font-face-uri":case "font-face-format":case "font-face-name":case "missing-glyph":return db(a,
d,c,e);case "head":return db(b,d,c,e);case "html":return 0===f.insertionMode&&b.push(hb),db(b,d,c,e);default:if(-1===c.indexOf("-")&&"string"!==typeof d.is)return db(a,d,c,e);a.push(P(c));m=g=null;for(r in d)if(y.call(d,r)&&(n=d[r],null!=n&&"function"!==typeof n&&"object"!==typeof n&&!1!==n))switch(!0===n&&(n=""),"className"===r&&(r="class"),r){case "children":g=n;break;case "dangerouslySetInnerHTML":m=n;break;case "style":Ya(a,e,n);break;case "suppressContentEditableWarning":case "suppressHydrationWarning":break;
default:ka(r)&&"function"!==typeof n&&"symbol"!==typeof n&&a.push(J,w(r),K,w(E(n)),I)}a.push(M);ab(a,m,g);return g}}var jb=x("</"),kb=x(">"),lb=x('<template id="'),mb=x('"></template>'),nb=x("\x3c!--$--\x3e"),ob=x('\x3c!--$?--\x3e<template id="'),pb=x('"></template>'),qb=x("\x3c!--$!--\x3e"),rb=x("\x3c!--/$--\x3e"),sb=x("<template"),tb=x('"'),ub=x(' data-dgst="');x(' data-msg="');x(' data-stck="');var vb=x("></template>");
...
function Sb(a,b,c,d){switch(c.insertionMode){case 0:case 1:return q(a,xb),q(a,b.segmentPrefix),q(a,w(d.toString(16))),u(a,yb);case 2:return q(a,Ab),q(a,b.segmentPrefix),q(a,w(d.toString(16))),u(a,Bb);case 3:return q(a,Db),q(a,b.segmentPrefix),q(a,w(d.toString(16))),u(a,Eb);case 4:return q(a,Gb),q(a,b.segmentPrefix),q(a,w(d.toString(16))),u(a,Hb);case 5:return q(a,Jb),q(a,b.segmentPrefix),q(a,w(d.toString(16))),u(a,Kb);case 6:return q(a,Mb),q(a,b.segmentPrefix),q(a,w(d.toString(16))),u(a,Nb);case 7:return q(a,
Pb),q(a,b.segmentPrefix),q(a,w(d.toString(16))),u(a,Qb);default:throw Error(k(397));}}function Tb(a,b){switch(b.insertionMode){case 0:case 1:return u(a,zb);case 2:return u(a,Cb);case 3:return u(a,Fb);case 4:return u(a,Ib);case 5:return u(a,Lb);case 6:return u(a,Ob);case 7:return u(a,Rb);default:throw Error(k(397));}}
...
function pc(a,b,c){var d=[],e=[],f=b.explicitPreloads,h=b.implicitPreloads;b.precedences.forEach(function(a){a.forEach(function(a){O(e,a.props,c);a.flushed=!0;a.inShell=!0;a.hint.flushed=!0})});f.forEach(function(a){a.flushed||(O(d,a.props,c),a.flushed=!0)});f.clear();h.forEach(function(a){a.flushed||(O(e,a.props,c),a.flushed=!0)});h.clear();f=!0;for(b=0;b<d.length-1;b++)q(a,d[b]);b<d.length&&(f=u(a,d[b]));for(b=0;b<e.length-1;b++)q(a,e[b]);b<e.length&&(f=u(a,e[b]));return f}
...
function vc(a,b){q(a,rc);var c=rc;b.forEach(function(b){if(!b.inShell)if(b.flushed)q(a,c),q(a,w(oc(""+b.href))),q(a,uc),c=sc;else{q(a,c);var d=b.precedence,f=b.props;q(a,w(oc(""+b.href)));d=""+d;q(a,tc);q(a,w(oc(d)));for(var h in f)if(y.call(f,h)){var g=f[h];if(null!=g)switch(h){case "href":case "rel":case "precedence":case "data-rprec":break;case "children":case "dangerouslySetInnerHTML":throw Error(k(399,"link"));default:a:{d=a;var m=h,n=m.toLowerCase();switch(typeof g){case "function":case "symbol":break a}switch(m){case "innerHTML":case "dangerouslySetInnerHTML":case "suppressContentEditableWarning":case "suppressHydrationWarning":case "style":break a;
case "className":n="class";break;case "hidden":if(!1===g)break a;break;case "src":case "href":break;default:if(!ka(m))break a}if(!(2<m.length)||"o"!==m[0]&&"O"!==m[0]||"n"!==m[1]&&"N"!==m[1])g=""+g,q(d,tc),q(d,w(oc(n))),q(d,tc),q(d,w(oc(g)))}}}q(a,uc);c=sc;b.flushed=!0;b.hint.flushed=!0}});q(a,uc)}
...
function ad(a,b,c,d){var e=void 0!==a.state?a.state:null;a.updater=$c;a.props=c;a.state=e;var f={queue:[],replace:!1};a._reactInternals=f;var h=b.contextType;a.context="object"===typeof h&&null!==h?h._currentValue:d;h=b.getDerivedStateFromProps;"function"===typeof h&&(h=h(c,e),e=null===h||void 0===h?e:F({},e,h),a.state=e);if("function"!==typeof b.getDerivedStateFromProps&&"function"!==typeof a.getSnapshotBeforeUpdate&&("function"===typeof a.UNSAFE_componentWillMount||"function"===typeof a.componentWillMount))if(b=
a.state,"function"===typeof a.componentWillMount&&a.componentWillMount(),"function"===typeof a.UNSAFE_componentWillMount&&a.UNSAFE_componentWillMount(),b!==a.state&&$c.enqueueReplaceState(a,a.state,null),null!==f.queue&&0<f.queue.length)if(b=f.queue,h=f.replace,f.queue=null,f.replace=!1,h&&1===b.length)a.state=b[0];else{f=h?b[0]:a.state;e=!0;for(h=h?1:0;h<b.length;h++){var g=b[h];g="function"===typeof g?g.call(a,f,c,d):g;null!=g&&(e?(e=!1,f=F({},f,g)):F(f,g))}a.state=f}else f.queue=null}
var bd={id:1,overflow:""};function cd(a,b,c){var d=a.id;a=a.overflow;var e=32-dd(d)-1;d&=~(1<<e);c+=1;var f=32-dd(b)+e;if(30<f){var h=e-e%5;f=(d&(1<<h)-1).toString(32);d>>=h;e-=h;return{id:1<<32-dd(b)+e|c<<e|d,overflow:f+a}}return{id:1<<f|c<<e|d,overflow:a}}var dd=Math.clz32?Math.clz32:ed,fd=Math.log,gd=Math.LN2;function ed(a){a>>>=0;return 0===a?32:31-(fd(a)/gd|0)|0}
...
onError:void 0===e?Id:e,onAllReady:void 0===f?Jd:f,onShellReady:void 0===h?Jd:h,onShellError:void 0===g?Jd:g,onFatalError:void 0===m?Jd:m};c=Ld(b,0,null,c,!1,!1);c.parentFlushed=!0;a=Md(b,null,a,null,c,t,Sc,null,bd);n.push(a);return b}
function Md(a,b,c,d,e,f,h,g,m){a.allPendingTasks++;null===d?a.pendingRootTasks++:d.pendingTasks++;var n={node:c,ping:function(){var b=a.pingedTasks;b.push(n);1===b.length&&Nd(a)},blockedBoundary:d,blockedSegment:e,abortSet:f,legacyContext:h,context:g,treeContext:m,thenableState:b};f.add(n);return n}function Ld(a,b,c,d,e,f){return{status:0,id:-1,index:b,parentFlushed:!1,chunks:[],children:[],formatContext:d,boundary:c,lastPushedText:e,textEmbedded:f}}
...
function Pd(a,b,c,d){var e=c.render(),f=d.childContextTypes;if(null!==f&&void 0!==f){var h=b.legacyContext;if("function"!==typeof c.getChildContext)d=h;else{c=c.getChildContext();for(var g in c)if(!(g in f))throw Error(k(108,Qc(d)||"Unknown",g));d=F({},h,c)}b.legacyContext=d;Z(a,b,null,e);b.legacyContext=h}else Z(a,b,null,e)}function Qd(a,b){if(a&&a.defaultProps){b=F({},b);a=a.defaultProps;for(var c in a)void 0===b[c]&&(b[c]=a[c]);return b}return b}
function Rd(a,b,c,d,e,f){if("function"===typeof d)if(d.prototype&&d.prototype.isReactComponent)c=Tc(d,b.legacyContext),f=d.contextType,f=new d(e,"object"===typeof f&&null!==f?f._currentValue:c),ad(f,d,e,c),Pd(a,b,f,d);else{f=Tc(d,b.legacyContext);R={};kd=b;od=T=0;U=c;c=d(e,f);c=sd(d,e,c,f);var h=0!==T;if("object"===typeof c&&null!==c&&"function"===typeof c.render&&void 0===c.$$typeof)ad(c,d,e,f),Pd(a,b,c,d);else if(h){e=b.treeContext;b.treeContext=cd(e,1,0);try{Z(a,b,null,c)}finally{b.treeContext=
e}}else Z(a,b,null,c)}else if("string"===typeof d){c=b.blockedSegment;f=ib(c.chunks,a.preamble,d,e,a.responseState,c.formatContext,c.lastPushedText);c.lastPushedText=!1;h=c.formatContext;c.formatContext=Ra(h,d,e);Sd(a,b,f);c.formatContext=h;a:{b=c.chunks;a=a.postamble;switch(d){case "area":case "base":case "br":case "col":case "embed":case "hr":case "img":case "input":case "keygen":case "link":case "meta":case "param":case "source":case "track":case "wbr":break a;case "body":a.unshift(jb,w(d),kb);
break a;case "html":a.push(jb,w(d),kb);break a}b.push(jb,w(d),kb)}c.lastPushedText=!1}else{switch(d){case Mc:case Kc:case zc:case Ac:case yc:Z(a,b,null,e.children);return;case Lc:"hidden"!==e.mode&&Z(a,b,null,e.children);return;case Gc:Z(a,b,null,e.children);return;case Jc:throw Error(k(343));case Fc:a:{d=b.blockedBoundary;c=b.blockedSegment;f=e.fallback;e=e.children;h=new Set;var g={id:null,rootSegmentID:-1,parentFlushed:!1,pendingTasks:0,forceClientRender:!1,completedSegments:[],byteSize:0,fallbackAbortableTasks:h,
errorDigest:null,resources:new Set},m=Ld(a,c.chunks.length,g,c.formatContext,!1,!1);c.children.push(m);c.lastPushedText=!1;var n=Ld(a,0,null,c.formatContext,!1,!1);n.parentFlushed=!0;b.blockedBoundary=g;b.blockedSegment=n;a.resources.boundaryResources=g.resources;try{if(Sd(a,b,e),n.lastPushedText&&n.textEmbedded&&n.chunks.push(Sa),n.status=1,0===g.pendingTasks&&(null!==a.completedRootSegment||0<a.pendingRootTasks)&&Fa(a.resources,g.resources),Td(g,n),0===g.pendingTasks)break a}catch(t){n.status=4,
g.forceClientRender=!0,g.errorDigest=Y(a,t)}finally{a.resources.boundaryResources=d?d.resources:null,b.blockedBoundary=d,b.blockedSegment=c}b=Md(a,null,f,d,m,h,b.legacyContext,b.context,b.treeContext);a.pingedTasks.push(b)}return}if("object"===typeof d&&null!==d)switch(d.$$typeof){case Ec:d=d.render;R={};kd=b;od=T=0;U=c;c=d(e,f);e=sd(d,e,c,f);if(0!==T){d=b.treeContext;b.treeContext=cd(d,1,0);try{Z(a,b,null,e)}finally{b.treeContext=d}}else Z(a,b,null,e);return;case Hc:d=d.type;e=Qd(d,e);Rd(a,b,c,d,
e,f);return;case Bc:c=e.children;d=d._context;e=e.value;f=d._currentValue;d._currentValue=e;h=Q;Q=e={parent:h,depth:null===h?0:h.depth+1,context:d,parentValue:f,value:e};b.context=e;Z(a,b,null,c);a=Q;if(null===a)throw Error(k(403));e=a.parentValue;a.context._currentValue=e===Oc?a.context._defaultValue:e;a=Q=a.parent;b.context=a;return;case Cc:e=e.children;e=e(d._currentValue);Z(a,b,null,e);return;case Ic:f=d._init;d=f(d._payload);e=Qd(d,e);Rd(a,b,c,d,e,void 0);return}throw Error(k(130,null==d?d:typeof d,
""));}}
...
function Sd(a,b,c){var d=b.blockedSegment.formatContext,e=b.legacyContext,f=b.context;try{return Z(a,b,null,c)}catch(n){if(td(),"object"===typeof n&&null!==n&&"function"===typeof n.then){var h=ud();c=n;var g=b.blockedSegment,m=Ld(a,g.chunks.length,null,g.formatContext,g.lastPushedText,!0);g.children.push(m);g.lastPushedText=!1;a=Md(a,h,b.node,b.blockedBoundary,m,b.abortSet,b.legacyContext,b.context,b.treeContext);hd(c);a=a.ping;c.then(a,a);b.blockedSegment.formatContext=d;b.legacyContext=e;b.context=
...
function Nd(a){if(2!==a.status){var b=Q,c=Gd.current;Gd.current=Ed;var d=Hd.current;Hd.current=Fd;var e=a.resources;va.push(G);G=e;e=Ga.current;Ga.current=za;var f=Dd;Dd=a.responseState;try{var h=a.pingedTasks,g;for(g=0;g<h.length;g++){var m=h[g];var n=a,t=m.blockedBoundary;n.resources.boundaryResources=t?t.resources:null;var r=m.blockedSegment;if(0===r.status){Zc(m.context);try{var v=m.thenableState;m.thenableState=null;Z(n,m,v,m.node);r.lastPushedText&&r.textEmbedded&&r.chunks.push(Sa);m.abortSet.delete(m);
...
null}}}h.splice(0,g);null!==a.destination&&Yd(a,a.destination)}catch(N){Y(a,N),Od(a,N)}finally{Dd=f,Gd.current=c,Hd.current=d,G=va.pop(),Ga.current=e,c===Ed&&Zc(b)}}}
function Zd(a,b,c){c.parentFlushed=!0;switch(c.status){case 0:var d=c.id=a.nextSegmentId++;c.lastPushedText=!1;c.textEmbedded=!1;a=a.responseState;q(b,lb);q(b,a.placeholderPrefix);a=w(d.toString(16));q(b,a);return u(b,mb);case 1:c.status=2;var e=!0;d=c.chunks;var f=0;c=c.children;for(var h=0;h<c.length;h++){for(e=c[h];f<e.index;f++)q(b,d[f]);e=$d(a,b,e)}for(;f<d.length-1;f++)q(b,d[f]);f<d.length&&(e=u(b,d[f]));return e;default:throw Error(k(390));}}
function $d(a,b,c){var d=c.boundary;if(null===d)return Zd(a,b,c);d.parentFlushed=!0;if(d.forceClientRender)d=d.errorDigest,u(b,qb),q(b,sb),d&&(q(b,ub),q(b,w(E(d))),q(b,tb)),u(b,vb),Zd(a,b,c);else if(0<d.pendingTasks){d.rootSegmentID=a.nextSegmentId++;0<d.completedSegments.length&&a.partialBoundaries.push(d);var e=a.responseState;var f=e.nextSuspenseID++;e=x(e.boundaryPrefix+f.toString(16));d=d.id=e;wb(b,a.responseState,d);Zd(a,b,c)}else if(d.byteSize>a.progressiveChunkSize)d.rootSegmentID=a.nextSegmentId++,
...
function be(a,b,c){a.resources.boundaryResources=c.resources;for(var d=c.completedSegments,e=0;e<d.length;e++)ce(a,b,c,d[e]);d.length=0;a=a.responseState;d=c.id;e=c.rootSegmentID;c=c.resources;var f;a:{for(f=c.values();;){var h=f.next().value;if(!h)break;if(!h.inShell){f=!0;break a}}f=!1}q(b,a.startInlineScript);f?a.sentCompleteBoundaryFunction?a.sentStyleInsertionFunction?q(b,bc):(a.sentStyleInsertionFunction=!0,q(b,ac)):(a.sentCompleteBoundaryFunction=!0,a.sentStyleInsertionFunction=!0,q(b,$b)):
a.sentCompleteBoundaryFunction?q(b,Zb):(a.sentCompleteBoundaryFunction=!0,q(b,Yb));if(null===d)throw Error(k(395));e=w(e.toString(16));q(b,d);q(b,cc);q(b,a.segmentPrefix);q(b,e);f?(q(b,dc),vc(b,c)):q(b,ec);return u(b,fc)}
function ce(a,b,c,d){if(2===d.status)return!0;var e=d.id;if(-1===e){if(-1===(d.id=c.rootSegmentID))throw Error(k(392));return ae(a,b,d)}ae(a,b,d);a=a.responseState;q(b,a.startInlineScript);a.sentCompleteSegmentFunction?q(b,Vb):(a.sentCompleteSegmentFunction=!0,q(b,Ub));q(b,a.segmentPrefix);e=w(e.toString(16));q(b,e);q(b,Wb);q(b,a.placeholderPrefix);q(b,e);return u(b,Xb)}
function Yd(a,b){l=new Uint8Array(512);p=0;try{var c,d=a.completedRootSegment;if(null!==d)if(0===a.pendingRootTasks){var e=a.preamble;for(c=0;c<e.length;c++)q(b,e[c]);pc(b,a.resources,a.responseState);$d(a,b,d);a.completedRootSegment=null;var f=a.responseState.bootstrapChunks;for(d=0;d<f.length-1;d++)q(b,f[d]);d<f.length&&u(b,f[d])}else return;else qc(b,a.resources,a.responseState);var h=a.clientRenderedBoundaries;for(c=0;c<h.length;c++){var g=h[c];f=b;var m=a.responseState,n=g.id,t=g.errorDigest,
r=g.errorMessage,v=g.errorComponentStack;q(f,m.startInlineScript);m.sentClientRenderFunction?q(f,hc):(m.sentClientRenderFunction=!0,q(f,gc));if(null===n)throw Error(k(395));q(f,n);q(f,ic);if(t||r||v)q(f,kc),q(f,w(mc(t||"")));if(r||v)q(f,kc),q(f,w(mc(r||"")));v&&(q(f,kc),q(f,w(mc(v))));if(!u(f,jc)){a.destination=null;c++;h.splice(0,c);return}}h.splice(0,c);var z=a.completedBoundaries;for(c=0;c<z.length;c++)if(!be(a,b,z[c])){a.destination=null;c++;z.splice(0,c);return}z.splice(0,c);da(b);l=new Uint8Array(512);
p=0;var C=a.partialBoundaries;for(c=0;c<C.length;c++){var D=C[c];a:{h=a;g=b;h.resources.boundaryResources=D.resources;var V=D.completedSegments;for(m=0;m<V.length;m++)if(!ce(h,g,D,V[m])){m++;V.splice(0,m);var xa=!1;break a}V.splice(0,m);xa=!0}if(!xa){a.destination=null;c++;C.splice(0,c);return}}C.splice(0,c);var aa=a.completedBoundaries;for(c=0;c<aa.length;c++)if(!be(a,b,aa[c])){a.destination=null;c++;aa.splice(0,c);return}aa.splice(0,c)}finally{if(0===a.allPendingTasks&&0===a.pingedTasks.length&&
...
exports.renderToReadableStream=function(a,b){return new Promise(function(c,d){var e,f,h=new Promise(function(a,b){f=a;e=b}),g=Kd(a,Pa(b?b.identifierPrefix:void 0,b?b.nonce:void 0,b?b.bootstrapScriptContent:void 0,b?b.bootstrapScripts:void 0,b?b.bootstrapModules:void 0),Qa(b?b.namespaceURI:void 0),b?b.progressiveChunkSize:void 0,b?b.onError:void 0,f,function(){var a=new ReadableStream({type:"bytes",pull:function(a){if(1===g.status)g.status=2,fa(a,g.fatalError);else if(2!==g.status&&null===g.destination){g.destination=
a;try{Yd(g,a)}catch(v){Y(g,v),Od(g,v)}}},cancel:function(){de(g)}},{highWaterMark:0});a.allReady=h;c(a)},function(a){h.catch(function(){});d(a)},e);if(b&&b.signal){var m=b.signal;if(m.aborted)de(g,m.reason);else{var n=function(){de(g,m.reason);m.removeEventListener("abort",n)};m.addEventListener("abort",n)}}Nd(g)})};exports.version="18.3.0-experimental-a8c16a004-20221012";
