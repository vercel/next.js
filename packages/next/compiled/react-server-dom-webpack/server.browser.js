...
var DefaultCacheDispatcher = {
  getCacheSignal: function () {
    ...
    var entry = currentCache.get(createSignal);
 ...
 * LICENSE file in the root directory of this source tree.
 */
var aa=__nccwpck_require__(522);var e=null,m=0;function p(a,b){if(0!==b.length)if(512<b.length)0<m&&(a.enqueue(new Uint8Array(e.buffer,0,m)),e=new Uint8Array(512),m=0),a.enqueue(b);else{var d=e.length-m;d<b.length&&(0===d?a.enqueue(e):(e.set(b.subarray(0,d),m),a.enqueue(e),b=b.subarray(d)),e=new Uint8Array(512),m=0);e.set(b,m);m+=b.length}return!0}var q=new TextEncoder;function r(a){return q.encode(a)}function ba(a,b){"function"===typeof a.error?a.error(b):a.close()}
var t=JSON.stringify,u=Symbol.for("react.module.reference"),v=Symbol.for("react.element"),ca=Symbol.for("react.fragment"),da=Symbol.for("react.provider"),ea=Symbol.for("react.server_context"),fa=Symbol.for("react.forward_ref"),ha=Symbol.for("react.suspense"),ia=Symbol.for("react.suspense_list"),ja=Symbol.for("react.memo"),w=Symbol.for("react.lazy"),ka=Symbol.for("react.default_value"),la=Symbol.for("react.memo_cache_sentinel");
function y(a,b,d,c,f,h,g){this.acceptsBooleans=2===b||3===b||4===b;this.attributeName=c;this.attributeNamespace=f;this.mustUseProperty=d;this.propertyName=a;this.type=b;this.sanitizeURL=h;this.removeEmptyString=g}var ma="children dangerouslySetInnerHTML defaultValue defaultChecked innerHTML suppressContentEditableWarning suppressHydrationWarning style".split(" ");ma.push("innerText","textContent");ma.forEach(function(a){new y(a,0,!1,a,null,!1,!1)});
...
fillOpacity:!0,floodOpacity:!0,stopOpacity:!0,strokeDasharray:!0,strokeDashoffset:!0,strokeMiterlimit:!0,strokeOpacity:!0,strokeWidth:!0},na=["Webkit","ms","Moz","O"];Object.keys(B).forEach(function(a){na.forEach(function(b){b=b+a.charAt(0).toUpperCase()+a.substring(1);B[b]=B[a]})});var oa=Array.isArray;r("<script>");r("\x3c/script>");r('<script src="');r('<script type="module" src="');r('" integrity="');r('" async="">\x3c/script>');r("\x3c!-- --\x3e");r(' style="');r(":");r(";");r(" ");r('="');r('"');
...
function D(a,b){if(a!==b){a.context._currentValue=a.parentValue;a=a.parent;var d=b.parent;if(null===a){if(null!==d)throw Error("The stacks must reach the root at the same time. This is a bug in React.");}else{if(null===d)throw Error("The stacks must reach the root at the same time. This is a bug in React.");D(a,d);b.context._currentValue=b.value}}}function pa(a){a.context._currentValue=a.parentValue;a=a.parent;null!==a&&pa(a)}
function qa(a){var b=a.parent;null!==b&&qa(b);a.context._currentValue=a.value}function ra(a,b){a.context._currentValue=a.parentValue;a=a.parent;if(null===a)throw Error("The depth must equal at least at zero before reaching the root. This is a bug in React.");a.depth===b.depth?D(a,b):ra(a,b)}
function sa(a,b){var d=b.parent;if(null===d)throw Error("The depth must equal at least at zero before reaching the root. This is a bug in React.");a.depth===d.depth?D(a,d):sa(a,d);b.context._currentValue=b.value}function E(a){var b=C;b!==a&&(null===b?qa(a):null===a?pa(b):b.depth===a.depth?D(b,a):b.depth>a.depth?ra(b,a):sa(b,a),C=a)}function ta(a,b){var d=a._currentValue;a._currentValue=b;var c=C;return C=a={parent:c,depth:null===c?0:c.depth+1,context:a,parentValue:d,value:b}}
function F(a){switch(a.status){case "fulfilled":case "rejected":break;default:"string"!==typeof a.status&&(a.status="pending",a.then(function(b){"pending"===a.status&&(a.status="fulfilled",a.value=b)},function(b){"pending"===a.status&&(a.status="rejected",a.reason=b)}))}}var G=null,H=0,I=null;function ua(){var a=I;I=null;return a}function va(a){return a._currentValue}
var Aa={useMemo:function(a){return a()},useCallback:function(a){return a},useDebugValue:function(){},useDeferredValue:J,useTransition:J,readContext:va,useContext:va,useReducer:J,useRef:J,useState:J,useInsertionEffect:J,useLayoutEffect:J,useImperativeHandle:J,useEffect:J,useId:wa,useMutableSource:J,useSyncExternalStore:J,useCacheRefresh:function(){return xa},useMemoCache:function(a){for(var b=Array(a),d=0;d<a;d++)b[d]=la;return b},use:za};
function J(){throw Error("This Hook is not supported in Server Components.");}function xa(){throw Error("Refreshing the cache is not supported in Server Components.");}function wa(){if(null===G)throw Error("useId can only be used while React is rendering");var a=G.identifierCount++;return":"+G.identifierPrefix+"S"+a.toString(32)+":"}function Ba(){}
function za(a){if(null!==a&&"object"===typeof a)if("function"===typeof a.then){var b=H;H+=1;switch(a.status){case "fulfilled":return a.value;case "rejected":throw a.reason;default:a:{if(null!==I){var d=I[b];if(void 0!==d)break a}d=null}if(null!==d)switch(a!==d&&a.then(Ba,Ba),d.status){case "fulfilled":return d.value;case "rejected":throw d.reason;default:throw d;}else throw null===I&&(I=[]),I[b]=a,a;}}else if(a.$$typeof===ea)return a._currentValue;throw Error("An unsupported type was passed to use(): "+
String(a));}function K(){return(new AbortController).signal}var Ca={getCacheSignal:function(){if(!L)throw Error("Reading the cache is only supported while rendering.");var a=L.get(K);void 0===a&&(a=K(),L.set(K,a));return a},getCacheForType:function(a){if(!L)throw Error("Reading the cache is only supported while rendering.");var b=L.get(a);void 0===b&&(b=a(),L.set(a,b));return b}},L=null,M=aa.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED,N=M.ContextRegistry,O=M.ReactCurrentDispatcher,P=M.ReactCurrentCache;
function Da(a){console.error(a)}
function Ea(a,b,d,c,f){var h=new Set,g=[],l={status:0,fatalError:null,destination:null,bundlerConfig:b,cache:new Map,nextChunkId:0,pendingChunks:0,abortableTasks:h,pingedTasks:g,completedModuleChunks:[],completedJSONChunks:[],completedErrorChunks:[],writtenSymbols:new Map,writtenModules:new Map,writtenProviders:new Map,identifierPrefix:f||"",identifierCount:1,onError:void 0===d?Da:d,toJSON:function(a,b){return Fa(l,this,a,b)}};l.pendingChunks++;b=Ga(c);a=Ha(l,a,b,h);g.push(a);return l}var Ia={};
function Ja(a){if("fulfilled"===a.status)return a.value;if("rejected"===a.status)throw a.reason;throw a;}
function Q(a,b,d,c,f){if(null!==d&&void 0!==d)throw Error("Refs cannot be used in Server Components, nor passed to Client Components.");if("function"===typeof a){if(a.$$typeof===u)return[v,a,b,c];H=0;I=f;c=a(c);return"object"===typeof c&&null!==c&&"function"===typeof c.then?(F(c),{$$typeof:w,_payload:c,_init:Ja}):c}if("string"===typeof a)return[v,a,b,c];if("symbol"===typeof a)return a===ca?c.children:[v,a,b,c];if(null!=a&&"object"===typeof a){if(a.$$typeof===u)return[v,a,b,c];switch(a.$$typeof){case w:var h=
a._init;a=h(a._payload);return Q(a,b,d,c,f);case fa:return b=a.render,H=0,I=f,b(c,void 0);case ja:return Q(a.type,b,d,c,f);case da:return ta(a._context,c.value),[v,a,b,{value:c.value,children:c.children,__pop:Ia}]}}throw Error("Unsupported Server Component type: "+R(a));}function Ha(a,b,d,c){var f={id:a.nextChunkId++,status:0,model:b,context:d,ping:function(){var b=a.pingedTasks;b.push(f);1===b.length&&Ka(a)},thenableState:null};c.add(f);return f}
function La(a,b,d,c){var f=c.filepath+"#"+c.name+(c.async?"#async":""),h=a.writtenModules,g=h.get(f);if(void 0!==g)return b[0]===v&&"1"===d?"@"+g.toString(16):"$"+g.toString(16);try{var l=a.bundlerConfig[c.filepath][c.name];var k=c.async?{id:l.id,chunks:l.chunks,name:l.name,async:!0}:l;a.pendingChunks++;var n=a.nextChunkId++,W=t(k),X="M"+n.toString(16)+":"+W+"\n";var Y=q.encode(X);a.completedModuleChunks.push(Y);h.set(f,n);return b[0]===v&&"1"===d?"@"+n.toString(16):"$"+n.toString(16)}catch(Z){return a.pendingChunks++,
b=a.nextChunkId++,d=S(a,Z),T(a,b,d),"$"+b.toString(16)}}function Ma(a){return Object.prototype.toString.call(a).replace(/^\[object (.*)\]$/,function(a,d){return d})}function R(a){switch(typeof a){case "string":return JSON.stringify(10>=a.length?a:a.substr(0,10)+"...");case "object":if(oa(a))return"[...]";a=Ma(a);return"Object"===a?"{...}":a;case "function":return"function";default:return String(a)}}
function U(a){if("string"===typeof a)return a;switch(a){case ha:return"Suspense";case ia:return"SuspenseList"}if("object"===typeof a)switch(a.$$typeof){case fa:return U(a.render);case ja:return U(a.type);case w:var b=a._payload;a=a._init;try{return U(a(b))}catch(d){}}return""}
function V(a,b){var d=Ma(a);if("Object"!==d&&"Array"!==d)return d;d=-1;var c=0;if(oa(a)){var f="[";for(var h=0;h<a.length;h++){0<h&&(f+=", ");var g=a[h];g="object"===typeof g&&null!==g?V(g):R(g);""+h===b?(d=f.length,c=g.length,f+=g):f=10>g.length&&40>f.length+g.length?f+g:f+"..."}f+="]"}else if(a.$$typeof===v)f="<"+U(a.type)+"/>";else{f="{";h=Object.keys(a);for(g=0;g<h.length;g++){0<g&&(f+=", ");var l=h[g],k=JSON.stringify(l);f+=('"'+l+'"'===k?l:k)+": ";k=a[l];k="object"===typeof k&&null!==k?V(k):
R(k);l===b?(d=f.length,c=k.length,f+=k):f=10>k.length&&40>f.length+k.length?f+k:f+"..."}f+="}"}return void 0===b?f:-1<d&&0<c?(a=" ".repeat(d)+"^".repeat(c),"\n  "+f+"\n  "+a):"\n  "+f}
function Fa(a,b,d,c){switch(c){case v:return"$"}for(;"object"===typeof c&&null!==c&&(c.$$typeof===v||c.$$typeof===w);)try{switch(c.$$typeof){case v:var f=c;c=Q(f.type,f.key,f.ref,f.props,null);break;case w:var h=c._init;c=h(c._payload)}}catch(g){if("object"===typeof g&&null!==g&&"function"===typeof g.then)return a.pendingChunks++,a=Ha(a,c,C,a.abortableTasks),c=a.ping,g.then(c,c),F(g),a.thenableState=ua(),"@"+a.id.toString(16);a.pendingChunks++;c=a.nextChunkId++;d=S(a,g);T(a,c,d);return"@"+c.toString(16)}if(null===
c)return null;if("object"===typeof c){if(c.$$typeof===u)return La(a,b,d,c);if(c.$$typeof===da)return f=c._context._globalName,b=a.writtenProviders,c=b.get(d),void 0===c&&(a.pendingChunks++,c=a.nextChunkId++,b.set(f,c),d="P"+c.toString(16)+":"+f+"\n",d=q.encode(d),a.completedJSONChunks.push(d)),"$"+c.toString(16);if(c===Ia){a=C;if(null===a)throw Error("Tried to pop a Context at the root of the app. This is a bug in React.");c=a.parentValue;a.context._currentValue=c===ka?a.context._defaultValue:c;C=
a.parent;return}return c}if("string"===typeof c)return a="$"===c[0]||"@"===c[0]?"$"+c:c,a;if("boolean"===typeof c||"number"===typeof c||"undefined"===typeof c)return c;if("function"===typeof c){if(c.$$typeof===u)return La(a,b,d,c);if(/^on[A-Z]/.test(d))throw Error("Event handlers cannot be passed to Client Component props."+V(b,d)+"\nIf you need interactivity, consider converting part of this to a Client Component.");throw Error("Functions cannot be passed directly to Client Components because they're not serializable."+
V(b,d));}if("symbol"===typeof c){f=a.writtenSymbols;h=f.get(c);if(void 0!==h)return"$"+h.toString(16);h=c.description;if(Symbol.for(h)!==c)throw Error("Only global symbols received from Symbol.for(...) can be passed to Client Components. The symbol Symbol.for("+(c.description+") cannot be found among global symbols.")+V(b,d));a.pendingChunks++;d=a.nextChunkId++;b=t(h);b="S"+d.toString(16)+":"+b+"\n";b=q.encode(b);a.completedModuleChunks.push(b);f.set(c,d);return"$"+d.toString(16)}if("bigint"===typeof c)throw Error("BigInt ("+
c+") is not yet supported in Client Component props."+V(b,d));throw Error("Type "+typeof c+" is not supported in Client Component props."+V(b,d));}function S(a,b){a=a.onError;b=a(b);if(null!=b&&"string"!==typeof b)throw Error('onError returned something with a type other than "string". onError should return a string and may return null or undefined but must not return anything else. It received something of type "'+typeof b+'" instead');return b||""}
function Na(a,b){null!==a.destination?(a.status=2,ba(a.destination,b)):(a.status=1,a.fatalError=b)}function T(a,b,d){d={digest:d};b="E"+b.toString(16)+":"+t(d)+"\n";b=q.encode(b);a.completedErrorChunks.push(b)}
function Ka(a){var b=O.current,d=P.current,c=L;O.current=Aa;P.current=Ca;L=a.cache;G=a;try{var f=a.pingedTasks;a.pingedTasks=[];for(var h=0;h<f.length;h++){var g=f[h];var l=a;if(0===g.status){E(g.context);try{var k=g.model;if("object"===typeof k&&null!==k&&k.$$typeof===v){var n=k,W=g.thenableState;g.model=k;k=Q(n.type,n.key,n.ref,n.props,W);for(g.thenableState=null;"object"===typeof k&&null!==k&&k.$$typeof===v;)n=k,g.model=k,k=Q(n.type,n.key,n.ref,n.props,null)}var X=g.id,Y=t(k,l.toJSON),Z="J"+X.toString(16)+
":"+Y+"\n";var Qa=q.encode(Z);l.completedJSONChunks.push(Qa);l.abortableTasks.delete(g);g.status=1}catch(x){if("object"===typeof x&&null!==x&&"function"===typeof x.then){var ya=g.ping;x.then(ya,ya);F(x);g.thenableState=ua()}else{l.abortableTasks.delete(g);g.status=4;var Ra=S(l,x);T(l,g.id,Ra)}}}}null!==a.destination&&Oa(a,a.destination)}catch(x){S(a,x),Na(a,x)}finally{O.current=b,P.current=d,L=c,G=null}}
function Oa(a,b){e=new Uint8Array(512);m=0;try{for(var d=a.completedModuleChunks,c=0;c<d.length;c++)if(a.pendingChunks--,!p(b,d[c])){a.destination=null;c++;break}d.splice(0,c);var f=a.completedJSONChunks;for(c=0;c<f.length;c++)if(a.pendingChunks--,!p(b,f[c])){a.destination=null;c++;break}f.splice(0,c);var h=a.completedErrorChunks;for(c=0;c<h.length;c++)if(a.pendingChunks--,!p(b,h[c])){a.destination=null;c++;break}h.splice(0,c)}finally{e&&0<m&&(b.enqueue(new Uint8Array(e.buffer,0,m)),e=null,m=0)}0===
a.pendingChunks&&b.close()}function Pa(a,b){try{var d=a.abortableTasks;if(0<d.size){var c=S(a,void 0===b?Error("The render was aborted by the server without a reason."):b);a.pendingChunks++;var f=a.nextChunkId++;T(a,f,c);d.forEach(function(b){b.status=3;var c="$"+f.toString(16);b=b.id;c=t(c);c="J"+b.toString(16)+":"+c+"\n";c=q.encode(c);a.completedErrorChunks.push(c)});d.clear()}null!==a.destination&&Oa(a,a.destination)}catch(h){S(a,h),Na(a,h)}}
function Ga(a){if(a){var b=C;E(null);for(var d=0;d<a.length;d++){var c=a[d],f=c[0];c=c[1];N[f]||(N[f]=aa.createServerContext(f,ka));ta(N[f],c)}a=C;E(b);return a}return null}
exports.renderToReadableStream=function(a,b,d){var c=Ea(a,b,d?d.onError:void 0,d?d.context:void 0,d?d.identifierPrefix:void 0);if(d&&d.signal){var f=d.signal;if(f.aborted)Pa(c,f.reason);else{var h=function(){Pa(c,f.reason);f.removeEventListener("abort",h)};f.addEventListener("abort",h)}}return new ReadableStream({type:"bytes",start:function(){Ka(c)},pull:function(a){if(1===c.status)c.status=2,ba(a,c.fatalError);else if(2!==c.status&&null===c.destination){c.destination=a;try{Oa(c,a)}catch(l){S(c,l),
Na(c,l)}}},cancel:function(){}},{highWaterMark:0})};
