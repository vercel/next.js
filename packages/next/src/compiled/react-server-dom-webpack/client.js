/******/ ;(() => {
  ...
  /******/ var __webpack_modules__ = {
      ...
      if (process.env.NODE_ENV !== 'production') {
        ;(function () {
          ...
          function resolveModuleReference(bundlerConfig, moduleData) {
            if (bundlerConfig) {
              var resolvedModuleData =
                bundlerConfig[moduleData.id][moduleData.name]
          ...
          function resolveModule(response, id, model) {
            ...
            if (promise) {
              ...
              if (!chunk) {
                chunks.set(
                  id,
                  createResolvedModuleChunk(response, moduleReference)
                )
              } else {
                // This can't actually happen because we don't have any forward
                // references to modules.
          ...
          function processStringChunk(response, chunk, offset) {
            ...
            while (linebreak > -1) {
              var fullrow =
                response._partialRow + chunk.substring(offset, linebreak)
    ...
    /***/ 879: /***/ (
       ...
       * LICENSE file in the root directory of this source tree.
       */
      var h = __nccwpck_require__(522),
        k = { stream: !0 }
      function m(a, b) {
        return a
          ? ((a = a[b.id][b.name]),
            b.async
              ? { id: a.id, chunks: a.chunks, name: a.name, async: !0 }
              : a)
          : b
      }
      var n = new Map(),
      ...
      var t = Symbol.for('react.element'),
        ...
        w = h.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ContextRegistry
      function x(a) {
        ...
        if ('' !== b) {
          ...
          switch (c) {
            case 'J':
              ...
              ;(c = d.get(e))
                ? 'pending' === c.status &&
                  ...
                  (c.value = b),
                  null !== a && (z(c), F(c, a, e)))
                : d.set(e, new y('resolved_model', b, null, a))
              break
            case 'M':
              Q(a, e, b)
              break
            ...
            case 'E':
              ...
              ;(d = c.get(e))
                ? G(d, b)
                : c.set(e, new y('rejected', null, b, a))
              break
            default:
              throw Error(
                "Error parsing the data. It's probably an error code or network corruption."
      ...
      exports.createFromXHR = function (a, b) {
        function c() {
          for (var b = a.responseText, c = f, d = b.indexOf('\n', c); -1 < d; )
            (c = e._partialRow + b.substring(c, d)),
              S(e, c),
              (e._partialRow = ''),
              (c = d + 1),
              (d = b.indexOf('\n', c))
        ...
        var e = U(b && b.moduleMap ? b.moduleMap : null),
          f = 0
