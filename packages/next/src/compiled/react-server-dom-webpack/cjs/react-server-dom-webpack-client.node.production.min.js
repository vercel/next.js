...
function pa(a){switch(a.status){case "resolved_model":O(a);break;case "resolved_module":P(a)}switch(a.status){case "fulfilled":return a.value;case "pending":case "blocked":throw a;default:throw a.reason;}}function Q(a,b){for(var c=0;c<a.length;c++)(0,a[c])(b)}function R(a,b,c){switch(a.status){case "fulfilled":Q(b,a.value);break;case "pending":case "blocked":a.value=b;a.reason=c;break;case "rejected":c&&Q(c,a.reason)}}
...
function qa(a,b,c){if(V){var d=V;d.deps++}else d=V={deps:1,value:null};return function(g){b[c]=g;d.deps--;0===d.deps&&"blocked"===a.status&&(g=a.value,a.status="fulfilled",a.value=d.value,null!==g&&Q(g,d.value))}}function ra(a){return function(b){return S(a,b)}}
...
case "pending":case "blocked":return d=U,a.then(qa(d,b,c),ra(d)),null;default:throw a.reason;}}}return d}function ua(){throw Error('Trying to call a function from "use server" but the callServer option was not implemented in your router runtime.');}function va(a,b,c,d){var g=new Map;a={_bundlerConfig:a,_moduleLoading:b,_callServer:void 0!==c?c:ua,_nonce:d,_chunks:g,_stringDecoder:new p.TextDecoder,_fromJSON:null,_rowState:0,_rowID:0,_rowTag:0,_rowLength:0,_buffer:[]};a._fromJSON=wa(a);return a}
