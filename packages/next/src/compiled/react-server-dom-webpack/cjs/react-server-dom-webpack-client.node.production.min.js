...
*/
'use strict';var p=require("util"),r=require("react-dom"),u={stream:!0};function v(a,b){if(a){var c=a[b[0]];if(a=c[b[2]])c=a.name;else{a=c["*"];if(!a)throw Error('Could not find the module "'+b[0]+'" in the React SSR Manifest. This is probably a bug in the React Server Components bundler.');c=b[2]}return 4===b.length?[a.id,a.chunks,c,1]:[a.id,a.chunks,c]}return b}var w=new Map;
...
function G(a){if(null===a||"object"!==typeof a)return null;a=F&&a[F]||a["@@iterator"];return"function"===typeof a?a:null}var H=Array.isArray,I=Object.getPrototypeOf,J=Object.prototype,K=new WeakMap;function aa(a){return Number.isFinite(a)?0===a&&-Infinity===1/a?"$-0":a:Infinity===a?"$Infinity":-Infinity===a?"$-Infinity":"$NaN"}
function ba(a,b,c,d){function g(e,f){if(null===f)return null;if("object"===typeof f){if("function"===typeof f.then){null===k&&(k=new FormData);l++;var t=h++;f.then(function(n){n=JSON.stringify(n,g);var q=k;q.append(b+t,n);l--;0===l&&c(q)},function(n){d(n)});return"$@"+t.toString(16)}if(H(f))return f;if(f instanceof FormData){null===k&&(k=new FormData);var D=k;e=h++;var m=b+e+"_";f.forEach(function(n,q){D.append(m+q,n)});return"$K"+e.toString(16)}if(f instanceof Map)return f=JSON.stringify(Array.from(f),
g),null===k&&(k=new FormData),e=h++,k.append(b+e,f),"$Q"+e.toString(16);if(f instanceof Set)return f=JSON.stringify(Array.from(f),g),null===k&&(k=new FormData),e=h++,k.append(b+e,f),"$W"+e.toString(16);if(G(f))return Array.from(f);e=I(f);if(e!==J&&(null===e||null!==I(e)))throw Error("Only plain objects, and a few built-ins, can be passed to Server Actions. Classes or null prototypes are not supported.");return f}if("string"===typeof f){if("Z"===f[f.length-1]&&this[e]instanceof Date)return"$D"+f;f=
"$"===f[0]?"$"+f:f;return f}if("boolean"===typeof f)return f;if("number"===typeof f)return aa(f);if("undefined"===typeof f)return"$undefined";if("function"===typeof f){f=K.get(f);if(void 0!==f)return f=JSON.stringify(f,g),null===k&&(k=new FormData),e=h++,k.set(b+e,f),"$F"+e.toString(16);throw Error("Client Functions cannot be passed directly to Server Functions. Only Functions passed from the Server can be passed back again.");}if("symbol"===typeof f){e=f.description;if(Symbol.for(e)!==f)throw Error("Only global symbols received from Symbol.for(...) can be passed to Server Functions. The symbol Symbol.for("+
(f.description+") cannot be found among global symbols."));return"$S"+e}if("bigint"===typeof f)return"$n"+f.toString(10);throw Error("Type "+typeof f+" is not supported as an argument to a Server Function.");}var h=1,l=0,k=null;a=JSON.stringify(a,g);null===k?c(a):(k.set(b+"0",a),0===l&&c(k))}var L=new WeakMap;
...
function da(a){var b=K.get(this);if(!b)throw Error("Tried to encode a Server Action from a different instance than the encoder is from. This is a bug in React.");var c=null;if(null!==b.bound){c=L.get(b);c||(c=ca(b),L.set(b,c));if("rejected"===c.status)throw c.reason;if("fulfilled"!==c.status)throw c;b=c.value;var d=new FormData;b.forEach(function(g,h){d.append("$ACTION_"+a+":"+h,g)});c=d;b="$ACTION_REF_"+a}else b="$ACTION_ID_"+b.id;return{name:b,method:"POST",encType:"multipart/form-data",data:c}}
function ea(a,b){var c=K.get(this);if(!c)throw Error("Tried to encode a Server Action from a different instance than the encoder is from. This is a bug in React.");if(c.id!==a)return!1;var d=c.bound;if(null===d)return 0===b;switch(d.status){case "fulfilled":return d.value.length===b;case "pending":throw d;case "rejected":throw d.reason;default:throw"string"!==typeof d.status&&(d.status="pending",d.then(function(g){d.status="fulfilled";d.value=g},function(g){d.status="rejected";d.reason=g})),d;}}
function M(a,b){Object.defineProperties(a,{$$FORM_ACTION:{value:da},$$IS_SIGNATURE_EQUAL:{value:ea},bind:{value:fa}});K.set(a,b)}var ha=Function.prototype.bind,ia=Array.prototype.slice;function fa(){var a=ha.apply(this,arguments),b=K.get(this);if(b){var c=ia.call(arguments,1),d=null;d=null!==b.bound?Promise.resolve(b.bound).then(function(g){return g.concat(c)}):Promise.resolve(c);M(a,{id:b.id,bound:d})}return a}
function ja(a,b){function c(){var d=Array.prototype.slice.call(arguments);return b(a,d)}M(c,{id:a,bound:null});return c}function N(a,b,c,d){this.status=a;this.value=b;this.reason=c;this._response=d}N.prototype=Object.create(Promise.prototype);
...
function na(a,b){function c(){var g=Array.prototype.slice.call(arguments),h=b.bound;return h?"fulfilled"===h.status?d(b.id,h.value.concat(g)):Promise.resolve(h).then(function(l){return d(b.id,l.concat(g))}):d(b.id,g)}var d=a._callServer;M(c,b);return c}function Y(a,b){a=X(a,b);switch(a.status){case "resolved_model":O(a)}switch(a.status){case "fulfilled":return a.value;default:throw a.reason;}}
function oa(a,b,c,d){if("$"===d[0]){if("$"===d)return C;switch(d[1]){case "$":return d.slice(1);case "L":return b=parseInt(d.slice(2),16),a=X(a,b),{$$typeof:E,_payload:a,_init:ka};case "@":return b=parseInt(d.slice(2),16),X(a,b);case "S":return Symbol.for(d.slice(2));case "F":return b=parseInt(d.slice(2),16),b=Y(a,b),na(a,b);case "Q":return b=parseInt(d.slice(2),16),a=Y(a,b),new Map(a);case "W":return b=parseInt(d.slice(2),16),a=Y(a,b),new Set(a);case "I":return Infinity;case "-":return"$-0"===d?
...
exports.createFromNodeStream=function(a,b,c){var d=qa(b.moduleMap,b.moduleLoading,Z,c&&"string"===typeof c.nonce?c.nonce:void 0);a.on("data",function(g){for(var h=0,l=d._rowState,k=d._rowID,e=d._rowTag,f=d._rowLength,t=d._buffer,D=g.length;h<D;){var m=-1;switch(l){case 0:m=g[h++];58===m?l=1:k=k<<4|(96<m?m-87:m-48);continue;case 1:l=g[h];84===l?(e=l,l=2,h++):64<l&&91>l?(e=l,l=3,h++):(e=0,l=3);continue;case 2:m=g[h++];44===m?l=4:f=f<<4|(96<m?m-87:m-48);continue;case 3:m=g.indexOf(10,h);break;case 4:m=
h+f,m>g.length&&(m=-1)}var n=g.byteOffset+h;if(-1<m){f=new Uint8Array(g.buffer,n,m-h);h=e;n=d._stringDecoder;e="";for(var q=0;q<t.length;q++)e+=n.decode(t[q],u);e+=n.decode(f);switch(h){case 73:sa(d,k,e);break;case 72:k=e[0];e=e.slice(1);e=JSON.parse(e,d._fromJSON);if(f=B.current)switch(k){case "D":f.prefetchDNS(e);break;case "C":"string"===typeof e?f.preconnect(e):f.preconnect(e[0],e[1]);break;case "L":k=e[0];h=e[1];3===e.length?f.preload(k,h,e[2]):f.preload(k,h);break;case "m":"string"===typeof e?
...
e.stack="Error: "+e.message;e.digest=f;f=d._chunks;(h=f.get(k))?S(h,e):f.set(k,new N("rejected",null,e,d));break;case 84:d._chunks.set(k,new N("fulfilled",e,null,d));break;case 68:throw Error("Failed to read a RSC payload created by a development version of React on the server while using a production version on the client. Always use matching versions on the server and the client.");default:f=d._chunks,(h=f.get(k))?(k=h,"pending"===k.status&&(f=k.value,h=k.reason,k.status="resolved_model",k.value=
e,null!==f&&(O(k),R(k,f,h)))):f.set(k,new N("resolved_model",e,null,d))}h=m;3===l&&h++;f=k=e=l=0;t.length=0}else{g=new Uint8Array(g.buffer,n,g.byteLength-h);t.push(g);f-=g.byteLength;break}}d._rowState=l;d._rowID=k;d._rowTag=e;d._rowLength=f});a.on("error",function(g){W(d,g)});a.on("end",function(){W(d,Error("Connection closed."))});return X(d,0)};exports.createServerReference=function(a){return ja(a,Z)};
