...
function wa(a){var b=a.parent;null!==b&&wa(b);a.context._currentValue=a.value}function xa(a,b){a.context._currentValue=a.parentValue;a=a.parent;if(null===a)throw Error("The depth must equal at least at zero before reaching the root. This is a bug in React.");a.depth===b.depth?F(a,b):xa(a,b)}
function ya(a,b){var c=b.parent;if(null===c)throw Error("The depth must equal at least at zero before reaching the root. This is a bug in React.");a.depth===c.depth?F(a,c):ya(a,c);b.context._currentValue=b.value}function za(a){var b=E;b!==a&&(null===b?wa(a):null===a?va(b):b.depth===a.depth?F(b,a):b.depth>a.depth?xa(b,a):ya(b,a),E=a)}function Aa(a,b){var c=a._currentValue;a._currentValue=b;var d=E;return E=a={parent:d,depth:null===d?0:d.depth+1,context:a,parentValue:c,value:b}}var Ba=Error("Suspense Exception: This is not a real error! It's an implementation detail of `use` to interrupt the current render. You must either rethrow it immediately, or move the `use` call outside of the `try/catch` block. Capturing without rethrowing will lead to unexpected behavior.\n\nTo handle async errors, wrap your component in an error boundary, or call the promise's `.catch` method and pass the result to `use`");
function Ca(){}function Da(a,b,c){c=a[c];void 0===c?a.push(b):c!==b&&(b.then(Ca,Ca),b=c);switch(b.status){case "fulfilled":return b.value;case "rejected":throw b.reason;default:if("string"!==typeof b.status)switch(a=b,a.status="pending",a.then(function(d){if("pending"===b.status){var e=b;e.status="fulfilled";e.value=d}},function(d){if("pending"===b.status){var e=b;e.status="rejected";e.reason=d}}),b.status){case "fulfilled":return b.value;case "rejected":throw b.reason;}G=b;throw Ba;}}var G=null;
function Ea(){if(null===G)throw Error("Expected a suspended thenable. This is a bug in React. Please file an issue.");var a=G;G=null;return a}var I=null,J=0,K=null;function Fa(){var a=K;K=null;return a}function Ga(a){return a._currentValue}
var Ka={useMemo:function(a){return a()},useCallback:function(a){return a},useDebugValue:function(){},useDeferredValue:L,useTransition:L,readContext:Ga,useContext:Ga,useReducer:L,useRef:L,useState:L,useInsertionEffect:L,useLayoutEffect:L,useImperativeHandle:L,useEffect:L,useId:Ha,useMutableSource:L,useSyncExternalStore:L,useCacheRefresh:function(){return Ia},useMemoCache:function(a){for(var b=Array(a),c=0;c<a;c++)b[c]=qa;return b},use:Ja};
function L(){throw Error("This Hook is not supported in Server Components.");}function Ia(){throw Error("Refreshing the cache is not supported in Server Components.");}function Ha(){if(null===I)throw Error("useId can only be used while React is rendering");var a=I.identifierCount++;return":"+I.identifierPrefix+"S"+a.toString(32)+":"}
...
function Xa(a){if(a){var b=E;za(null);for(var c=0;c<a.length;c++){var d=a[c],e=d[0];d=d[1];Ra[e]||(Ra[e]=ca.createServerContext(e,pa));Aa(Ra[e],d)}a=E;za(b);return a}return null}function jb(a,b){var c=b.lastIndexOf("#");a=b.substr(0,c);b=b.substr(c+1);return{specifier:a,name:b}}var kb=new Map;
function lb(a){var b=kb.get(a.specifier);if(b)return"fulfilled"===b.status?null:b;var c=import(a.specifier);c.then(function(d){c.status="fulfilled";c.value=d},function(d){c.status="rejected";c.reason=d});kb.set(a.specifier,c);return c}function mb(a){var b=kb.get(a.specifier);if("fulfilled"===b.status)b=b.value;else throw b.reason;return"*"===a.name?b:""===a.name?b.default:b[a.name]}function U(a,b,c,d){this.status=a;this.value=b;this.reason=c;this._response=d}U.prototype=Object.create(Promise.prototype);
...
exports.renderToPipeableStream=function(a,b,c){var d=Va(a,b,c?c.onError:void 0,c?c.context:void 0,c?c.identifierPrefix:void 0),e=!1;gb(d);return{pipe:function(g){if(e)throw Error("React currently only supports piping to one writable stream.");e=!0;hb(d,g);g.on("drain",xb(g,d));return g},abort:function(g){ib(d,g)}}};
