...
g];a.pendingChunks++;var B=a.nextChunkId++,Z=K(n),Jb=B.toString(16)+":I"+Z+"\n";a.completedImportChunks.push(Jb);f.set(e,B);return b[0]===C&&"1"===c?"$L"+B.toString(16):S(B)}catch(Kb){return a.pendingChunks++,b=a.nextChunkId++,c=N(a,Kb),O(a,b,c),S(b)}}function T(a,b){b=L(a,b,null,!1,a.abortableTasks);ob(a,b);return b.id}var U=!1;
...
function yb(a,b){for(var c=0;c<a.length;c++)(0,a[c])(b)}function zb(a,b){if("pending"===a.status||"blocked"===a.status){var c=a.reason;a.status="rejected";a.reason=b;null!==c&&yb(c,b)}}function Ab(a,b,c,d,e,f){var g=tb(a._bundlerConfig,b);a=vb(g);if(c)c=Promise.all([c,a]).then(function(k){k=k[0];var h=V(g);return h.bind.apply(h,[null].concat(k))});else if(a)c=Promise.resolve(a).then(function(){return V(g)});else return V(g);c.then(Bb(d,e,f),Cb(d));return null}var W=null,X=null;
...
function Gb(a,b){var c=2<arguments.length&&void 0!==arguments[2]?arguments[2]:new FormData,d=new Map,e={_bundlerConfig:a,_prefix:b,_formData:c,_chunks:d,_fromJSON:function(f,g){return"string"===typeof g?Fb(e,this,f,g):g}};return e}
function Hb(a,b,c){a._formData.append(b,c);var d=a._prefix;if(b.startsWith(d)&&(a=a._chunks,b=+b.slice(d.length),(b=a.get(b))&&"pending"===b.status&&(d=b.value,a=b.reason,b.status="resolved_model",b.value=c,null!==d)))switch(xb(b),b.status){case "fulfilled":yb(d,b.value);break;case "pending":case "blocked":b.value=d;b.reason=a;break;case "rejected":a&&yb(a,b.reason)}}function Ib(a){Db(a,Error("Connection closed."))}
function Lb(a,b,c){var d=tb(a,b);a=vb(d);return c?Promise.all([c,a]).then(function(e){e=e[0];var f=V(d);return f.bind.apply(f,[null].concat(e))}):a?Promise.resolve(a).then(function(){return V(d)}):Promise.resolve(V(d))}function Mb(a,b,c){a=Gb(b,c,a);Ib(a);a=Y(a,0);a.then(function(){});if("fulfilled"!==a.status)throw a.reason;return a.value}function Nb(a,b){return function(){return rb(b,a)}}function Ob(a,b){return function(){a.destination=null;sb(a,Error(b))}}
exports.createClientModuleProxy=function(a){a=x({},a,!1);return new Proxy(a,ma)};exports.decodeAction=function(a,b){var c=new FormData,d=null;a.forEach(function(e,f){f.startsWith("$ACTION_")?f.startsWith("$ACTION_REF_")?(e="$ACTION_"+f.slice(12)+":",e=Mb(a,b,e),d=Lb(b,e.id,e.bound)):f.startsWith("$ACTION_ID_")&&(e=f.slice(11),d=Lb(b,e,null)):c.append(f,e)});return null===d?null:d.then(function(e){return e.bind(null,c)})};
exports.decodeFormState=function(a,b,c){var d=b.get("$ACTION_KEY");if("string"!==typeof d)return Promise.resolve(null);var e=null;b.forEach(function(g,k){k.startsWith("$ACTION_REF_")&&(g="$ACTION_"+k.slice(12)+":",e=Mb(b,c,g))});if(null===e)return Promise.resolve(null);var f=e.id;return Promise.resolve(e.bound).then(function(g){return null===g?null:[a,d,f,g.length-1]})};exports.decodeReply=function(a,b){if("string"===typeof a){var c=new FormData;c.append("0",a);a=c}a=Gb(b,"",a);b=Y(a,0);Ib(a);return b};
exports.decodeReplyFromBusboy=function(a,b){var c=Gb(b,""),d=0,e=[];a.on("field",function(f,g){0<d?e.push(f,g):Hb(c,f,g)});a.on("file",function(f,g,k){var h=k.filename,p=k.mimeType;if("base64"===k.encoding.toLowerCase())throw Error("React doesn't accept base64 encoded file uploads because we don't expect form data passed from a browser to ever encode data that way. If that's the wrong assumption, we can easily fix it.");d++;var t=[];g.on("data",function(n){t.push(n)});g.on("end",function(){var n=
new Blob(t,{type:p});c._formData.append(f,n,h);d--;if(0===d){for(n=0;n<e.length;n+=2)Hb(c,e[n],e[n+1]);e.length=0}})});a.on("finish",function(){Ib(c)});a.on("error",function(f){Db(c,f)});return Y(c,0)};exports.registerClientReference=function(a,b,c){return x(a,b+"#"+c,!1)};exports.registerServerReference=function(a,b,c){return Object.defineProperties(a,{$$typeof:{value:w},$$id:{value:null===c?b:b+"#"+c},$$bound:{value:null},bind:{value:ia}})};
exports.renderToPipeableStream=function(a,b,c){var d=db(a,b,c?c.onError:void 0,c?c.identifierPrefix:void 0,c?c.onPostpone:void 0),e=!1;qb(d);return{pipe:function(f){if(e)throw Error("React currently only supports piping to one writable stream.");e=!0;rb(d,f);f.on("drain",Nb(f,d));f.on("error",Ob(d,"The destination stream errored while writing data."));f.on("close",Ob(d,"The destination stream closed early."));return f},abort:function(f){sb(d,f)}}};
