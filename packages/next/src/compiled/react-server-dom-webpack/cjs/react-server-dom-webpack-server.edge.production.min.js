...
if(!cb)throw Error('The "react" package in this environment is not configured correctly. The "react-server" condition must be enabled in any environment that runs React Server Components.');var O=JSON.stringify,db=cb.ReactCurrentCache,eb=ab.ReactCurrentDispatcher;function fb(a){console.error(a)}function gb(){}
...
writtenServerReferences:new Map,writtenProviders:new Map,identifierPrefix:e||"",identifierCount:1,taintCleanupQueue:[],onError:void 0===d?fb:d,onPostpone:void 0===f?gb:f,toJSON:function(r,E){return ib(l,this,r,E)}};l.pendingChunks++;b=jb(c);a=kb(l,a,b,g);h.push(a);return l}var P=null;function w(){if(P)return P;if(ua){var a=va.getStore();if(a)return a}return null}var lb={};
function mb(a,b){a.pendingChunks++;var d=kb(a,null,D,a.abortableTasks);switch(b.status){case "fulfilled":return d.model=b.value,nb(a,d),d.id;case "rejected":var c=Q(a,b.reason);R(a,d.id,c);return d.id;default:"string"!==typeof b.status&&(b.status="pending",b.then(function(e){"pending"===b.status&&(b.status="fulfilled",b.value=e)},function(e){"pending"===b.status&&(b.status="rejected",b.reason=e)}))}b.then(function(e){d.model=e;nb(a,d)},function(e){d.status=4;a.abortableTasks.delete(d);e=Q(a,e);R(a,
...
function T(a,b,d,c,e,f){if(null!==c&&void 0!==c)throw Error("Refs cannot be used in Server Components, nor passed to Client Components.");if("function"===typeof b){if(b.$$typeof===t)return[z,b,d,e];J=0;K=f;e=b(e);return"object"===typeof e&&null!==e&&"function"===typeof e.then?"fulfilled"===e.status?e.value:qb(e):e}if("string"===typeof b)return[z,b,d,e];if("symbol"===typeof b)return b===wa?e.children:[z,b,d,e];if(null!=b&&"object"===typeof b){if(b.$$typeof===t)return[z,b,d,e];switch(b.$$typeof){case A:var g=
b._init;b=g(b._payload);return T(a,b,d,c,e,f);case za:return a=b.render,J=0,K=f,a(e,void 0);case Ca:return T(a,b.type,d,c,e,f);case xa:return Ka(b._context,e.value),[z,b,d,{value:e.value,children:e.children,__pop:lb}]}}throw Error("Unsupported Server Component type: "+$a(b));}function nb(a,b){var d=a.pingedTasks;d.push(b);1===d.length&&(a.flushScheduled=null!==a.destination,setTimeout(function(){return rb(a)},0))}
function kb(a,b,d,c){var e={id:a.nextChunkId++,status:0,model:b,context:d,ping:function(){return nb(a,e)},thenableState:null};c.add(e);return e}function U(a){return"$"+a.toString(16)}function sb(a,b,d){a=O(d);b=b.toString(16)+":"+a+"\n";return q.encode(b)}
...
function R(a,b,d){d={digest:d};b=b.toString(16)+":E"+O(d)+"\n";b=q.encode(b);a.completedErrorChunks.push(b)}function vb(a,b,d){d=O(d,a.toJSON);b=b.toString(16)+":"+d+"\n";b=q.encode(b);a.completedRegularChunks.push(b)}
function rb(a){var b=eb.current;eb.current=Ua;var d=P;I=P=a;try{var c=a.pingedTasks;a.pingedTasks=[];for(var e=0;e<c.length;e++){var f=c[e];var g=a;if(0===f.status){Ja(f.context);try{var h=f.model;if("object"===typeof h&&null!==h&&h.$$typeof===z){var k=h,l=f.thenableState;f.model=h;h=T(g,k.type,k.key,k.ref,k.props,l);for(f.thenableState=null;"object"===typeof h&&null!==h&&h.$$typeof===z;)k=h,f.model=h,h=T(g,k.type,k.key,k.ref,k.props,null)}vb(g,f.id,h);g.abortableTasks.delete(f);f.status=1}catch(B){var r=
B===La?Oa():B;if("object"===typeof r&&null!==r&&"function"===typeof r.then){var E=f.ping;r.then(E,E);f.thenableState=Pa()}else{g.abortableTasks.delete(f);f.status=4;var G=Q(g,r);R(g,f.id,G)}}}}null!==a.destination&&S(a,a.destination)}catch(B){Q(a,B),wb(a,B)}finally{eb.current=b,I=null,P=d}}
...
b.close()}function xb(a){a.flushScheduled=null!==a.destination;ua?setTimeout(function(){return va.run(a,rb,a)},0):setTimeout(function(){return rb(a)},0)}function ob(a){if(!1===a.flushScheduled&&0===a.pingedTasks.length&&null!==a.destination){var b=a.destination;a.flushScheduled=!0;setTimeout(function(){return S(a,b)},0)}}
function yb(a,b){try{var d=a.abortableTasks;if(0<d.size){var c=void 0===b?Error("The render was aborted by the server without a reason."):b,e=Q(a,c);a.pendingChunks++;var f=a.nextChunkId++;R(a,f,e,c);d.forEach(function(g){g.status=3;var h=U(f);g=sb(a,g.id,h);a.completedErrorChunks.push(g)});d.clear()}null!==a.destination&&S(a,a.destination)}catch(g){Q(a,g),wb(a,g)}}
function jb(a){if(a){var b=D;Ja(null);for(var d=0;d<a.length;d++){var c=a[d],e=c[0];c=c[1];if(!bb[e]){var f={$$typeof:ya,_currentValue:C,_currentValue2:C,_defaultValue:C,_threadCount:0,Provider:null,Consumer:null,_globalName:e};f.Provider={$$typeof:xa,_context:f};bb[e]=f}Ka(bb[e],c)}a=D;Ja(b);return a}return null}
function zb(a,b){var d="",c=a[b];if(c)d=c.name;else{var e=b.lastIndexOf("#");-1!==e&&(d=b.slice(e+1),c=a[b.slice(0,e)]);if(!c)throw Error('Could not find the module "'+b+'" in the React Server Manifest. This is probably a bug in the React Server Components bundler.');}return[c.id,c.chunks,d]}var V=new Map;
function Ab(a){var b=globalThis.__next_require__(a);if("function"!==typeof b.then||"fulfilled"===b.status)return null;b.then(function(d){b.status="fulfilled";b.value=d},function(d){b.status="rejected";b.reason=d});return b}function Bb(){}
function Cb(a){for(var b=a[1],d=[],c=0;c<b.length;){var e=b[c++];b[c++];var f=V.get(e);if(void 0===f){f=__webpack_chunk_load__(e);d.push(f);var g=V.set.bind(V,e,null);f.then(g,Bb);V.set(e,f)}else null!==f&&d.push(f)}return 4===a.length?0===d.length?Ab(a[0]):Promise.all(d).then(function(){return Ab(a[0])}):0<d.length?Promise.all(d):null}
function W(a){var b=globalThis.__next_require__(a[0]);if(4===a.length&&"function"===typeof b.then)if("fulfilled"===b.status)b=b.value;else throw b.reason;return"*"===a[2]?b:""===a[2]?b.__esModule?b.default:b:b[a[2]]}function Db(a,b,d,c){this.status=a;this.value=b;this.reason=d;this._response=c}Db.prototype=Object.create(Promise.prototype);
...
function Gb(a,b){if("pending"===a.status||"blocked"===a.status){var d=a.reason;a.status="rejected";a.reason=b;null!==d&&Fb(d,b)}}function Hb(a,b,d,c,e,f){var g=zb(a._bundlerConfig,b);a=Cb(g);if(d)d=Promise.all([d,a]).then(function(h){h=h[0];var k=W(g);return k.bind.apply(k,[null].concat(h))});else if(a)d=Promise.resolve(a).then(function(){return W(g)});else return W(g);d.then(Ib(c,e,f),Jb(c));return null}var X=null,Y=null;
...
function Pb(a,b,d,c){if("$"===c[0])switch(c[1]){case "$":return c.slice(1);case "@":return b=parseInt(c.slice(2),16),Z(a,b);case "S":return Symbol.for(c.slice(2));case "F":return c=parseInt(c.slice(2),16),c=Lb(a,c),Hb(a,c.id,c.bound,X,b,d);case "Q":return b=parseInt(c.slice(2),16),a=Lb(a,b),new Map(a);case "W":return b=parseInt(c.slice(2),16),a=Lb(a,b),new Set(a);case "K":b=c.slice(2);var e=a._prefix+b+"_",f=new FormData;a._formData.forEach(function(g,h){h.startsWith(e)&&f.append(h.slice(e.length),
...
function Qb(a,b){var d=2<arguments.length&&void 0!==arguments[2]?arguments[2]:new FormData,c=new Map,e={_bundlerConfig:a,_prefix:b,_formData:d,_chunks:c,_fromJSON:function(f,g){return"string"===typeof g?Pb(e,this,f,g):g}};return e}function Rb(a){Kb(a,Error("Connection closed."))}function Sb(a,b,d){var c=zb(a,b);a=Cb(c);return d?Promise.all([d,a]).then(function(e){e=e[0];var f=W(c);return f.bind.apply(f,[null].concat(e))}):a?Promise.resolve(a).then(function(){return W(c)}):Promise.resolve(W(c))}
function Tb(a,b,d){a=Qb(b,d,a);Rb(a);a=Z(a,0);a.then(function(){});if("fulfilled"!==a.status)throw a.reason;return a.value}exports.createClientModuleProxy=function(a){a=v({},a,!1);return new Proxy(a,ka)};
...
exports.decodeFormState=function(a,b,d){var c=b.get("$ACTION_KEY");if("string"!==typeof c)return Promise.resolve(null);var e=null;b.forEach(function(g,h){h.startsWith("$ACTION_REF_")&&(g="$ACTION_"+h.slice(12)+":",e=Tb(b,d,g))});if(null===e)return Promise.resolve(null);var f=e.id;return Promise.resolve(e.bound).then(function(g){return null===g?null:[a,c,f,g.length-1]})};exports.decodeReply=function(a,b){if("string"===typeof a){var d=new FormData;d.append("0",a);a=d}a=Qb(b,"",a);Rb(a);return Z(a,0)};
...
exports.renderToReadableStream=function(a,b,d){var c=hb(a,b,d?d.onError:void 0,d?d.context:void 0,d?d.identifierPrefix:void 0,d?d.onPostpone:void 0);if(d&&d.signal){var e=d.signal;if(e.aborted)yb(c,e.reason);else{var f=function(){yb(c,e.reason);e.removeEventListener("abort",f)};e.addEventListener("abort",f)}}return new ReadableStream({type:"bytes",start:function(){xb(c)},pull:function(g){if(1===c.status)c.status=2,ca(g,c.fatalError);else if(2!==c.status&&null===c.destination){c.destination=g;try{S(c,
g)}catch(h){Q(c,h),wb(c,h)}}},cancel:function(g){c.destination=null;yb(c,g)}},{highWaterMark:0})};
