...
function N(a,b){var d=$a(a);if("Object"!==d&&"Array"!==d)return d;d=-1;var c=0;if(Ya(a)){var e="[";for(var f=0;f<a.length;f++){0<f&&(e+=", ");var g=a[f];g="object"===typeof g&&null!==g?N(g):ab(g);""+f===b?(d=e.length,c=g.length,e+=g):e=10>g.length&&40>e.length+g.length?e+g:e+"..."}e+="]"}else if(a.$$typeof===z)e="<"+M(a.type)+"/>";else{e="{";f=Object.keys(a);for(g=0;g<f.length;g++){0<g&&(e+=", ");var h=f[g],k=JSON.stringify(h);e+=('"'+h+'"'===k?h:k)+": ";k=a[h];k="object"===typeof k&&null!==k?N(k):
ab(k);h===b?(d=e.length,c=k.length,e+=k):e=10>k.length&&40>e.length+k.length?e+k:e+"..."}e+="}"}return void 0===b?e:-1<d&&0<c?(a=" ".repeat(d)+"^".repeat(c),"\n  "+e+"\n  "+a):"\n  "+e}var bb=aa.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED,cb=bb.ContextRegistry,db=aa.__SECRET_SERVER_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED;
if(!db)throw Error('The "react" package in this environment is not configured correctly. The "react-server" condition must be enabled in any environment that runs React Server Components.');var eb=Object.prototype,O=JSON.stringify,fb=db.ReactCurrentCache,gb=bb.ReactCurrentDispatcher;function hb(a){console.error(a)}function ib(){}
function jb(a,b,d,c,e,f){if(null!==fb.current&&fb.current!==Xa)throw Error("Currently React only supports one RSC renderer at a time.");ta.current=sa;fb.current=Xa;var g=new Set,h=[],k=new Set,l={status:0,flushScheduled:!1,fatalError:null,destination:null,bundlerConfig:b,cache:new Map,nextChunkId:0,pendingChunks:0,hints:k,abortableTasks:g,pingedTasks:h,completedImportChunks:[],completedHintChunks:[],completedRegularChunks:[],completedErrorChunks:[],writtenSymbols:new Map,writtenClientReferences:new Map,
writtenServerReferences:new Map,writtenProviders:new Map,identifierPrefix:e||"",identifierCount:1,taintCleanupQueue:[],onError:void 0===d?hb:d,onPostpone:void 0===f?ib:f,toJSON:function(r,E){return kb(l,this,r,E)}};l.pendingChunks++;b=lb(c);a=mb(l,a,b,g);h.push(a);return l}var P=null;function w(){if(P)return P;if(ua){var a=va.getStore();if(a)return a}return null}var nb={};
function ob(a,b){a.pendingChunks++;var d=mb(a,null,D,a.abortableTasks);switch(b.status){case "fulfilled":return d.model=b.value,pb(a,d),d.id;case "rejected":var c=Q(a,b.reason);R(a,d.id,c);return d.id;default:"string"!==typeof b.status&&(b.status="pending",b.then(function(e){"pending"===b.status&&(b.status="fulfilled",b.value=e)},function(e){"pending"===b.status&&(b.status="rejected",b.reason=e)}))}b.then(function(e){d.model=e;pb(a,d)},function(e){d.status=4;a.abortableTasks.delete(d);e=Q(a,e);R(a,
d.id,e);null!==a.destination&&S(a,a.destination)});return d.id}function x(a,b,d){d=O(d);var c=a.nextChunkId++;b="H"+b;b=c.toString(16)+":"+b;d=q.encode(b+d+"\n");a.completedHintChunks.push(d);qb(a)}function rb(a){if("fulfilled"===a.status)return a.value;if("rejected"===a.status)throw a.reason;throw a;}
...
b._init;b=g(b._payload);return T(a,b,d,c,e,f);case za:return a=b.render,J=0,K=f,a(e,void 0);case Ca:return T(a,b.type,d,c,e,f);case xa:return Ka(b._context,e.value),[z,b,d,{value:e.value,children:e.children,__pop:nb}]}}throw Error("Unsupported Server Component type: "+ab(b));}function pb(a,b){var d=a.pingedTasks;d.push(b);1===d.length&&(a.flushScheduled=null!==a.destination,setTimeout(function(){return tb(a)},0))}
function mb(a,b,d,c){var e={id:a.nextChunkId++,status:0,model:b,context:d,ping:function(){return pb(a,e)},thenableState:null};c.add(e);return e}function U(a){return"$"+a.toString(16)}function ub(a,b,d){a=O(d);b=b.toString(16)+":"+a+"\n";return q.encode(b)}
...
g];a.pendingChunks++;var G=a.nextChunkId++,B=O(E),Ob=G.toString(16)+":I"+B+"\n",Pb=q.encode(Ob);a.completedImportChunks.push(Pb);f.set(e,G);return b[0]===z&&"1"===d?"$L"+G.toString(16):U(G)}catch(Qb){return a.pendingChunks++,b=a.nextChunkId++,d=Q(a,Qb),R(a,b,d),U(b)}}function wb(a,b){a.pendingChunks++;var d=a.nextChunkId++;xb(a,d,b);return d}
function kb(a,b,d,c){switch(c){case z:return"$"}for(;"object"===typeof c&&null!==c&&(c.$$typeof===z||c.$$typeof===A);)try{switch(c.$$typeof){case z:var e=c;c=T(a,e.type,e.key,e.ref,e.props,null);break;case A:var f=c._init;c=f(c._payload)}}catch(g){d=g===La?Oa():g;if("object"===typeof d&&null!==d&&"function"===typeof d.then)return a.pendingChunks++,a=mb(a,c,D,a.abortableTasks),c=a.ping,d.then(c,c),a.thenableState=Pa(),"$L"+a.id.toString(16);a.pendingChunks++;c=a.nextChunkId++;d=Q(a,d);R(a,c,d);return"$L"+
c.toString(16)}if(null===c)return null;if("object"===typeof c){if(c.$$typeof===t)return vb(a,b,d,c);if("function"===typeof c.then)return"$@"+ob(a,c).toString(16);if(c.$$typeof===xa)return c=c._context._globalName,b=a.writtenProviders,d=b.get(d),void 0===d&&(a.pendingChunks++,d=a.nextChunkId++,b.set(c,d),c=ub(a,d,"$P"+c),a.completedRegularChunks.push(c)),U(d);if(c===nb){a=D;if(null===a)throw Error("Tried to pop a Context at the root of the app. This is a bug in React.");c=a.parentValue;a.context._currentValue=
c===C?a.context._defaultValue:c;D=a.parent;return}if(Ya(c))return c;if(c instanceof Map)return"$Q"+wb(a,Array.from(c)).toString(16);if(c instanceof Set)return"$W"+wb(a,Array.from(c)).toString(16);null===c||"object"!==typeof c?a=null:(a=Ea&&c[Ea]||c["@@iterator"],a="function"===typeof a?a:null);if(a)return Array.from(c);a=Za(c);if(a!==eb&&(null===a||null!==Za(a)))throw Error("Only plain objects, and a few built-ins, can be passed to Client Components from Server Components. Classes or null prototypes are not supported.");
...
function R(a,b,d){d={digest:d};b=b.toString(16)+":E"+O(d)+"\n";b=q.encode(b);a.completedErrorChunks.push(b)}function xb(a,b,d){d=O(d,a.toJSON);b=b.toString(16)+":"+d+"\n";b=q.encode(b);a.completedRegularChunks.push(b)}
function tb(a){var b=gb.current;gb.current=Ua;var d=P;I=P=a;try{var c=a.pingedTasks;a.pingedTasks=[];for(var e=0;e<c.length;e++){var f=c[e];var g=a;if(0===f.status){Ja(f.context);try{var h=f.model;if("object"===typeof h&&null!==h&&h.$$typeof===z){var k=h,l=f.thenableState;f.model=h;h=T(g,k.type,k.key,k.ref,k.props,l);for(f.thenableState=null;"object"===typeof h&&null!==h&&h.$$typeof===z;)k=h,f.model=h,h=T(g,k.type,k.key,k.ref,k.props,null)}xb(g,f.id,h);g.abortableTasks.delete(f);f.status=1}catch(B){var r=
B===La?Oa():B;if("object"===typeof r&&null!==r&&"function"===typeof r.then){var E=f.ping;r.then(E,E);f.thenableState=Pa()}else{g.abortableTasks.delete(f);f.status=4;var G=Q(g,r);R(g,f.id,G)}}}}null!==a.destination&&S(a,a.destination)}catch(B){Q(a,B),yb(a,B)}finally{gb.current=b,I=null,P=d}}
...
b.close()}function zb(a){a.flushScheduled=null!==a.destination;ua?setTimeout(function(){return va.run(a,tb,a)},0):setTimeout(function(){return tb(a)},0)}function qb(a){if(!1===a.flushScheduled&&0===a.pingedTasks.length&&null!==a.destination){var b=a.destination;a.flushScheduled=!0;setTimeout(function(){return S(a,b)},0)}}
function Ab(a,b){try{var d=a.abortableTasks;if(0<d.size){var c=void 0===b?Error("The render was aborted by the server without a reason."):b,e=Q(a,c);a.pendingChunks++;var f=a.nextChunkId++;R(a,f,e,c);d.forEach(function(g){g.status=3;var h=U(f);g=ub(a,g.id,h);a.completedErrorChunks.push(g)});d.clear()}null!==a.destination&&S(a,a.destination)}catch(g){Q(a,g),yb(a,g)}}
function lb(a){if(a){var b=D;Ja(null);for(var d=0;d<a.length;d++){var c=a[d],e=c[0];c=c[1];if(!cb[e]){var f={$$typeof:ya,_currentValue:C,_currentValue2:C,_defaultValue:C,_threadCount:0,Provider:null,Consumer:null,_globalName:e};f.Provider={$$typeof:xa,_context:f};cb[e]=f}Ka(cb[e],c)}a=D;Ja(b);return a}return null}
function Bb(a,b){var d="",c=a[b];if(c)d=c.name;else{var e=b.lastIndexOf("#");-1!==e&&(d=b.slice(e+1),c=a[b.slice(0,e)]);if(!c)throw Error('Could not find the module "'+b+'" in the React Server Manifest. This is probably a bug in the React Server Components bundler.');}return[c.id,c.chunks,d]}var V=new Map;
...
function Eb(a){for(var b=a[1],d=[],c=0;c<b.length;){var e=b[c++];b[c++];var f=V.get(e);if(void 0===f){f=__webpack_chunk_load__(e);d.push(f);var g=V.set.bind(V,e,null);f.then(g,Db);V.set(e,f)}else null!==f&&d.push(f)}return 4===a.length?0===d.length?Cb(a[0]):Promise.all(d).then(function(){return Cb(a[0])}):0<d.length?Promise.all(d):null}
...
function Rb(a,b,d,c){if("$"===c[0])switch(c[1]){case "$":return c.slice(1);case "@":return b=parseInt(c.slice(2),16),Z(a,b);case "S":return Symbol.for(c.slice(2));case "F":return c=parseInt(c.slice(2),16),c=Nb(a,c),Jb(a,c.id,c.bound,X,b,d);case "Q":return b=parseInt(c.slice(2),16),a=Nb(a,b),new Map(a);case "W":return b=parseInt(c.slice(2),16),a=Nb(a,b),new Set(a);case "K":b=c.slice(2);var e=a._prefix+b+"_",f=new FormData;a._formData.forEach(function(g,h){h.startsWith(e)&&f.append(h.slice(e.length),
...
function Sb(a,b){var d=2<arguments.length&&void 0!==arguments[2]?arguments[2]:new FormData,c=new Map,e={_bundlerConfig:a,_prefix:b,_formData:d,_chunks:c,_fromJSON:function(f,g){return"string"===typeof g?Rb(e,this,f,g):g}};return e}function Tb(a){Mb(a,Error("Connection closed."))}function Ub(a,b,d){var c=Bb(a,b);a=Eb(c);return d?Promise.all([d,a]).then(function(e){e=e[0];var f=W(c);return f.bind.apply(f,[null].concat(e))}):a?Promise.resolve(a).then(function(){return W(c)}):Promise.resolve(W(c))}
function Vb(a,b,d){a=Sb(b,d,a);Tb(a);a=Z(a,0);a.then(function(){});if("fulfilled"!==a.status)throw a.reason;return a.value}exports.createClientModuleProxy=function(a){a=v({},a,!1);return new Proxy(a,ka)};
...
exports.decodeFormState=function(a,b,d){var c=b.get("$ACTION_KEY");if("string"!==typeof c)return Promise.resolve(null);var e=null;b.forEach(function(g,h){h.startsWith("$ACTION_REF_")&&(g="$ACTION_"+h.slice(12)+":",e=Vb(b,d,g))});if(null===e)return Promise.resolve(null);var f=e.id;return Promise.resolve(e.bound).then(function(g){return null===g?null:[a,c,f,g.length-1]})};exports.decodeReply=function(a,b){if("string"===typeof a){var d=new FormData;d.append("0",a);a=d}a=Sb(b,"",a);Tb(a);return Z(a,0)};
...
exports.renderToReadableStream=function(a,b,d){var c=jb(a,b,d?d.onError:void 0,d?d.context:void 0,d?d.identifierPrefix:void 0,d?d.onPostpone:void 0);if(d&&d.signal){var e=d.signal;if(e.aborted)Ab(c,e.reason);else{var f=function(){Ab(c,e.reason);e.removeEventListener("abort",f)};e.addEventListener("abort",f)}}return new ReadableStream({type:"bytes",start:function(){zb(c)},pull:function(g){if(1===c.status)c.status=2,ca(g,c.fatalError);else if(2!==c.status&&null===c.destination){c.destination=g;try{S(c,
g)}catch(h){Q(c,h),yb(c,h)}}},cancel:function(g){c.destination=null;Ab(c,g)}},{highWaterMark:0})};
