...
function z(a) {
  for (var b = a.chunks, c = [], d = 0; d < b.length; d++) {
    var g = b[d],
      h = w.get(g)
    if (void 0 === h) {
      h = globalThis.__next_chunk_load__(g)
      c.push(h)
      var n = w.set.bind(w, g, null)
      h.then(n, y)
      w.set(g, h)
...
var A = r.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.Dispatcher,
...
function ea(a, b, c, d) {
  function g(l, e) {
    ...
    if ('object' === typeof e) {
      ...
      return e instanceof Map
        ? ((e = JSON.stringify(Array.from(e), g)),
          null === f && (f = new FormData()),
          (l = h++),
          f.append(b + l, e),
          '$Q' + l.toString(16))
    ...
    if ('string' === typeof e) {
      if ('Z' === e[e.length - 1] && this[l] instanceof Date) return '$D' + e
      e = '$' === e[0] ? '$' + e : e
      return e
    }
    if ('boolean' === typeof e) return e
    if ('number' === typeof e) return da(e)
    if ('undefined' === typeof e) return '$undefined'
    if ('function' === typeof e) {
      e = F.get(e)
      if (void 0 !== e)
        return (
          (e = JSON.stringify(e, g)),
          null === f && (f = new FormData()),
          (l = h++),
          f.set(b + l, e),
          '$F' + l.toString(16)
  ...
  null === f ? c(a) : (f.set(b + '0', a), 0 === n && c(f))
}
var G = new WeakMap()
function fa(a) {
  var b,
...
var J = t.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ContextRegistry
function K(a, b, c, d) {
  this.status = a
  this.value = b
  this.reason = c
...
function M(a) {
  try {
    var b = a.value,
      c = globalThis.__next_require__(b.id)
    if (b.async && 'function' === typeof c.then)
      if ('fulfilled' === c.status) c = c.value
      else throw c.reason
    var d =
      '*' === b.name
        ? c
...
function la(a, b) {
  function c() {
    ...
    return h
      ? 'fulfilled' === h.status
        ? d(b.id, h.value.concat(g))
        : Promise.resolve(h).then(function (n) {
            return d(b.id, n.concat(g))
          })
      : d(b.id, g)
  }
  var d = a._callServer
  ...
  if ('$' === d[0]) {
    ...
    switch (d[1]) {
      ...
      case 'P':
        return (
          (a = d.slice(2)),
          J[a] || (J[a] = t.createServerContext(a, aa)),
          J[a].Provider
        )
      case 'F':
        return (b = parseInt(d.slice(2), 16)), (b = W(a, b)), la(a, b)
      case 'Q':
      ...
      default:
        ...
        switch (a.status) {
          ...
          case 'pending':
          case 'blocked':
            return (d = R), a.then(ja(d, b, c), ka(d)), null
          default:
            throw a.reason
        }
    }
...
function pa(a, b, c) {
  ...
  } else g ? Q(g, h) : d.set(b, new K('resolved_module', h, null, a))
}
function oa(a) {
  return function (b, c) {
...
function Z(a, b) {
  function c(h) {
    var n = h.value
    if (h.done) U(a, Error('Connection closed.'))
    else {
      var f = 0,
        l = a._rowState,
        e = a._rowID,
        ...
        m = a._rowLength
      h = a._buffer
      for (var D = n.length; f < D; ) {
        var p = -1
        switch (l) {
          case 0:
            p = n[f++]
            58 === p ? (l = 1) : (e = (e << 4) | (96 < p ? p - 87 : p - 48))
            continue
          case 1:
            l = n[f]
            84 === l
          ...
          case 2:
            p = n[f++]
            44 === p ? (l = 4) : (m = (m << 4) | (96 < p ? p - 87 : p - 48))
            continue
          case 3:
            p = n.indexOf(10, f)
            break
          case 4:
            ;(p = f + m), p > n.length && (p = -1)
        }
        var q = n.byteOffset + f
        if (-1 < p) {
          f = new Uint8Array(n.buffer, q, p - f)
          m = a
          q = k
          var S = m._stringDecoder
          k = ''
          for (var I = 0; I < h.length; I++) k += S.decode(h[I], u)
          k += S.decode(f)
          switch (q) {
            case 73:
              pa(m, e, k)
            ...
            case 72:
              e = k[0]
              k = k.slice(1)
              m = JSON.parse(k, m._fromJSON)
              k = void 0
              if ((q = A.current))
                switch (
                  ('string' === typeof m ? (f = m) : ((f = m[0]), (k = m[1])),
                  e)
                ) {
                  case 'D':
                    q.prefetchDNS(f, k)
            ...
            case 69:
              ...
              ;(q = f.get(e))
                ? P(q, k)
                : f.set(e, new K('rejected', null, k, m))
              break
            case 84:
              m._chunks.set(e, new K('fulfilled', k, null, m))
              break
            default:
              ;(f = m._chunks),
                (q = f.get(e))
                  ? ((m = q),
                    ...
                    'pending' === m.status &&
                      ...
                      (m.value = e),
                      null !== k && (L(m), O(m, k, f))))
                  : f.set(e, new K('resolved_model', k, null, m))
          }
          f = p
          3 === l && f++
          m = e = k = l = 0
          ...
          n = new Uint8Array(n.buffer, q, n.byteLength - f)
          h.push(n)
          m -= n.byteLength
          break
        }
