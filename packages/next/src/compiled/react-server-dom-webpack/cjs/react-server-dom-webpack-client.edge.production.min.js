...
function w(a){for(var b=a.chunks,c=[],d=0;d<b.length;d++){var f=b[d],e=t.get(f);if(void 0===e){e=globalThis.__next_chunk_load__(f);c.push(e);var m=t.set.bind(t,f,null);e.then(m,v);t.set(f,e)}else null!==e&&c.push(e)}if(a.async){if(b=u.get(a.id))return"fulfilled"===b.status?null:b;var l=Promise.all(c).then(function(){return globalThis.__next_require__(a.id)});l.then(function(g){l.status="fulfilled";l.value=g},function(g){l.status="rejected";l.reason=g});u.set(a.id,l);return l}return 0<c.length?Promise.all(c):null}
