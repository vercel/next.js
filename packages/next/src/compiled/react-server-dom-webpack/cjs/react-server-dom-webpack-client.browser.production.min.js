...
return"$T"+K(c,d).toString(16)}if("symbol"===typeof d){if(void 0===c)throw Error("Symbols cannot be passed to a Server Function without a temporary reference set. Pass a TemporaryReferenceSet to the options.");return"$T"+K(c,d).toString(16)}if("bigint"===typeof d)return"$n"+d.toString(10);throw Error("Type "+typeof d+" is not supported as an argument to a Server Function.");}var l=1,h=0,k=null;a=JSON.stringify(a,g);null===k?e(a):(k.set(b+"0",a),0===h&&e(k))}function la(a,b){L.set(a,b)}
