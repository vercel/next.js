...
function nb(a,b){a.pendingChunks++;var d=lb(a,null,E,a.abortableTasks);switch(b.status){case "fulfilled":return d.model=b.value,ob(a,d),d.id;case "rejected":var c=Q(a,b.reason);R(a,d.id,c);return d.id;default:"string"!==typeof b.status&&(b.status="pending",b.then(function(e){"pending"===b.status&&(b.status="fulfilled",b.value=e)},function(e){"pending"===b.status&&(b.status="rejected",b.reason=e)}))}b.then(function(e){d.model=e;ob(a,d)},function(e){d.status=4;a.abortableTasks.delete(d);e=Q(a,e);R(a,
d.id,e);null!==a.destination&&S(a,a.destination)});return d.id}function z(a,b,d){d=O(d);var c=a.nextChunkId++;b="H"+b;b=c.toString(16)+":"+b;a.completedHintChunks.push(b+d+"\n");pb(a)}function qb(a){if("fulfilled"===a.status)return a.value;if("rejected"===a.status)throw a.reason;throw a;}
...
a.pendingChunks++;var G=a.nextChunkId++,C=O(n),Rb=G.toString(16)+":I"+C+"\n";a.completedImportChunks.push(Rb);f.set(e,G);return b[0]===B&&"1"===d?"$L"+G.toString(16):U(G)}catch(Sb){return a.pendingChunks++,b=a.nextChunkId++,d=Q(a,Sb),R(a,b,d),U(b)}}function vb(a,b){a.pendingChunks++;var d=a.nextChunkId++;wb(a,d,b);return d}
...
function Ub(a,b,d){var c=Bb(a,b);a=Eb(c);return d?Promise.all([d,a]).then(function(e){e=e[0];var f=W(c);return f.bind.apply(f,[null].concat(e))}):a?Promise.resolve(a).then(function(){return W(c)}):Promise.resolve(W(c))}function Vb(a,b,d){a=Pb(b,d,a);Tb(a);a=Z(a,0);a.then(function(){});if("fulfilled"!==a.status)throw a.reason;return a.value}function Wb(a,b){return function(){return zb(b,a)}}function Xb(a,b){return function(){a.destination=null;Ab(a,Error(b))}}
