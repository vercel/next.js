...
var Oa={useMemo:function(a){return a()},useCallback:function(a){return a},useDebugValue:function(){},useDeferredValue:J,useTransition:J,readContext:Ka,useContext:Ka,useReducer:J,useRef:J,useState:J,useInsertionEffect:J,useLayoutEffect:J,useImperativeHandle:J,useEffect:J,useId:La,useSyncExternalStore:J,useCacheRefresh:function(){return Ma},useMemoCache:function(a){for(var b=Array(a),d=0;d<a;d++)b[d]=xa;return b},use:Na};
...
writtenServerReferences:new Map,writtenProviders:new Map,identifierPrefix:e||"",identifierCount:1,onError:void 0===d?Za:d,toJSON:function(q,u){return ab(h,this,q,u)}};h.pendingChunks++;b=bb(c);a=cb(h,a,b,f);g.push(a);return h}var N=null;function w(){if(N)return N;var a=na.getStore();return a?a:null}var db={};
...
a.pendingChunks++;var A=a.nextChunkId++,oa=M(n);var B=A.toString(16)+":I"+oa+"\n";a.completedImportChunks.push(B);f.set(e,A);return b[0]===z&&"1"===d?"$L"+A.toString(16):S(A)}catch(Cb){return a.pendingChunks++,b=a.nextChunkId++,d=O(a,Cb),P(a,b,d),S(b)}}function kb(a,b){a.pendingChunks++;var d=a.nextChunkId++;b=lb(a,d,b);a.completedRegularChunks.push(b);return d}
...
c.toString(16)}if(null===c)return null;if("object"===typeof c){if(c.$$typeof===v)return jb(a,b,d,c);if("function"===typeof c.then)return"$@"+eb(a,c).toString(16);if(c.$$typeof===qa)return c=c._context._globalName,b=a.writtenProviders,d=b.get(d),void 0===d&&(a.pendingChunks++,d=a.nextChunkId++,b.set(c,d),c=mb(a,d,"$P"+c),a.completedRegularChunks.push(c)),S(d);if(c===db){a=D;if(null===a)throw Error("Tried to pop a Context at the root of the app. This is a bug in React.");c=a.parentValue;a.context._currentValue=
c===wa?a.context._defaultValue:c;D=a.parent;return}return c instanceof Map?"$Q"+kb(a,Array.from(c)).toString(16):c instanceof Set?"$W"+kb(a,Array.from(c)).toString(16):!Sa(c)&&(null===c||"object"!==typeof c?a=null:(a=ya&&c[ya]||c["@@iterator"],a="function"===typeof a?a:null),a)?Array.from(c):c}if("string"===typeof c){if("Z"===c[c.length-1]&&b[d]instanceof Date)return"$D"+c;if(1024<=c.length)return a.pendingChunks+=2,d=a.nextChunkId++,b="string"===typeof c?Buffer.byteLength(c,"utf8"):c.byteLength,
b=d.toString(16)+":T"+b.toString(16)+",",a.completedRegularChunks.push(b,c),S(d);a="$"===c[0]?"$"+c:c;return a}if("boolean"===typeof c)return c;if("number"===typeof c)return a=c,Number.isFinite(a)?0===a&&-Infinity===1/a?"$-0":a:Infinity===a?"$Infinity":-Infinity===a?"$-Infinity":"$NaN";if("undefined"===typeof c)return"$undefined";if("function"===typeof c){if(c.$$typeof===v)return jb(a,b,d,c);if(c.$$typeof===fa)return d=a.writtenServerReferences,b=d.get(c),void 0!==b?a="$F"+b.toString(16):(b=c.$$bound,
b={id:c.$$id,bound:b?Promise.resolve(b):null},a=kb(a,b),d.set(c,a),a="$F"+a.toString(16)),a;if(/^on[A-Z]/.test(d))throw Error("Event handlers cannot be passed to Client Component props."+L(b,d)+"\nIf you need interactivity, consider converting part of this to a Client Component.");throw Error('Functions cannot be passed directly to Client Components unless you explicitly expose it by marking it with "use server".'+L(b,d));}if("symbol"===typeof c){e=a.writtenSymbols;f=e.get(c);if(void 0!==f)return S(f);
f=c.description;if(Symbol.for(f)!==c)throw Error("Only global symbols received from Symbol.for(...) can be passed to Client Components. The symbol Symbol.for("+(c.description+") cannot be found among global symbols.")+L(b,d));a.pendingChunks++;d=a.nextChunkId++;b=mb(a,d,"$S"+f);a.completedImportChunks.push(b);e.set(c,d);return S(d)}if("bigint"===typeof c)return"$n"+c.toString(10);throw Error("Type "+typeof c+" is not supported in Client Component props."+L(b,d));}
...
f.status=1}catch(B){var n=B===Fa?Ia():B;if("object"===typeof n&&null!==n&&"function"===typeof n.then){var A=f.ping;n.then(A,A);f.thenableState=Ja()}else{g.abortableTasks.delete(f);f.status=4;var oa=O(g,n);P(g,f.id,oa)}}}}null!==a.destination&&Q(a,a.destination)}catch(B){O(a,B),nb(a,B)}finally{Xa.current=b,G=null,N=d}}
...
null;c++;break}g.splice(0,c)}finally{a.flushScheduled=!1,l&&0<m&&b.write(l.subarray(0,m)),l=null,m=0,p=!0}"function"===typeof b.flush&&b.flush();0===a.pendingChunks&&b.end()}function ob(a){a.flushScheduled=null!==a.destination;setImmediate(function(){return na.run(a,ib,a)})}function y(a){if(!1===a.flushScheduled&&0===a.pingedTasks.length&&null!==a.destination){var b=a.destination;a.flushScheduled=!0;setImmediate(function(){return Q(a,b)})}}
function pb(a,b){if(1===a.status)a.status=2,b.destroy(a.fatalError);else if(2!==a.status&&null===a.destination){a.destination=b;try{Q(a,b)}catch(d){O(a,d),nb(a,d)}}}
function qb(a,b){try{var d=a.abortableTasks;if(0<d.size){var c=O(a,void 0===b?Error("The render was aborted by the server without a reason."):b);a.pendingChunks++;var e=a.nextChunkId++;P(a,e,c);d.forEach(function(f){f.status=3;var g=S(e);f=mb(a,f.id,g);a.completedErrorChunks.push(f)});d.clear()}null!==a.destination&&Q(a,a.destination)}catch(f){O(a,f),nb(a,f)}}
function bb(a){if(a){var b=D;Da(null);for(var d=0;d<a.length;d++){var c=a[d],e=c[0];c=c[1];Wa[e]||(Wa[e]=ca.createServerContext(e,wa));Ea(Wa[e],c)}a=D;Da(b);return a}return null}function lb(a,b,d){a=M(d,a.toJSON);return b.toString(16)+":"+a+"\n"}function mb(a,b,d){a=M(d);return b.toString(16)+":"+a+"\n"}
function rb(a,b){var d="",c=a[b];if(c)d=c.name;else{var e=b.lastIndexOf("#");-1!==e&&(d=b.slice(e+1),c=a[b.slice(0,e)]);if(!c)throw Error('Could not find the module "'+b+'" in the React Server Manifest. This is probably a bug in the React Server Components bundler.');}return{id:c.id,chunks:c.chunks,name:d,async:!1}}var T=new Map;
function sb(a){var b=globalThis.__next_require__(a);if("function"!==typeof b.then||"fulfilled"===b.status)return null;b.then(function(d){b.status="fulfilled";b.value=d},function(d){b.status="rejected";b.reason=d});return b}function tb(){}
function ub(a){for(var b=a.chunks,d=[],c=0;c<b.length;c++){var e=b[c],f=T.get(e);if(void 0===f){f=globalThis.__next_chunk_load__(e);d.push(f);var g=T.set.bind(T,e,null);f.then(g,tb);T.set(e,f)}else null!==f&&d.push(f)}return a.async?0===d.length?sb(a.id):Promise.all(d).then(function(){return sb(a.id)}):0<d.length?Promise.all(d):null}
function U(a){var b=globalThis.__next_require__(a.id);if(a.async&&"function"===typeof b.then)if("fulfilled"===b.status)b=b.value;else throw b.reason;return"*"===a.name?b:""===a.name?b.__esModule?b.default:b:b[a.name]}function V(a,b,d,c){this.status=a;this.value=b;this.reason=d;this._response=c}V.prototype=Object.create(Promise.prototype);
V.prototype.then=function(a,b){switch(this.status){case "resolved_model":W(this)}switch(this.status){case "fulfilled":a(this.value);break;case "pending":case "blocked":a&&(null===this.value&&(this.value=[]),this.value.push(a));b&&(null===this.reason&&(this.reason=[]),this.reason.push(b));break;default:b(this.reason)}};function vb(a,b){for(var d=0;d<a.length;d++)(0,a[d])(b)}
function wb(a,b){if("pending"===a.status||"blocked"===a.status){var d=a.reason;a.status="rejected";a.reason=b;null!==d&&vb(d,b)}}function xb(a,b,d,c,e,f){var g=rb(a._bundlerConfig,b);a=ub(g);if(d)d=Promise.all([d,a]).then(function(k){k=k[0];var h=U(g);return h.bind.apply(h,[null].concat(k))});else if(a)d=Promise.resolve(a).then(function(){return U(g)});else return U(g);d.then(yb(c,e,f),zb(c));return null}var X=null,Y=null;
function W(a){var b=X,d=Y;X=a;Y=null;try{var c=JSON.parse(a.value,a._response._fromJSON);null!==Y&&0<Y.deps?(Y.value=c,a.status="blocked",a.value=null,a.reason=null):(a.status="fulfilled",a.value=c)}catch(e){a.status="rejected",a.reason=e}finally{X=b,Y=d}}function Ab(a,b){a._chunks.forEach(function(d){"pending"===d.status&&wb(d,b)})}
function Z(a,b){var d=a._chunks,c=d.get(b);c||(c=a._formData.get(a._prefix+b),c=null!=c?new V("resolved_model",c,null,a):new V("pending",null,null,a),d.set(b,c));return c}function yb(a,b,d){if(Y){var c=Y;c.deps++}else c=Y={deps:1,value:null};return function(e){b[d]=e;c.deps--;0===c.deps&&"blocked"===a.status&&(e=a.value,a.status="fulfilled",a.value=c.value,null!==e&&vb(e,c.value))}}function zb(a){return function(b){return wb(a,b)}}
function Bb(a,b){a=Z(a,b);"resolved_model"===a.status&&W(a);if("fulfilled"!==a.status)throw a.reason;return a.value}
function Db(a,b,d,c){if("$"===c[0])switch(c[1]){case "$":return c.slice(1);case "@":return b=parseInt(c.slice(2),16),Z(a,b);case "S":return Symbol.for(c.slice(2));case "F":return c=parseInt(c.slice(2),16),c=Bb(a,c),xb(a,c.id,c.bound,X,b,d);case "Q":return b=parseInt(c.slice(2),16),a=Bb(a,b),new Map(a);case "W":return b=parseInt(c.slice(2),16),a=Bb(a,b),new Set(a);case "K":b=c.slice(2);var e=a._prefix+b+"_",f=new FormData;a._formData.forEach(function(g,k){k.startsWith(e)&&f.append(k.slice(e.length),
g)});return f;case "I":return Infinity;case "-":return"$-0"===c?-0:-Infinity;case "N":return NaN;case "u":return;case "D":return new Date(Date.parse(c.slice(2)));case "n":return BigInt(c.slice(2));default:c=parseInt(c.slice(1),16);a=Z(a,c);switch(a.status){case "resolved_model":W(a)}switch(a.status){case "fulfilled":return a.value;case "pending":case "blocked":return c=X,a.then(yb(c,b,d),zb(c)),null;default:throw a.reason;}}return c}
function Eb(a,b){var d=2<arguments.length&&void 0!==arguments[2]?arguments[2]:new FormData,c=new Map,e={_bundlerConfig:a,_prefix:b,_formData:d,_chunks:c,_fromJSON:function(f,g){return"string"===typeof g?Db(e,this,f,g):g}};return e}
function Fb(a,b,d){a._formData.append(b,d);var c=a._prefix;if(b.startsWith(c)&&(a=a._chunks,b=+b.slice(c.length),(b=a.get(b))&&"pending"===b.status&&(c=b.value,a=b.reason,b.status="resolved_model",b.value=d,null!==c)))switch(W(b),b.status){case "fulfilled":vb(c,b.value);break;case "pending":case "blocked":b.value=c;b.reason=a;break;case "rejected":a&&vb(a,b.reason)}}function Gb(a){Ab(a,Error("Connection closed."))}
function Hb(a,b,d){var c=rb(a,b);a=ub(c);return d?Promise.all([d,a]).then(function(e){e=e[0];var f=U(c);return f.bind.apply(f,[null].concat(e))}):a?Promise.resolve(a).then(function(){return U(c)}):Promise.resolve(U(c))}function Ib(a,b){return function(){return pb(b,a)}}
exports.decodeAction=function(a,b){var d=new FormData,c=null;a.forEach(function(e,f){if(f.startsWith("$ACTION_"))if(f.startsWith("$ACTION_REF_")){e="$ACTION_"+f.slice(12)+":";e=Eb(b,e,a);Gb(e);e=Z(e,0);e.then(function(){});if("fulfilled"!==e.status)throw e.reason;e=e.value;c=Hb(b,e.id,e.bound)}else f.startsWith("$ACTION_ID_")&&(e=f.slice(11),c=Hb(b,e,null));else d.append(f,e)});return null===c?null:c.then(function(e){return e.bind(null,d)})};
exports.decodeReply=function(a,b){if("string"===typeof a){var d=new FormData;d.append("0",a);a=d}a=Eb(b,"",a);Gb(a);return Z(a,0)};
exports.decodeReplyFromBusboy=function(a,b){var d=Eb(b,""),c=0,e=[];a.on("field",function(f,g){0<c?e.push(f,g):Fb(d,f,g)});a.on("file",function(f,g,k){var h=k.filename,q=k.mimeType;if("base64"===k.encoding.toLowerCase())throw Error("React doesn't accept base64 encoded file uploads because we don't expect form data passed from a browser to ever encode data that way. If that's the wrong assumption, we can easily fix it.");c++;var u=[];g.on("data",function(n){u.push(n)});g.on("end",function(){var n=
new Blob(u,{type:q});d._formData.append(f,n,h);c--;if(0===c){for(n=0;n<e.length;n+=2)Fb(d,e[n],e[n+1]);e.length=0}})});a.on("finish",function(){Gb(d)});a.on("error",function(f){Ab(d,f)});return Z(d,0)};
exports.renderToPipeableStream=function(a,b,d){var c=$a(a,b,d?d.onError:void 0,d?d.context:void 0,d?d.identifierPrefix:void 0),e=!1;ob(c);return{pipe:function(f){if(e)throw Error("React currently only supports piping to one writable stream.");e=!0;pb(c,f);f.on("drain",Ib(f,c));return f},abort:function(f){qb(c,f)}}};
