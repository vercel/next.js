...
function la(a,b){switch(b){case "$$typeof":return a.$$typeof;case "$$id":return a.$$id;case "$$async":return a.$$async;case "name":return a.name;case "defaultProps":return;case "toJSON":return;case Symbol.toPrimitive:return Object.prototype[Symbol.toPrimitive];case "__esModule":var c=a.$$id;a.default=x(function(){throw Error("Attempted to call the default export of "+c+" from the server but it's on the client. It's not possible to invoke a client function from the server, it can only be rendered as a Component or passed to props of a Client Component.");
},a.$$id+"#",a.$$async);return!0;case "then":if(a.then)return a.then;if(a.$$async)return;var d=x({},a.$$id,!0),e=new Proxy(d,ma);a.status="fulfilled";a.value=e;return a.then=x(function(f){return Promise.resolve(f(e))},a.$$id+"#then",!1)}d=a[b];d||(d=x(function(){throw Error("Attempted to call "+String(b)+"() from the server but "+String(b)+" is on the client. It's not possible to invoke a client function from the server, it can only be rendered as a Component or passed to props of a Client Component.");
...
function I(a){if("string"===typeof a)return a;switch(a){case Aa:return"Suspense";case Ba:return"SuspenseList"}if("object"===typeof a)switch(a.$$typeof){case za:return I(a.render);case Ca:return I(a.type);case D:var b=a._payload;a=a._init;try{return I(a(b))}catch(c){}}return""}
function J(a,b){var c=Va(a);if("Object"!==c&&"Array"!==c)return c;c=-1;var d=0;if(Ta(a)){var e="[";for(var f=0;f<a.length;f++){0<f&&(e+=", ");var g=a[f];g="object"===typeof g&&null!==g?J(g):Wa(g);""+f===b?(c=e.length,d=g.length,e+=g):e=10>g.length&&40>e.length+g.length?e+g:e+"..."}e+="]"}else if(a.$$typeof===C)e="<"+I(a.type)+"/>";else{e="{";f=Object.keys(a);for(g=0;g<f.length;g++){0<g&&(e+=", ");var k=f[g],h=JSON.stringify(k);e+=('"'+k+'"'===h?k:h)+": ";h=a[k];h="object"===typeof h&&null!==h?J(h):
Wa(h);k===b?(c=e.length,d=h.length,e+=h):e=10>h.length&&40>e.length+h.length?e+h:e+"..."}e+="}"}return void 0===b?e:-1<c&&0<d?(a=" ".repeat(c)+"^".repeat(d),"\n  "+e+"\n  "+a):"\n  "+e}var Xa=ca.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED,Ya=ca.__SECRET_SERVER_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED;if(!Ya)throw Error('The "react" package in this environment is not configured correctly. The "react-server" condition must be enabled in any environment that runs React Server Components.');
...
function db(a,b,c,d,e){if(null!==$a.current&&$a.current!==Sa)throw Error("Currently React only supports one RSC renderer at a time.");va.current=ua;$a.current=Sa;var f=new Set,g=[],k=new Set;b={status:0,flushScheduled:!1,fatalError:null,destination:null,bundlerConfig:b,cache:new Map,nextChunkId:0,pendingChunks:0,hints:k,abortableTasks:f,pingedTasks:g,completedImportChunks:[],completedHintChunks:[],completedRegularChunks:[],completedErrorChunks:[],writtenSymbols:new Map,writtenClientReferences:new Map,
writtenServerReferences:new Map,writtenObjects:new WeakMap,identifierPrefix:d||"",identifierCount:1,taintCleanupQueue:[],onError:void 0===c?bb:c,onPostpone:void 0===e?cb:e};a=L(b,a,null,!1,f);g.push(a);return b}var M=null;function y(){if(M)return M;var a=wa.getStore();return a?a:null}
...
function jb(a,b,c,d,e){var f=b.thenableState;b.thenableState=null;Ja=0;G=f;d=d(e,void 0);if("object"===typeof d&&null!==d&&"function"===typeof d.then){e=d;if("fulfilled"===e.status)return e.value;d=ib(d)}e=b.keyPath;f=b.implicitSlot;null!==c?b.keyPath=null===e?c:e+","+c:null===e&&(b.implicitSlot=!0);a=Q(a,b,R,"",d);b.keyPath=e;b.implicitSlot=f;return a}
function kb(a,b,c,d,e,f){if(null!==e&&void 0!==e)throw Error("Refs cannot be used in Server Components, nor passed to Client Components.");if("function"===typeof c)return c.$$typeof===v?[C,c,d,f]:jb(a,b,d,c,f);if("string"===typeof c)return[C,c,d,f];if("symbol"===typeof c)return c===xa&&null===d?(d=b.implicitSlot,null===b.keyPath&&(b.implicitSlot=!0),a=Q(a,b,R,"",f.children),b.implicitSlot=d,a):[C,c,d,f];if(null!=c&&"object"===typeof c){if(c.$$typeof===v)return[C,c,d,f];switch(c.$$typeof){case D:var g=
c._init;c=g(c._payload);return kb(a,b,c,d,e,f);case za:return jb(a,b,d,c.render,f);case Ca:return kb(a,b,c.type,d,e,f)}}throw Error("Unsupported Server Component type: "+Wa(c));}function fb(a,b){var c=a.pingedTasks;c.push(b);1===c.length&&(a.flushScheduled=null!==a.destination,setImmediate(function(){return lb(a)}))}
function L(a,b,c,d,e){a.pendingChunks++;var f=a.nextChunkId++;"object"===typeof b&&null!==b&&a.writtenObjects.set(b,f);var g={id:f,status:0,model:b,keyPath:c,implicitSlot:d,ping:function(){return fb(a,g)},toJSON:function(k,h){var p=g.keyPath,t=g.implicitSlot;try{var n=Q(a,g,this,k,h)}catch(Z){if(k=Z===Fa?Ia():Z,h=g.model,h="object"===typeof h&&null!==h&&(h.$$typeof===C||h.$$typeof===D),"object"===typeof k&&null!==k&&"function"===typeof k.then){n=L(a,g.model,g.keyPath,g.implicitSlot,a.abortableTasks);
var B=n.ping;k.then(B,B);n.thenableState=Ka();g.keyPath=p;g.implicitSlot=t;n=h?"$L"+n.id.toString(16):S(n.id)}else if(g.keyPath=p,g.implicitSlot=t,h)a.pendingChunks++,p=a.nextChunkId++,t=N(a,k),O(a,p,t),n="$L"+p.toString(16);else throw k;}return n},thenableState:null};e.add(g);return g}function S(a){return"$"+a.toString(16)}function mb(a,b,c){a=K(c);return b.toString(16)+":"+a+"\n"}
function nb(a,b,c,d){var e=d.$$async?d.$$id+"#async":d.$$id,f=a.writtenClientReferences,g=f.get(e);if(void 0!==g)return b[0]===C&&"1"===c?"$L"+g.toString(16):S(g);try{var k=a.bundlerConfig,h=d.$$id;g="";var p=k[h];if(p)g=p.name;else{var t=h.lastIndexOf("#");-1!==t&&(g=h.slice(t+1),p=k[h.slice(0,t)]);if(!p)throw Error('Could not find the module "'+h+'" in the React Client Manifest. This is probably a bug in the React Server Components bundler.');}var n=!0===d.$$async?[p.id,p.chunks,g,1]:[p.id,p.chunks,
g];a.pendingChunks++;var B=a.nextChunkId++,Z=K(n),Kb=B.toString(16)+":I"+Z+"\n";a.completedImportChunks.push(Kb);f.set(e,B);return b[0]===C&&"1"===c?"$L"+B.toString(16):S(B)}catch(Lb){return a.pendingChunks++,b=a.nextChunkId++,c=N(a,Lb),O(a,b,c),S(b)}}function T(a,b){b=L(a,b,null,!1,a.abortableTasks);ob(a,b);return b.id}var U=!1;
function Q(a,b,c,d,e){b.model=e;if(e===C)return"$";if(null===e)return null;if("object"===typeof e){switch(e.$$typeof){case C:c=a.writtenObjects;d=c.get(e);if(void 0!==d)if(U===e)U=null;else return-1===d?(a=T(a,e),S(a)):S(d);else c.set(e,-1);return kb(a,b,e.type,e.key,e.ref,e.props);case D:return c=e._init,e=c(e._payload),Q(a,b,R,"",e)}if(e.$$typeof===v)return nb(a,c,d,e);c=a.writtenObjects;d=c.get(e);if("function"===typeof e.then){if(void 0!==d)if(U===e)U=null;else return"$@"+d.toString(16);a=eb(a,
b,e);c.set(e,a);return"$@"+a.toString(16)}if(void 0!==d)if(U===e)U=null;else return-1===d?(a=T(a,e),S(a)):S(d);else c.set(e,-1);if(Ta(e))return e;if(e instanceof Map){e=Array.from(e);for(b=0;b<e.length;b++)c=e[b][0],"object"===typeof c&&null!==c&&(d=a.writtenObjects,void 0===d.get(c)&&d.set(c,-1));return"$Q"+T(a,e).toString(16)}if(e instanceof Set){e=Array.from(e);for(b=0;b<e.length;b++)c=e[b],"object"===typeof c&&null!==c&&(d=a.writtenObjects,void 0===d.get(c)&&d.set(c,-1));return"$W"+T(a,e).toString(16)}null===
e||"object"!==typeof e?a=null:(a=Ea&&e[Ea]||e["@@iterator"],a="function"===typeof a?a:null);if(a)return a=Array.from(e),a;a=Ua(e);if(a!==Za&&(null===a||null!==Ua(a)))throw Error("Only plain objects, and a few built-ins, can be passed to Client Components from Server Components. Classes or null prototypes are not supported.");return e}if("string"===typeof e){if("Z"===e[e.length-1]&&c[d]instanceof Date)return"$D"+e;if(1024<=e.length)return a.pendingChunks+=2,b=a.nextChunkId++,c="string"===typeof e?
...
c?a="$F"+c.toString(16):(c=e.$$bound,c={id:e.$$id,bound:c?Promise.resolve(c):null},a=T(a,c),b.set(e,a),a="$F"+a.toString(16)),a;if(/^on[A-Z]/.test(d))throw Error("Event handlers cannot be passed to Client Component props."+J(c,d)+"\nIf you need interactivity, consider converting part of this to a Client Component.");throw Error('Functions cannot be passed directly to Client Components unless you explicitly expose it by marking it with "use server".'+J(c,d));}if("symbol"===typeof e){b=a.writtenSymbols;
var f=b.get(e);if(void 0!==f)return S(f);f=e.description;if(Symbol.for(f)!==e)throw Error("Only global symbols received from Symbol.for(...) can be passed to Client Components. The symbol Symbol.for("+(e.description+") cannot be found among global symbols.")+J(c,d));a.pendingChunks++;c=a.nextChunkId++;d=mb(a,c,"$S"+f);a.completedImportChunks.push(d);b.set(e,c);return S(c)}if("bigint"===typeof e)return"$n"+e.toString(10);throw Error("Type "+typeof e+" is not supported in Client Component props."+J(c,
d));}function N(a,b){a=a.onError;b=a(b);if(null!=b&&"string"!==typeof b)throw Error('onError returned something with a type other than "string". onError should return a string and may return null or undefined but must not return anything else. It received something of type "'+typeof b+'" instead');return b||""}function pb(a,b){null!==a.destination?(a.status=2,a.destination.destroy(b)):(a.status=1,a.fatalError=b)}
function O(a,b,c){c={digest:c};b=b.toString(16)+":E"+K(c)+"\n";a.completedErrorChunks.push(b)}var R={};
...
function lb(a){var b=ab.current;ab.current=Pa;var c=M;F=M=a;try{var d=a.pingedTasks;a.pingedTasks=[];for(var e=0;e<d.length;e++)ob(a,d[e]);null!==a.destination&&P(a,a.destination)}catch(f){N(a,f),pb(a,f)}finally{ab.current=b,F=null,M=c}}
...
null;d++;break}g.splice(0,d)}finally{a.flushScheduled=!1,l&&0<m&&b.write(l.subarray(0,m)),l=null,m=0,q=!0}"function"===typeof b.flush&&b.flush();0===a.pendingChunks&&b.end()}function qb(a){a.flushScheduled=null!==a.destination;setImmediate(function(){return wa.run(a,lb,a)})}function gb(a){if(!1===a.flushScheduled&&0===a.pingedTasks.length&&null!==a.destination){var b=a.destination;a.flushScheduled=!0;setImmediate(function(){return P(a,b)})}}
function rb(a,b){if(1===a.status)a.status=2,b.destroy(a.fatalError);else if(2!==a.status&&null===a.destination){a.destination=b;try{P(a,b)}catch(c){N(a,c),pb(a,c)}}}
function sb(a,b){try{var c=a.abortableTasks;if(0<c.size){a.pendingChunks++;var d=a.nextChunkId++,e=void 0===b?Error("The render was aborted by the server without a reason."):b,f=N(a,e);O(a,d,f,e);c.forEach(function(g){g.status=3;var k=S(d);g=mb(a,g.id,k);a.completedErrorChunks.push(g)});c.clear()}null!==a.destination&&P(a,a.destination)}catch(g){N(a,g),pb(a,g)}}
function tb(a,b){var c="",d=a[b];if(d)c=d.name;else{var e=b.lastIndexOf("#");-1!==e&&(c=b.slice(e+1),d=a[b.slice(0,e)]);if(!d)throw Error('Could not find the module "'+b+'" in the React Server Manifest. This is probably a bug in the React Server Components bundler.');}return[d.id,d.chunks,c]}var ub=new Map;
function vb(a){var b=globalThis.__next_require__(a);if("function"!==typeof b.then||"fulfilled"===b.status)return null;b.then(function(c){b.status="fulfilled";b.value=c},function(c){b.status="rejected";b.reason=c});return b}function wb(){}
...
function V(a){var b=globalThis.__next_require__(a[0]);if(4===a.length&&"function"===typeof b.then)if("fulfilled"===b.status)b=b.value;else throw b.reason;return"*"===a[2]?b:""===a[2]?b.__esModule?b.default:b:b[a[2]]}function yb(a,b,c,d){this.status=a;this.value=b;this.reason=c;this._response=d}yb.prototype=Object.create(Promise.prototype);
...
function Bb(a,b){if("pending"===a.status||"blocked"===a.status){var c=a.reason;a.status="rejected";a.reason=b;null!==c&&Ab(c,b)}}function Cb(a,b,c,d,e,f){var g=tb(a._bundlerConfig,b);a=xb(g);if(c)c=Promise.all([c,a]).then(function(k){k=k[0];var h=V(g);return h.bind.apply(h,[null].concat(k))});else if(a)c=Promise.resolve(a).then(function(){return V(g)});else return V(g);c.then(Db(d,e,f),Eb(d));return null}var W=null,X=null;
function zb(a){var b=W,c=X;W=a;X=null;try{var d=JSON.parse(a.value,a._response._fromJSON);null!==X&&0<X.deps?(X.value=d,a.status="blocked",a.value=null,a.reason=null):(a.status="fulfilled",a.value=d)}catch(e){a.status="rejected",a.reason=e}finally{W=b,X=c}}function Fb(a,b){a._chunks.forEach(function(c){"pending"===c.status&&Bb(c,b)})}
function Y(a,b){var c=a._chunks,d=c.get(b);d||(d=a._formData.get(a._prefix+b),d=null!=d?new yb("resolved_model",d,null,a):new yb("pending",null,null,a),c.set(b,d));return d}function Db(a,b,c){if(X){var d=X;d.deps++}else d=X={deps:1,value:null};return function(e){b[c]=e;d.deps--;0===d.deps&&"blocked"===a.status&&(e=a.value,a.status="fulfilled",a.value=d.value,null!==e&&Ab(e,d.value))}}function Eb(a){return function(b){return Bb(a,b)}}
function Gb(a,b){a=Y(a,b);"resolved_model"===a.status&&zb(a);if("fulfilled"!==a.status)throw a.reason;return a.value}
function Hb(a,b,c,d){if("$"===d[0])switch(d[1]){case "$":return d.slice(1);case "@":return b=parseInt(d.slice(2),16),Y(a,b);case "S":return Symbol.for(d.slice(2));case "F":return d=parseInt(d.slice(2),16),d=Gb(a,d),Cb(a,d.id,d.bound,W,b,c);case "Q":return b=parseInt(d.slice(2),16),a=Gb(a,b),new Map(a);case "W":return b=parseInt(d.slice(2),16),a=Gb(a,b),new Set(a);case "K":b=d.slice(2);var e=a._prefix+b+"_",f=new FormData;a._formData.forEach(function(g,k){k.startsWith(e)&&f.append(k.slice(e.length),
g)});return f;case "I":return Infinity;case "-":return"$-0"===d?-0:-Infinity;case "N":return NaN;case "u":return;case "D":return new Date(Date.parse(d.slice(2)));case "n":return BigInt(d.slice(2));default:d=parseInt(d.slice(1),16);a=Y(a,d);switch(a.status){case "resolved_model":zb(a)}switch(a.status){case "fulfilled":return a.value;case "pending":case "blocked":return d=W,a.then(Db(d,b,c),Eb(d)),null;default:throw a.reason;}}return d}
function Ib(a,b){var c=2<arguments.length&&void 0!==arguments[2]?arguments[2]:new FormData,d=new Map,e={_bundlerConfig:a,_prefix:b,_formData:c,_chunks:d,_fromJSON:function(f,g){return"string"===typeof g?Hb(e,this,f,g):g}};return e}
function Jb(a,b,c){a._formData.append(b,c);var d=a._prefix;if(b.startsWith(d)&&(a=a._chunks,b=+b.slice(d.length),(b=a.get(b))&&"pending"===b.status&&(d=b.value,a=b.reason,b.status="resolved_model",b.value=c,null!==d)))switch(zb(b),b.status){case "fulfilled":Ab(d,b.value);break;case "pending":case "blocked":b.value=d;b.reason=a;break;case "rejected":a&&Ab(a,b.reason)}}function Mb(a){Fb(a,Error("Connection closed."))}
function Nb(a,b,c){var d=tb(a,b);a=xb(d);return c?Promise.all([c,a]).then(function(e){e=e[0];var f=V(d);return f.bind.apply(f,[null].concat(e))}):a?Promise.resolve(a).then(function(){return V(d)}):Promise.resolve(V(d))}function Ob(a,b,c){a=Ib(b,c,a);Mb(a);a=Y(a,0);a.then(function(){});if("fulfilled"!==a.status)throw a.reason;return a.value}function Pb(a,b){return function(){return rb(b,a)}}function Qb(a,b){return function(){a.destination=null;sb(a,Error(b))}}
exports.createClientModuleProxy=function(a){a=x({},a,!1);return new Proxy(a,ma)};exports.decodeAction=function(a,b){var c=new FormData,d=null;a.forEach(function(e,f){f.startsWith("$ACTION_")?f.startsWith("$ACTION_REF_")?(e="$ACTION_"+f.slice(12)+":",e=Ob(a,b,e),d=Nb(b,e.id,e.bound)):f.startsWith("$ACTION_ID_")&&(e=f.slice(11),d=Nb(b,e,null)):c.append(f,e)});return null===d?null:d.then(function(e){return e.bind(null,c)})};
exports.decodeFormState=function(a,b,c){var d=b.get("$ACTION_KEY");if("string"!==typeof d)return Promise.resolve(null);var e=null;b.forEach(function(g,k){k.startsWith("$ACTION_REF_")&&(g="$ACTION_"+k.slice(12)+":",e=Ob(b,c,g))});if(null===e)return Promise.resolve(null);var f=e.id;return Promise.resolve(e.bound).then(function(g){return null===g?null:[a,d,f,g.length-1]})};exports.decodeReply=function(a,b){if("string"===typeof a){var c=new FormData;c.append("0",a);a=c}a=Ib(b,"",a);b=Y(a,0);Mb(a);return b};
exports.decodeReplyFromBusboy=function(a,b){var c=Ib(b,""),d=0,e=[];a.on("field",function(f,g){0<d?e.push(f,g):Jb(c,f,g)});a.on("file",function(f,g,k){var h=k.filename,p=k.mimeType;if("base64"===k.encoding.toLowerCase())throw Error("React doesn't accept base64 encoded file uploads because we don't expect form data passed from a browser to ever encode data that way. If that's the wrong assumption, we can easily fix it.");d++;var t=[];g.on("data",function(n){t.push(n)});g.on("end",function(){var n=
new Blob(t,{type:p});c._formData.append(f,n,h);d--;if(0===d){for(n=0;n<e.length;n+=2)Jb(c,e[n],e[n+1]);e.length=0}})});a.on("finish",function(){Mb(c)});a.on("error",function(f){Fb(c,f)});return Y(c,0)};exports.registerClientReference=function(a,b,c){return x(a,b+"#"+c,!1)};exports.registerServerReference=function(a,b,c){return Object.defineProperties(a,{$$typeof:{value:w},$$id:{value:null===c?b:b+"#"+c},$$bound:{value:null},bind:{value:ia}})};
exports.renderToPipeableStream=function(a,b,c){var d=db(a,b,c?c.onError:void 0,c?c.identifierPrefix:void 0,c?c.onPostpone:void 0),e=!1;qb(d);return{pipe:function(f){if(e)throw Error("React currently only supports piping to one writable stream.");e=!0;rb(d,f);f.on("drain",Pb(f,d));f.on("error",Qb(d,"The destination stream errored while writing data."));f.on("close",Qb(d,"The destination stream closed early."));return f},abort:function(f){sb(d,f)}}};
