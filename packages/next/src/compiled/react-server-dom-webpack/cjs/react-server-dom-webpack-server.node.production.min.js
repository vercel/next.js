...
function xa(a){var b=a.parent;null!==b&&xa(b);a.context._currentValue=a.value}function ya(a,b){a.context._currentValue=a.parentValue;a=a.parent;if(null===a)throw Error("The depth must equal at least at zero before reaching the root. This is a bug in React.");a.depth===b.depth?E(a,b):ya(a,b)}
function za(a,b){var d=b.parent;if(null===d)throw Error("The depth must equal at least at zero before reaching the root. This is a bug in React.");a.depth===d.depth?E(a,d):za(a,d);b.context._currentValue=b.value}function Aa(a){var b=D;b!==a&&(null===b?xa(a):null===a?wa(b):b.depth===a.depth?E(b,a):b.depth>a.depth?ya(b,a):za(b,a),D=a)}function Ba(a,b){var d=a._currentValue;a._currentValue=b;var c=D;return D=a={parent:c,depth:null===c?0:c.depth+1,context:a,parentValue:d,value:b}}var Ca=Error("Suspense Exception: This is not a real error! It's an implementation detail of `use` to interrupt the current render. You must either rethrow it immediately, or move the `use` call outside of the `try/catch` block. Capturing without rethrowing will lead to unexpected behavior.\n\nTo handle async errors, wrap your component in an error boundary, or call the promise's `.catch` method and pass the result to `use`");
function Da(){}function Ea(a,b,d){d=a[d];void 0===d?a.push(b):d!==b&&(b.then(Da,Da),b=d);switch(b.status){case "fulfilled":return b.value;case "rejected":throw b.reason;default:if("string"!==typeof b.status)switch(a=b,a.status="pending",a.then(function(c){if("pending"===b.status){var e=b;e.status="fulfilled";e.value=c}},function(c){if("pending"===b.status){var e=b;e.status="rejected";e.reason=c}}),b.status){case "fulfilled":return b.value;case "rejected":throw b.reason;}F=b;throw Ca;}}var F=null;
function Fa(){if(null===F)throw Error("Expected a suspended thenable. This is a bug in React. Please file an issue.");var a=F;F=null;return a}var G=null,I=0,J=null;function Ga(){var a=J;J=null;return a}function Ha(a){return a._currentValue}
var La={useMemo:function(a){return a()},useCallback:function(a){return a},useDebugValue:function(){},useDeferredValue:K,useTransition:K,readContext:Ha,useContext:Ha,useReducer:K,useRef:K,useState:K,useInsertionEffect:K,useLayoutEffect:K,useImperativeHandle:K,useEffect:K,useId:Ia,useMutableSource:K,useSyncExternalStore:K,useCacheRefresh:function(){return Ja},useMemoCache:function(a){for(var b=Array(a),d=0;d<a;d++)b[d]=qa;return b},use:Ka};
function K(){throw Error("This Hook is not supported in Server Components.");}function Ja(){throw Error("Refreshing the cache is not supported in Server Components.");}function Ia(){if(null===G)throw Error("useId can only be used while React is rendering");var a=G.identifierCount++;return":"+G.identifierPrefix+"S"+a.toString(32)+":"}
...
function Ya(a){if(a){var b=D;Aa(null);for(var d=0;d<a.length;d++){var c=a[d],e=c[0];c=c[1];Sa[e]||(Sa[e]=ca.createServerContext(e,pa));Ba(Sa[e],c)}a=D;Aa(b);return a}return null}var T=new Map,kb=new Map;function lb(){}
function mb(a){for(var b=a.chunks,d=[],c=0;c<b.length;c++){var e=b[c],g=T.get(e);if(void 0===g){g=globalThis.__next_chunk_load__(e);d.push(g);var h=T.set.bind(T,e,null);g.then(h,lb);T.set(e,g)}else null!==g&&d.push(g)}if(a.async){if(b=kb.get(a.id))return"fulfilled"===b.status?null:b;var k=Promise.all(d).then(function(){return globalThis.__next_require__(a.id)});k.then(function(l){k.status="fulfilled";k.value=l},function(l){k.status="rejected";k.reason=l});kb.set(a.id,k);return k}return 0<d.length?Promise.all(d):
null}function nb(a){if(a.async){var b=kb.get(a.id);if("fulfilled"===b.status)b=b.value;else throw b.reason;}else b=globalThis.__next_require__(a.id);return"*"===a.name?b:""===a.name?b.__esModule?b.default:b:b[a.name]}function U(a,b,d,c){this.status=a;this.value=b;this.reason=d;this._response=c}U.prototype=Object.create(Promise.prototype);
...
exports.renderToPipeableStream=function(a,b,d){var c=Wa(a,b,d?d.onError:void 0,d?d.context:void 0,d?d.identifierPrefix:void 0),e=!1;hb(c);return{pipe:function(g){if(e)throw Error("React currently only supports piping to one writable stream.");e=!0;ib(c,g);g.on("drain",yb(g,c));return g},abort:function(g){jb(c,g)}}};
