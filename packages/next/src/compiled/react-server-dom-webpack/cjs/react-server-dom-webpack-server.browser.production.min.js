...
function N(a,b){var d=Ya(a);if("Object"!==d&&"Array"!==d)return d;d=-1;var c=0;if(Wa(a)){var e="[";for(var f=0;f<a.length;f++){0<f&&(e+=", ");var g=a[f];g="object"===typeof g&&null!==g?N(g):Za(g);""+f===b?(d=e.length,c=g.length,e+=g):e=10>g.length&&40>e.length+g.length?e+g:e+"..."}e+="]"}else if(a.$$typeof===z)e="<"+M(a.type)+"/>";else{e="{";f=Object.keys(a);for(g=0;g<f.length;g++){0<g&&(e+=", ");var h=f[g],k=JSON.stringify(h);e+=('"'+h+'"'===k?h:k)+": ";k=a[h];k="object"===typeof k&&null!==k?N(k):
Za(k);h===b?(d=e.length,c=k.length,e+=k):e=10>k.length&&40>e.length+k.length?e+k:e+"..."}e+="}"}return void 0===b?e:-1<d&&0<c?(a=" ".repeat(d)+"^".repeat(c),"\n  "+e+"\n  "+a):"\n  "+e}var $a=ba.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED,ab=$a.ContextRegistry,bb=ba.__SECRET_SERVER_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED;
if(!bb)throw Error('The "react" package in this environment is not configured correctly. The "react-server" condition must be enabled in any environment that runs React Server Components.');var cb=Object.prototype,O=JSON.stringify,db=bb.ReactCurrentCache,eb=$a.ReactCurrentDispatcher;function fb(a){console.error(a)}function gb(){}
function hb(a,b,d,c,e,f){if(null!==db.current&&db.current!==Va)throw Error("Currently React only supports one RSC renderer at a time.");ta.current=sa;db.current=Va;var g=new Set,h=[],k=new Set,m={status:0,flushScheduled:!1,fatalError:null,destination:null,bundlerConfig:b,cache:new Map,nextChunkId:0,pendingChunks:0,hints:k,abortableTasks:g,pingedTasks:h,completedImportChunks:[],completedHintChunks:[],completedRegularChunks:[],completedErrorChunks:[],writtenSymbols:new Map,writtenClientReferences:new Map,
writtenServerReferences:new Map,writtenProviders:new Map,identifierPrefix:e||"",identifierCount:1,taintCleanupQueue:[],onError:void 0===d?fb:d,onPostpone:void 0===f?gb:f,toJSON:function(t,E){return ib(m,this,t,E)}};m.pendingChunks++;b=jb(c);a=kb(m,a,b,g);h.push(a);return m}var w=null,lb={};
function mb(a,b){a.pendingChunks++;var d=kb(a,null,D,a.abortableTasks);switch(b.status){case "fulfilled":return d.model=b.value,nb(a,d),d.id;case "rejected":var c=P(a,b.reason);Q(a,d.id,c);return d.id;default:"string"!==typeof b.status&&(b.status="pending",b.then(function(e){"pending"===b.status&&(b.status="fulfilled",b.value=e)},function(e){"pending"===b.status&&(b.status="rejected",b.reason=e)}))}b.then(function(e){d.model=e;nb(a,d)},function(e){d.status=4;a.abortableTasks.delete(d);e=P(a,e);Q(a,
d.id,e);null!==a.destination&&R(a,a.destination)});return d.id}function x(a,b,d){d=O(d);var c=a.nextChunkId++;b="H"+b;b=c.toString(16)+":"+b;d=q.encode(b+d+"\n");a.completedHintChunks.push(d);!1===a.flushScheduled&&0===a.pingedTasks.length&&null!==a.destination&&(d=a.destination,a.flushScheduled=!0,R(a,d))}function ob(a){if("fulfilled"===a.status)return a.value;if("rejected"===a.status)throw a.reason;throw a;}
...
function S(a,b,d,c,e,f){if(null!==c&&void 0!==c)throw Error("Refs cannot be used in Server Components, nor passed to Client Components.");if("function"===typeof b){if(b.$$typeof===r)return[z,b,d,e];J=0;K=f;e=b(e);return"object"===typeof e&&null!==e&&"function"===typeof e.then?"fulfilled"===e.status?e.value:pb(e):e}if("string"===typeof b)return[z,b,d,e];if("symbol"===typeof b)return b===ua?e.children:[z,b,d,e];if(null!=b&&"object"===typeof b){if(b.$$typeof===r)return[z,b,d,e];switch(b.$$typeof){case A:var g=
b._init;b=g(b._payload);return S(a,b,d,c,e,f);case xa:return a=b.render,J=0,K=f,a(e,void 0);case Aa:return S(a,b.type,d,c,e,f);case va:return Ia(b._context,e.value),[z,b,d,{value:e.value,children:e.children,__pop:lb}]}}throw Error("Unsupported Server Component type: "+Za(b));}function nb(a,b){var d=a.pingedTasks;d.push(b);1===d.length&&(a.flushScheduled=null!==a.destination,qb(a))}
function kb(a,b,d,c){var e={id:a.nextChunkId++,status:0,model:b,context:d,ping:function(){return nb(a,e)},thenableState:null};c.add(e);return e}function T(a){return"$"+a.toString(16)}function rb(a,b,d){a=O(d);b=b.toString(16)+":"+a+"\n";return q.encode(b)}
...
function qb(a){var b=eb.current;eb.current=Sa;var d=w;I=w=a;try{var c=a.pingedTasks;a.pingedTasks=[];for(var e=0;e<c.length;e++){var f=c[e];var g=a;if(0===f.status){Ha(f.context);try{var h=f.model;if("object"===typeof h&&null!==h&&h.$$typeof===z){var k=h,m=f.thenableState;f.model=h;h=S(g,k.type,k.key,k.ref,k.props,m);for(f.thenableState=null;"object"===typeof h&&null!==h&&h.$$typeof===z;)k=h,f.model=h,h=S(g,k.type,k.key,k.ref,k.props,null)}ub(g,f.id,h);g.abortableTasks.delete(f);f.status=1}catch(B){var t=
B===Ja?Ma():B;if("object"===typeof t&&null!==t&&"function"===typeof t.then){var E=f.ping;t.then(E,E);f.thenableState=Na()}else{g.abortableTasks.delete(f);f.status=4;var G=P(g,t);Q(g,f.id,G)}}}}null!==a.destination&&R(a,a.destination)}catch(B){P(a,B),vb(a,B)}finally{eb.current=b,I=null,w=d}}
...
b.close()}function wb(a,b){try{var d=a.abortableTasks;if(0<d.size){var c=void 0===b?Error("The render was aborted by the server without a reason."):b,e=P(a,c);a.pendingChunks++;var f=a.nextChunkId++;Q(a,f,e,c);d.forEach(function(g){g.status=3;var h=T(f);g=rb(a,g.id,h);a.completedErrorChunks.push(g)});d.clear()}null!==a.destination&&R(a,a.destination)}catch(g){P(a,g),vb(a,g)}}
function jb(a){if(a){var b=D;Ha(null);for(var d=0;d<a.length;d++){var c=a[d],e=c[0];c=c[1];if(!ab[e]){var f={$$typeof:wa,_currentValue:C,_currentValue2:C,_defaultValue:C,_threadCount:0,Provider:null,Consumer:null,_globalName:e};f.Provider={$$typeof:va,_context:f};ab[e]=f}Ia(ab[e],c)}a=D;Ha(b);return a}return null}
function xb(a,b){var d="",c=a[b];if(c)d=c.name;else{var e=b.lastIndexOf("#");-1!==e&&(d=b.slice(e+1),c=a[b.slice(0,e)]);if(!c)throw Error('Could not find the module "'+b+'" in the React Server Manifest. This is probably a bug in the React Server Components bundler.');}return[c.id,c.chunks,d]}var U=new Map;
function yb(a){var b=__webpack_require__(a);if("function"!==typeof b.then||"fulfilled"===b.status)return null;b.then(function(d){b.status="fulfilled";b.value=d},function(d){b.status="rejected";b.reason=d});return b}function zb(){}
function Ab(a){for(var b=a[1],d=[],c=0;c<b.length;){var e=b[c++],f=b[c++],g=U.get(e);void 0===g?(Bb.set(e,f),f=__webpack_chunk_load__(e),d.push(f),g=U.set.bind(U,e,null),f.then(g,zb),U.set(e,f)):null!==g&&d.push(g)}return 4===a.length?0===d.length?yb(a[0]):Promise.all(d).then(function(){return yb(a[0])}):0<d.length?Promise.all(d):null}
function V(a){var b=__webpack_require__(a[0]);if(4===a.length&&"function"===typeof b.then)if("fulfilled"===b.status)b=b.value;else throw b.reason;return"*"===a[2]?b:""===a[2]?b.__esModule?b.default:b:b[a[2]]}var Bb=new Map,Cb=__webpack_require__.u;__webpack_require__.u=function(a){var b=Bb.get(a);return void 0!==b?b:Cb(a)};function W(a,b,d,c){this.status=a;this.value=b;this.reason=d;this._response=c}W.prototype=Object.create(Promise.prototype);
...
function Fb(a,b){if("pending"===a.status||"blocked"===a.status){var d=a.reason;a.status="rejected";a.reason=b;null!==d&&Eb(d,b)}}function Gb(a,b,d,c,e,f){var g=xb(a._bundlerConfig,b);a=Ab(g);if(d)d=Promise.all([d,a]).then(function(h){h=h[0];var k=V(g);return k.bind.apply(k,[null].concat(h))});else if(a)d=Promise.resolve(a).then(function(){return V(g)});else return V(g);d.then(Hb(c,e,f),Ib(c));return null}var X=null,Y=null;
...
exports.renderToReadableStream=function(a,b,d){var c=hb(a,b,d?d.onError:void 0,d?d.context:void 0,d?d.identifierPrefix:void 0,d?d.onPostpone:void 0);if(d&&d.signal){var e=d.signal;if(e.aborted)wb(c,e.reason);else{var f=function(){wb(c,e.reason);e.removeEventListener("abort",f)};e.addEventListener("abort",f)}}return new ReadableStream({type:"bytes",start:function(){c.flushScheduled=null!==c.destination;qb(c)},pull:function(g){if(1===c.status)c.status=2,ca(g,c.fatalError);else if(2!==c.status&&null===
c.destination){c.destination=g;try{R(c,g)}catch(h){P(c,h),vb(c,h)}}},cancel:function(g){c.destination=null;wb(c,g)}},{highWaterMark:0})};
