...
*/
'use strict';var aa=require("react-dom"),ba=require("react"),l=null,n=0;function p(a,b){if(0!==b.byteLength)if(2048<b.byteLength)0<n&&(a.enqueue(new Uint8Array(l.buffer,0,n)),l=new Uint8Array(2048),n=0),a.enqueue(b);else{var d=l.length-n;d<b.byteLength&&(0===d?a.enqueue(l):(l.set(b.subarray(0,d),n),a.enqueue(l),b=b.subarray(d)),l=new Uint8Array(2048),n=0);l.set(b,n);n+=b.byteLength}return!0}var q=new TextEncoder;function ca(a,b){"function"===typeof a.error?a.error(b):a.close()}
...
function fb(a,b){a.pendingChunks++;var d=L(a,null,B,a.abortableTasks);switch(b.status){case "fulfilled":return d.model=b.value,gb(a,d),d.id;case "rejected":var c=M(a,b.reason);N(a,d.id,c);return d.id;default:"string"!==typeof b.status&&(b.status="pending",b.then(function(e){"pending"===b.status&&(b.status="fulfilled",b.value=e)},function(e){"pending"===b.status&&(b.status="rejected",b.reason=e)}))}b.then(function(e){d.model=e;gb(a,d)},function(e){d.status=4;e=M(a,e);N(a,d.id,e);a.abortableTasks.delete(d);
null!==a.destination&&O(a,a.destination)});return d.id}function w(a,b,d){d=K(d);var c=a.nextChunkId++;b="H"+b;b=c.toString(16)+":"+b;d=q.encode(b+d+"\n");a.completedHintChunks.push(d);!1===a.flushScheduled&&0===a.pingedTasks.length&&null!==a.destination&&(d=a.destination,a.flushScheduled=!0,O(a,d))}function hb(a){if("fulfilled"===a.status)return a.value;if("rejected"===a.status)throw a.reason;throw a;}
