...
function Ma(){if(null===La)throw Error("Expected a suspended thenable. This is a bug in React. Please file an issue.");var a=La;La=null;return a}var D=null,Na=0,E=null;function Oa(){var a=E||[];E=null;return a}
...
function nb(a,b,c,e,d){a.pendingChunks++;var f=a.nextChunkId++;"object"!==typeof b||null===b||null!==c||e||a.writtenObjects.set(b,f);var g={id:f,status:0,model:b,keyPath:c,implicitSlot:e,ping:function(){return pb(a,g)},toJSON:function(k,h){a:{var p=g.keyPath,u=g.implicitSlot;try{var m=R(a,g,this,k,h)}catch(ia){k=ia===Ia?Ma():ia;h=g.model;h="object"===typeof h&&null!==h&&(h.$$typeof===z||h.$$typeof===A);if("object"===typeof k&&null!==k){if("function"===typeof k.then){m=nb(a,g.model,g.keyPath,g.implicitSlot,
a.abortableTasks);var C=m.ping;k.then(C,C);m.thenableState=Oa();g.keyPath=p;g.implicitSlot=u;m=h?"$L"+m.id.toString(16):S(m.id);break a}if(k.$$typeof===B){a.pendingChunks++;m=a.nextChunkId++;M(a,k.message);N(a,m);g.keyPath=p;g.implicitSlot=u;m=h?"$L"+m.toString(16):S(m);break a}}g.keyPath=p;g.implicitSlot=u;if(h)a.pendingChunks++,p=a.nextChunkId++,u=O(a,k),P(a,p,u),m="$L"+p.toString(16);else throw k;}}return m},thenableState:null};d.add(g);return g}function S(a){return"$"+a.toString(16)}
...
g];a.pendingChunks++;var C=a.nextChunkId++,ia=I(m),Tb=C.toString(16)+":I"+ia+"\n";a.completedImportChunks.push(Tb);f.set(d,C);return b[0]===z&&"1"===c?"$L"+C.toString(16):S(C)}catch(Ub){return a.pendingChunks++,b=a.nextChunkId++,c=O(a,Ub),P(a,b,c),S(b)}}function T(a,b){b=nb(a,b,null,!1,a.abortableTasks);Bb(a,b);return b.id}
...
G(c,e));a.pendingChunks++;c=a.nextChunkId++;e=zb(a,c,"$S"+f);a.completedImportChunks.push(e);b.set(d,c);return S(c)}if("bigint"===typeof d)return a=J.get(d),void 0!==a&&K(a.message),"$n"+d.toString(10);throw Error("Type "+typeof d+" is not supported in Client Component props."+G(c,e));}function M(a,b){a=a.onPostpone;a(b)}
function O(a,b){a=a.onError;b=a(b);if(null!=b&&"string"!==typeof b)throw Error('onError returned something with a type other than "string". onError should return a string and may return null or undefined but must not return anything else. It received something of type "'+typeof b+'" instead');return b||""}function Cb(a,b){jb(a);null!==a.destination?(a.status=2,a.destination.destroy(b)):(a.status=1,a.fatalError=b)}function N(a,b){b=b.toString(16)+":P\n";a.completedErrorChunks.push(b)}
...
b.status=4;var k=O(a,f);P(a,b.id,k)}finally{}}function yb(a){var b=ib.current;ib.current=Ta;var c=L;D=L=a;try{var e=a.pingedTasks;a.pingedTasks=[];for(var d=0;d<e.length;d++)Bb(a,e[d]);null!==a.destination&&Q(a,a.destination)}catch(f){O(a,f),Cb(a,f)}finally{ib.current=b,D=null,L=c}}
