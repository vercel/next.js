...
function Sb(a,b,c,e){if("$"===e[0])switch(e[1]){case "$":return e.slice(1);case "@":return b=parseInt(e.slice(2),16),Z(a,b);case "S":return Symbol.for(e.slice(2));case "F":return e=parseInt(e.slice(2),16),e=Ob(a,e),Kb(a,e.id,e.bound,X,b,c);case "T":return xa(e.slice(2));case "Q":return b=parseInt(e.slice(2),16),a=Ob(a,b),new Map(a);case "W":return b=parseInt(e.slice(2),16),a=Ob(a,b),new Set(a);case "K":b=e.slice(2);var d=a._prefix+b+"_",g=new FormData;a._formData.forEach(function(f,k){k.startsWith(d)&&
