...
function y(a){for(var b=a[1],c=[],d=0;d<b.length;d++){var e=b[d],g=u.get(e);if(void 0===g){g=globalThis.__next_chunk_load__(e);c.push(g);var f=u.set.bind(u,e,null);g.then(f,x);u.set(e,g)}else null!==g&&c.push(g)}return 4===a.length?0===c.length?v(a[0]):Promise.all(c).then(function(){return v(a[0])}):0<c.length?Promise.all(c):null}
