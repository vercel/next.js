...
g];a.pendingChunks++;var C=a.nextChunkId++,ia=I(m),Sb=C.toString(16)+":I"+ia+"\n";a.completedImportChunks.push(Sb);f.set(d,C);return b[0]===z&&"1"===c?"$L"+C.toString(16):S(C)}catch(Tb){return a.pendingChunks++,b=a.nextChunkId++,c=O(a,Tb),P(a,b,c),S(b)}}function T(a,b){b=lb(a,b,null,!1,a.abortableTasks);zb(a,b);return b.id}
...
function Eb(a,b){var c="",e=a[b];if(e)c=e.name;else{var d=b.lastIndexOf("#");-1!==d&&(c=b.slice(d+1),e=a[b.slice(0,d)]);if(!e)throw Error('Could not find the module "'+b+'" in the React Server Manifest. This is probably a bug in the React Server Components bundler.');}return[e.id,e.chunks,c]}var Fb=new Map;
function Gb(a){var b=globalThis.__next_require__(a);if("function"!==typeof b.then||"fulfilled"===b.status)return null;b.then(function(c){b.status="fulfilled";b.value=c},function(c){b.status="rejected";b.reason=c});return b}function Hb(){}
function Ib(a){for(var b=a[1],c=[],e=0;e<b.length;e++){var d=b[e],f=Fb.get(d);if(void 0===f){f=globalThis.__next_chunk_load__(d);c.push(f);var g=Fb.set.bind(Fb,d,null);f.then(g,Hb);Fb.set(d,f)}else null!==f&&c.push(f)}return 4===a.length?0===c.length?Gb(a[0]):Promise.all(c).then(function(){return Gb(a[0])}):0<c.length?Promise.all(c):null}
function W(a){var b=globalThis.__next_require__(a[0]);if(4===a.length&&"function"===typeof b.then)if("fulfilled"===b.status)b=b.value;else throw b.reason;return"*"===a[2]?b:""===a[2]?b.__esModule?b.default:b:b[a[2]]}function Jb(a,b,c,e){this.status=a;this.value=b;this.reason=c;this._response=e}Jb.prototype=Object.create(Promise.prototype);
...
function Mb(a,b){if("pending"===a.status||"blocked"===a.status){var c=a.reason;a.status="rejected";a.reason=b;null!==c&&Lb(c,b)}}function Nb(a,b,c,e,d,f){var g=Eb(a._bundlerConfig,b);a=Ib(g);if(c)c=Promise.all([c,a]).then(function(k){k=k[0];var h=W(g);return h.bind.apply(h,[null].concat(k))});else if(a)c=Promise.resolve(a).then(function(){return W(g)});else return W(g);c.then(Ob(e,d,f),Pb(e));return null}var X=null,Y=null;
...
function Yb(a,b,c){var e=Eb(a,b);a=Ib(e);return c?Promise.all([c,a]).then(function(d){d=d[0];var f=W(e);return f.bind.apply(f,[null].concat(d))}):a?Promise.resolve(a).then(function(){return W(e)}):Promise.resolve(W(e))}function Zb(a,b,c){a=Vb(b,c,a);Xb(a);a=Z(a,0);a.then(function(){});if("fulfilled"!==a.status)throw a.reason;return a.value}function $b(a,b){return function(){return Cb(b,a)}}exports.createClientModuleProxy=function(a){a=v({},a,!1);return new Proxy(a,oa)};
...
exports.renderToPipeableStream=function(a,b,c){var e=kb(a,b,c?c.onError:void 0,c?c.identifierPrefix:void 0,c?c.onPostpone:void 0),d=!1;Bb(e);return{pipe:function(f){if(d)throw Error("React currently only supports piping to one writable stream.");d=!0;Cb(e,f);f.on("drain",$b(f,e));return f},abort:function(f){Db(e,f)}}};
