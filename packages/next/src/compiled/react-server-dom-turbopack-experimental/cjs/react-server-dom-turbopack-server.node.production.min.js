...
function Zb(a,b,c,e){if("$"===e[0])switch(e[1]){case "$":return e.slice(1);case "@":return b=parseInt(e.slice(2),16),Z(a,b);case "F":return e=parseInt(e.slice(2),16),e=Wb(a,e),Rb(a,e.id,e.bound,Ub,b,c);case "T":return Ba(e.slice(2));case "Q":return b=parseInt(e.slice(2),16),a=Wb(a,b),new Map(a);case "W":return b=parseInt(e.slice(2),16),a=Wb(a,b),new Set(a);case "K":b=e.slice(2);var d=a._prefix+b+"_",f=new FormData;a._formData.forEach(function(g,k){k.startsWith(d)&&f.append(k.slice(d.length),g)});
