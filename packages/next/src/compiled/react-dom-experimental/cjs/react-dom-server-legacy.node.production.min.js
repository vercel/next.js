...
case "input":a.push(C("input"));var wa=null,ma=null,ca=null,W=null,Q=null,xa=null,ya=null,za=null,Aa=null,da;for(da in c)if(n.call(c,da)){var E=c[da];if(null!=E)switch(da){case "children":case "dangerouslySetInnerHTML":throw Error("input is a self-closing tag and must neither have `children` nor use `dangerouslySetInnerHTML`.");case "name":wa=E;break;case "formAction":ma=E;break;case "formEncType":ca=E;break;case "formMethod":W=E;break;case "formTarget":Q=E;break;case "defaultChecked":Aa=E;break;
case "defaultValue":ya=E;break;case "checked":za=E;break;case "value":xa=E;break;default:x(a,da,E)}}var ea=pb(a,e,ma,ca,W,Q,wa);null!==za?lb(a,"checked",za):null!==Aa&&lb(a,"checked",Aa);null!==xa?x(a,"value",xa):null!==ya&&x(a,"value",ya);a.push("/>");null!==ea&&ea.forEach(ob,a);return null;case "button":a.push(C("button"));var M=null,fa=null,ha=null,Ba=null,ia=null,hc=null,ic=null,Ca;for(Ca in c)if(n.call(c,Ca)){var R=c[Ca];if(null!=R)switch(Ca){case "children":M=R;break;case "dangerouslySetInnerHTML":fa=
R;break;case "name":ha=R;break;case "formAction":Ba=R;break;case "formEncType":ia=R;break;case "formMethod":hc=R;break;case "formTarget":ic=R;break;default:x(a,Ca,R)}}var jc=pb(a,e,Ba,ia,hc,ic,ha);a.push(">");null!==jc&&jc.forEach(ob,a);y(a,fa,M);if("string"===typeof M){a.push(q(M));var kc=null}else kc=M;return kc;case "form":a.push(C("form"));var Da=null,lc=null,X=null,Ea=null,Fa=null,Ga=null,Ha;for(Ha in c)if(n.call(c,Ha)){var Y=c[Ha];if(null!=Y)switch(Ha){case "children":Da=Y;break;case "dangerouslySetInnerHTML":lc=
Y;break;case "action":X=Y;break;case "encType":Ea=Y;break;case "method":Fa=Y;break;case "target":Ga=Y;break;default:x(a,Ha,Y)}}var yb=null,zb=null;if("function"===typeof X)if("function"===typeof X.$$FORM_ACTION){var Qd=mb(e),na=X.$$FORM_ACTION(Qd);X=na.action||"";Ea=na.encType;Fa=na.method;Ga=na.target;yb=na.data;zb=na.name}else a.push(" ","action",'="',nb,'"'),Ga=Fa=Ea=X=null,qb(e);null!=X&&x(a,"action",X);null!=Ea&&x(a,"encType",Ea);null!=Fa&&x(a,"method",Fa);null!=Ga&&x(a,"target",Ga);a.push(">");
...
var Db=null,Bc=null,Z;for(Z in c)if(n.call(c,Z)){var H=c[Z];if(null!=H&&"function"!==typeof H&&"object"!==typeof H&&!1!==H)switch(!0===H&&(H=""),"className"===Z&&(Z="class"),Z){case "children":Db=H;break;case "dangerouslySetInnerHTML":Bc=H;break;case "style":kb(a,H);break;case "suppressContentEditableWarning":case "suppressHydrationWarning":break;default:ta(Z)&&"function"!==typeof H&&"symbol"!==typeof H&&a.push(" ",Z,'="',q(H),'"')}}a.push(">");y(a,Bc,Db);return Db}}return wb(a,c,b)}
...
function sd(){if(null===rd)throw Error("Expected a suspended thenable. This is a bug in React. Please file an issue.");var a=rd;rd=null;return a}function td(a,b){return a===b&&(0!==a||1/a===1/b)||a!==a&&b!==b}var ud="function"===typeof Object.is?Object.is:td,J=null,vd=null,wd=null,K=null,xd=!1,yd=!1,zd=0,Ad=0,Bd=null,Cd=null,Dd=0;
function N(){if(null===J)throw Error("Invalid hook call. Hooks can only be called inside of the body of a function component. This could happen for one of the following reasons:\n1. You might have mismatching versions of React and the renderer (such as React DOM)\n2. You might be breaking the Rules of Hooks\n3. You might have more than one copy of React in the same app\nSee https://reactjs.org/link/invalid-hook-call for tips about how to debug and fix this problem.");return J}
function Ed(){if(0<Dd)throw Error("Rendered more hooks than during the previous render");return{memoizedState:null,queue:null,next:null}}function Fd(){null===K?null===wd?(xd=!1,wd=K=Ed()):(xd=!0,K=wd):null===K.next?(xd=!1,K=K.next=Ed()):(xd=!0,K=K.next);return K}function Gd(a,b,c,d){for(;yd;)yd=!1,Ad=zd=0,Dd+=1,K=null,c=a(b,d);Hd();return c}function Id(){var a=Bd;Bd=null;return a}function Hd(){vd=J=null;yd=!1;wd=null;Dd=0;K=Cd=null}function Jd(a,b){return"function"===typeof b?b(a):b}
function Kd(a,b,c){J=N();K=Fd();if(xd){var d=K.queue;b=d.dispatch;if(null!==Cd&&(c=Cd.get(d),void 0!==c)){Cd.delete(d);d=K.memoizedState;do d=a(d,c.action),c=c.next;while(null!==c);K.memoizedState=d;return[d,b]}return[K.memoizedState,b]}a=a===Jd?"function"===typeof b?b():b:void 0!==c?c(b):b;K.memoizedState=a;a=K.queue={last:null,dispatch:null};a=a.dispatch=Ld.bind(null,J,a);return[K.memoizedState,a]}
function Md(a,b){J=N();K=Fd();b=void 0===b?null:b;if(null!==K){var c=K.memoizedState;if(null!==c&&null!==b){var d=c[1];a:if(null===d)d=!1;else{for(var e=0;e<d.length&&e<b.length;e++)if(!ud(b[e],d[e])){d=!1;break a}d=!0}if(d)return c[0]}}a=a();K.memoizedState=[a,b];return a}
function Ld(a,b,c){if(25<=Dd)throw Error("Too many re-renders. React limits the number of renders to prevent an infinite loop.");if(a===J)if(yd=!0,a={action:c,next:null},null===Cd&&(Cd=new Map),c=Cd.get(b),void 0===c)Cd.set(b,a);else{for(b=c;null!==b.next;)b=b.next;b.next=a}}function Nd(){throw Error("A function wrapped in useEffectEvent can't be called during rendering.");}function Od(){throw Error("startTransition cannot be called during server rendering.");}
...
var Vd={readContext:function(a){return a._currentValue2},use:function(a){if(null!==a&&"object"===typeof a){if("function"===typeof a.then)return Rd(a);if(a.$$typeof===Ic||a.$$typeof===Jc)return a._currentValue2}throw Error("An unsupported type was passed to use(): "+String(a));},useContext:function(a){N();return a._currentValue2},useMemo:Md,useReducer:Kd,useRef:function(a){J=N();K=Fd();var b=K.memoizedState;return null===b?(a={current:a},K.memoizedState=a):b},useState:function(a){return Kd(Jd,a)},
useInsertionEffect:Td,useLayoutEffect:Td,useCallback:function(a,b){return Md(function(){return a},b)},useImperativeHandle:Td,useEffect:Td,useDebugValue:Td,useDeferredValue:function(a){N();return a},useTransition:function(){N();return[!1,Od]},useId:function(){var a=vd.treeContext;var b=a.overflow;a=a.id;a=(a&~(1<<32-kd(a)-1)).toString(32)+b;var c=Ud;if(null===c)throw Error("Invalid hook call. Hooks can only be called inside of the body of a function component.");b=zd++;a=":"+c.idPrefix+"R"+a;0<b&&
(a+="H"+b.toString(32));return a+":"},useMutableSource:function(a,b){N();return b(a._source)},useSyncExternalStore:function(a,b,c){if(void 0===c)throw Error("Missing getServerSnapshot, which is required for server-rendered content. Will revert to client rendering.");return c()},useCacheRefresh:function(){return Sd},useEffectEvent:function(){return Nd},useMemoCache:function(a){for(var b=Array(a),c=0;c<a;c++)b[c]=Vc;return b},useHostTransitionStatus:function(){N();return Wa},useOptimistic:function(a){N();
return[a,Pd]}},Ud=null,Wd={getCacheSignal:function(){throw Error("Not implemented.");},getCacheForType:function(){throw Error("Not implemented.");}},Xd=Va.ReactCurrentDispatcher,Yd=Va.ReactCurrentCache;function Zd(a){console.error(a);return null}function $d(){}
...
1,ke(h,m),0===h.pendingTasks)break a}catch(t){m.status=4,h.forceClientRender=!0,h.errorDigest=ee(a,t)}finally{a.resources.boundaryResources=d?d.resources:null,b.blockedBoundary=d,b.blockedSegment=c}b=ce(a,null,f,d,k,g,b.legacyContext,b.context,b.treeContext);a.pingedTasks.push(b)}return}if("object"===typeof d&&null!==d)switch(d.$$typeof){case Kc:d=d.render;J={};vd=b;Ad=zd=0;Bd=c;c=d(e,f);e=Gd(d,e,c,f);if(0!==zd){d=b.treeContext;b.treeContext=jd(d,1,0);try{T(a,b,null,e)}finally{b.treeContext=d}}else T(a,
b,null,e);return;case Nc:d=d.type;e=he(d,e);ie(a,b,c,d,e,f);return;case Hc:c=e.children;d=d._context;e=e.value;f=d._currentValue2;d._currentValue2=e;g=$c;$c=e={parent:g,depth:null===g?0:g.depth+1,context:d,parentValue:f,value:e};b.context=e;T(a,b,null,c);a=$c;if(null===a)throw Error("Tried to pop a Context at the root of the app. This is a bug in React.");e=a.parentValue;a.context._currentValue2=e===Uc?a.context._defaultValue:e;a=$c=a.parent;b.context=a;return;case Ic:e=e.children;e=e(d._currentValue2);
T(a,b,null,e);return;case Oc:f=d._init;d=f(d._payload);e=he(d,e);ie(a,b,c,d,e,void 0);return}throw Error("Element type is invalid: expected a string (for built-in components) or a class/function (for composite components) but got: "+((null==d?d:typeof d)+"."));}}
function T(a,b,c,d){b.node=d;if("object"===typeof d&&null!==d){switch(d.$$typeof){case Cc:ie(a,b,c,d.type,d.props,d.ref);return;case Dc:throw Error("Portals are not currently supported by the server renderer. Render them conditionally so that they only appear on the client render.");case Oc:c=d._init;d=c(d._payload);T(a,b,null,d);return}if(Ua(d)){le(a,b,d);return}null===d||"object"!==typeof d?c=null:(c=Wc&&d[Wc]||d["@@iterator"],c="function"===typeof c?c:null);if(c&&(c=c.call(d))){d=c.next();if(!d.done){var e=
[];do e.push(d.value),d=c.next();while(!d.done);le(a,b,e)}return}if("function"===typeof d.then)return T(a,b,null,Rd(d));if(d.$$typeof===Ic||d.$$typeof===Jc)return T(a,b,null,d._currentValue2);a=Object.prototype.toString.call(d);throw Error("Objects are not valid as a React child (found: "+("[object Object]"===a?"object with keys {"+Object.keys(d).join(", ")+"}":a)+"). If you meant to render a collection of children, use an array instead.");}"string"===typeof d?(c=b.blockedSegment,c.lastPushedText=
...
a.clientRenderedBoundaries;for(c=0;c<v.length;c++){var D=v[c];l=b;var w=a.responseState,wa=D.id,ma=D.errorDigest,ca=D.errorMessage,W=D.errorComponentStack,Q=0===w.streamingFormat;Q?(l.push(w.startInlineScript),0===(w.instructions&4)?(w.instructions|=4,l.push('$RX=function(b,c,d,e){var a=document.getElementById(b);a&&(b=a.previousSibling,b.data="$!",a=a.dataset,c&&(a.dgst=c),d&&(a.msg=d),e&&(a.stck=e),b._reactRetry&&b._reactRetry())};;$RX("')):l.push('$RX("')):l.push('<template data-rxi="" data-bid="');
if(null===wa)throw Error("An ID must have been assigned before we can complete the boundary.");l.push(wa);Q&&l.push('"');if(ma||ca||W)if(Q){l.push(",");var xa=Lb(ma||"");l.push(xa)}else{l.push('" data-dgst="');var ya=q(ma||"");l.push(ya)}if(ca||W)if(Q){l.push(",");var za=Lb(ca||"");l.push(za)}else{l.push('" data-msg="');var Aa=q(ca||"");l.push(Aa)}if(W)if(Q){l.push(",");var da=Lb(W);l.push(da)}else{l.push('" data-stck="');var E=q(W);l.push(E)}if(Q?!l.push(")\x3c/script>"):!l.push('"></template>')){a.destination=
...
exports.version="18.3.0-experimental-8ec962d82-20230623";
