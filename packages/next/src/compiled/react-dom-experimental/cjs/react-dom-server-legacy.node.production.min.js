...
c);break;case "xlinkArcrole":u(a,"xlink:arcrole",c);break;case "xlinkRole":u(a,"xlink:role",c);break;case "xlinkShow":u(a,"xlink:show",c);break;case "xlinkTitle":u(a,"xlink:title",c);break;case "xlinkType":u(a,"xlink:type",c);break;case "xmlBase":u(a,"xml:base",c);break;case "xmlLang":u(a,"xml:lang",c);break;case "xmlSpace":u(a,"xml:space",c);break;default:if(!(2<b.length)||"o"!==b[0]&&"O"!==b[0]||"n"!==b[1]&&"N"!==b[1])if(b=Qa.get(b)||b,ta(b)){switch(typeof c){case "function":case "symbol":return;
...
G)){var m=c[G];if(null!=m)switch(G){case "children":T=m;break;case "selected":U=m;break;case "dangerouslySetInnerHTML":F=m;break;case "value":O=m;default:x(a,G,m)}}if(null!=p){var B=null!==O?""+O:rb(T);if(Ua(p))for(var L=0;L<p.length;L++){if(""+p[L]===B){a.push(' selected=""');break}}else""+p===B&&a.push(' selected=""')}else U&&a.push(' selected=""');a.push(">");y(a,F,T);return T;case "textarea":a.push(C("textarea"));var A=null,P=null,v=null,D;for(D in c)if(n.call(c,D)){var w=c[D];if(null!=w)switch(D){case "children":v=
...
case "input":a.push(C("input"));var va=null,ma=null,ca=null,V=null,Q=null,wa=null,xa=null,ya=null,za=null,da;for(da in c)if(n.call(c,da)){var E=c[da];if(null!=E)switch(da){case "children":case "dangerouslySetInnerHTML":throw Error("input is a self-closing tag and must neither have `children` nor use `dangerouslySetInnerHTML`.");case "name":va=E;break;case "formAction":ma=E;break;case "formEncType":ca=E;break;case "formMethod":V=E;break;case "formTarget":Q=E;break;case "defaultChecked":za=E;break;
case "defaultValue":xa=E;break;case "checked":ya=E;break;case "value":wa=E;break;default:x(a,da,E)}}var ea=pb(a,e,ma,ca,V,Q,va);null!==ya?lb(a,"checked",ya):null!==za&&lb(a,"checked",za);null!==wa?x(a,"value",wa):null!==xa&&x(a,"value",xa);a.push("/>");null!==ea&&ea.forEach(ob,a);return null;case "button":a.push(C("button"));var M=null,fa=null,ha=null,Aa=null,ia=null,hc=null,ic=null,Ba;for(Ba in c)if(n.call(c,Ba)){var R=c[Ba];if(null!=R)switch(Ba){case "children":M=R;break;case "dangerouslySetInnerHTML":fa=
R;break;case "name":ha=R;break;case "formAction":Aa=R;break;case "formEncType":ia=R;break;case "formMethod":hc=R;break;case "formTarget":ic=R;break;default:x(a,Ba,R)}}var jc=pb(a,e,Aa,ia,hc,ic,ha);a.push(">");null!==jc&&jc.forEach(ob,a);y(a,fa,M);if("string"===typeof M){a.push(q(M));var kc=null}else kc=M;return kc;case "form":a.push(C("form"));var Ca=null,lc=null,W=null,Da=null,Ea=null,Fa=null,Ga;for(Ga in c)if(n.call(c,Ga)){var X=c[Ga];if(null!=X)switch(Ga){case "children":Ca=X;break;case "dangerouslySetInnerHTML":lc=
X;break;case "action":W=X;break;case "encType":Da=X;break;case "method":Ea=X;break;case "target":Fa=X;break;default:x(a,Ga,X)}}var yb=null,zb=null;if("function"===typeof W)if("function"===typeof W.$$FORM_ACTION){var Qd=mb(e),na=W.$$FORM_ACTION(Qd);W=na.action||"";Da=na.encType;Ea=na.method;Fa=na.target;yb=na.data;zb=na.name}else a.push(" ","action",'="',nb,'"'),Fa=Ea=Da=W=null,qb(e);null!=W&&x(a,"action",W);null!=Da&&x(a,"encType",Da);null!=Ea&&x(a,"method",Ea);null!=Fa&&x(a,"target",Fa);a.push(">");
null!==zb&&(a.push('<input type="hidden"'),u(a,"name",zb),a.push("/>"),null!==yb&&yb.forEach(ob,a));y(a,lc,Ca);if("string"===typeof Ca){a.push(q(Ca));var mc=null}else mc=Ca;return mc;case "menuitem":a.push(C("menuitem"));for(var Za in c)if(n.call(c,Za)){var nc=c[Za];if(null!=nc)switch(Za){case "children":case "dangerouslySetInnerHTML":throw Error("menuitems cannot have `children` nor `dangerouslySetInnerHTML`.");default:x(a,Za,nc)}}a.push(">");return null;case "title":if(3===f.insertionMode||f.noscriptTagInScope||
null!=c.itemProp)var oc=ub(a,c);else ub(e.hoistableChunks,c),oc=null;return oc;case "link":return sb(a,c,e,d,g,f.insertionMode,f.noscriptTagInScope);case "script":var Ab=c.async;if("string"!==typeof c.src||!c.src||!Ab||"function"===typeof Ab||"symbol"===typeof Ab||c.onLoad||c.onError||3===f.insertionMode||f.noscriptTagInScope||null!=c.itemProp)var pc=vb(a,c);else{var Bb="[script]"+c.src,Ha=d.scriptsMap.get(Bb);if(!Ha){Ha={type:"script",chunks:[],state:0,props:null};d.scriptsMap.set(Bb,Ha);d.scripts.add(Ha);
var qc=c,$a=d.preloadsMap.get(Bb);if($a){$a.state|=4;var ab=qc=la({},c),rc=$a.props;null==ab.crossOrigin&&(ab.crossOrigin=rc.crossOrigin);null==ab.integrity&&(ab.integrity=rc.integrity)}vb(Ha.chunks,qc)}g&&a.push("\x3c!-- --\x3e");pc=null}return pc;case "style":var Ia=c.precedence,Ja=c.href;if(3===f.insertionMode||f.noscriptTagInScope||null!=c.itemProp||"string"!==typeof Ia||"string"!==typeof Ja||""===Ja){a.push(C("style"));var oa=null,sc=null,Ka;for(Ka in c)if(n.call(c,Ka)){var bb=c[Ka];if(null!=
bb)switch(Ka){case "children":oa=bb;break;case "dangerouslySetInnerHTML":sc=bb;break;default:x(a,Ka,bb)}}a.push(">");var La=Array.isArray(oa)?2>oa.length?oa[0]:null:oa;"function"!==typeof La&&"symbol"!==typeof La&&null!==La&&void 0!==La&&a.push(q(""+La));y(a,sc,oa);a.push("</","style",">");var tc=null}else{var uc="[style]"+Ja,S=d.stylesMap.get(uc);if(!S){if(S=d.stylePrecedences.get(Ia))S.props.hrefs.push(Ja);else{S={type:"style",chunks:[],state:0,props:{precedence:Ia,hrefs:[Ja]}};d.stylePrecedences.set(Ia,
S);var vc=new Set;vc.add(S);d.precedences.set(Ia,vc)}d.stylesMap.set(uc,S);d.boundaryResources&&d.boundaryResources.add(S);var wc=S.chunks,pa=null,xc=null,cb;for(cb in c)if(n.call(c,cb)){var Cb=c[cb];if(null!=Cb)switch(cb){case "children":pa=Cb;break;case "dangerouslySetInnerHTML":xc=Cb}}var Ma=Array.isArray(pa)?2>pa.length?pa[0]:null:pa;"function"!==typeof Ma&&"symbol"!==typeof Ma&&null!==Ma&&void 0!==Ma&&wc.push(q(""+Ma));y(wc,xc,pa)}g&&a.push("\x3c!-- --\x3e");tc=void 0}return tc;case "meta":if(3===
f.insertionMode||f.noscriptTagInScope||null!=c.itemProp)var yc=tb(a,c,"meta");else g&&a.push("\x3c!-- --\x3e"),yc="string"===typeof c.charSet?tb(e.charsetChunks,c,"meta"):"viewport"===c.name?tb(e.preconnectChunks,c,"meta"):tb(e.hoistableChunks,c,"meta");return yc;case "listing":case "pre":a.push(C(b));var Na=null,Oa=null,Pa;for(Pa in c)if(n.call(c,Pa)){var db=c[Pa];if(null!=db)switch(Pa){case "children":Na=db;break;case "dangerouslySetInnerHTML":Oa=db;break;default:x(a,Pa,db)}}a.push(">");if(null!=
Oa){if(null!=Na)throw Error("Can only set one of `children` or `props.dangerouslySetInnerHTML`.");if("object"!==typeof Oa||!("__html"in Oa))throw Error("`props.dangerouslySetInnerHTML` must be in the form `{__html: ...}`. Please visit https://reactjs.org/link/dangerously-set-inner-html for more information.");var ja=Oa.__html;null!==ja&&void 0!==ja&&("string"===typeof ja&&0<ja.length&&"\n"===ja[0]?a.push("\n",ja):a.push(""+ja))}"string"===typeof Na&&"\n"===Na[0]&&a.push("\n");return Na;case "base":case "area":case "br":case "col":case "embed":case "hr":case "img":case "keygen":case "param":case "source":case "track":case "wbr":return tb(a,
...
e.push(",");g=q(JSON.stringify(g));e.push(g)}}a.push("]");c=",[";d.state|=2}});a.push("]")}function bc(){return{preloadsMap:new Map,preconnectsMap:new Map,stylesMap:new Map,scriptsMap:new Map,preconnects:new Set,fontPreloads:new Set,precedences:new Map,stylePrecedences:new Map,bootstrapScripts:new Set,scripts:new Set,explicitPreloads:new Set,boundaryResources:null}}
...
function eb(a,b){var c=I?I:null;if(c){var d=c.resources;if("string"===typeof a&&a){b=null==b||"string"!==typeof b.crossOrigin?null:"use-credentials"===b.crossOrigin?"use-credentials":"";var e="[preconnect]["+(null===b?"null":b)+"]"+a,f=d.preconnectsMap.get(e);f||(f={type:"preconnect",chunks:[],state:0,props:null},d.preconnectsMap.set(e,f),z(f.chunks,{rel:"preconnect",href:a,crossOrigin:b}));d.preconnects.add(f);cc(c)}}}
...
integrity:b.integrity,type:b.type,nonce:b.nonce,fetchPriority:b.fetchPriority,imageSrcSet:b.imageSrcSet,imageSizes:b.imageSizes,referrerPolicy:b.referrerPolicy}},d.preloadsMap.set(f,g),z(g.chunks,g.props));"font"===e?d.fontPreloads.add(g):d.explicitPreloads.add(g);cc(c)}}}
...
function je(a,b,c){var d=b.blockedSegment,e=d.children.length,f=d.chunks.length,g=b.blockedSegment.formatContext,h=b.legacyContext,k=b.context;try{return Z(a,b,null,c)}catch(l){if(Hd(),d.children.length=e,d.chunks.length=f,c=l===od?sd():l,"object"===typeof c&&null!==c&&"function"===typeof c.then)d=Id(),e=b.blockedSegment,f=be(a,e.chunks.length,null,e.formatContext,e.lastPushedText,!0),e.children.push(f),e.lastPushedText=!1,a=ce(a,d,b.node,b.blockedBoundary,f,b.abortSet,b.legacyContext,b.context,b.treeContext).ping,
...
function de(a){if(2!==a.status){var b=$c,c=Xd.current;Xd.current=Vd;var d=Yd.current;Yd.current=Wd;var e=I;I=a;var f=Ud;Ud=a.responseState;try{var g=a.pingedTasks,h;for(h=0;h<g.length;h++){var k=g[h];var l=a,t=k.blockedBoundary;l.resources.boundaryResources=t?t.resources:null;var p=k.blockedSegment;if(0===p.status){fd(k.context);var T=p.children.length,O=p.chunks.length;try{var U=k.thenableState;k.thenableState=null;Z(l,k,U,k.node);l.responseState.generateStaticMarkup||p.lastPushedText&&p.textEmbedded&&
p.chunks.push("\x3c!-- --\x3e");k.abortSet.delete(k);p.status=1;ne(l,k.blockedBoundary,p)}catch(v){Hd();p.children.length=T;p.chunks.length=O;var F=v===od?sd():v;if("object"===typeof F&&null!==F&&"function"===typeof F.then){var G=k.ping;F.then(G,G);k.thenableState=Id()}else{k.abortSet.delete(k);p.status=4;var m=l,B=k.blockedBoundary,L=F,A=ee(m,L);null===B?fe(m,L):(B.pendingTasks--,B.forceClientRender||(B.forceClientRender=!0,B.errorDigest=A,B.parentFlushed&&m.clientRenderedBoundaries.push(B)));m.allPendingTasks--;
if(0===m.allPendingTasks){var P=m.onAllReady;P()}}}finally{l.resources.boundaryResources=null}}}g.splice(0,h);null!==a.destination&&pe(a,a.destination)}catch(v){ee(a,v),fe(a,v)}finally{Ud=f,Xd.current=c,Yd.current=d,c===Vd&&fd(b),I=e}}}
...
function pe(a,b){try{var c,d=a.completedRootSegment;if(null!==d)if(0===a.pendingRootTasks){var e=a.resources,f=a.responseState;if(0!==a.allPendingTasks&&f.externalRuntimeScript){var g=f.externalRuntimeScript,h=g.chunks,k="[script]"+g.src,l=e.scriptsMap.get(k);l||(l={type:"script",chunks:h,state:0,props:null},e.scriptsMap.set(k,l),e.scripts.add(l))}var t=f.htmlChunks,p=f.headChunks;g=0;if(t){for(g=0;g<t.length;g++)b.push(t[g]);if(p)for(g=0;g<p.length;g++)b.push(p[g]);else{var T=C("head");b.push(T);
b.push(">")}}else if(p)for(g=0;g<p.length;g++)b.push(p[g]);var O=f.charsetChunks;for(g=0;g<O.length;g++)b.push(O[g]);O.length=0;e.preconnects.forEach(Sb,b);e.preconnects.clear();var U=f.preconnectChunks;for(g=0;g<U.length;g++)b.push(U[g]);U.length=0;e.fontPreloads.forEach(Sb,b);e.fontPreloads.clear();e.precedences.forEach(Xb,b);e.bootstrapScripts.forEach(Sb,b);e.scripts.forEach(Sb,b);e.scripts.clear();e.explicitPreloads.forEach(Sb,b);e.explicitPreloads.clear();var F=f.preloadChunks;for(g=0;g<F.length;g++)b.push(F[g]);
F.length=0;var G=f.hoistableChunks;for(g=0;g<G.length;g++)b.push(G[g]);G.length=0;t&&null===p&&(b.push("</"),b.push("head"),b.push(">"));re(a,b,d);a.completedRootSegment=null;Gb(b,a.responseState)}else return;else if(0<a.pendingRootTasks)return;var m=a.resources,B=a.responseState;d=0;m.preconnects.forEach(Tb,b);m.preconnects.clear();var L=B.preconnectChunks;for(d=0;d<L.length;d++)b.push(L[d]);L.length=0;m.fontPreloads.forEach(Tb,b);m.fontPreloads.clear();m.precedences.forEach(Zb,b);m.scripts.forEach(Tb,
b);m.scripts.clear();m.explicitPreloads.forEach(Tb,b);m.explicitPreloads.clear();var A=B.preloadChunks;for(d=0;d<A.length;d++)b.push(A[d]);A.length=0;var P=B.hoistableChunks;for(d=0;d<P.length;d++)b.push(P[d]);P.length=0;var v=a.clientRenderedBoundaries;for(c=0;c<v.length;c++){var D=v[c];m=b;var w=a.responseState,va=D.id,ma=D.errorDigest,ca=D.errorMessage,V=D.errorComponentStack,Q=0===w.streamingFormat;Q?(m.push(w.startInlineScript),0===(w.instructions&4)?(w.instructions|=4,m.push('$RX=function(b,c,d,e){var a=document.getElementById(b);a&&(b=a.previousSibling,b.data="$!",a=a.dataset,c&&(a.dgst=c),d&&(a.msg=d),e&&(a.stck=e),b._reactRetry&&b._reactRetry())};;$RX("')):
m.push('$RX("')):m.push('<template data-rxi="" data-bid="');if(null===va)throw Error("An ID must have been assigned before we can complete the boundary.");m.push(va);Q&&m.push('"');if(ma||ca||V)if(Q){m.push(",");var wa=Lb(ma||"");m.push(wa)}else{m.push('" data-dgst="');var xa=q(ma||"");m.push(xa)}if(ca||V)if(Q){m.push(",");var ya=Lb(ca||"");m.push(ya)}else{m.push('" data-msg="');var za=q(ca||"");m.push(za)}if(V)if(Q){m.push(",");var da=Lb(V);m.push(da)}else{m.push('" data-stck="');var E=q(V);m.push(E)}if(Q?
!m.push(")\x3c/script>"):!m.push('"></template>')){a.destination=null;c++;v.splice(0,c);return}}v.splice(0,c);var ea=a.completedBoundaries;for(c=0;c<ea.length;c++)if(!te(a,b,ea[c])){a.destination=null;c++;ea.splice(0,c);return}ea.splice(0,c);var M=a.partialBoundaries;for(c=0;c<M.length;c++){var fa=M[c];a:{v=a;D=b;v.resources.boundaryResources=fa.resources;var ha=fa.completedSegments;for(w=0;w<ha.length;w++)if(!ue(v,D,fa,ha[w])){w++;ha.splice(0,w);var Aa=!1;break a}ha.splice(0,w);Aa=Rb(D,fa.resources,
v.responseState)}if(!Aa){a.destination=null;c++;M.splice(0,c);return}}M.splice(0,c);var ia=a.completedBoundaries;for(c=0;c<ia.length;c++)if(!te(a,b,ia[c])){a.destination=null;c++;ia.splice(0,c);return}ia.splice(0,c)}finally{0===a.allPendingTasks&&0===a.pingedTasks.length&&0===a.clientRenderedBoundaries.length&&0===a.completedBoundaries.length&&(a.flushScheduled=!1,a=a.responseState,a.hasBody&&(b.push("</"),b.push("body"),b.push(">")),a.htmlChunks&&(b.push("</"),b.push("html"),b.push(">")),b.push(null))}}
...
exports.version="18.3.0-experimental-cb3404a0c-20230807";
