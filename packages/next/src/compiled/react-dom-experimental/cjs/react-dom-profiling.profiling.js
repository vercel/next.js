  ...
  switch (deletedFiber.tag) {
    ...
    case 15:
      if (
        ...
        do {
          prevHostParentIsContainer$133 = prevHostParentIsContainer.tag;
          var inst = prevHostParentIsContainer.inst,
            destroy = inst.destroy;
          void 0 !== destroy &&
            (0 !== (prevHostParentIsContainer$133 & 2)
              ? ((inst.destroy = void 0),
                safelyCallDestroy(
                  deletedFiber,
                  nearestMountedAncestor,
              ...
              : 0 !== (prevHostParentIsContainer$133 & 4) &&
...
for (
  var i$jscomp$inline_1494 = 0;
  i$jscomp$inline_1494 < simpleEventPluginEvents.length;
  i$jscomp$inline_1494++
) {
  var eventName$jscomp$inline_1495 =
      simpleEventPluginEvents[i$jscomp$inline_1494],
    domEventName$jscomp$inline_1496 =
      eventName$jscomp$inline_1495.toLowerCase(),
    capitalizedEvent$jscomp$inline_1497 =
      eventName$jscomp$inline_1495[0].toUpperCase() +
      eventName$jscomp$inline_1495.slice(1);
  registerSimpleEvent(
    domEventName$jscomp$inline_1496,
    "on" + capitalizedEvent$jscomp$inline_1497
  );
}
...
var internals$jscomp$inline_1750 = {
  bundleType: 0,
