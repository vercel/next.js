...
for (
  var i$jscomp$inline_1970 = 0;
  i$jscomp$inline_1970 < simpleEventPluginEvents.length;
  i$jscomp$inline_1970++
) {
  var eventName$jscomp$inline_1971 =
      simpleEventPluginEvents[i$jscomp$inline_1970],
    domEventName$jscomp$inline_1972 =
      eventName$jscomp$inline_1971.toLowerCase(),
    capitalizedEvent$jscomp$inline_1973 =
      eventName$jscomp$inline_1971[0].toUpperCase() +
      eventName$jscomp$inline_1971.slice(1);
  registerSimpleEvent(
    domEventName$jscomp$inline_1972,
    "on" + capitalizedEvent$jscomp$inline_1973
  );
}
...
var internals$jscomp$inline_3007 = {
  bundleType: 0,
