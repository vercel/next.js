...
if (canUseDOM) {
  ...
  if (canUseDOM) {
    ...
    JSCompiler_inline_result$jscomp$306 = isSupported$jscomp$inline_436;
          ...
          18 === wasInHydratedSubtree[0].tag
            ? ((inHydratedSubtree = !1),
              null !== prevEffectDuration.hydrationErrors &&
                ((prevEffectDuration = finishedWork.actualStartTime),
                supportsUserTiming &&
                  performance.measure("Suspense", {
                    start: prevEffectDuration,
                    end: endTime,
                    detail: {
                      devtools: {
                        color: "error",
    ...
    if (0 !== (completedWork.mode & 2)) {
      for (
        ...
        (newChildLanes |= child$152.lanes | child$152.childLanes),
          (subtreeFlags |= child$152.subtreeFlags & 31457280),
          (subtreeFlags |= child$152.flags & 31457280),
      ...
      for (
        ...
        (newChildLanes |=
          ...
          (subtreeFlags |= treeBaseDuration$151.subtreeFlags & 31457280),
          (subtreeFlags |= treeBaseDuration$151.flags & 31457280),
...
function prepareFreshStack(root, lanes) {
  ...
  if (0 !== (lanes & 3) || 0 !== (lanes & 60)) {
    ...
    supportsUserTiming &&
      ...
      0 < previousRenderStartTime &&
        ((reusableLaneDevToolDetails.color =
          (lanes & 738197589) === lanes ? "tertiary-light" : "primary-light"),
        (reusableLaneOptions.start = previousRenderStartTime),
    ...
    if (null !== finishedWork) {
      ...
      for (
        var entanglements = root$jscomp$0.entanglements,
          ...
          lanes$jscomp$0 = previouslyPendingLanes & ~remainingLanes$jscomp$0;
        0 < lanes$jscomp$0;
      ...
      if (1 === suspendedCommitReason) {
        ...
        supportsUserTiming &&
          ...
          (reusableLaneOptions.end = endTime),
          performance.measure("Suspended", reusableLaneOptions));
      } else if (2 === suspendedCommitReason) {
      ...
      if (0 !== (finishedWork.subtreeFlags & 15990) || rootHasEffect) {
        ...
        var priorSelectionInformation = selectionInformation,
          curFocusedElem = getActiveElementDeep(root$jscomp$0.containerInfo),
        ...
        if (
          ...
          for (
            var i$jscomp$0 = 0;
            i$jscomp$0 < ancestors.length;
            i$jscomp$0++
          ) {
            var info = ancestors[i$jscomp$0];
      ...
      if (null !== recoverableErrors)
        for (
          var onRecoverableError = root$jscomp$0.onRecoverableError,
            i$jscomp$1 = 0;
          i$jscomp$1 < recoverableErrors.length;
          i$jscomp$1++
        ) {
          var recoverableError = recoverableErrors[i$jscomp$1];
  ...
  if (null !== rootWithPendingPassiveEffects) {
    ...
    try {
      ...
      if (null === rootWithPendingPassiveEffects)
        ...
        rootWithPendingPassiveEffects = null;
        pendingPassiveEffectsLanes = 0;
        renderPriority.callbackNode = null;
        renderPriority.callbackPriority = 0;
        renderPriority.cancelPendingCommit = null;
        ...
        flushSyncWorkAcrossRoots_impl(0, !1);
        ensureRootIsScheduled(renderPriority);
        if (
          injectedHook &&
...
for (
  var i$jscomp$inline_1561 = 0;
  i$jscomp$inline_1561 < simpleEventPluginEvents.length;
  i$jscomp$inline_1561++
) {
  var eventName$jscomp$inline_1562 =
      simpleEventPluginEvents[i$jscomp$inline_1561],
    domEventName$jscomp$inline_1563 =
      eventName$jscomp$inline_1562.toLowerCase(),
    capitalizedEvent$jscomp$inline_1564 =
      eventName$jscomp$inline_1562[0].toUpperCase() +
      eventName$jscomp$inline_1562.slice(1);
  registerSimpleEvent(
    domEventName$jscomp$inline_1563,
    "on" + capitalizedEvent$jscomp$inline_1564
  );
}
...
var internals$jscomp$inline_2327 = {
  bundleType: 0,
