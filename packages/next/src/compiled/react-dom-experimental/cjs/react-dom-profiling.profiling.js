...
for (
  var i$jscomp$inline_1989 = 0;
  i$jscomp$inline_1989 < simpleEventPluginEvents.length;
  i$jscomp$inline_1989++
) {
  var eventName$jscomp$inline_1990 =
      simpleEventPluginEvents[i$jscomp$inline_1989],
    domEventName$jscomp$inline_1991 =
      eventName$jscomp$inline_1990.toLowerCase(),
    capitalizedEvent$jscomp$inline_1992 =
      eventName$jscomp$inline_1990[0].toUpperCase() +
      eventName$jscomp$inline_1990.slice(1);
  registerSimpleEvent(
    domEventName$jscomp$inline_1991,
    "on" + capitalizedEvent$jscomp$inline_1992
  );
}
    ...
    var readyCallback = function () {
        ...
        for (i = 0; i < animations.length; i++) {
          ...
          if (
            ...
            var timing$312 = pseudoElement.getTiming();
            anim =
              rangeEnd -
              (("number" === typeof timing$312.duration
                ? timing$312.duration
                : 0) +
                timing$312.delay) *
                longestDuration;
            groupName = rangeEnd - timing$312.delay * longestDuration;
            if (
              "reverse" === timing$312.direction ||
              "alternate-reverse" === timing$312.direction
            )
              (timing$312 = anim), (anim = groupName), (groupName = timing$312);
            animateGesture(
...
var internals$jscomp$inline_3040 = {
  bundleType: 0,
...
if ("undefined" !== typeof __REACT_DEVTOOLS_GLOBAL_HOOK__) {
  var hook$jscomp$inline_3041 = __REACT_DEVTOOLS_GLOBAL_HOOK__;
  if (
    !hook$jscomp$inline_3041.isDisabled &&
    hook$jscomp$inline_3041.supportsFiber
  )
    try {
      (rendererID = hook$jscomp$inline_3041.inject(
        internals$jscomp$inline_3040
      )),
        (injectedHook = hook$jscomp$inline_3041);
    } catch (err) {}
}
function noop() {}
