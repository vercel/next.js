...
function getActiveElementDeep(containerInfo) {
  var $jscomp$optchain$tmp936298381$1, $jscomp$nullish$tmp0;
  containerInfo =
    null !=
    ($jscomp$nullish$tmp0 =
      null == containerInfo
        ? void 0
        : null ==
            ($jscomp$optchain$tmp936298381$1 = containerInfo.ownerDocument)
          ? void 0
          : $jscomp$optchain$tmp936298381$1.defaultView)
      ? $jscomp$nullish$tmp0
      : window;
  for (
    $jscomp$optchain$tmp936298381$1 = getActiveElement(containerInfo.document);
    $jscomp$optchain$tmp936298381$1 instanceof containerInfo.HTMLIFrameElement;

  ) {
    try {
      var JSCompiler_inline_result =
        "string" ===
        typeof $jscomp$optchain$tmp936298381$1.contentWindow.location.href;
    } catch (err) {
      JSCompiler_inline_result = !1;
    }
    if (JSCompiler_inline_result)
      containerInfo = $jscomp$optchain$tmp936298381$1.contentWindow;
    else break;
    $jscomp$optchain$tmp936298381$1 = getActiveElement(containerInfo.document);
  }
  return $jscomp$optchain$tmp936298381$1;
}
...
function commitDeletionEffectsOnFiber(
  ...
  switch (deletedFiber.tag) {
    ...
    case 6:
      ...
      var prevHostParentIsContainer$132 = hostParentIsContainer;
      hostParent = null;
      recursivelyTraverseDeletionEffects(
        finishedRoot,
        nearestMountedAncestor,
      ...
      hostParentIsContainer = prevHostParentIsContainer$132;
      if (null !== hostParent)
    ...
    case 15:
      if (
        ...
        do {
          prevHostParentIsContainer$132 = prevHostParentIsContainer.tag;
          var inst = prevHostParentIsContainer.inst,
            destroy = inst.destroy;
          void 0 !== destroy &&
            (0 !== (prevHostParentIsContainer$132 & 2)
              ? ((inst.destroy = void 0),
                safelyCallDestroy(
                  deletedFiber,
                  nearestMountedAncestor,
              ...
              : 0 !== (prevHostParentIsContainer$132 & 4) &&
...
var isomorphicReactPackageVersion$jscomp$inline_1701 = React.version;
if (
  "19.0.0-experimental-ee1a403a-20240916" !==
  isomorphicReactPackageVersion$jscomp$inline_1701
)
  throw Error(
    formatProdErrorMessage(
      527,
