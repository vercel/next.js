    ...
    var readyCallback = function () {
        ...
        for (i = 0; i < animations.length; i++) {
          ...
          if (
            ...
            anim =
              rangeEnd -
              (("number" === typeof timing$277.duration
                ? timing$277.duration
                : 0) +
                timing$277.delay) *
                longestDuration;
            ...
            if (
              "reverse" === timing$277.direction ||
              "alternate-reverse" === timing$277.direction
            )
...
var internals$jscomp$inline_2785 = {
  bundleType: 0,
...
if ("undefined" !== typeof __REACT_DEVTOOLS_GLOBAL_HOOK__) {
  var hook$jscomp$inline_2786 = __REACT_DEVTOOLS_GLOBAL_HOOK__;
  if (
    !hook$jscomp$inline_2786.isDisabled &&
    hook$jscomp$inline_2786.supportsFiber
  )
    try {
      (rendererID = hook$jscomp$inline_2786.inject(
        internals$jscomp$inline_2785
      )),
        (injectedHook = hook$jscomp$inline_2786);
    } catch (err) {}
}
