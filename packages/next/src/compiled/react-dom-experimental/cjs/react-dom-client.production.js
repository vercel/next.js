  ...
  switch (deletedFiber.tag) {
    ...
    case 15:
      if (
        ...
        do {
          prevHostParentIsContainer$123 = prevHostParentIsContainer.tag;
          var inst = prevHostParentIsContainer.inst,
            destroy = inst.destroy;
          void 0 !== destroy &&
            (0 !== (prevHostParentIsContainer$123 & 2)
              ? ((inst.destroy = void 0),
                safelyCallDestroy(
                  deletedFiber,
                  nearestMountedAncestor,
              ...
              : 0 !== (prevHostParentIsContainer$123 & 4) &&
                ((inst.destroy = void 0),
                safelyCallDestroy(
                  deletedFiber,
                  nearestMountedAncestor,
...
function bubbleProperties(completedWork) {
  var didBailout =
    ...
    subtreeFlags = 0;
  if (didBailout)
    for (var child$137 = completedWork.child; null !== child$137; )
      (newChildLanes |= child$137.lanes | child$137.childLanes),
        ...
        (child$137.return = completedWork),
        (child$137 = child$137.sibling);
  else
    for (child$137 = completedWork.child; null !== child$137; )
      (newChildLanes |= child$137.lanes | child$137.childLanes),
        (subtreeFlags |= child$137.subtreeFlags),
        (subtreeFlags |= child$137.flags),
        (child$137.return = completedWork),
        (child$137 = child$137.sibling);
...
var internals$jscomp$inline_2093 = {
  bundleType: 0,
...
if ("undefined" !== typeof __REACT_DEVTOOLS_GLOBAL_HOOK__) {
  var hook$jscomp$inline_2094 = __REACT_DEVTOOLS_GLOBAL_HOOK__;
  if (
    !hook$jscomp$inline_2094.isDisabled &&
    hook$jscomp$inline_2094.supportsFiber
  )
    try {
      (rendererID = hook$jscomp$inline_2094.inject(
        internals$jscomp$inline_2093
      )),
        (injectedHook = hook$jscomp$inline_2094);
    } catch (err) {}
}
