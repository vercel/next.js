...
for (
  var reportGlobalError =
    ...
    i$jscomp$inline_440 = 0;
  i$jscomp$inline_440 < simpleEventPluginEvents.length;
  i$jscomp$inline_440++
) {
  var eventName$jscomp$inline_441 =
      simpleEventPluginEvents[i$jscomp$inline_440],
    domEventName$jscomp$inline_442 = eventName$jscomp$inline_441.toLowerCase(),
    capitalizedEvent$jscomp$inline_443 =
      eventName$jscomp$inline_441[0].toUpperCase() +
      eventName$jscomp$inline_441.slice(1);
  registerSimpleEvent(
    domEventName$jscomp$inline_442,
    "on" + capitalizedEvent$jscomp$inline_443
  );
}
...
function resolveClassComponentProps(Component, baseProps) {
  ...
  if ((Component = Component.defaultProps)) {
    ...
    for (var propName$158 in Component)
      void 0 === newProps[propName$158] &&
        (newProps[propName$158] = Component[propName$158]);
  }
  return newProps;
}
  ...
  if (!isHydrating)
    switch (renderState.tailMode) {
      ...
      case "collapsed":
        ...
        for (var lastTailNode$190 = null; null !== lastTailNode; )
          null !== lastTailNode.alternate && (lastTailNode$190 = lastTailNode),
            (lastTailNode = lastTailNode.sibling);
        null === lastTailNode$190
          ? hasRenderedATailFallback || null === renderState.tail
            ? (renderState.tail = null)
            : (renderState.tail.sibling = null)
          : (lastTailNode$190.sibling = null);
    }
}
function bubbleProperties(completedWork) {
  var didBailout =
    ...
    subtreeFlags = 0;
  if (didBailout)
    for (var child$191 = completedWork.child; null !== child$191; )
      (newChildLanes |= child$191.lanes | child$191.childLanes),
        (subtreeFlags |= child$191.subtreeFlags & 31457280),
        (subtreeFlags |= child$191.flags & 31457280),
        (child$191.return = completedWork),
        (child$191 = child$191.sibling);
  else
    for (child$191 = completedWork.child; null !== child$191; )
      (newChildLanes |= child$191.lanes | child$191.childLanes),
        (subtreeFlags |= child$191.subtreeFlags),
        (subtreeFlags |= child$191.flags),
        (child$191.return = completedWork),
        (child$191 = child$191.sibling);
...
function completeWork(current, workInProgress, renderLanes) {
  ...
  switch (workInProgress.tag) {
    ...
    case 13:
      ...
      if (renderLanes) {
        ...
        null !== newProps.memoizedState &&
          ...
          (cache$203 = newProps.memoizedState.cachePool.pool);
        cache$203 !== currentResource && (newProps.flags |= 2048);
      }
      renderLanes !== current &&
        renderLanes &&
    ...
    case 19:
      ...
      cache$203 = currentResource.rendering;
      if (null === cache$203)
        if (newProps) cutOffTailIfNeeded(currentResource, !1);
          ...
          if (
            ...
            for (current = workInProgress.child; null !== current; ) {
              cache$203 = findFirstSuspended(current);
              if (null !== cache$203) {
                workInProgress.flags |= 128;
                cutOffTailIfNeeded(currentResource, !1);
                current = cache$203.updateQueue;
                workInProgress.updateQueue = current;
        ...
        if (!newProps)
          if (((current = findFirstSuspended(cache$203)), null !== current)) {
            if (
              ((workInProgress.flags |= 128),
              (newProps = !0),
              (current = current.updateQueue),
        ...
        currentResource.isBackwards
          ? ((cache$203.sibling = workInProgress.child),
            (workInProgress.child = cache$203))
          : ((current = currentResource.last),
            null !== current
              ? (current.sibling = cache$203)
              : (workInProgress.child = cache$203),
            (currentResource.last = cache$203));
      }
  ...
  if (null === resource.instance)
    switch (resource.type) {
      ...
      case "stylesheet":
        ...
        setInitialProperties(instance$234, "link", instance);
        resource.state.loading |= 4;
      ...
      case "script":
        ...
        if (
          (styleProps = hoistableRoot.querySelector(
            getScriptSelectorFromKey(instance$234)
          ))
        )
          return (
...
var devToolsConfig$jscomp$inline_1624 = {
  findFiberByHostInstance: getClosestInstanceFromNode,
  bundleType: 0,
  version: "19.0.0-experimental-cb151849e1-20240424",
  rendererPackageName: "react-dom"
};
var internals$jscomp$inline_2002 = {
  bundleType: devToolsConfig$jscomp$inline_1624.bundleType,
  version: devToolsConfig$jscomp$inline_1624.version,
  rendererPackageName: devToolsConfig$jscomp$inline_1624.rendererPackageName,
  rendererConfig: devToolsConfig$jscomp$inline_1624.rendererConfig,
  ...
  findFiberByHostInstance:
    devToolsConfig$jscomp$inline_1624.findFiberByHostInstance ||
  ...
  reconcilerVersion: "19.0.0-experimental-cb151849e1-20240424"
};
if ("undefined" !== typeof __REACT_DEVTOOLS_GLOBAL_HOOK__) {
  var hook$jscomp$inline_2003 = __REACT_DEVTOOLS_GLOBAL_HOOK__;
  if (
    !hook$jscomp$inline_2003.isDisabled &&
    hook$jscomp$inline_2003.supportsFiber
  )
    try {
      (rendererID = hook$jscomp$inline_2003.inject(
        internals$jscomp$inline_2002
      )),
        (injectedHook = hook$jscomp$inline_2003);
    } catch (err) {}
}
