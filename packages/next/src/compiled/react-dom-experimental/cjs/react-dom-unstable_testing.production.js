...
if (canUseDOM) {
  ...
  if (canUseDOM) {
    var isSupported$jscomp$inline_404 = "oninput" in document;
    if (!isSupported$jscomp$inline_404) {
      var element$jscomp$inline_405 = document.createElement("div");
      element$jscomp$inline_405.setAttribute("oninput", "return;");
      isSupported$jscomp$inline_404 =
        "function" === typeof element$jscomp$inline_405.oninput;
    }
    JSCompiler_inline_result$jscomp$268 = isSupported$jscomp$inline_404;
...
for (
  var reportGlobalError =
    ...
    i$jscomp$inline_445 = 0;
  i$jscomp$inline_445 < simpleEventPluginEvents.length;
  i$jscomp$inline_445++
) {
  var eventName$jscomp$inline_446 =
      simpleEventPluginEvents[i$jscomp$inline_445],
    domEventName$jscomp$inline_447 = eventName$jscomp$inline_446.toLowerCase(),
    capitalizedEvent$jscomp$inline_448 =
      eventName$jscomp$inline_446[0].toUpperCase() +
      eventName$jscomp$inline_446.slice(1);
  registerSimpleEvent(
    domEventName$jscomp$inline_447,
    "on" + capitalizedEvent$jscomp$inline_448
  );
}
