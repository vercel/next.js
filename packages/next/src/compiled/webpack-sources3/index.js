;(function () {
  var e = {
      ...
      class CachedSource extends s {
        ...
        getCachedData() {
          ...
          for (const t of this._cachedMaps) {
            ...
            e.set(t[0], { map: undefined, bufferedMap: n.bufferedMap })
          }
        ...
        buffer() {
          if (void 0 !== this._cachedSource)
            return Buffer.isBuffer(this._cachedSource)
              ? this._cachedSource
              : Buffer.from(this._cachedSource, 'utf-8')
          if ('function' == typeof this.original().buffer)
            return this.original().buffer()
          let r = this.source()
          return Buffer.isBuffer(r) ? r : Buffer.from(r, 'utf-8')
        }
        size() {
        ...
        streamChunks(e, t, n, s) {
          ...
          if (
            ...
            if (o) {
              return r(u, o, t, n, s, !!(e && e.finalSource), true)
            } else {
        ...
        map(e) {
          ...
          this._cachedMaps.set(t, { map: s, bufferedMap: undefined })
          return s
        }
        updateHash(e) {
    ...
    23: function (e, t, n) {
      ...
      const r = n(188)
      const i = n(467)
      const { getMap: u, getSourceAndMap: o } = n(940)
      const f = new WeakSet()
      class ConcatSource extends s {
        ...
        streamChunks(e, t, n, s) {
          ...
          if (this._children.length === 1)
            return this._children[0].streamChunks(e, t, n, s)
          let r = 0
          let u = 0
          let o = new Map()
          let f = new Map()
    ...
    326: function (e, t, n) {
      'use strict'
      const { getMap: s, getSourceAndMap: r } = n(940)
      const i = n(144)
      const u = n(865)
      const o = n(68)
      const f = n(289)
    ...
    188: function (e, t, n) {
      ...
      class RawSource extends r {
        constructor(e, t = false) {
          ...
          this._valueAsBuffer = n ? e : undefined
          this._valueAsString = n ? undefined : e
        }
        isBuffer() {
        ...
        streamChunks(e, t, n, r) {
          ...
          return s(this._valueAsString, t, n, r, !!(e && e.finalSource))
        }
        updateHash(e) {
          if (this._valueAsBuffer === undefined) {
            this._valueAsBuffer = Buffer.from(this._value, 'utf-8')
          ...
          let { generatedLine: m, generatedColumn: A } = i(
            ...
            (e, n, i, _, m, A, M) => {
              ...
              if (h < v) {
                do {
                  ...
                  if (h > u) {
                    ...
                    B += n
                    u = h
                    if (checkOriginalContent(_, m, A, s)) {
                      A += s.length
                    }
                  }
                  ...
                  for (let e = 0; e < y.length; e++) {
                    const n = y[e]
                    t(n, C, i + (C === p ? d : 0), _, m, A, w)
                    w = -1
                    if (e === y.length - 1 && !n.endsWith('\n')) {
                      if (p === C) {
                        d += n.length
                      } else {
                        d = n.length
              ...
              if (B < e.length) {
                ...
                const r = n + l
                t(s, r, i + (r === p ? d : 0), _, m, A, M < 0 ? -1 : S[M])
              }
              u = v
            },
            (e, t, s) => {
    ...
    323: function (e, t, n) {
      ...
      const streamAndGetSourceAndMap = (e, t, n, i, u) => {
        ...
        let a = []
        let h = []
        const l = s(Object.assign({}, t, { columns: true }))
      ...
      e.exports = (e, t, n, i, u) => {
        if (typeof e.streamChunks === 'function') {
          ...
          if (o.map) {
            ...
            return s(o.source, n, i, u, !!(t && t.finalSource))
          }
        }
      }
    },
        ...
        return s(
          ...
          (t, s, u, h, l, y, w) => {
            if (h === m) {
              ...
              if (m !== -1) {
                const { chunks: e, mappingsData: n } = O[l - 1]
                const i = m * 5
                const o = n[i + 1]
                const h = n[i + 2]
                let _ = n[i + 3]
    ...
    823: function (e, t, n) {
      ...
      const i = n(298)
      const u = n(144)
      const streamChunksOfSourceMapFull = (e, t, n, s, o) => {
        const f = u(e)
        if (f.length === 0) {
      ...
      const streamChunksOfSourceMapLinesFull = (e, t, n, s, o) => {
        const f = u(e)
        if (f.length === 0) {
          return { generatedLine: 1, generatedColumn: 0 }
        }
      ...
      const streamChunksOfSourceMapFinal = (e, t, n, u, o) => {
        const f = s(e)
      ...
      const streamChunksOfSourceMapLinesFinal = (e, t, n, u, o) => {
        const f = s(e)
        const { generatedLine: c, generatedColumn: a } = f
        if (c === 1 && a === 0) {
          return { generatedLine: 1, generatedColumn: 0 }
      ...
      e.exports = (e, t, n, s, r, i, u) => {
        if (u) {
          return i
            ? streamChunksOfSourceMapFinal(e, t, n, s, r)
            : streamChunksOfSourceMapFull(e, t, n, s, r)
        } else {
          return i
            ? streamChunksOfSourceMapLinesFinal(e, t, n, s, r)
            : streamChunksOfSourceMapLinesFull(e, t, n, s, r)
        }
      }
    },
    591: function (e, t, n) {
      ...
      defineExport('Source', () => n(68))
      defineExport('RawSource', () => n(188))
      defineExport('OriginalSource', () => n(326))
      defineExport('SourceMapSource', () => n(753))
      defineExport('CachedSource', () => n(449))
      defineExport('ConcatSource', () => n(23))
      defineExport('ReplaceSource', () => n(633))
      defineExport('PrefixSource', () => n(759))
      defineExport('SizeOnlySource', () => n(201))
      defineExport('CompatSource', () => n(160))
    },
  }
  var t = {}
