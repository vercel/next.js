  ...
  var e = {
    373: function (e, t, n) {
      ...
      class CachedSource extends s {
        ...
        streamChunks(e, t, n, s) {
          ...
          this._cachedMaps.set(f, { map: a, bufferedMap: undefined })
          return o
        }
        map(e) {
          const t = e ? JSON.stringify(e) : '{}'
    ...
    923: function (e, t, n) {
      ...
      class RawSource extends u {
        constructor(e, t = false) {
          ...
          this._value = t && n ? undefined : typeof e === 'string' ? r(e) : e
          this._valueAsBuffer = n ? e : undefined
          this._valueAsString = n ? undefined : r(e)
        }
        isBuffer() {
        ...
        source() {
          if (this._value === undefined) {
            const e = r(this._valueAsBuffer.toString('utf-8'))
            if (i()) {
              this._value = e
            }
            return e
          ...
          if (f === undefined) {
            f =
              typeof this._value === 'string'
                ? this._value
                : r(this._value.toString('utf-8'))
            if (i()) {
              this._valueAsString = f
            }
          }
            ...
            if (h === m) {
              ...
              if (m !== -1) {
                ...
                if (f >= 0) {
                  ...
                  if (k === -2) {
                    const [e, t] = f < M.length ? M[f] : [null, undefined]
                    let n = d.get(e)
                    if (n === undefined) {
                      d.set(e, (n = d.size))
                      c(n, e, t)
                  ...
                  if (x >= 0) {
                    ...
                    if (e !== null) {
                      const t = S[w]
                      const n =
                        h <= e.length ? e[h - 1].slice(g, g + t.length) : ''
                      if (t === n) {
                        L = w < _.length ? _[w] : -2
                        if (L === -2) {
                          const e = S[w]
    ...
    732: function (e, t, n) {
      ...
      const streamChunksOfRawSource = (e, t, n, s) => {
        ...
        return u.length === 0 || f.endsWith('\n')
          ...
          : { generatedLine: u.length, generatedColumn: f.length }
      }
      e.exports = (e, t, n, r, i) =>
    ...
    126: function (e, t, n) {
      ...
      const streamChunksOfSourceMapFull = (e, t, n, s, f) => {
        ...
        return { generatedLine: g, generatedColumn: _ }
      }
    ...
    590: function (e) {
      ...
      function internString(e) {
        if (!isStringInterningEnabled() || !e || typeof e !== 'string') {
          return e
        }
        let t = n.get(e)
        if (t === undefined) {
