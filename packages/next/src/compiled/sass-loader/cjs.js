;(function () {
  ...
  var __webpack_modules__ = {
    ...
    845: function (e, t, s) {
      ...
      var r = _interopRequireDefault(s(873))
      var a = s(979)
      ...
      async function loader(e) {
        ...
        if (typeof d.loadedUrls !== 'undefined') {
          ...
          typeof d.stats !== 'undefined' &&
          typeof d.stats.includedFiles !== 'undefined'
        ) {
    ...
    979: function (__unused_webpack_module, exports, __nccwpck_require__) {
      ...
      async function getSassOptions(e, t, s, n, o) {
        ...
        if (i) {
          ...
          a.loadPaths = []
            .concat(
              (a.loadPaths ? a.loadPaths.slice() : []).map((e) =>
          ...
          a.importers = a.importers
            ? Array.isArray(a.importers)
              ? a.importers.slice()
              : [a.importers]
            : []
        } else {
          ...
          if (
            s &&
            s.toLowerCase() === '.sass' &&
            typeof a.indentedSyntax === 'undefined'
          ) {
          ...
          a.importer = a.importer
            ? proxyCustomImporters(
                Array.isArray(a.importer) ? a.importer.slice() : [a.importer],
                e
              )
            : []
          ...
          a.includePaths = []
            .concat(process.cwd())
            .concat(
              (a.includePaths ? a.includePaths.slice() : []).map((e) =>
                _path.default.isAbsolute(e)
                  ? e
                  : _path.default.join(process.cwd(), e)
              )
      ...
      function getWebpackResolver(e, t, s = []) {
        const n =
          t &&
          (t.info.includes('dart-sass') || t.info.includes('sass-embedded'))
