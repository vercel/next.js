...
function Lb(a,b,c,d){if("$"===d[0])switch(d[1]){case "$":return d.slice(1);case "@":return b=parseInt(d.slice(2),16),Z(a,b);case "F":return d=parseInt(d.slice(2),16),d=Kb(a,d),Db(a,d.id,d.bound,X,b,c);case "T":return xa(d.slice(2));case "Q":return b=parseInt(d.slice(2),16),a=Kb(a,b),new Map(a);case "W":return b=parseInt(d.slice(2),16),a=Kb(a,b),new Set(a);case "K":b=d.slice(2);var e=a._prefix+b+"_",f=new FormData;a._formData.forEach(function(g,k){k.startsWith(e)&&f.append(k.slice(e.length),g)});return f;
