...
function na(a){switch(a.status){case "resolved_model":O(a);break;case "resolved_module":P(a)}switch(a.status){case "fulfilled":return a.value;case "pending":case "blocked":throw a;default:throw a.reason;}}function Q(a,b){for(var d=0;d<a.length;d++)(0,a[d])(b)}function R(a,b,d){switch(a.status){case "fulfilled":Q(b,a.value);break;case "pending":case "blocked":a.value=b;a.reason=d;break;case "rejected":d&&Q(d,a.reason)}}
...
function W(a,b){a._chunks.forEach(function(d){"pending"===d.status&&S(d,b)})}function X(a,b){var d=a._chunks,c=d.get(b);c||(c=new N("pending",null,null,a),d.set(b,c));return c}function oa(a,b,d){if(V){var c=V;c.deps++}else c=V={deps:1,value:null};return function(g){b[d]=g;c.deps--;0===c.deps&&"blocked"===a.status&&(g=a.value,a.status="fulfilled",a.value=c.value,null!==g&&Q(g,c.value))}}function pa(a){return function(b){return S(a,b)}}
...
U,a.then(oa(c,b,d),pa(c)),null;default:throw a.reason;}}}return c}function sa(){throw Error('Trying to call a function from "use server" but the callServer option was not implemented in your router runtime.');}function ta(a,b,d,c){var g=new Map;a={_bundlerConfig:a,_moduleLoading:b,_callServer:void 0!==d?d:sa,_nonce:c,_chunks:g,_stringDecoder:new p.TextDecoder,_fromJSON:null,_rowState:0,_rowID:0,_rowTag:0,_rowLength:0,_buffer:[]};a._fromJSON=ua(a);return a}
