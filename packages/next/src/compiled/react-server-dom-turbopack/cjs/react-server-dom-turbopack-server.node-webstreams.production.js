/**
 * @license React
 * react-server-dom-turbopack-server.node-webstreams.production.js
 *
...
var CLIENT_REFERENCE_TAG$2 = Symbol.for("react.client.reference"),
  SERVER_REFERENCE_TAG$1 = Symbol.for("react.server.reference"),
...
function createTemporaryReference(temporaryReferences, id) {
  ...
  reference = new Proxy(reference, proxyHandlers$1);
...
function use(usable) {
  ...
  if (usable.$$typeof === CLIENT_REFERENCE_TAG$2) {
...
function describeValueForErrorMessage(value) {
  switch (typeof value) {
    ...
    case "object":
      ...
      if (null !== value && value.$$typeof === CLIENT_REFERENCE_TAG$1)
        return "client";
...
function describeObjectForErrorMessage(objectOrArray, expandedName) {
  ...
  if (isArrayImpl(objectOrArray)) {
    ...
    if (objectOrArray.$$typeof === CLIENT_REFERENCE_TAG$1) return "client";
    str = "{";
...
function processServerComponentReturnValue(request, task, Component, result) {
  if (
    ...
    null === result ||
    result.$$typeof === CLIENT_REFERENCE_TAG$2
  )
    return result;
  ...
  if (12 === request.status)
    throw (
      ("object" === typeof props &&
        ...
        props.$$typeof !== CLIENT_REFERENCE_TAG$2 &&
...
function renderElement(request, task, type, key, ref, props) {
  ...
  if (
    ...
    type.$$typeof !== CLIENT_REFERENCE_TAG$2 &&
...
function renderModelDestructive(
  ...
  if ("object" === typeof value) {
    ...
    if (value.$$typeof === CLIENT_REFERENCE_TAG$2)
  ...
  if ("function" === typeof value) {
    ...
    if (value.$$typeof === SERVER_REFERENCE_TAG$1)
      return (
  ...
  switch (name) {
    ...
    case "then":
      ...
      var clientReference = registerClientReferenceImpl({}, target.$$id, !0),
        proxy = new Proxy(clientReference, proxyHandlers);
...
exports.createClientModuleProxy = function (moduleId) {
  ...
  return new Proxy(moduleId, proxyHandlers);
};
