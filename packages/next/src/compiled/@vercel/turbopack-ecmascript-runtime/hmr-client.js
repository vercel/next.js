...
import { addMessageListener as turboSocketAddMessageListener, sendMessage as turboSocketSendMessage } from "./websocket";
export function connect(param) {
    ...
    // vercel/next.js#54586 is merged.
    sendMessage =turboSocketSendMessage  } = param;
...
function mergeEcmascriptChunkUpdates(updateA, updateB) {
    ...
    if (updateA.type === "deleted" && updateB.type === "added") {
        ...
        const deletedModules = new Set((_updateA_modules = updateA.modules) != null ? _updateA_modules : []);
        var _updateB_modules;
        const addedModules = new Set((_updateB_modules = updateB.modules) != null ? _updateB_modules : []);
    ...
    if (updateA.type === "partial" && updateB.type === "partial") {
        ...
        const added = new Set([
            ...(_updateA_added = updateA.added) != null ? _updateA_added : [],
            ...(_updateB_added = updateB.added) != null ? _updateB_added : []
        ]);
        var _updateA_deleted, _updateB_deleted;
        const deleted = new Set([
            ...(_updateA_deleted = updateA.deleted) != null ? _updateA_deleted : [],
            ...(_updateB_deleted = updateB.deleted) != null ? _updateB_deleted : []
        ]);
    ...
    if (updateA.type === "added" && updateB.type === "partial") {
        ...
        const modules = new Set([
            ...(_updateA_modules1 = updateA.modules) != null ? _updateA_modules1 : [],
            ...(_updateB_added1 = updateB.added) != null ? _updateB_added1 : []
        ]);
        var _updateB_deleted1;
        for (const moduleId of (_updateB_deleted1 = updateB.deleted) != null ? _updateB_deleted1 : []){
    ...
    if (updateA.type === "partial" && updateB.type === "deleted") {
        ...
        const modules = new Set((_updateB_modules1 = updateB.modules) != null ? _updateB_modules1 : []);
...
export function setHooks(newHooks) {
...
export function subscribeToUpdate(resource, sendMessage, callback) {
