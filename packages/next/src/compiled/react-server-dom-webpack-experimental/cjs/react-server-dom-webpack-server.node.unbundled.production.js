...
function renderFunctionComponent(request, task, key, Component, props) {
  ...
  if (
    ...
    if (iteratorFn) {
      ...
      var iterableChild$14 = Component;
      Component = {};
      Component =
        ((Component[ASYNC_ITERATOR] = function () {
          return iterableChild$14[ASYNC_ITERATOR]();
        }),
        Component);
    }
  }
...
function abort(request, reason) {
  try {
    ...
    logRecoverableError(request, error$32, null), fatalError(request, error$32);
  }
}
...
exports.decodeReplyFromBusboy = function (busboyStream, webpackMap, options) {
  ...
  busboyStream.on("file", function (name, value, _ref) {
    ...
    if ("base64" === _ref.encoding.toLowerCase())
      ...
      pendingFiles++;
      var JSCompiler_object_inline_chunks_249 = [];
      value.on("data", function (chunk) {
        JSCompiler_object_inline_chunks_249.push(chunk);
      });
      value.on("end", function () {
        try {
          var blob = new Blob(JSCompiler_object_inline_chunks_249, {
            type: mimeType
          });
