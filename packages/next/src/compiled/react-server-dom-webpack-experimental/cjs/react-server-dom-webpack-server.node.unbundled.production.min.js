...
writtenServerReferences:new Map,writtenObjects:new WeakMap,identifierPrefix:e||"",identifierCount:1,taintCleanupQueue:k,onError:void 0===c?jb:c,onPostpone:void 0===d?kb:d};a=mb(b,a,null,!1,f);g.push(a);return b}var L=null;function w(){if(L)return L;var a=za.getStore();return a?a:null}
...
function yb(a,b,c){a=I(c);return b.toString(16)+":"+a+"\n"}
...
g];a.pendingChunks++;var C=a.nextChunkId++,ia=I(m),Vb=C.toString(16)+":I"+ia+"\n";a.completedImportChunks.push(Vb);f.set(d,C);return b[0]===z&&"1"===c?"$L"+C.toString(16):S(C)}catch(Wb){return a.pendingChunks++,b=a.nextChunkId++,c=O(a,Wb),P(a,b,c),S(b)}}function T(a,b){b=mb(a,b,null,!1,a.abortableTasks);Ab(a,b);return b.id}
...
"l",d);if(d instanceof Float32Array)return U(a,"F",d);if(d instanceof Float64Array)return U(a,"d",d);if(d instanceof BigInt64Array)return U(a,"N",d);if(d instanceof BigUint64Array)return U(a,"m",d);if(d instanceof DataView)return U(a,"V",d);null===d||"object"!==typeof d?c=null:(c=Ha&&d[Ha]||d["@@iterator"],c="function"===typeof c?c:null);if(c)return ub(a,b,Array.from(d));a=Ya(d);if(a!==cb&&(null===a||null!==Ya(a)))throw Error("Only plain objects, and a few built-ins, can be passed to Client Components from Server Components. Classes or null prototypes are not supported.");
...
b.status=4;var k=O(a,f);P(a,b.id,k)}finally{}}function xb(a){var b=hb.current;hb.current=Ta;var c=L;D=L=a;try{var e=a.pingedTasks;a.pingedTasks=[];for(var d=0;d<e.length;d++)Ab(a,e[d]);null!==a.destination&&Q(a,a.destination)}catch(f){O(a,f),Bb(a,f)}finally{hb.current=b,D=null,L=c}}
...
g[e])){a.destination=null;e++;break}g.splice(0,e)}finally{a.flushScheduled=!1,l&&0<n&&b.write(l.subarray(0,n)),l=null,n=0,q=!0}"function"===typeof b.flush&&b.flush();0===a.pendingChunks&&(ib(a),b.end())}function Cb(a){a.flushScheduled=null!==a.destination;setImmediate(function(){return za.run(a,xb,a)})}function pb(a){if(!1===a.flushScheduled&&0===a.pingedTasks.length&&null!==a.destination){var b=a.destination;a.flushScheduled=!0;setImmediate(function(){return Q(a,b)})}}
function Db(a,b){if(1===a.status)a.status=2,b.destroy(a.fatalError);else if(2!==a.status&&null===a.destination){a.destination=b;try{Q(a,b)}catch(c){O(a,c),Bb(a,c)}}}
function Eb(a,b){try{var c=a.abortableTasks;if(0<c.size){a.pendingChunks++;var e=a.nextChunkId++;if("object"===typeof b&&null!==b&&b.$$typeof===B)M(a,b.message),N(a,e,b);else{var d=void 0===b?Error("The render was aborted by the server without a reason."):b,f=O(a,d);P(a,e,f,d)}c.forEach(function(g){g.status=3;var k=S(e);g=yb(a,g.id,k);a.completedErrorChunks.push(g)});c.clear()}null!==a.destination&&Q(a,a.destination)}catch(g){O(a,g),Bb(a,g)}}
...
function W(a){var b=Gb.get(a.specifier);if("fulfilled"===b.status)b=b.value;else throw b.reason;return"*"===a.name?b:""===a.name?b.default:b[a.name]}function Ib(a,b,c,e){this.status=a;this.value=b;this.reason=c;this._response=e}Ib.prototype=Object.create(Promise.prototype);
...
function Lb(a,b){if("pending"===a.status||"blocked"===a.status){var c=a.reason;a.status="rejected";a.reason=b;null!==c&&Kb(c,b)}}function Mb(a,b,c,e,d,f){var g=Fb(a._bundlerConfig,b);a=Hb(g);if(c)c=Promise.all([c,a]).then(function(k){k=k[0];var h=W(g);return h.bind.apply(h,[null].concat(k))});else if(a)c=Promise.resolve(a).then(function(){return W(g)});else return W(g);c.then(Nb(e,d,f),Ob(e));return null}var X=null,Y=null;
...
function Tb(a,b,c){a._formData.append(b,c);var e=a._prefix;if(b.startsWith(e)&&(a=a._chunks,b=+b.slice(e.length),(b=a.get(b))&&"pending"===b.status&&(e=b.value,a=b.reason,b.status="resolved_model",b.value=c,null!==e)))switch(Jb(b),b.status){case "fulfilled":Kb(e,b.value);break;case "pending":case "blocked":b.value=e;b.reason=a;break;case "rejected":a&&Kb(a,b.reason)}}function Ub(a){Pb(a,Error("Connection closed."))}
function Xb(a,b,c){var e=Fb(a,b);a=Hb(e);return c?Promise.all([c,a]).then(function(d){d=d[0];var f=W(e);return f.bind.apply(f,[null].concat(d))}):a?Promise.resolve(a).then(function(){return W(e)}):Promise.resolve(W(e))}function Yb(a,b,c){a=Sb(b,c,a);Ub(a);a=Z(a,0);a.then(function(){});if("fulfilled"!==a.status)throw a.reason;return a.value}function Zb(a,b){return function(){return Db(b,a)}}function $b(a,b){return function(){a.destination=null;Eb(a,Error(b))}}
...
new Blob(u,{type:p});c._formData.append(f,m,h);e--;if(0===e){for(m=0;m<d.length;m+=2)Tb(c,d[m],d[m+1]);d.length=0}})});a.on("finish",function(){Ub(c)});a.on("error",function(f){Pb(c,f)});return Z(c,0)};exports.registerClientReference=function(a,b,c){return v(a,b+"#"+c,!1)};exports.registerServerReference=function(a,b,c){return Object.defineProperties(a,{$$typeof:{value:ha},$$id:{value:null===c?b:b+"#"+c},$$bound:{value:null},bind:{value:la}})};
exports.renderToPipeableStream=function(a,b,c){var e=lb(a,b,c?c.onError:void 0,c?c.identifierPrefix:void 0,c?c.onPostpone:void 0),d=!1;Cb(e);return{pipe:function(f){if(d)throw Error("React currently only supports piping to one writable stream.");d=!0;Db(e,f);f.on("drain",Zb(f,e));f.on("error",$b(e,"The destination stream errored while writing data."));f.on("close",$b(e,"The destination stream closed early."));return f},abort:function(f){Eb(e,f)}}};
