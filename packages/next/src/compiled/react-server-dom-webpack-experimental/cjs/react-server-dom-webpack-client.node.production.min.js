...
null!==p&&"function"===typeof p.then){m++;var Q=f++;k=function(){try{var w=JSON.stringify(h,g),D=l;D.append(b+Q,w);m--;0===m&&d(D)}catch(pa){e(pa)}};p.then(k,k);return"$"+Q.toString(16)}e(p);return null}finally{m--}}if("function"===typeof h.then){null===l&&(l=new FormData);m++;var R=f++;h.then(function(p){try{var w=JSON.stringify(p,g);p=l;p.append(b+R,w);m--;0===m&&d(p)}catch(D){e(D)}},function(p){e(p)});return"$@"+R.toString(16)}if(ka(h))return h;if(h instanceof FormData){null===l&&(l=new FormData);
...
d(l))}var C=new WeakMap;function sa(a){var b,c,d=new Promise(function(e,g){b=e;c=g});na(a,"",void 0,function(e){if("string"===typeof e){var g=new FormData;g.append("0",e);e=g}d.status="fulfilled";d.value=e;b(e)},function(e){d.status="rejected";d.reason=e;c(e)});return d}
