...
function x(a,b,d){if(null!==a)for(var c=1;c<b.length;c+=2){var e=d,g=y.current;if(g){var f=g.preinitScript,l=a.prefix+b[c];var k=a.crossOrigin;k="string"===typeof k?"use-credentials"===k?k:"":void 0;f.call(g,l,{crossOrigin:k,nonce:e})}}}var y=q.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactDOMCurrentDispatcher,A=Symbol.for("react.element"),B=Symbol.for("react.lazy"),aa=Symbol.for("react.postpone"),C=Symbol.iterator;
