...
null!==p&&"function"===typeof p.then){m++;var P=f++;k=function(){try{var w=JSON.stringify(h,g),C=l;C.append(b+P,w);m--;0===m&&d(C)}catch(na){e(na)}};p.then(k,k);return"$"+P.toString(16)}e(p);return null}finally{m--}}if("function"===typeof h.then){null===l&&(l=new FormData);m++;var Q=f++;h.then(function(p){try{var w=JSON.stringify(p,g);p=l;p.append(b+Q,w);m--;0===m&&d(p)}catch(C){e(C)}},function(p){e(p)});return"$@"+Q.toString(16)}if(ia(h))return h;if(h instanceof FormData){null===l&&(l=new FormData);
...
return"$T"+A(c,h).toString(16)}if("symbol"===typeof h){k=h.description;if(Symbol.for(k)!==h)throw Error("Only global symbols received from Symbol.for(...) can be passed to Server Functions. The symbol Symbol.for("+(h.description+") cannot be found among global symbols."));return"$S"+k}if("bigint"===typeof h)return"$n"+h.toString(10);throw Error("Type "+typeof h+" is not supported as an argument to a Server Function.");}var f=1,m=0,l=null;a=JSON.stringify(a,g);null===l?d(a):(l.set(b+"0",a),0===m&&
d(l))}var D=new WeakMap;function qa(a){var b,c,d=new Promise(function(e,g){b=e;c=g});la(a,"",void 0,function(e){if("string"===typeof e){var g=new FormData;g.append("0",e);e=g}d.status="fulfilled";d.value=e;b(e)},function(e){d.status="rejected";d.reason=e;c(e)});return d}
function ra(a){var b=B.get(this);if(!b)throw Error("Tried to encode a Server Action from a different instance than the encoder is from. This is a bug in React.");var c=null;if(null!==b.bound){c=D.get(b);c||(c=qa(b),D.set(b,c));if("rejected"===c.status)throw c.reason;if("fulfilled"!==c.status)throw c;b=c.value;var d=new FormData;b.forEach(function(e,g){d.append("$ACTION_"+a+":"+g,e)});c=d;b="$ACTION_REF_"+a}else b="$ACTION_ID_"+b.id;return{name:b,method:"POST",encType:"multipart/form-data",data:c}}
