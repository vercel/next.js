...
*/
'use strict';var q=require("next/dist/compiled/react-dom-experimental"),t={stream:!0};function aa(a,b){if(a){var c=a[b[0]];if(a=c[b[2]])c=a.name;else{a=c["*"];if(!a)throw Error('Could not find the module "'+b[0]+'" in the React SSR Manifest. This is probably a bug in the React Server Components bundler.');c=b[2]}return 4===b.length?[a.id,a.chunks,c,1]:[a.id,a.chunks,c]}return b}var u=new Map;
...
function la(a,b,c,d,f){function g(r,h){if(null===h)return null;if("object"===typeof h){switch(h.$$typeof){case z:if(void 0===c)throw Error("React Element cannot be passed to Server Functions from the Client without a temporary reference set. Pass a TemporaryReferenceSet to the options.");return"$T"+D(c,h).toString(16);case A:r=h._payload;var w=h._init;null===k&&(k=new FormData);l++;try{var n=w(r),m=e++,E=JSON.stringify(n,g);k.append(b+m,E);return"$"+m.toString(16)}catch(p){if("object"===typeof p&&
null!==p&&"function"===typeof p.then){l++;var S=e++;n=function(){try{var x=JSON.stringify(h,g),F=k;F.append(b+S,x);l--;0===l&&d(F)}catch(ma){f(ma)}};p.then(n,n);return"$"+S.toString(16)}f(p);return null}finally{l--}}if("function"===typeof h.then){null===k&&(k=new FormData);l++;var T=e++;h.then(function(p){try{var x=JSON.stringify(p,g);p=k;p.append(b+T,x);l--;0===l&&d(p)}catch(F){f(F)}},function(p){f(p)});return"$@"+T.toString(16)}if(ia(h))return h;if(h instanceof FormData){null===k&&(k=new FormData);
...
return"$T"+D(c,h).toString(16)}if("symbol"===typeof h){if(void 0===c)throw Error("Symbols cannot be passed to a Server Function without a temporary reference set. Pass a TemporaryReferenceSet to the options.");return"$T"+D(c,h).toString(16)}if("bigint"===typeof h)return"$n"+h.toString(10);throw Error("Type "+typeof h+" is not supported as an argument to a Server Function.");}var e=1,l=0,k=null;a=JSON.stringify(a,g);null===k?d(a):(k.set(b+"0",a),0===l&&d(k))}function pa(a,b){G.set(a,b)}
...
function ra(a,b,c,d){if(P){var f=P;d||f.deps++}else f=P={deps:d?0:1,value:null};return function(g){b[c]=g;f.deps--;0===f.deps&&"blocked"===a.status&&(g=a.value,a.status="fulfilled",a.value=f.value,null!==g&&K(g,f.value))}}function sa(a){return function(b){return M(a,b)}}
function ta(a,b){function c(){var f=Array.prototype.slice.call(arguments),g=b.bound;return g?"fulfilled"===g.status?d(b.id,g.value.concat(f)):Promise.resolve(g).then(function(e){return d(b.id,e.concat(f))}):d(b.id,f)}var d=a._callServer;G.set(c,b);return c}function U(a,b){a=R(a,b);switch(a.status){case "resolved_model":I(a)}switch(a.status){case "fulfilled":return a.value;default:throw a.reason;}}
...
function W(a,b){for(var c=a.length,d=b.length,f=0;f<c;f++)d+=a[f].byteLength;d=new Uint8Array(d);for(var g=f=0;g<c;g++){var e=a[g];d.set(e,f);f+=e.byteLength}d.set(b,f);return d}function X(a,b,c,d,f,g){c=0===c.length&&0===d.byteOffset%g?d:W(c,d);f=new f(c.buffer,c.byteOffset,c.byteLength/g);V(a,b,f)}
...
function Z(a,b){function c(g){var e=g.value;if(g.done)Q(a,Error("Connection closed."));else{var l=0,k=a._rowState;g=a._rowID;for(var r=a._rowTag,h=a._rowLength,w=a._buffer,n=e.length;l<n;){var m=-1;switch(k){case 0:m=e[l++];58===m?k=1:g=g<<4|(96<m?m-87:m-48);continue;case 1:k=e[l];84===k||65===k||67===k||99===k||85===k||83===k||115===k||76===k||108===k||70===k||100===k||78===k||109===k||86===k?(r=k,k=2,l++):64<k&&91>k?(r=k,k=3,l++):(r=0,k=3);continue;case 2:m=e[l++];44===m?k=4:h=h<<4|(96<m?m-87:m-
48);continue;case 3:m=e.indexOf(10,l);break;case 4:m=l+h,m>e.length&&(m=-1)}var E=e.byteOffset+l;if(-1<m)h=new Uint8Array(e.buffer,E,m-l),xa(a,g,r,w,h),l=m,3===k&&l++,h=g=r=k=0,w.length=0;else{e=new Uint8Array(e.buffer,E,e.byteLength-l);w.push(e);h-=e.byteLength;break}}a._rowState=k;a._rowID=g;a._rowTag=r;a._rowLength=h;return f.read().then(c).catch(d)}}function d(g){Q(a,g)}var f=b.getReader();f.read().then(c).catch(d)}
