...
e;ob(a,d)},function(e){d.status=4;a.abortableTasks.delete(d);e=P(a,e);Q(a,d.id,e);null!==a.destination&&R(a,a.destination)});return d.id}function x(a,b,d){d=N(d);var c=a.nextChunkId++;b="H"+b;b=c.toString(16)+":"+b;d=r.encode(b+d+"\n");a.completedHintChunks.push(d);rb(a)}function sb(a){if("fulfilled"===a.status)return a.value;if("rejected"===a.status)throw a.reason;throw a;}
...
g)}catch(h){P(c,h),zb(c,h)}}},cancel:function(g){c.destination=null;Bb(c,g)}},{highWaterMark:0})};
