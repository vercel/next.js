...
e;pb(a,d)},function(e){d.status=4;e=Q(a,e);R(a,d.id,e);null!==a.destination&&S(a,a.destination)});return d.id}function z(a,b,d){d=O(d);var c=a.nextChunkId++;b="H"+b;b=c.toString(16)+":"+b;a.completedHintChunks.push(b+d+"\n");sb(a)}function tb(a){if("fulfilled"===a.status)return a.value;if("rejected"===a.status)throw a.reason;throw a;}
...
a.pendingChunks++;var H=a.nextChunkId++,D=O(p),Tb=H.toString(16)+":I"+D+"\n";a.completedImportChunks.push(Tb);f.set(e,H);return b[0]===B&&"1"===d?"$L"+H.toString(16):U(H)}catch(Ub){return a.pendingChunks++,b=a.nextChunkId++,d=Q(a,Ub),R(a,b,d),U(b)}}function yb(a,b){a.pendingChunks++;var d=a.nextChunkId++;zb(a,d,b);return d}
...
var Fb=new Map;function Gb(a){var b=globalThis.__next_require__(a);if("function"!==typeof b.then||"fulfilled"===b.status)return null;b.then(function(d){b.status="fulfilled";b.value=d},function(d){b.status="rejected";b.reason=d});return b}function Hb(){}
function Ib(a){for(var b=a.chunks,d=[],c=0;c<b.length;c++){var e=b[c],f=Fb.get(e);if(void 0===f){f=globalThis.__next_chunk_load__(e);d.push(f);var g=Fb.set.bind(Fb,e,null);f.then(g,Hb);Fb.set(e,f)}else null!==f&&d.push(f)}return a.async?0===d.length?Gb(a.id):Promise.all(d).then(function(){return Gb(a.id)}):0<d.length?Promise.all(d):null}
function W(a){var b=globalThis.__next_require__(a.id);if(a.async&&"function"===typeof b.then)if("fulfilled"===b.status)b=b.value;else throw b.reason;return"*"===a.name?b:""===a.name?b.__esModule?b.default:b:b[a.name]}function Jb(a,b,d,c){this.status=a;this.value=b;this.reason=d;this._response=c}Jb.prototype=Object.create(Promise.prototype);
...
function Vb(a,b){var d=2<arguments.length&&void 0!==arguments[2]?arguments[2]:new FormData,c=new Map,e={_bundlerConfig:a,_prefix:b,_formData:d,_chunks:c,_fromJSON:function(f,g){return"string"===typeof g?Sb(e,this,f,g):g}};return e}
function Wb(a,b,d){a._formData.append(b,d);var c=a._prefix;if(b.startsWith(c)&&(a=a._chunks,b=+b.slice(c.length),(b=a.get(b))&&"pending"===b.status&&(c=b.value,a=b.reason,b.status="resolved_model",b.value=d,null!==c)))switch(Kb(b),b.status){case "fulfilled":Lb(c,b.value);break;case "pending":case "blocked":b.value=c;b.reason=a;break;case "rejected":a&&Lb(a,b.reason)}}function Xb(a){Qb(a,Error("Connection closed."))}
function Yb(a,b,d){var c=Eb(a,b);a=Ib(c);return d?Promise.all([d,a]).then(function(e){e=e[0];var f=W(c);return f.bind.apply(f,[null].concat(e))}):a?Promise.resolve(a).then(function(){return W(c)}):Promise.resolve(W(c))}function Zb(a,b,d){a=Vb(b,d,a);Xb(a);a=Z(a,0);a.then(function(){});if("fulfilled"!==a.status)throw a.reason;return a.value}function $b(a,b){return function(){return Cb(b,a)}}exports.createClientModuleProxy=function(a){a=x({},a,!1);return new Proxy(a,ma)};
