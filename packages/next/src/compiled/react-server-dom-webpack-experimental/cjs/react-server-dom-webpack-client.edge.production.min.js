...
function D(a,b,c,d,e){function g(r,k){if(null===k)return null;if("object"===typeof k){switch(k.$$typeof){case v:if(void 0===c)throw Error("React Element cannot be passed to Server Functions from the Client without a temporary reference set. Pass a TemporaryReferenceSet to the options.");return"$T"+B(c,k).toString(16);case w:r=k._payload;var x=k._init;null===h&&(h=new FormData);l++;try{var n=x(r),m=f++,E=JSON.stringify(n,g);h.append(b+m,E);return"$"+m.toString(16)}catch(p){if("object"===typeof p&&
null!==p&&"function"===typeof p.then){l++;var U=f++;n=function(){try{var y=JSON.stringify(k,g),F=h;F.append(b+U,y);l--;0===l&&d(F)}catch(qa){e(qa)}};p.then(n,n);return"$"+U.toString(16)}e(p);return null}finally{l--}}if("function"===typeof k.then){null===h&&(h=new FormData);l++;var V=f++;k.then(function(p){try{var y=JSON.stringify(p,g);p=h;p.append(b+V,y);l--;0===l&&d(p)}catch(F){e(F)}},function(p){e(p)});return"$@"+V.toString(16)}if(ja(k))return k;if(k instanceof FormData){null===h&&(h=new FormData);
...
return"$T"+B(c,k).toString(16)}if("symbol"===typeof k){n=k.description;if(Symbol.for(n)!==k)throw Error("Only global symbols received from Symbol.for(...) can be passed to Server Functions. The symbol Symbol.for("+(k.description+") cannot be found among global symbols."));return"$S"+n}if("bigint"===typeof k)return"$n"+k.toString(10);throw Error("Type "+typeof k+" is not supported as an argument to a Server Function.");}var f=1,l=0,h=null;a=JSON.stringify(a,g);null===h?d(a):(h.set(b+"0",a),0===l&&
d(h))}var G=new WeakMap;function ma(a){var b,c,d=new Promise(function(e,g){b=e;c=g});D(a,"",void 0,function(e){if("string"===typeof e){var g=new FormData;g.append("0",e);e=g}d.status="fulfilled";d.value=e;b(e)},function(e){d.status="rejected";d.reason=e;c(e)});return d}
...
m-48);continue;case 3:m=f.indexOf(10,l);break;case 4:m=l+k,m>f.length&&(m=-1)}var E=f.byteOffset+l;if(-1<m)k=new Uint8Array(f.buffer,E,m-l),Da(a,g,r,x,k),l=m,3===h&&l++,k=g=r=h=0,x.length=0;else{f=new Uint8Array(f.buffer,E,f.byteLength-l);x.push(f);k-=f.byteLength;break}}a._rowState=h;a._rowID=g;a._rowTag=r;a._rowLength=k;return e.read().then(c).catch(d)}}function d(g){R(a,g)}var e=b.getReader();e.read().then(c).catch(d)}
