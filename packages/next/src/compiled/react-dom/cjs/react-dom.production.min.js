...
function Go(a,b,c,d,e){var f=c._reactRootContainer;if(f){var g=f;if("function"===typeof e){var h=e;e=function(){var l=dl(g);h.call(l)}}cl(b,g,a,e)}else g=Fo(c,b,a,e,d);return dl(g)}function Ho(a,b){if("font"===a)return"";if("string"===typeof b)return"use-credentials"===b?b:""}var Io=ca.Dispatcher;ca.Events=[Jb,Kb,Lb,Kc,Lc,zk];var Jo={findFiberByHostInstance:Hb,bundleType:0,version:"18.3.0-canary-a41957507-20231017",rendererPackageName:"react-dom"};
