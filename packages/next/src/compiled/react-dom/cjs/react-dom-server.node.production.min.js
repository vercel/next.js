...
ba;break;case "checked":vc=ba;break;case "value":Na=ba;break;default:P(a,bb,ba)}}var Nd=Mc(a,d,e,wa,xa,Ma,ya,ia);null!==vc?tc(a,"checked",vc):null!==wc&&tc(a,"checked",wc);null!==Na?P(a,"value",Na):null!==oa&&P(a,"value",oa);a.push(Lc);null!==Nd&&Nd.forEach(Kc,a);return null;case "button":a.push(U("button"));var cb=null,Od=null,Pd=null,Qd=null,Rd=null,Sd=null,Td=null,db;for(db in c)if(D.call(c,db)){var ja=c[db];if(null!=ja)switch(db){case "children":cb=ja;break;case "dangerouslySetInnerHTML":Od=ja;
break;case "name":Pd=ja;break;case "formAction":Qd=ja;break;case "formEncType":Rd=ja;break;case "formMethod":Sd=ja;break;case "formTarget":Td=ja;break;default:P(a,db,ja)}}var Ud=Mc(a,d,e,Qd,Rd,Sd,Td,Pd);a.push(R);null!==Ud&&Ud.forEach(Kc,a);Oc(a,Od,cb);if("string"===typeof cb){a.push(E(cb));var Vd=null}else Vd=cb;return Vd;case "form":a.push(U("form"));var eb=null,Wd=null,pa=null,fb=null,gb=null,hb=null,ib;for(ib in c)if(D.call(c,ib)){var qa=c[ib];if(null!=qa)switch(ib){case "children":eb=qa;break;
case "dangerouslySetInnerHTML":Wd=qa;break;case "action":pa=qa;break;case "encType":fb=qa;break;case "method":gb=qa;break;case "target":hb=qa;break;default:P(a,ib,qa)}}var xc=null,yc=null;if("function"===typeof pa)if("function"===typeof pa.$$FORM_ACTION){var Of=uc(d),Oa=pa.$$FORM_ACTION(Of);pa=Oa.action||"";fb=Oa.encType;gb=Oa.method;hb=Oa.target;xc=Oa.data;yc=Oa.name}else a.push(N,"action",rc,Ic,L),hb=gb=fb=pa=null,Nc(d,e);null!=pa&&P(a,"action",pa);null!=fb&&P(a,"encType",fb);null!=gb&&P(a,"method",
gb);null!=hb&&P(a,"target",hb);a.push(R);null!==yc&&(a.push(Jc),O(a,"name",yc),a.push(Lc),null!==xc&&xc.forEach(Kc,a));Oc(a,Wd,eb);if("string"===typeof eb){a.push(E(eb));var Xd=null}else Xd=eb;return Xd;case "menuitem":a.push(U("menuitem"));for(var Hb in c)if(D.call(c,Hb)){var Yd=c[Hb];if(null!=Yd)switch(Hb){case "children":case "dangerouslySetInnerHTML":throw Error("menuitems cannot have `children` nor `dangerouslySetInnerHTML`.");default:P(a,Hb,Yd)}}a.push(R);return null;case "title":if(3===g.insertionMode||
g.tagScope&1||null!=c.itemProp)var zc=Vc(a,c);else l?zc=null:(Vc(e.hoistableChunks,c),zc=void 0);return zc;case "link":var Pf=c.rel,ra=c.href,Ib=c.precedence;if(3===g.insertionMode||g.tagScope&1||null!=c.itemProp||"string"!==typeof Pf||"string"!==typeof ra||""===ra){S(a,c);var jb=null}else if("stylesheet"===c.rel)if("string"!==typeof Ib||null!=c.disabled||c.onLoad||c.onError)jb=S(a,c);else{var Pa=e.styles.get(Ib),Jb=d.styleResources.hasOwnProperty(ra)?d.styleResources[ra]:void 0;if(null!==Jb){d.styleResources[ra]=
null;Pa||(Pa={precedence:E(Ib),rules:[],hrefs:[],sheets:new Map},e.styles.set(Ib,Pa));var Kb={state:0,props:C({},c,{"data-precedence":c.precedence,precedence:null})};if(Jb){2===Jb.length&&dd(Kb.props,Jb);var Ac=e.preloads.stylesheets.get(ra);Ac&&0<Ac.length?Ac.length=0:Kb.state=1}Pa.sheets.set(ra,Kb);f&&f.stylesheets.add(Kb)}else if(Pa){var Zd=Pa.sheets.get(ra);Zd&&f&&f.stylesheets.add(Zd)}h&&a.push(kc);jb=null}else c.onLoad||c.onError?jb=S(a,c):(h&&a.push(kc),jb=l?null:S(e.hoistableChunks,c));return jb;
case "script":var Bc=c.async;if("string"!==typeof c.src||!c.src||!Bc||"function"===typeof Bc||"symbol"===typeof Bc||c.onLoad||c.onError||3===g.insertionMode||g.tagScope&1||null!=c.itemProp)var $d=Xc(a,c);else{var Lb=c.src;if("module"===c.type){var Mb=d.moduleScriptResources;var ae=e.preloads.moduleScripts}else Mb=d.scriptResources,ae=e.preloads.scripts;var Nb=Mb.hasOwnProperty(Lb)?Mb[Lb]:void 0;if(null!==Nb){Mb[Lb]=null;var Cc=c;if(Nb){2===Nb.length&&(Cc=C({},c),dd(Cc,Nb));var be=ae.get(Lb);be&&(be.length=
0)}var ce=[];e.scripts.add(ce);Xc(ce,Cc)}h&&a.push(kc);$d=null}return $d;case "style":var Ob=c.precedence,za=c.href;if(3===g.insertionMode||g.tagScope&1||null!=c.itemProp||"string"!==typeof Ob||"string"!==typeof za||""===za){a.push(U("style"));var Qa=null,de=null,lb;for(lb in c)if(D.call(c,lb)){var Pb=c[lb];if(null!=Pb)switch(lb){case "children":Qa=Pb;break;case "dangerouslySetInnerHTML":de=Pb;break;default:P(a,lb,Pb)}}a.push(R);var mb=Array.isArray(Qa)?2>Qa.length?Qa[0]:null:Qa;"function"!==typeof mb&&
"symbol"!==typeof mb&&null!==mb&&void 0!==mb&&a.push(E(""+mb));Oc(a,de,Qa);a.push(Wc("style"));var ee=null}else{var Aa=e.styles.get(Ob);if(null!==(d.styleResources.hasOwnProperty(za)?d.styleResources[za]:void 0)){d.styleResources[za]=null;Aa?Aa.hrefs.push(E(za)):(Aa={precedence:E(Ob),rules:[],hrefs:[E(za)],sheets:new Map},e.styles.set(Ob,Aa));var fe=Aa.rules,Ra=null,ge=null,Qb;for(Qb in c)if(D.call(c,Qb)){var Dc=c[Qb];if(null!=Dc)switch(Qb){case "children":Ra=Dc;break;case "dangerouslySetInnerHTML":ge=
Dc}}var nb=Array.isArray(Ra)?2>Ra.length?Ra[0]:null:Ra;"function"!==typeof nb&&"symbol"!==typeof nb&&null!==nb&&void 0!==nb&&fe.push(E(""+nb));Oc(fe,ge,Ra)}Aa&&f&&f.styles.add(Aa);h&&a.push(kc);ee=void 0}return ee;case "meta":if(3===g.insertionMode||g.tagScope&1||null!=c.itemProp)var he=Uc(a,c,"meta");else h&&a.push(kc),he=l?null:"string"===typeof c.charSet?Uc(e.charsetChunks,c,"meta"):"viewport"===c.name?Uc(e.viewportChunks,c,"meta"):Uc(e.hoistableChunks,c,"meta");return he;case "listing":case "pre":a.push(U(b));
...
":"!==J[4]||"d"!==J[0]&&"D"!==J[0]||"a"!==J[1]&&"A"!==J[1]||"t"!==J[2]&&"T"!==J[2]||"a"!==J[3]&&"A"!==J[3])){var ie="string"===typeof c.sizes?c.sizes:void 0,Sa=J?J+"\n"+(ie||""):M,Ec=e.preloads.images,Ca=Ec.get(Sa);if(Ca){if("high"===c.fetchPriority||10>e.highImagePreloads.size)Ec.delete(Sa),e.highImagePreloads.add(Ca)}else if(!d.imageResources.hasOwnProperty(Sa)){d.imageResources[Sa]=F;var Fc=c.crossOrigin;var je="string"===typeof Fc?"use-credentials"===Fc?Fc:"":void 0;var ea=e.headers,Gc;ea&&0<
ea.remainingCapacity&&("high"===c.fetchPriority||500>ea.highImagePreloads.length)&&(Gc=ed(M,"image",{imageSrcSet:c.srcSet,imageSizes:c.sizes,crossOrigin:je,integrity:c.integrity,nonce:c.nonce,type:c.type,fetchPriority:c.fetchPriority,referrerPolicy:c.refererPolicy}),2<=(ea.remainingCapacity-=Gc.length))?(e.resets.image[Sa]=F,ea.highImagePreloads&&(ea.highImagePreloads+=", "),ea.highImagePreloads+=Gc):(Ca=[],S(Ca,{rel:"preload",as:"image",href:J?void 0:M,imageSrcSet:J,imageSizes:ie,crossOrigin:je,
...
case "head":if(2>g.insertionMode&&null===e.headChunks){e.headChunks=[];var ke=Yc(e.headChunks,c,"head")}else ke=Yc(a,c,"head");return ke;case "html":if(0===g.insertionMode&&null===e.htmlChunks){e.htmlChunks=[bd];var le=Yc(e.htmlChunks,c,"html")}else le=Yc(a,c,"html");return le;default:if(-1!==b.indexOf("-")){a.push(U(b));var Hc=null,me=null,Ta;for(Ta in c)if(D.call(c,Ta)){var Da=c[Ta];if(null!=Da){var Qf=Ta;switch(Ta){case "children":Hc=Da;break;case "dangerouslySetInnerHTML":me=Da;break;case "style":qc(a,
Da);break;case "suppressContentEditableWarning":case "suppressHydrationWarning":case "ref":break;default:vb(Ta)&&"function"!==typeof Da&&"symbol"!==typeof Da&&a.push(N,Qf,rc,E(Da),L)}}}a.push(R);Oc(a,me,Hc);return Hc}}return Yc(a,c,b)}var fd=new Map;function Wc(a){var b=fd.get(a);void 0===b&&(b=B("</"+a+">"),fd.set(a,b));return b}function gd(a,b){b=b.bootstrapChunks;for(var c=0;c<b.length-1;c++)u(a,b[c]);return c<b.length?(c=b[c],b.length=0,z(a,c)):!0}
...
e)}}};exports.version="18.3.0-canary-a4939017f-20240320";
