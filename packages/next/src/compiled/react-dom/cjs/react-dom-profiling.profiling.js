...
if (canUseDOM) {
  ...
  if (canUseDOM) {
    ...
    JSCompiler_inline_result$jscomp$285 = isSupported$jscomp$inline_419;
  ...
  switch (type) {
    ...
    case "link":
      if (
        ...
        var styles$247 = getResourcesFromRoot(currentProps).hoistableStyles,
...
(function (internals) {
  ...
  reconcilerVersion: "19.0.0-canary-cb151849e1-20240424"
});
function noop() {}
