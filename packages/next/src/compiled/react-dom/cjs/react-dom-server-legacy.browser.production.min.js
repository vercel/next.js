...
f.noscriptTagInScope);case "script":a:if(3===f.insertionMode||f.noscriptTagInScope||null!=c.itemProp||"string"!==typeof c.src||!c.src)a=Ja(a,c);else{l="[script]"+c.src;if(!0!==c.async||c.onLoad||c.onError){if(h=d.preloadsMap.get(l),h||(h={type:"preload",chunks:[],state:0,props:{rel:"preload",as:"script",href:c.src,crossOrigin:c.crossOrigin,integrity:c.integrity,referrerPolicy:c.referrerPolicy}},d.preloadsMap.set(l,h),d.usedScripts.add(h),C(h.chunks,h.props)),!0!==c.async){Ja(a,c);a=null;break a}}else if(h=
d.scriptsMap.get(l),!h){h={type:"script",chunks:[],state:0,props:null};d.scriptsMap.set(l,h);d.scripts.add(h);n=c;if(d=d.preloadsMap.get(l))d.state|=4,c=n=q({},c),d=d.props,null==c.crossOrigin&&(c.crossOrigin=d.crossOrigin),null==c.integrity&&(c.integrity=d.integrity);Ja(h.chunks,n)}g&&a.push("\x3c!-- --\x3e");a=null}return a;case "style":n=c.precedence;l=c.href;if(3===f.insertionMode||f.noscriptTagInScope||null!=c.itemProp||"string"!==typeof n||"string"!==typeof l||""===l){a.push(E("style"));d=g=
null;for(p in c)if(t.call(c,p)&&(h=c[p],null!=h))switch(p){case "children":g=h;break;case "dangerouslySetInnerHTML":d=h;break;default:A(a,p,h)}a.push(">");c=Array.isArray(g)?2>g.length?g[0]:null:g;"function"!==typeof c&&"symbol"!==typeof c&&null!==c&&void 0!==c&&a.push(w(""+c));B(a,d,g);a.push("</","style",">");a=null}else{p="[style]"+l;r=d.stylesMap.get(p);if(!r){(r=d.stylePrecedences.get(n))?r.props.hrefs.push(l):(r={type:"style",chunks:[],state:0,props:{precedence:n,hrefs:[l]}},d.stylePrecedences.set(n,
r),l=new Set,l.add(r),d.precedences.set(n,l));d.stylesMap.set(p,r);d.boundaryResources&&d.boundaryResources.add(r);d=r.chunks;l=n=null;for(h in c)if(t.call(c,h)&&(p=c[h],null!=p))switch(h){case "children":n=p;break;case "dangerouslySetInnerHTML":l=p}c=Array.isArray(n)?2>n.length?n[0]:null:n;"function"!==typeof c&&"symbol"!==typeof c&&null!==c&&void 0!==c&&d.push(w(""+c));B(d,l,n)}g&&a.push("\x3c!-- --\x3e");a=void 0}return a;case "meta":return 3===f.insertionMode||f.noscriptTagInScope||null!=c.itemProp?
...
exports.version="18.3.0-next-703c67560-20230307";
