...
return null;case "title":return 3===f.insertionMode||f.noscriptTagInScope||null!=c.itemProp?a=bb(a,c):(bb(e.hoistableChunks,c),a=null),a;case "link":return Za(a,c,e,d,g,f.insertionMode,f.noscriptTagInScope);case "script":a:if(3===f.insertionMode||f.noscriptTagInScope||null!=c.itemProp||"string"!==typeof c.src||!c.src)a=cb(a,c);else{p="[script]"+c.src;if(!0!==c.async||c.onLoad||c.onError){if(k=d.preloadsMap.get(p),k||(k={type:"preload",chunks:[],state:0,props:{rel:"preload",as:"script",href:c.src,
crossOrigin:c.crossOrigin,integrity:c.integrity,referrerPolicy:c.referrerPolicy}},d.preloadsMap.set(p,k),d.usedScripts.add(k),O(k.chunks,k.props)),!0!==c.async){cb(a,c);a=null;break a}}else if(k=d.scriptsMap.get(p),!k){k={type:"script",chunks:[],state:0,props:null};d.scriptsMap.set(p,k);d.scripts.add(k);q=c;if(d=d.preloadsMap.get(p))d.state|=4,c=q=x({},c),d=d.props,null==c.crossOrigin&&(c.crossOrigin=d.crossOrigin),null==c.integrity&&(c.integrity=d.integrity);cb(k.chunks,q)}g&&a.push(G);a=null}return a;
case "style":q=c.precedence;p=c.href;if(3===f.insertionMode||f.noscriptTagInScope||null!=c.itemProp||"string"!==typeof q||"string"!==typeof p||""===p){a.push(P("style"));d=g=null;for(r in c)if(y.call(c,r)&&(k=c[r],null!=k))switch(r){case "children":g=k;break;case "dangerouslySetInnerHTML":d=k;break;default:L(a,r,k)}a.push(M);c=Array.isArray(g)?2>g.length?g[0]:null:g;"function"!==typeof c&&"symbol"!==typeof c&&null!==c&&void 0!==c&&a.push(v(D(""+c)));N(a,d,g);a.push(Q,v("style"),R);a=null}else{r="[style]"+
p;u=d.stylesMap.get(r);if(!u){(u=d.stylePrecedences.get(q))?u.props.hrefs.push(p):(u={type:"style",chunks:[],state:0,props:{precedence:q,hrefs:[p]}},d.stylePrecedences.set(q,u),p=new Set,p.add(u),d.precedences.set(q,p));d.stylesMap.set(r,u);d.boundaryResources&&d.boundaryResources.add(u);d=u.chunks;p=q=null;for(k in c)if(y.call(c,k)&&(r=c[k],null!=r))switch(k){case "children":q=r;break;case "dangerouslySetInnerHTML":p=r}c=Array.isArray(q)?2>q.length?q[0]:null:q;"function"!==typeof c&&"symbol"!==typeof c&&
null!==c&&void 0!==c&&d.push(v(D(""+c)));N(d,p,q)}g&&a.push(G);a=void 0}return a;case "meta":return 3===f.insertionMode||f.noscriptTagInScope||null!=c.itemProp?a=ab(a,c,"meta"):(g&&a.push(G),a="string"===typeof c.charSet?ab(e.charsetChunks,c,"meta"):ab(e.hoistableChunks,c,"meta")),a;case "listing":case "pre":a.push(P(b));d=g=null;for(var J in c)if(y.call(c,J)&&(k=c[J],null!=k))switch(J){case "children":g=k;break;case "dangerouslySetInnerHTML":d=k;break;default:L(a,J,k)}a.push(M);if(null!=d){if(null!=
...
else if(2!==m.status&&null===m.destination){m.destination=q;try{He(m,q)}catch(u){we(m,u),xe(m,u)}}},cancel:function(){Ne(m)}},{highWaterMark:0});r.allReady=g;c(r)},function(r){g.catch(function(){});d(r)},e);if(b&&b.signal){var k=b.signal;if(k.aborted)Ne(m,k.reason);else{var p=function(){Ne(m,k.reason);k.removeEventListener("abort",p)};k.addEventListener("abort",p)}}ve(m)})};exports.version="18.3.0-next-703c67560-20230307";
