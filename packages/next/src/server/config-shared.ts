...
export interface ExperimentalConfig {
  ...
  /**
   * Automatically generate a unique deployment ID for each build.
   * When enabled, the `deploymentId` config option is ignored.
   */
  autoGenerateDeploymentId?: boolean
...
export interface NextConfig {
   ...
   * If `experimental.autoGenerateDeploymentId` is enabled, this value is ignored and a unique ID is auto-generated.
   *
   * @example
   * ```js
   * // Static string
