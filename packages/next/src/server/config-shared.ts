...
export interface ExperimentalConfig {
   ...
   * @see https://nextjs.org/docs/api-reference/next-config#appdir
   */
  appDir?: boolean
  amp?: {
    optimizer?: any
   ...
   * @see https://nextjs.org/docs/api-reference/next-config#servercomponentsexternalpackages
   */
   ...
   * @see https://nextjs.org/docs/api-reference/next-config#mdxrs
   */
  mdxRs?: boolean
   ...
   * @see https://nextjs.org/docs/api-reference/next-config#typedroutes
   */
  typedRoutes?: boolean
