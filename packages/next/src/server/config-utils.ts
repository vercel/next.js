...
export function loadWebpackHook() {
  ...
  ;(require('../server/require-hook') as typeof import('../server/require-hook')).addHookAliases(
    [
      ...
      ['webpack/lib/node/NodeTargetPlugin.js', 'next/dist/compiled/webpack/NodeTargetPlugin'],
      ['webpack/lib/node/NodeTemplatePlugin', 'next/dist/compiled/webpack/NodeTemplatePlugin'],
      ['webpack/lib/node/NodeTemplatePlugin.js', 'next/dist/compiled/webpack/NodeTemplatePlugin'],
      ['webpack/lib/LibraryTemplatePlugin', 'next/dist/compiled/webpack/LibraryTemplatePlugin'],
      ['webpack/lib/LibraryTemplatePlugin.js', 'next/dist/compiled/webpack/LibraryTemplatePlugin'],
      ['webpack/lib/SingleEntryPlugin', 'next/dist/compiled/webpack/SingleEntryPlugin'],
      ['webpack/lib/SingleEntryPlugin.js', 'next/dist/compiled/webpack/SingleEntryPlugin'],
      [
      ...
      ['webpack/lib/ExternalsPlugin.js', 'next/dist/compiled/webpack/ExternalsPlugin'],
      [
      ...
      ['webpack/lib/ModuleFilenameHelpers', 'next/dist/compiled/webpack/ModuleFilenameHelpers'],
      ['webpack/lib/ModuleFilenameHelpers.js', 'next/dist/compiled/webpack/ModuleFilenameHelpers'],
      ...
      ['@babel/runtime/package.json', 'next/dist/compiled/@babel/runtime/package.json'],
    ].map(
