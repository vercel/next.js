...
> = {
  dynamic: {
    ...
    link: 'https://nextjs.org/docs/api-reference/segment-config#dynamic',
  },
  fetchCache: {
    description:
    ...
    link: 'https://nextjs.org/docs/api-reference/segment-config#fetchcache',
  },
  preferredRegion: {
    description:
    ...
    link: 'https://nextjs.org/docs/api-reference/segment-config#preferredregion',
  ...
  revalidate: {
    ...
    link: 'https://nextjs.org/docs/api-reference/segment-config#revalidate',
    isValid: (value: string) => {
  ...
  dynamicParams: {
    ...
    link: 'https://nextjs.org/docs/api-reference/segment-config#dynamicparams',
  },
  runtime: {
    description:
    ...
    link: 'https://nextjs.org/docs/api-reference/segment-config#runtime',
  },
  metadata: {
    description: 'Next.js Metadata configurations',
    link: 'https://nextjs.org/docs/api-reference/metadata',
  },
}
