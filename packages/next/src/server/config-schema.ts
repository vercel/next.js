...
export const experimentalSchema = {
  ...
  typeScriptBuildMode: z.enum(['serial', 'adaptive', 'external']).optional(),
  typeScriptBuildCpuBudget: z.number().int().positive().optional(),
  typeScriptBuildResultPath: z.string().min(1).optional(),
