    ...
    if (cacheComponents) {
      ...
      if (prerenderHTTPError) {
        try {
          ...
          // HTTPAccessFallbackError (e.g. the matched boundary's subtree
          // re-throws `notFound()` because the boundary was actually above
          // where the original notFound() was called), fall through to the
          // generic synthetic-shell recovery below.
          if (!isHTTPAccessFallbackError(recoveryErr)) {
            throw recoveryErr
          }
        }
      }
