...
async function renderWithRestartOnCacheMissInDev(
  ...
  if (initialStageController.currentStage !== RenderStage.Abandoned) {
    ...
    // The render was abandoned due to cache misses.
    // Clean up the unused streams to avoid leaking resources.
    initialStreamResult.stream.cancel()
    initialStreamResult.accumulatedChunksPromise.catch(() => {})
  }
