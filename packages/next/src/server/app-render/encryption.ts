...
export const encryptActionBoundArgs = React.cache(async function encryptActionBoundArgs(
  actionId: string,
  ...args: any[]
) {
...
export async function decryptActionBoundArgs(actionId: string, encryptedPromise: Promise<string>) {
