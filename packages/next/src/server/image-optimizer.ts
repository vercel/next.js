...
import { mediaType } from '@next/vendored/@hapi/accept'
import contentDisposition from '@next/vendored/content-disposition'
import { getOrientation, Orientation } from '@next/vendored/get-orientation'
import imageSizeOf from '@next/vendored/image-size'
