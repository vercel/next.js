    ...
    if (hasSomeFallbackParams) {
      ...
      switch (prerenderStore.type) {
        ...
        default:
          ...
          // We aren't in a dynamicIO (or cacheComponents) prerender but we do have fallback params at this
      ...
      if (fallbackParams.has(prop)) {
        Object.defineProperty(augmentedUnderlying, prop, {
          get() {
            ...
            // fallback shells
            // TODO remove this comment when dynamicIO or cacheComponents is the
            // default since there will be no `dynamic = "error"`
