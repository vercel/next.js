...
): ExternalObject<RefCell<FlushGuard | undefined | null>>
...
export declare function lightningCssTransform(opts: object): unknown

export declare function lightningCssTransformStyleAttribute(
  opts: object
): unknown
 ...
 */
export declare const enum MemoryEvictionMode {
  /** Never evict. */
  Off = 'off',
  /**
...
export declare const enum NapiCodeFrameColorMode {
  Error = 0,
  Warning = 1,
  Info = 2,
}
...
export interface NapiCompilationEvent {
  typeName: string
  severity: string
  message: string
  eventJson: string
...
export interface NapiEntrypoints {
  ...
  moduleFederation?: ExternalObject<ExternalEndpoint>
