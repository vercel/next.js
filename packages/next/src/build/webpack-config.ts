    ...
    alias: {
      ...
      ...(isEdgeServer
        ? {
            ...
            [path.join(NEXT_PROJECT_ROOT, 'dist', 'client', 'link')]:
            ...
            [path.join(NEXT_PROJECT_ROOT, 'dist', 'client', 'script')]:
              'next/dist/esm/client/script',
            [path.join(NEXT_PROJECT_ROOT, 'dist', 'client', 'router')]:
              'next/dist/esm/client/router',
            [path.join(NEXT_PROJECT_ROOT, 'dist', 'shared', 'lib', 'head')]:
              'next/dist/esm/shared/lib/head',
            [path.join(NEXT_PROJECT_ROOT, 'dist', 'shared', 'lib', 'dynamic')]:
              'next/dist/esm/shared/lib/dynamic',
            [path.join(NEXT_PROJECT_ROOT, 'dist', 'pages', '_document')]:
              'next/dist/esm/pages/_document',
            [path.join(NEXT_PROJECT_ROOT, 'dist', 'pages', '_app')]:
