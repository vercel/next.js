...
import { urlToRequest } from '@next/vendored/loader-utils3'
import modulesValues from '@next/vendored/postcss-modules-values'
import localByDefault from '@next/vendored/postcss-modules-local-by-default'
import extractImports from '@next/vendored/postcss-modules-extract-imports'
import modulesScope from '@next/vendored/postcss-modules-scope'
