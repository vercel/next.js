...
import { getSourceMapFromFile } from 'next/dist/server/dev/get-source-map-from-file'
import {
...
} from 'next/dist/server/lib/source-maps'
import { openFileInEditor } from 'next/dist/next-devtools/server/launch-editor'
import {
...
import { middlewareResponse } from 'next/dist/next-devtools/server/middleware-response'
...
import { formatStackFrameFile } from 'next/dist/next-devtools/shared/webpack-module-path'
