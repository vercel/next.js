...
import { createPagesMapping } from 'next/dist/build/route-discovery'
import { getStaticInfoIncludingLayouts } from 'next/dist/build/get-static-info-including-layouts'
...
import { APP_DIR_ALIAS, WEBPACK_LAYERS } from 'next/dist/lib/constants'
...
import { type Span, trace } from 'next/dist/trace'
...
import {
  isInternalComponent,
  isNonRoutePagesPage,
} from 'next/dist/lib/is-internal-component'
...
import { FAST_REFRESH_RUNTIME_RELOAD } from 'next/dist/server/dev/messages'
import { getNextErrorFeedbackMiddleware } from 'next/dist/next-devtools/server/get-next-error-feedback-middleware'
import { getDevOverlayFontMiddleware } from 'next/dist/next-devtools/server/font/get-dev-overlay-font-middleware'
import { getDisableDevIndicatorMiddleware } from 'next/dist/next-devtools/server/dev-indicator-middleware'
import getWebpackBundler from '../../shared/lib/get-webpack-bundler'
import { getRestartDevServerMiddleware } from 'next/dist/next-devtools/server/restart-dev-server-middleware'
import { checkFileSystemCacheInvalidationAndCleanup } from '../../build/webpack/cache-invalidation'
import { receiveBrowserLogsWebpack } from 'next/dist/server/dev/browser-logs/receive-logs'
import {
  devToolsConfigMiddleware,
  getDevToolsConfig,
} from 'next/dist/next-devtools/server/devtools-config-middleware'
import { getAttachNodejsDebuggerMiddleware } from 'next/dist/next-devtools/server/attach-nodejs-debugger-middleware'
...
} from 'next/dist/server/dev/debug-channel'
import {
  getVersionInfo,
  matchNextPageBundleRequest,
} from 'next/dist/server/dev/hot-reloader-shared-utils'
import { getMcpMiddleware } from 'next/dist/server/mcp/get-mcp-middleware'
import { setStackFrameResolver } from 'next/dist/server/mcp/tools/utils/format-errors'
import { recordMcpTelemetry } from 'next/dist/server/mcp/mcp-telemetry-tracker'
import { getFileLogger } from 'next/dist/server/dev/browser-logs/file-logger'
import type { ServerCacheStatus } from 'next/dist/next-devtools/dev-overlay/cache-indicator'
import type { Lockfile } from 'next/dist/build/lockfile'
import {
  sendSerializedErrorsToClient,
  sendSerializedErrorsToClientForHtmlRequest,
  setErrorsRscStreamForHtmlRequest,
} from 'next/dist/server/dev/serialized-errors'
