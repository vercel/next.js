...
import { EVENT_BUILD_FEATURE_USAGE } from 'next/dist/telemetry/events'
...
import { isInterceptionRouteRewrite } from 'next/dist/lib/is-interception-route-rewrite'
...
const KNOWN_SAFE_DYNAMIC_PACKAGES =
  require('next/dist/lib/known-edge-safe-packages.json') as string[]
