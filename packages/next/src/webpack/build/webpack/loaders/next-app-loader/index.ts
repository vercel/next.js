...
import { AppPathnameNormalizer } from 'next/dist/server/normalizers/built/app/app-pathname-normalizer'
import type { ProxyConfig } from 'next/dist/build/analysis/get-page-static-info'
import { isAppBuiltinPage } from 'next/dist/build/utils'
import { loadEntrypoint } from 'next/dist/build/load-entrypoint'
import {
  isGroupSegment,
  DEFAULT_SEGMENT_KEY,
  PAGE_SEGMENT_KEY,
} from 'next/dist/shared/lib/segment'
...
import { PARALLEL_ROUTE_DEFAULT_PATH } from 'next/dist/client/components/builtin/default'
import { PARALLEL_ROUTE_DEFAULT_NULL_PATH } from 'next/dist/client/components/builtin/default-null'
import type { Compilation } from 'webpack'
import { createAppRouteCode } from './create-app-route-code'
import { MissingDefaultParallelRouteError } from 'next/dist/shared/lib/errors/missing-default-parallel-route-error'
import { isInterceptionRouteAppPath } from 'next/dist/shared/lib/router/utils/interception-routes'
