...
import { saveCpuProfile } from 'next/dist/server/lib/cpu-profile'
...
import formatWebpackMessages from 'next/dist/shared/lib/format-webpack-messages'
import { nonNullable } from 'next/dist/lib/non-nullable'
import type { COMPILER_INDEXES } from 'next/dist/shared/lib/constants'
import {
  COMPILER_NAMES,
...
import {
  ...
  resumePluginState,
  getPluginState,
} from 'next/dist/build/build-context'
...
import {
  durationToString,
  hrtimeToSeconds,
} from 'next/dist/build/duration-to-string'
