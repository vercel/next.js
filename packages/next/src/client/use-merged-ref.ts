...
// of time if a cleanup function will be returned. This implements cleanup
// functions with the old behavior in 18. We know refs are always called
// alternating with `null` and then `T`. So a call with `null` means we need to
// call the previous cleanup functions.
