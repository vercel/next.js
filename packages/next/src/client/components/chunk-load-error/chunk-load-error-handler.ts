...
declare global {
  var __turbopack_clear_chunk_resolver__:
    ...
    | undefined
  var __next_clear_chunk_cache__: ((chunkId: string) => void) | undefined
}
 ...
 */
function extractWebpackChunkId(chunkUrl: string): string | undefined {
 ...
 * Works for both Turbopack and Webpack.
 *
