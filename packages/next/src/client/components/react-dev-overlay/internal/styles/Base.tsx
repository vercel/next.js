...
export function Base(): React.ReactNode {
  return (
    <style>
      {css`
        :host {
          ...
          --color-stack-h3: hsl(0, 0%, 13%);
          --color-stack-headline: hsl(0, 0%, 40%);
          --color-stack-subline: hsl(0, 0%, 60%);
        ...
        @media (prefers-color-scheme: dark) {
          :host {
            ...
            --color-bg-secondary-hover: hsl(240, 3%, 20%);

            --color-backdrop: hsl(240, 2%, 18%);

            --color-accents-3: hsl(0, 0%, 46%);

            --color-border: hsla(0, 0%, 20%, 0.7);

            // TODO
            --color-stack-h3: hsl(240, 4%, 79%);
            --color-stack-headline: hsl(240, 1%, 45%);
            --color-stack-subline: hsl(240, 2%, 57%);
          }
        }
