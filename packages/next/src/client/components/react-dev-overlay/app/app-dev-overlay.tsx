...
export interface Dispatcher {
  ...
  renderIndicatorHide(): void
  renderIndicatorShow(): void
}
...
export const dispatcher: Dispatcher = {
  ...
  renderIndicatorHide: createQueuable((dispatch: Dispatch) => {
    dispatch({ type: ACTION_RENDERING_INDICATOR_HIDE })
  }),
  renderIndicatorShow: createQueuable((dispatch: Dispatch) => {
