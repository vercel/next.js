...
> {
  ...
  static getDerivedStateFromError(error: Error) {
    ...
    // For non-chunk errors, explicitly reset chunk error state to ensure the
    // correct error UI is rendered. This is necessary because React performs
    // shallow state merging - if a chunk error occurred previously and set
    // chunkErrorAction to 'banner', a subsequent non-chunk error would otherwise
    // keep that banner action set due to state merging.
    return {
      error,
      chunkErrorAction: null,
      frozenHTML: null,
