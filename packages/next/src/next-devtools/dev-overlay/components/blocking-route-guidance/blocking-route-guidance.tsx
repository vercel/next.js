        ...
        {variant === 'runtime' ? (
          <>
            <Collapsible title="I want the rest of the page to load instantly">
              ...
              <DocsLink hash="wrap-in-suspense">Wrap in Suspense</DocsLink>
            </Collapsible>
            ...
            <Collapsible title="I can move this into a smaller component">
              ...
              <DocsLink hash="move-the-access-into-a-child">
            ...
            <Collapsible title="I'm using params or searchParams">
              ...
              <DocsLink hash="params-and-searchparams">
            ...
            <Collapsible title="I just want the simplest fix">
              ...
              <DocsLink hash="add-a-loadingjs-file">
          ...
          <>
            <Collapsible title="This data doesn't change often">
              ...
              <DocsLink hash="cache-data-with-use-cache">
            ...
            <Collapsible title="This data is personalized or real-time">
              ...
              <DocsLink hash="stream-dynamic-data">
                Stream dynamic data
              </DocsLink>
            </Collapsible>
            ...
            <Collapsible title="This data can be slightly stale">
              ...
              <DocsLink hash="short-lived-caches">Short-lived caches</DocsLink>
            </Collapsible>
          </>
        )}
      </div>
