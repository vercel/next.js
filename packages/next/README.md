...
⚠️ Default `error.js` and your `_error.js` components are only used in production. In development you get an error with call stack to know where the error originated from. ⚠️
