...
To get started with Next.js visit <a aria-label="next.js learn" href="https://nextjs.org/learn">https://nextjs.org/learn</a>

## Documentation 📃

Full documentation on [https://nextjs.org/docs](https://nextjs.org/docs).

## Who is using Next.js ❓

Used by the world's leading companies. Check out the [Next.js Showcase](https://nextjs.org/showcase) to learn more.
