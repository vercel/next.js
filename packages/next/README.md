...
- `pathname` - path of the page in `/pages`.
...
- `route` - `String` of the current route. That is the path of the page in `/pages`.
- `pathname` - `String` similar to `route`, but can include a trailing backslash.
