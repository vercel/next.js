...
a.__jsx-style-dynamic-selector {color:red}`}</_JSXStyle>
  ...
  className: _JSXStyle.dynamic([['12e2c41a8d37fe78', [colors.green.light]]]),
})
const b = {
  styles: (
    <_JSXStyle
...
a.__jsx-style-dynamic-selector {color:red}`}</_JSXStyle>
  ...
  className: _JSXStyle.dynamic([['d5617758481f82cd', [colors.green.light]]]),
}
...
a.__jsx-style-dynamic-selector {color:red}`}</_JSXStyle>
    ...
    className: _JSXStyle.dynamic([['a7ac579c753e9d90', [colors.green.light]]]),
  }
}
export default {
  styles: (
    <_JSXStyle
      id={'e4642e4164827181'}
    >{`div.jsx-e4642e4164827181 {font-size:3em}
