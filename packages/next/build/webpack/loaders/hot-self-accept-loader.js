...
module.exports = function (content: string, sourceMap: any) {
  ...
  if (!options.extensions) {
    throw new Error(
      'extensions is not provided to hot-self-accept-loader. Please upgrade all next-plugins to the latest version.'
    )
  }

  if (!options.include) {
    throw new Error(
      'include option is not provided to hot-self-accept-loader. Please upgrade all next-plugins to the latest version.'
    )
  }
...
function getRoute (resourcePath: string, options: Options) {
  ...
  if (!dir) {
    throw new Error(
      `'hot-self-accept-loader' was called on a file that isn't a page.`
    )
  }
