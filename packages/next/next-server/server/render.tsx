...
export async function renderToHTML(
  ...
  if (
    ...
    warn(
      ` Detected getInitialProps on page ${pathname} while running "next export". It's recommended to use getStaticProps which has a more correct behavior for static exporting: https://err.sh/next.js/getinitialprops-export`
    )
  }
