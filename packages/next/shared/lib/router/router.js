    ...
    change(method, url, as, options, forcedScroll) {
        ...
        return _asyncToGenerator(function*() {
            ...
            try {
                ...
                const nextScroll = forcedScroll != null ? forcedScroll : resetScroll;
                const mergedNextState = _extends({}, nextState, {
                    route,
                    pathname,
                    query,
                    asPath: cleanedAs,
                ...
                const canSkipUpdating = options._h && !nextScroll && compareRouterStates(mergedNextState, _this.state);
                if (!canSkipUpdating) {
