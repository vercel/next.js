...
// eslint-disable-next-line camelcase
externals['@javivelasco/isbot'] = 'next/dist/compiled/@javivelasco/isbot'
export async function ncc_isbot(task, opts) {
  await task
    .source(
      opts.src || relative(__dirname, require.resolve('@javivelasco/isbot'))
    )
    .ncc({ packageName: '@javivelasco/isbot', externals })
