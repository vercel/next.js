...
export async function renderToHTMLOrFlight(
  ...
  const wrappedRender = async () => {
    ...
    const createComponentTree = async ({
      ...
      return {
        Component: () => {
          // This (dev only) suffix serves two purposes:
          // 1) Work around Safari issue of always caching the resource if you
          //    preload it
          //    - https://github.com/vercel/next.js/issues/5860
          //    - https://bugs.webkit.org/show_bug.cgi?id=187726
          // 2) Make sure new classes generated by Tailwind’s JIT compiler are
