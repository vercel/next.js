import os from 'os'
import Ajv from 'next/dist/compiled/ajv'
import ajvKeywords from 'next/dist/compiled/ajv-keywords'
import { JSONSchemaType } from 'next/dist/compiled/ajv'
...
export function validateConfig(userConfig: NextConfig): {
  ...
  ajv.validate(configSchema, userConfig)
  return {
    errors: ajv.errors,
  }
}
