...
import { getPageRuntime, invalidatePageRuntime } from '../../build/entries'
    ...
    return new Promise((resolve, reject) => {
      ...
      wp.on('aggregated', async () => {
        ...
        for (const [fileName, { accuracy, safeTime }] of knownFiles) {
          ...
          invalidatePageRuntime(fileName, safeTime)
          const pageRuntimeConfig = await getPageRuntime(fileName)
