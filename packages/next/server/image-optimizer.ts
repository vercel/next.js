  ...
  try {
    ...
    if (sharp) {
      ...
      if (showSharpMissingWarning && nextConfig.output === 'standalone') {
        ...
        console.error(
          `Error: 'sharp' is required to be installed in standalone mode for the image optimization to function correctly. Read more at: https://nextjs.org/docs/messages/missing-sharp-standalone`
        )
