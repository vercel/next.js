...
;(async function () {
  try {
    ...
    // we lock the version to last built swc binaries for
    // last successfully built binaries
    // https://github.com/vercel/next.js/pull/77477#issuecomment-2752725970
    for (let platform of platforms) {
      let optionalDependencies = nextPkg.optionalDependencies || {}
      optionalDependencies['@next/swc-' + platform] = '13.5.9'
