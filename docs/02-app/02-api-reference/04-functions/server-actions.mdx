...
{/* TODO: This page will need to be integrated into the React docs */}
...
Create a Server Action by defining an asynchronous function with the `"use server"` directive at the top of the function body. This function should have **serializable arguments** and a **serializable return value**.
...
Both Server and Client Actions support progressive enhancement, using one of two strategies:
