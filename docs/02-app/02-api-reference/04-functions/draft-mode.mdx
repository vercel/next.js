...
```tsx filename="app/draft/route.ts"
...
```js filename="app/draft/route.js"
import { draftMode } from 'next/headers'
...
To disable Draft Mode manually, [Route Handler](/docs/app/building-your-application/routing/route-handlers) and call the `disable()` method:
