...
`unstable_noStore` can be used to declaratively opt out of static rendering and indicate a particular [Server Component](/docs/app/building-your-application/rendering/server-components) should not be cached.
