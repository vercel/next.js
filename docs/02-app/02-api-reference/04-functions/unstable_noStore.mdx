...
> **Good to know**:
> - Even though `noStore` is defined at the component level, the entire route becomes dynamic (until [Partial Prerendering](/docs/app/api-reference/next-config-js/partial-prerendering) is stable)
