...
> - `revalidatePath` can be used to revalidate both [App Router](https://nextjs.org/docs/app/building-your-application/routing) and [Pages Router](https://nextjs.org/docs/pages/building-your-application/routing), but can only been called from App Router elements, either [server actions](#server-action) or [route handler](#route-handler). 
