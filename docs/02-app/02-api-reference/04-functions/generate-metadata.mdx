...
A brief description of what this web-page is about. Not recommended, superseded by [description](https://nextjs.org/docs/app/api-reference/functions/generate-metadata#description).

```jsx filename="layout.js | page.js"
export const metadata = {
  abstract: 'This website is about Next.js',
}
```

```html filename="<head> output" hideLineNumbers
<meta name="abstract" content="This website is about Next.js" />
```
