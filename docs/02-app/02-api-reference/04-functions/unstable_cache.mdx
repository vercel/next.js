...
> This API will be deprecated in future versions. If you're using Next.js 15 canary, we recommend using [`connection`](/docs/app/api-reference/functions/connection) instead of `unstable_noStore`.
