...
To use `cacheTag`, enable the [`dynamicIO` flag](/docs/canary/app/api-reference/next-config-js/dynamicIO) in your `next.config.js` and import `cacheTag` from `next/cache`:
