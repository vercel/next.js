...
`generateViewport` should return a [`Viewport` object](#metadata-fields) containing one or more viewport fields.
...
export async function generateViewport(): Viewport {
