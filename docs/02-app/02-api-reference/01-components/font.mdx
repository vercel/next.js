...
| [`usedFontFamilyName`](#usedFontFamilyName) | <Check size={18} /> | <Check size={18} /> | String                     | -                 |
...
A predefined font-family name used in @font-face and style declarations instead of the default hashed name.
This argument is useful when the font-family name is already defined in a 3rd party library and you need the loaded font to match it.
