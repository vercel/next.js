...
| [`disableFontFamilyHashing`](#disablefontfamilyhashing) | <Check size={18} /> | <Check size={18} /> | Boolean                    | -                 |
...
A boolean value to disable the default font-family name hashing in the @font-face declarations.
