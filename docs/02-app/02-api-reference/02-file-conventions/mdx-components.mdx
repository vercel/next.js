...
The `mdx-components.js|tsx` file is **required** to use [MDX with App Router](/docs/app/building-your-application/configuring/mdx) and will not work without it. Additionally, you can use it [render and style custom elements](#render-and-style-custom-elements).
