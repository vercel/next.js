...
| [`maxDuration`](#maxduration)         | `number`                                                                                                                  | `Response time limit` |
...
> **Good to know**:
>
> - If a `maxDuration` is not specified, the default is the [function timeout limit](https://vercel.com/docs/concepts/limits/overview#general-limits) of your Vercel plan.
