...
> - When deployed on Vercel, favicon files stored in the app folder are cached within the build cache. To update a file, it's necessary to invalidate this cache.
