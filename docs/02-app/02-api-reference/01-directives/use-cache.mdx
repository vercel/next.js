...
- The `use cache` directive will be available separately from the [`dynamicIO`](https://nextjs.org/docs/canary/app/api-reference/next-config-js/dynamicIO) flag in the future.
