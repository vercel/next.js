...
> **Note:** This does not work yet with the app router. See [https://github.com/vercel/next.js/issues/42812#issuecomment-1313287665](https://github.com/vercel/next.js/issues/42812#issuecomment-1313287665)
