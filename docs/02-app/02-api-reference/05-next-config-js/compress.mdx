...
> **Good to know:**
>
> - For Next.js applications on Vercel, compression is handled by the Vercel's proxy and not Next.js. See the [Vercel documentation](https://vercel.com/docs/edge-network/compression) for more information.
