...
If you are using TypeScript in your project, you can use [`next.config.ts`](/docs/app/building-your-application/configuring/typescript#type-checking-in-nextjs-configuration) to use TypeScript in your configuration:
