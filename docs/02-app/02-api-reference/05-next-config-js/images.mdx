...
Before using this loader, make sure to enable the Image Processor module in your Azion application following this guide: [Image Processor first steps](https://www.azion.com/en/documentation/products/guides/image-processor/).

```js
// Docs: https://www.azion.com/en/documentation/products/build/edge-application/image-processor/
export default function azionLoader({ src, width, quality}) {
  return `https://example.com/${src}?ims=${width}x/filters:quality(${quality} || 75)`
}
```
