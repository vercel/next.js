...
The `staticGeneration*` options allow you to configure the Static Generation process in your Next.js application. It's helpful for advanced use cases that would benefit from greater control.
...
- `staticGenerationMinPagesPerWorker`: The minimum number of pages to be processed before start a new worker.
