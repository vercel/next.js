...
> **Good to know**: Since Next.js 13.4, Strict Mode is `true` by default, so the above configuration is not necessary. You can still disable Strict Mode by setting `reactStrictMode: false`.
