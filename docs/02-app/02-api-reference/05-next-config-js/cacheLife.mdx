...
The configuration object has key values with the following `CacheLife` format:
...
- The [`dynamicIO` flag](/docs/app/api-reference/next-config-js/dynamicIO) must be enabled.