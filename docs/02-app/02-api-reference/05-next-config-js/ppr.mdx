...
For version 14, you can enable it by adding the [`ppr`](/docs/app/api-reference/next-config-js/ppr) option to your `next.config.js` file. You must also be on canary to to enable PPR. This will apply to all routes in your application:
...
| Version   | Changes                                     |
| --------- | ------------------------------------------- |
| `v15.0.0` | exerpimental `incremental` value introduced |
