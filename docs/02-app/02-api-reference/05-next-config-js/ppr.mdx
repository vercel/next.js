...
To enable Partial Prerendering, set the experimental `ppr` flag `incremental`:
...
- `incremental`: Allowing you to incrementally opt-in layouts and pages, should be used with the [`experimental_ppr`](/docs/app/api-reference/file-conventions/route-segment-config#experimental_ppr) route config option.
