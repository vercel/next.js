...
<<<<<<< HEAD:docs/02-app/02-api-reference/08-legacy-apis/unstable_noStore.mdx
<Note type="warning">
  This API will be deprecated in the future. If you are using Next.js version 15, we recommend using [`use cache`](/docs/api-reference/directives/use-cache) instead of `unstable_noStore`.
</Note>
=======
...
>>>>>>> canary:docs/02-app/02-api-reference/04-functions/unstable_noStore.mdx
