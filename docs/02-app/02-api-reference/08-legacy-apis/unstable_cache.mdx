...
<Note type="warning">
  This API will be deprecated in the future. If you are using Next.js version 15, we recommend using [`use cache`](/docs/api-reference/directives/use-cache) instead of `unstable_cache`.
</Note>
