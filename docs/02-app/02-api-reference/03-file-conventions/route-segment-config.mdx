...
<Note type="warning">
  If you are using Next.js version 15, and have opted into the `dynamicIO` flag, then these options will be disabled, and will be removed in a future version.
</Note>
