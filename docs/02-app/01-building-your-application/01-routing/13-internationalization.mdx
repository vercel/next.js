...
- [next-i18n-router](https://github.com/i18nexus/next-i18n-router): Adds internationalized routing with locale detection to the App Router
- [next-intl](https://next-intl-docs.vercel.app/docs/next-13): i18n library for Next.js built on top of the FormatJS `intl` library
