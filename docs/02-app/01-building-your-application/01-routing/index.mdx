...
| [`guard`](/docs/app/building-your-application/routing/guarding-ui-segments)           | Guarding function executed before rendering any page in a segment and its children             |
