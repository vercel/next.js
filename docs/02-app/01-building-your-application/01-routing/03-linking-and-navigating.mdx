...
The `useRouter` hook allows you to programmatically change routes from Client Components. For Server Components, you would use [`redirect()`](/docs/app/api-reference/functions/redirect) instead.
