...
```jsx filename="app/@authModal/login/page.jsx" switcher
import { Modal } from 'components/modal'
...
```jsx filename="app/@authModal/login/default.jsx" switcher
export default function Default() {
  return null
}
```
...
```jsx filename="app/@authModal/[...catchAll]/page.jsx"switcher
export default function CatchAll() {
  return null
}
```
