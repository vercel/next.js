...
Route Handlers are dynamic by default since v15 of Next.js. To opt-in to caching for GET requests in route handlers you can specify via the following config.
