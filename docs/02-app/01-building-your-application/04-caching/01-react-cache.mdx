---
title: React Cache
description: Learn to use React.cache() to memoize functions, and how Next.js uses it to deduplicate data requests.
---

{/* TODO: Update this page from the POV of React.Cache and then discuss how Next.js integrates it in `fetch` requests */}
...
Request deduplication is automatically applied to `generateMetadata`, `generateStaticParams`, and `fetch` requests used in Layouts, Pages, and Server Components across the same render pass.
