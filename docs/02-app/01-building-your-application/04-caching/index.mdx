...
The following Route Segment Config options will opt out of Full Route Cache:

- `const dynamic = 'force-dynamic'`

This config will opt out of the Data Cache:

- `const fetchCache = 'default-no-store'`

See the [`fetchCache`](/docs/app/api-reference/file-conventions/route-segment-config#fetchcache) for more Data Cache options.
