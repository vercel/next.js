...
| [`unstable_cache`](/docs/canary/app/api-reference/legacy-apis/unstable_cache)    |                            |                       | Cache                 |             |
...
1. When using `fetch` or [`unstable_cache`](/docs/canary/app/api-reference/legacy-apis/unstable_cache), you have the option to tag cache entries with one or more tags.
