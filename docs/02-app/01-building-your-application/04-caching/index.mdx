...
By default, Next.js will cache as much as possible to improve performance and reduce cost. This means routes are [**statically rendered**](/docs/app/building-your-application/rendering/server-components#static-rendering-default) and data requests are decoupled from rendering, allowing you to cache and revalidate individual data requests.
...
- **Render Cache**: Automatically stores the result of rendering on the server at build time (or during revalidation), and on the client at runtime. This improves the [navigation](/docs/app/building-your-application/routing/linking-and-navigating#how-routing-and-navigation-works) experience (see [prefetching](/docs/app/building-your-application/routing/linking-and-navigating#2-prefetching) and [partial rendering](/docs/app/building-your-application/routing/linking-and-navigating#4-partial-rendering)), **reduces the number of server requests**, and computation cost of rendering.

Mutating data or revalidating **Data Cache** will in turn update the **Render Cache** by rerendering the components to show the latest data.
...
| API                                               | Purpose                                                                                        | Where                                             |
| ------------------------------------------------- | ---------------------------------------------------------------------------------------------- | ------------------------------------------------- |
| [revalidatePath]()                                | Mutate data                                                                                    | Server Actions, Route Handlers                    |
| [revalidateTag]()                                 | Mutate data                                                                                    | Server Actions, Route Handlers                    |
