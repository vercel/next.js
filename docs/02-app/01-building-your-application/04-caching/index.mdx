...
- [Time-based Revalidation](/docs/app/building-your-application/data-fetching/fetching-caching-and-revalidating#time-based-revalidation).
- [On-demand Revalidation](/docs/app/building-your-application/data-fetching/fetching-caching-and-revalidating#revalidating-data)

See the [Revalidating Data](/docs/app/building-your-application/data-fetching/fetching-caching-and-revalidating#revalidating-data) section for more.
...
> **Related terms**:
>
> - The terms **Automatic Static Optimization**, **Static Site Generation**, or **Static Rendering** might be also be used interchangeably to refer to the process of rendering and caching routes of your application at build time.
...
- **Using the route segment config options `export const dynamic = force-dynamic` or `export const revalidate = 0`**: This will skip the Full Route Cache and the Data Cache. Meaning components will be rendered and data fetched on every incoming request. The Router Cache will still apply as it's a client-side cache.
...
1. [Route Handlers](/docs/app/building-your-application/routing/router-handlers) - to revalidate data in response to a third party event (e.g. webhook).
