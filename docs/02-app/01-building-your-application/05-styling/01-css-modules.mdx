...
> **Good to know:**
>
> - CSS ordering behaves differently in development mode, always ensure to check preview deployments to verify the final CSS order in your production build.
> - You can use the [`cssChunking`](/docs/app/api-reference/next-config-js/cssChunking) option in `next.config.ts` to control how CSS is chunked.
