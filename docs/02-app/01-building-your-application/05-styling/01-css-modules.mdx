---
title: CSS Modules and Stylesheets
...
- [Regular Stylesheets](#regular-stylesheets) with the `<link>` tag
...
- Extract shared styles into a separate file and import them into the files that need them.
- If using [Tailwind](/docs/app/building-your-application/styling/tailwind-css), import the stylesheets at the top of the file, preferably in the [Root Layout](/docs/app/building-your-application/routing/pages-and-layouts#root-layout-required).
