...
In cases like this, you can interleave Client and Server Components in the same route, see the [Composition Patterns](/docs/app/building-your-application/rendering#composition-patterns) documentation for implementation details.
