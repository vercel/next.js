...
[React Server Components]() can be used to render parts of your application on the server. In Next.js, the rendering is split by route segments to enable streaming.

There are three ways you can render Server Components with Next.js:

- [Static Rendering](#static-rendering-default)
- [Dynamic Rendering](#dynamic-rendering)
- [Streaming](#streaming)

This page will go through how Server Components work, how they are rendered, and when you might use them.
