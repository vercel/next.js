...
For version 14, you can enable it by adding the [`ppr`](/docs/app/api-reference/next-config-js/partial-prerendering) option to your `next.config.js` file. This will apply to all routes in your application:
