...
- During a [request-response lifecycle](/docs/app/building-your-application/rendering#requestresponse-lifecyle), your code moves from the server to the client. If you need to access data or resources on the server while on the client, you'll be making a **new** request to the server - not switching back.
