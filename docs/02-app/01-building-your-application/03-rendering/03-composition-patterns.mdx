...
When architecting your application, you can interleave Client and Server Components. It may be helpful to vizualise your UI as a tree of components. Starting with the [root layout](/docs/app/building-your-application/layout), which is a Server Component, you can then render certain branches on the client by adding the [`"use client"`]() directive.
