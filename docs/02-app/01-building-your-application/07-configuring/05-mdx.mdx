...
The following example demonstrates how to integrate remark and rehype plugins into Next.js for utilizing extended Markdown syntax with remote MDX
...
const options = {
  mdxOptions: {
// you can add the necessary plugins to the array.
    remarkPlugins: [],
    rehypePlugins: [],
  },
};
...
To share a layout amongst MDX pages, you can use the [built-in layouts support](/docs/app/building-your-application/routing/
pages-and-layouts#layouts) with the App Router.
