...
## Render and style custom elements
...
When you want to style your own elements for a custom feel to your website or application, you can provide your own components that map to `HTML` elements.

<AppOnly>

To do this, create a `mdx-components.tsx` file at the root of your application (the parent folder of `app/` or `src/`) and add custom elements:
