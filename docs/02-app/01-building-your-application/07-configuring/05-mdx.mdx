...
To share a layout across MDX pages, you can use the [built-in layouts support](/docs/app/building-your-application/routing/layout-and-templates#layouts) with the App Router.
