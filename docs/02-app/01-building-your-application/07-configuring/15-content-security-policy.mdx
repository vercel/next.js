...
In a future version Next.js will block `javascript:` URLs by default. You can opt-in to this behavior by setting the experimental config `hardenedXSSProtection` to `true` in your `next.config.js`:
