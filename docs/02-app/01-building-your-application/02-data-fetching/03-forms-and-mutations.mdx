...
> **Good to know**: actions take the [FormData](https://developer.mozilla.org/en-US/docs/Web/API/FormData/FormData) data type. The data submitted via the HTML [`form`](https://developer.mozilla.org/en-US/docs/Web/HTML/Element/form) is accessible in the server action `create`. 
