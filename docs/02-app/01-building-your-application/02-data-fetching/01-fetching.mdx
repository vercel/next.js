...
If you are using `fetch`, requests are no longer being automatically [memoized](/docs/app/building-your-application/caching#request-memoization). Read the fetch changes [here](/docs/app/building-your-application/upgrading/version-15#fetch-requests)
