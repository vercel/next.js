...
This page will be SSG by default. The page will be prerendered during `next build`. Can be revalidated using [Incremental Static Regeneration](/docs/app/building-your-application/data-fetching/incremental-static-regeneration).
...
```
The database call will run again everytime you revalidte the page using [Incremental Static Regeneration](/docs/app/building-your-application/data-fetching/incremental-static-regeneration).
