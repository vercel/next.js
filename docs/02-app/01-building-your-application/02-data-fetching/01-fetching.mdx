...
- Next.js [`use cache`](/docs/app/api-reference/directives/use-cache)
- Next.js [`cacheLife`](/docs/app/api-reference/directives/use-cache#time-based-revalidation-with-cachelife)
- Next.js [`cacheTag`](/docs/app/api-reference/directives/use-cache#revalidating-on-demand-with-cachetag)
...
You can use the [`use cache`](/docs/app/api-reference/directives/use-cache) directive in combination with the [`cacheLife`](/docs/app/api-reference/directives/use-cache#time-based-revalidation-with-cachelife), and [`cacheTag`](/docs/app/api-reference/directives/use-cache#revalidating-on-demand-with-cachetag) functions to cache the response to allow pages to be prerendered when running `next build`.
