...
- [Configuring self-hosted Next.js behind firewalls and load balancers](#configuring-self-hosted-next-js-behind-firewalls-and-load-balancers)
...
> **Good to know:**
>
> - Adjust your cache configuration to handle `_rsc` according to your caching strategy and desired behavior.
> - Ensure that your firewall or load balancer is configured to pass through the necessary headers and query parameters for optimal Next.js functionality.
