...
> **Good to know**:
>
> - Fetch requests are not automatically deduplicated under some of the conditions. [Learn more about caching](/docs/app/building-your-application/data-fetching/caching).
