...
```jsx filename="app/actions.jsx" highlight={1, 3}
'use server'
...
```jsx filename="app/add-to-cart.jsx"
export default function AddToCart({ productId }) {
  async function addItem(data) {
    'use server'
...
```jsx filename="app/form.jsx" highlight={15}
...
```jsx filename="app/components/example-client-component.jsx" highlight={3, 7, 10}
'use client'
...
```jsx filename="app/posts/[id]/page.jsx" switcher
import kv from '@vercel/kv'
import LikeButton from './like-button'
...
```jsx filename="app/post/[id]/like-button.jsx" switcher
'use client'
...
```jsx filename="app/components/example-client-component.jsx"
'use client'
...
```jsx filename="app/components/example-server-component.jsx"
