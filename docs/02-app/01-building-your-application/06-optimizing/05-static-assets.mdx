...
Next.js automatically adds caching headers to immutable assets in the `/public` folder. Assets like static images, and other media are ideal candidates for the as they rarely change. The default caching headers applied are:
