...
The `sendGTMEvent` function can be used to track user interactions on your page by sending events using the `dataLayer` object.
...
documentation to learn about the variables and events that can be passed into the function.
