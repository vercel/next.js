...
Options to pass to the Google Maps Embed. For full list of option read [Google Map Embed docs](https://developers.google.com/maps/documentation/embed/embedding-map)
...
| `playlabel` | Optional | A visually hidden label for the play button for accessability.                                                                                                                                             |
