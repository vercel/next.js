---
title: Testing
description: Learn how to set up Next.js with three commonly used testing tools — Cypress, Playwright, Vitest, Jest and React Testing Library.
---
...
Learn how to set up Next.js with commonly used testing tools: [Cypress](#cypress), [Playwright](#playwright), [Jest with React Testing Library](#jest-and-react-testing-library), and [Vitest](#vitest).
...
To get started with Cypress, install `cypress` package:
