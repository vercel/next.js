...
If you're using the **App Router**, this file should be placed in the root of the project. Or, if using the **Pages** Router, this file should be placed under the `pages` folder.
