...
Next, create a custom [`instrumentation.ts`](/docs/app/building-your-application/optimizing/instrumentation) file in the root of the project if you are using the App Router, or inside the `pages` folder if using the Pages Router.
