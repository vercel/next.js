...
- **Static Asset Caching:**
  Next.js automatically adds caching headers to immutable assets in **`/public`** or other static directories. Assets Static images, and other media are ideal candidates for long-term caching as they rarely change. The default caching headers applied are:
