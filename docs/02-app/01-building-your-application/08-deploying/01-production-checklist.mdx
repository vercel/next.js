...
- [Fetching data on the server](/docs/app/building-your-application/data-fetching/patterns#fetching-data-on-the-server)
- [Parallel Data Fetching](https://nextjs.org/learn/dashboard-app/fetching-data#parallel-data-fetching)- Reduce waterfalls and unblock pages by fetching data in parallel.
...
[Google Lighthouse](https://developer.chrome.com/docs/lighthouse/overview) is a powerful tool for assessing Core Web Vitals, along with other important aspects such as performance, accessibility, best practices, and SEO. To get the most accurate results:
...
Lighthouse is available directly within Chrome DevTools, as a command-line tool, and online through [Google PageSpeed Insights](https://pagespeed.web.dev).
