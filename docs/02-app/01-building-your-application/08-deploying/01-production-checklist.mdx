...
- Ensure [logging](/docs/app/api-reference/next-config-js/logging) is set up.
- Ensure [error handling](/docs/app/building-your-application/routing/error-handling) is set up.
- Customize your 404 (Not Found) responses using the [`notfound()`](/docs/app/api-reference/functions/not-found) function, and set up your custom error page to handle 500 (Server Error) scenarios effectively.
...
- Improve performance using:
  - [`next/image` and Automatic Image Optimization](/docs/app/building-your-application/optimizing/images)
  - [Automatic Font Optimization](/docs/app/building-your-application/optimizing/fonts)
  - [Script Optimization](/docs/app/building-your-application/optimizing/scripts)
