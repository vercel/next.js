...
Beginning from [React Testing Library 16](https://github.com/testing-library/react-testing-library/releases/tag/v16.0.0), `@testing-library/dom` is a peer dependency and needs to be explicitly installed.
