...
> **Warning:** You can test Client and _synchronous_ Server Components, however, Jest and React Testing Library currently do not support _async_ Server Components.
...
This will take you through a series of prompts to setup Jest for your project, including automatically creating a `jest.config.ts` file.
...
Run `npm run test` to run your test suite.
