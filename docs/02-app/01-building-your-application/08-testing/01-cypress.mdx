...
To get started with Cypress, install `cypress` as a dev dependency:
...
You can choose between E2E and Component tests. Selecting one of these options will automatically create a `cypress.config.js` file and a `cypress` folder.

You can look through the generated folder and the [Writing Your First Test](https://docs.cypress.io/guides/getting-started/writing-your-first-test) section of the Cypress documentation to help familiarize yourself with Cypress.
