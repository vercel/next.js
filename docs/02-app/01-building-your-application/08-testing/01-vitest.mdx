...
# or
yarn add -D vitest @vitejs/plugin-react jsdom @testing-library/react vite-tsconfig-paths
# or
pnpm install -D vitest @vitejs/plugin-react jsdom @testing-library/react vite-tsconfig-paths
# or
bun add -D vitest @vitejs/plugin-react jsdom @testing-library/react vite-tsconfig-paths
```
...
import tsconfigPaths from 'vite-tsconfig-paths' // To import tsconfig.ts `baseUrl` configurations to find modules. 
