...
If it can't be automatically migrated, the codemod will either add a typecast (if a TypeScript file) or a comment to inform the user that it needs to be manually updated.
