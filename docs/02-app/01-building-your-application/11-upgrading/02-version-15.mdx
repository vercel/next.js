...
npm i next@15.0.0-rc react@rc react-dom@rc eslint-config-next@15.0.0-rc
```

```bash filename="Terminal"
yarn add next@15.0.0-rc react@rc react-dom@rc eslint-config-next@15.0.0-rc
```

```bash filename="Terminal"
pnpm up next@15.0.0-rc react@rc react-dom@rc eslint-config-next@15.0.0-rc
```

```bash filename="Terminal"
bun add next@15.0.0-rc react@rc react-dom@rc eslint-config-next@15.0.0-rc
```
