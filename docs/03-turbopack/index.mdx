...
See the [configuration reference](/docs/turbopack/configuration) for the full option list, including [experimental options](/docs/turbopack/configuration#experimental-options) and their defaults in dev and build.
