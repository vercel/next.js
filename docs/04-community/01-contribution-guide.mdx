...
Next, open the command palette again, and search for `Markdown: Preview File` or `Markdown: Open Preview to the Side`. This will open a preview window where you can see your formatted changes. Make sure to open an MDX file of your choice to see its preview. Make sure to open an MDX file of your choice to see its preview.
