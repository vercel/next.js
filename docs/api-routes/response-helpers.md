...
- `res.unstable_revalidate(urlPath)` - [Revalidate a page on demand](/docs/basic-features/data-fetching/incremental-static-regeneration.md#testing-on-demand-isr-during-development) using `getStaticProps`. `urlPath` must be a `string`.
