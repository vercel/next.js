...
- `url` - The URL to prefetch, that is, a path with a matching page. Using this parameter you can also prefetch dynamic routes (see example bellow)
...
export default function Login() {
  ...
  useEffect(() => {
    ...
    // Prefetch a dynamic product page
