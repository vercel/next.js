...
- `query`: `Object` - The query string or [dynamic path](/docs/routing/dynamic-routes.md) parameters parsed to an object. It will be an empty object during prerendering if the page doesn't have [data fetching requirements](/docs/basic-features/data-fetching/overview.md).
