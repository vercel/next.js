...
- `width` - The desired width of the source image in pixels. Must be an integer without a unit. Required unless `layout="fill"`.
- `height` - The desired height of the source image, in pixels. Must be an integer without a unit. Required unless `layout="fill"`.
