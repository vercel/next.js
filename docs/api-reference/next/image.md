...
| Version   | Changes                                                                                               |
| --------- | ----------------------------------------------------------------------------------------------------- |
| `v12.2.0` | `unoptimized` configuration and experimental `remotePatterns` configuration added.                    |
...
This prop can be assigned to all images by configuring `next.config.js` with the following:
