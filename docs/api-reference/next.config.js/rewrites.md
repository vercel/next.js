...
Note: for static pages from the [Automatic Static Optimization](/docs/advanced-features/automatic-static-optimization.md) or [prerendering](/docs/basic-features/data-fetching/getStaticProps.md) params from rewrites will be parsed on the client after hydration and provided in the query.
