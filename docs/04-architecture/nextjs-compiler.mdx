...
Allows to remove JSX properties. This is often used for testing. Similar to [`babel-plugin-react-remove-properties`](https://www.npmjs.com/package/babel-plugin-react-remove-properties).
