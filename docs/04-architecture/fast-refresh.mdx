...
when your import doesn't match the actual filename, even when the initial import
seems to work. If your component isn't updating, check to ensure this. For instance,
if the filename is 'Header.tsx', make sure you aren't accidently importing './header', for example.
