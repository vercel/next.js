...
You can view this example in action [here](https://next-iron-session.now.sh/). Check out the [`with-iron-session`](https://github.com/vercel/next.js/tree/canary/examples/with-iron-session) example to see how it works.
