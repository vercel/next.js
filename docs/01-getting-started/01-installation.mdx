...
If you're new to Next.js, see [project structure](/docs/getting-started/project-structure) for an overview of all the possible files and folders in your application.
