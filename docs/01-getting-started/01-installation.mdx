...
source: app/a-broken-source-link
related:
  title: Next Steps
  ...
  links:
    ...
    - app/a-broken-related-link
---

[a broken hash link](#a-broken-hash-link)
[an internal link with a broken hash link](/docs/app#a-broken-hash-link)
[a broken internal link](/docs/a-broken-internal-link)
[another broken internal link](/docs/a-broken-internal-link-2)
