...
Alternatively, if you prefer to use bun for creating a Next.js application, you can do so by running:

```bash filename="Terminal"
bun create next-app
```

For this to work, you need to have bun installed on your system
