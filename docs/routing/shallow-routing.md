...
Shallow routing **only** works for URL changes in the same, current page. For example, let's assume we have another page called `pages/about.js`, and you run this:
