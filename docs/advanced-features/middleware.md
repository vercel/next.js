...
You **cannot change the response body** when using Middleware. If you need to change the response, consider using [Edge API Routes](/docs/api-routes/edge-api-routes.md)
