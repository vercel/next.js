...
To report client errors, use a service like [Sentry](https://docs.sentry.io/platforms/javascript/guides/nextjs/). Here is an example on [how to integrate Sentry SDK with Next.js](https://github.com/vercel/next.js/tree/canary/examples/with-sentry).
