---
title: Pages Router
description: Before Next.js 13, the Pages Router was the main way to create routes in Next.js with an intuitive filesystem router.
---

> You're viewing the documentation for the Pages Router. See the [App Router](/docs/app) documentation for the latest features.

The **Pages Router** uses an intuitive filesystem router to map each file to a route.
