...
- API Routes can't be used with [static exports](/docs/pages/guides/self-hosting#static-html-export). However, [Route Handlers](/docs/app/building-your-application/routing/route-handlers) in the App Router can.
