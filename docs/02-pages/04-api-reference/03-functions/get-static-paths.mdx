...
> **Good to know**: `fallback: true` is not supported when using [`output: 'export'`](/docs/pages/guides/self-hosting#static-html-export).
...
> **Good to know**: `fallback: 'blocking'` is not supported when using [`output: 'export'`](/docs/pages/guides/self-hosting#static-html-export).
