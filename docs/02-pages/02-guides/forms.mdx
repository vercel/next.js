...
Forms enable you to create and update data in web applications. Next.js provides a powerful way to handle data mutations using **API Routes**. This guide walks you through handling form submission on the server.
...
For more advanced server-side validation, you can use a schema validation library like [zod](https://zod.dev/) to validate the form fields before mutating data:
...
You can use React state to show a loading state while a form is submitting on the server:
