...
Next.js compiles CSS for its [built-in CSS support](/docs/app/getting-started/styling-and-assets/css) using PostCSS.
...
You can learn more about [Next.js' CSS Module support here](/docs/app/getting-started/styling-and-assets/css).
