...
| Value       | Description                                                                                           |
| ----------- | ----------------------------------------------------------------------------------------------------- |
| `'legacy'`  | Use the legacy decorator transform. This is the default and supports existing decorator applications. |
| `'2021-12'` | Use the December 2021 decorators proposal.                                                            |
| `'2022-03'` | Use the March 2022 decorators proposal, which reached Stage 3.                                        |

Next.js only parses decorator syntax when `experimentalDecorators` is enabled in `jsconfig.json` or `tsconfig.json`:
