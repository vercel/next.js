...
Each router's docs are organized into 3 sections:
...
The remaining sections apply to both routers:

- [Turbopack](/docs/turbopack): The default bundler, including its configuration options and the differences from webpack.
- [webpack](/docs/webpack): Using webpack instead, and the surfaces Next.js exposes for it.
- [Architecture](/docs/architecture): How Next.js works under the hood, including the compiler and the development loop.
- [Community](/docs/community): How to get involved in the Next.js community and contribute to Next.js.
