...
> **Good to know**
>
> The react and react-dom entries in your package.json primarily act as a contract for external tooling (TypeScript, testing frameworks, linters, IDEs), rather than determining the actual React version used at runtime.
>
