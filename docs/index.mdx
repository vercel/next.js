...
| [TypeScript](/docs/app/api-reference/configuration/typescript)     | Improved support for TypeScript, with better type checking and more efficient compilation, as well as custom TypeScript Plugin and type checker.                                                 |
...
To get started, check out the [Installation](/docs/appgetting-started/installation) guide.
