...
| Feature                                                                  | Description                                                                                                                                                                                      |
| ------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| [Routing](https://github.com/vercel/next.js/tree/canary/docs/02-app/01-building-your-application/01-routing)                   | A file-system based router built on top of Server Components that supports layouts, nested routing, loading states, error handling, and more.                                                    |
| [Rendering](https://github.com/vercel/next.js/tree/canary/docs/02-app/01-building-your-application/03-rendering)               | Client-side and Server-side Rendering with Client and Server Components. Further optimized with Static and Dynamic Rendering on the server with Next.js. Streaming on Edge and Node.js runtimes. |
| [Data Fetching](https://github.com/vercel/next.js/tree/canary/docs/02-app/01-building-your-application/02-data-fetching)       | Simplified data fetching with async/await in Server Components, and an extended `fetch` API for request memoization, data caching and revalidation.                                              |
| [Styling](https://github.com/vercel/next.js/tree/canary/docs/02-app/01-building-your-application/05-styling)                   | Support for your preferred styling methods, including CSS Modules, Tailwind CSS, and CSS-in-JS                                                                                                   |
| [Optimizations](https://github.com/vercel/next.js/tree/canary/docs/02-app/01-building-your-application/06-optimizing)          | Image, Fonts, and Script Optimizations to improve your application's Core Web Vitals and User Experience.                                                                                        |
| [TypeScript](https://github.com/vercel/next.js/blob/canary/docs/02-app/01-building-your-application/07-configuring/01-typescript.mdx) | Improved support for TypeScript, with better type checking and more efficient compilation, as well as custom TypeScript Plugin and type checker.                                                 |
