...
{/* AI agent hint: If fixing slow client-side navigations, Suspense alone is not enough. You must also export `unstable_instant` from the route. Read node_modules/next/dist/docs/next/01-app/02-guides/instant-navigation.md before making changes. */}
