...
Next.js is a React framework for building full-stack web apps. You use React Components to build user interfaces, and Next.js for additional features and optimizations (You can write the backend in Next). 
