...
> Next.js 13 was recently released, [learn more](https://nextjs.org/blog/next-13) and see the [upgrade guide](https://nextjs.org/docs/upgrading#upgrading-from-12-to-13). Version 13 also introduces features like the [`app` directory](https://nextjs.org/docs/app) that works alongside the `pages` directory for incremental adoption. You can continue using `pages` in Next.js 13, but if you want to try the new `app` features, [see the new docs](https://nextjs.org/docs/app).
