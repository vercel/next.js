...
Create a [`pages/_app.js` file](/docs/basic-features/custom-app.md) if not already present.
...
Due to the global nature of stylesheets, and to avoid conflicts, you may **only import them inside [`pages/_app.js`](/docs/basic-features/custom-app.md)**.
