...
- Next.js triggers a regeneration of the page in the background. (May not work depending on your OS for background handling - works when deploying on Vercel)
