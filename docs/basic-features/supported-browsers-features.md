...
In this case, you should add a top-level import for the **specific polyfill** you need in your [Custom `<App>`](/docs/basic-features/custom-app.md) or the individual component.
