...
> A file named `next-env.d.ts` will be created in the root of your project. This file ensures Next.js types are picked up by the TypeScript compiler. **You SHOULD NOT remove it nor edit it** as it can change at any time. As such this file should not be committed and should be ignored by version control.
