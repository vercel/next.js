...
> Tip: if you just want to enforce indentation, you'll probably need this 3 rules [indent](https://eslint.org/docs/latest/rules/indent), [react/jsx-indent](https://github.com/jsx-eslint/eslint-plugin-react/blob/master/docs/rules/jsx-indent.md) and [react/jsx-indent-props](https://github.com/jsx-eslint/eslint-plugin-react/blob/master/docs/rules/jsx-indent-props.md).
