...
| ✔️  | [next/no-server-modules-on-client-side](https://nextjs.org/docs/messages/no-server-modules-on-client-side) | Disallow using Node.js built in modules in client side code.                                                                 |
