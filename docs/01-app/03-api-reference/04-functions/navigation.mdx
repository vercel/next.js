...
[Cache Stages](/docs/app/glossary#cache-stages) control how much of the route each prefetch includes. With Partial Prefetching enabled, content can arrive at three points:
