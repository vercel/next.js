...
> **Good to know**: If you want to display a date formatted for the user's timezone on a **prerendered** page without making the page dynamic, see [Displaying dates and times](/docs/app/guides/displaying-dates) instead.
