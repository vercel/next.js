...
- [Dynamic APIs](/docs/app/building-your-application/rendering/server-components#dynamic-apis) cannot be called within `after`. Call them outside of `after` and use the object they returned.
