...
Next.js passes these custom metrics to the `reportWebVitals` function exported from `pages/_app.js`.
The `useReportWebVitals` hook reports only the [Web Vitals](#web-vitals) listed above.
