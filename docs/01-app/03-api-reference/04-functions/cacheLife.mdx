...
> **Good to know**: The use cache directive must either be placed at the file level or at the top of an async function or component, and cacheLife can be called within its scope.
