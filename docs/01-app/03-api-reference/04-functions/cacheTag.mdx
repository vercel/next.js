...
- Use [`updateTag`](/docs/app/api-reference/functions/updateTag) inside a Server Action for immediate expiry so the next read fetches fresh data (read-your-own-writes).
