...
> **Recommendation:** Use the [`<Link>` component](/docs/app/getting-started/linking-and-navigating#link-component) for navigation unless you have a specific requirement for using `useRouter`.
...
- `router.prefetch(href: string)`: [Prefetch](/docs/app/getting-started/linking-and-navigating#2-prefetching) the provided route for faster client-side transitions.
