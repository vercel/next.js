...
> - For [Catch-all](/docs/app/api-reference/file-conventions/dynamic-routes#catch-all-segments) routes like `[...slug]`, visiting `/blog/a/b/c` returns `'a/b/c'` as a single string, not separate segments.
