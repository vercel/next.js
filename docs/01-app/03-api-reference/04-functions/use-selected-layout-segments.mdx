...
> - For [Catch-all](/docs/app/api-reference/file-conventions/dynamic-routes#catch-all-segments) routes like `[...slug]`, visiting `/blog/a/b/c` returns `['blog', 'a/b/c']`, not `['blog', 'a', 'b', 'c']`.
