...
To start using `unauthorized`, enable the experimental [`authInterrupts`](/docs/app/api-reference/next-config-js/authInterrupts) configuration option in your `next.config.js` file:
