...
- With [Cache Components](/docs/app/getting-started/caching), where you call `headers()` in the component tree determines how much of the page can be prerendered. See [Maximizing the static shell](/docs/app/getting-started/caching#maximizing-the-static-shell).
