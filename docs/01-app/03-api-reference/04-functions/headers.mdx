...
- With [Cache Components](/docs/app/getting-started/caching), where you call `headers()` in the component tree determines how much of the page can be prerendered. See [Creating a meaningful loading experience](/docs/app/getting-started/caching#creating-a-meaningful-loading-experience).
