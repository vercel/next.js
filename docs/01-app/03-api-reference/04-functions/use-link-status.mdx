...
This applies to any pending indicator, not only a link hint. See [Spinners that flash on fast operations](/docs/app/guides/loading-ui#spinners-that-flash-on-fast-operations) for the general treatment, including holding the indicator once it becomes visible.
