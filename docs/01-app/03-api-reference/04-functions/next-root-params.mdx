...
> - Root parameters must not be under any [Route Group](/docs/app/api-reference/file-conventions/route-groups). Any Route Group that you have will not allow the compiler to generate and therefore export the params.
