...
Support for Route Handlers is planned for a future version of Next.js. In the meantime, use the [`params`](/docs/app/api-reference/file-conventions/route#context-optional) from the route context:
