...
If a URL import redirects to a different domain (for example, `https://github.com/org/repo/raw/main/file.png` redirecting to `https://raw.githubusercontent.com/...`), the redirect target domain must also be listed in the `urlImports` array:

```js filename="next.config.js"
module.exports = {
  experimental: {
    urlImports: [
      'https://github.com/org/repo/raw/main/',
