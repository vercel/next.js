...
> **Good to know:** The deployment ID protects static assets (JavaScript, CSS) and Server Functions from version mismatches. The navigation itself is not "protected" - instead, a mismatch triggers a reload to fetch the correct assets.
