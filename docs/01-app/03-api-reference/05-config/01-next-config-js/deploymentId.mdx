...
> **Good to know:** The `deploymentId` value is appended to URLs without encoding.
> Avoid characters with special meaning in URLs such as `#`, `&`, `=`, and `?`.
> A Git SHA or version string is recommended.
