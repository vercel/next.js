...
```ts filename="next.config.ts" highlight={3-5} switcher
...
```js filename="next.config.mjs" highlight={6-8} switcher
// @ts-check
...
```ts filename="next.config.ts" highlight={3-11} switcher
import type { NextConfig } from 'next'
...
```js filename="next.config.mjs" highlight={3-11} switcher
// @ts-check
...
```ts filename="next.config.ts" highlight={5-9} switcher
import type { NextConfig } from 'next'
...
```js filename="next.config.mjs" highlight={5-9} switcher
// @ts-check
import { PHASE_DEVELOPMENT_SERVER } from 'next/constants'
