...
The agent opens each draft in a separate review form. You can edit a report, remove details, close the form without sending, or select **Send feedback**. Nothing is sent when a form opens.
