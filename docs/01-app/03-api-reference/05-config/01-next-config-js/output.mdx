...
```ts filename="packages/web-app/next.config.ts" highlight={6} switcher
import type { NextConfig } from 'next'
...
```js filename="packages/web-app/next.config.mjs" highlight={8} switcher
import path from 'path'
...
```ts filename="next.config.ts" highlight={4-10} switcher
import type { NextConfig } from 'next'
...
```js filename="next.config.mjs" highlight={5-11} switcher
/**
 * @type {import('next').NextConfig}
 */
const nextConfig = {
...
```ts filename="next.config.ts" highlight={4-6} switcher
import type { NextConfig } from 'next'
...
```js filename="next.config.mjs" highlight={5-7} switcher
/**
 * @type {import('next').NextConfig}
 */
const nextConfig = {
...
```ts filename="next.config.ts" highlight={6-9} switcher
import type { NextConfig } from 'next'
import path from 'path'
...
```js filename="next.config.mjs" highlight={8-11} switcher
import path from 'path'
...
```ts filename="next.config.ts" highlight={5-6} switcher
import type { NextConfig } from 'next'
