...
Traces that use [`experimental.turbopackAdditionalRoots`](/docs/turbopack/configuration#additional-roots-experimental) also include the `additionalRoots` extension:
