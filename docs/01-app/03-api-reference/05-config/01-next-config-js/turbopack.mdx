...
For symlinked dependencies, you can instead keep the project root narrow and configure the linked locations with the experimental `turbopackAdditionalRoots` option.

### Experimental additional roots
