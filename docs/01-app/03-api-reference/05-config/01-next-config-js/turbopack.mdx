...
To configure loaders, add the names of the loaders you've installed and any options in your Next.js config file, mapping file extensions to a list of loaders. Rules are evaluated in order.
...
To configure resolve aliases, map imported patterns to their new destination in your Next.js config file:
...
To configure resolve extensions, use the `resolveExtensions` field in your Next.js config file:
