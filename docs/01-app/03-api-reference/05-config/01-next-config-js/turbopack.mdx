...
```ts filename="next.config.ts" highlight={5-7} switcher
...
```js filename="next.config.mjs" highlight={7-9} switcher
import path from 'path'
...
```ts filename="next.config.ts" highlight={5-10} switcher
import type { NextConfig } from 'next'
...
```js filename="next.config.mjs" highlight={6-11} switcher
/**
 * @type {import('next').NextConfig}
 */
const nextConfig = {
...
```ts filename="next.config.ts" highlight={5-17} switcher
import type { NextConfig } from 'next'
...
```js filename="next.config.mjs" highlight={6-18} switcher
/**
 * @type {import('next').NextConfig}
 */
const nextConfig = {
...
```ts filename="next.config.ts" highlight={5-8} switcher
import type { NextConfig } from 'next'
...
```js filename="next.config.mjs" highlight={6-9} switcher
/**
 * @type {import('next').NextConfig}
 */
const nextConfig = {
