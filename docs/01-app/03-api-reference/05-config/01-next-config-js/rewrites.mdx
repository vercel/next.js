...
```ts filename="next.config.ts" highlight={4-11} switcher
...
```js filename="next.config.mjs" highlight={5-12} switcher
/**
...
```ts filename="next.config.ts" highlight={4-33} switcher
import type { NextConfig } from 'next'
...
```js filename="next.config.mjs" highlight={5-34} switcher
/**
 * @type {import('next').NextConfig}
 */
const nextConfig = {
...
```ts filename="next.config.ts" highlight={4-14} switcher
import type { NextConfig } from 'next'
...
```js filename="next.config.mjs" highlight={5-15} switcher
/**
 * @type {import('next').NextConfig}
 */
const nextConfig = {
...
```ts filename="next.config.ts" highlight={4-77} switcher
import type { NextConfig } from 'next'
...
```js filename="next.config.mjs" highlight={5-68} switcher
/**
 * @type {import('next').NextConfig}
 */
const nextConfig = {
...
```ts filename="next.config.ts" highlight={5-16} switcher
import type { NextConfig } from 'next'
...
```ts filename="next.config.ts" highlight={4-40} switcher
import type { NextConfig } from 'next'
...
```js filename="next.config.mjs" highlight={5-41} switcher
/**
 * @type {import('next').NextConfig}
 */
const nextConfig = {
