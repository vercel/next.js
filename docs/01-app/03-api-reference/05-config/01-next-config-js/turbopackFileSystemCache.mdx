...
const nextConfig: NextConfig = {
  experimental: {
    ...
    // Optional: cap filesystem cache size (bytes)
    turbopackFileSystemCacheMaxSize: 12 * 1024 * 1024 * 1024, // 12GB
  },
}
...
When `experimental.turbopackFileSystemCacheMaxSize` is set and the cache grows beyond this limit, Next.js invalidates and cleans the Turbopack filesystem cache during startup before continuing.
