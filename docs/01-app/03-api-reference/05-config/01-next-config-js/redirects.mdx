...
```ts filename="next.config.ts" highlight={4-12} switcher
...
```js filename="next.config.mjs" highlight={5-13} switcher
/**
...
```ts filename="next.config.ts" highlight={4-13} switcher
import type { NextConfig } from 'next'
...
```js filename="next.config.mjs" highlight={5-14} switcher
/**
 * @type {import('next').NextConfig}
 */
const nextConfig = {
...
```ts filename="next.config.ts" highlight={4-82} switcher
import type { NextConfig } from 'next'
...
```js filename="next.config.mjs" highlight={4-81} switcher
/** @type {import('next').NextConfig} */
const nextConfig = {
  async redirects() {
    return [
...
```ts filename="next.config.ts" highlight={4-21} switcher
import type { NextConfig } from 'next'
...
```js filename="next.config.mjs" highlight={5-22} switcher
/**
 * @type {import('next').NextConfig}
 */
const nextConfig = {
...
```ts filename="next.config.ts" highlight={4-32} switcher
import type { NextConfig } from 'next'
...
```js filename="next.config.mjs" highlight={5-32} switcher
/**
 * @type {import('next').NextConfig}
 */
const nextConfig = {
...
```ts filename="next.config.ts" highlight={4-45} switcher
import type { NextConfig } from 'next'
...
```js filename="next.config.mjs" highlight={5-46} switcher
/**
 * @type {import('next').NextConfig}
 */
const nextConfig = {
