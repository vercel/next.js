...
When implementing redirects with internationalization in the App Router, handle locales using [dynamic route segments and middleware](/docs/app/guides/internationalization). This means you must include the locale directly in your redirect paths:
