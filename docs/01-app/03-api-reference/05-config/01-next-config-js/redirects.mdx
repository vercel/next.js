...
When implementing redirects with internationalization in the App Router, you handle locales through [dynamic route segments and middleware](/docs/app/guides/internationalization). This means you need to include locale information directly in your redirect paths:
