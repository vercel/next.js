...
behavior, tweak the raw size thresholds it uses, and enable component chunks.
...
Component chunks provide the initial page load benefits of merged chunks without
sacrificing reusability. This feature lets the runtime dynamically choose whether to
load a merged chunk as a single file, or to
