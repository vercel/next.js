...
If you want to use a cloud provider to optimize images instead of using the Next.js built-in Image Optimization API, you can configure your Next.js config file with the following:
...
```js filename="my/image/loader.mjs"
'use client'
...
```js filename="my/image/loader.mjs" switcher
// Docs: https://techdocs.akamai.com/ivm/reference/test-images-on-demand
