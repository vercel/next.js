...
Cache Components is the default caching model in Next.js. When enabled, data fetching is dynamic by default and you opt specific pages, components, or functions into caching with [`use cache`](/docs/app/api-reference/directives/use-cache).
