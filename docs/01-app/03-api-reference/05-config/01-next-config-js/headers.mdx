...
```ts filename="next.config.ts" highlight={4-20} switcher
...
```js filename="next.config.mjs" highlight={5-21} switcher
/**
...
```ts filename="next.config.ts" highlight={4-25} switcher
import type { NextConfig } from 'next'
...
```js filename="next.config.mjs" highlight={5-26} switcher
/**
 * @type {import('next').NextConfig}
 */
const nextConfig = {
...
```ts filename="next.config.ts" highlight={4-16} switcher
import type { NextConfig } from 'next'
...
```js filename="next.config.mjs" highlight={5-17} switcher
/**
 * @type {import('next').NextConfig}
 */
const nextConfig = {
...
```ts filename="next.config.ts" highlight={4-17} switcher
import type { NextConfig } from 'next'
...
```js filename="next.config.mjs" highlight={5-18} switcher
/**
 * @type {import('next').NextConfig}
 */
const nextConfig = {
...
```ts filename="next.config.ts" highlight={4-102} switcher
import type { NextConfig } from 'next'
...
```js filename="next.config.mjs" highlight={5-103} switcher
/**
 * @type {import('next').NextConfig}
 */
const nextConfig = {
...
```ts filename="next.config.ts" highlight={4-28} switcher
import type { NextConfig } from 'next'
...
```js filename="next.config.mjs" highlight={7-29} switcher
/**
 * @type {import('next').NextConfig}
 */
const nextConfig = {
...
```ts filename="next.config.ts" highlight={4-54} switcher
import type { NextConfig } from 'next'
...
```js filename="next.config.mjs" highlight={5-55} switcher
/**
 * @type {import('next').NextConfig}
 */
const nextConfig = {
