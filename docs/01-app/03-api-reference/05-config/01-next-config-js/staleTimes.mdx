...
> - This doesn't change [back/forward caching](/docs/app/api-reference/config/next-config-js/staleTimes) behavior to prevent layout shift and to prevent losing the browser scroll position.
