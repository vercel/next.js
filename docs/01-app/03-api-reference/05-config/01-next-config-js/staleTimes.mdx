...
> - Individual pages and layouts can override these global defaults using [`export const unstable_staleTime`](/docs/app/api-reference/file-conventions/route-segment-config#unstable_staletime).
