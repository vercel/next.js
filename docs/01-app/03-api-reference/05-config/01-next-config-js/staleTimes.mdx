...
> - Individual pages and layouts can override these global defaults using [`export const staleTime`](/docs/app/api-reference/file-conventions/route-segment-config#staletime).
