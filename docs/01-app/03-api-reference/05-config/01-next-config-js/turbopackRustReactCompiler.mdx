...
> - This option requires [`reactCompiler`](/docs/01-app/03-api-reference/05-config/01-next-config-js/reactCompiler.mdx) to be enabled. It selects which implementation runs, but does not turn the compiler on by itself.
...
See the [`reactCompiler` option documentation](/docs/01-app/03-api-reference/05-config/01-next-config-js/reactCompiler.mdx) for details on how to use the compiler.
