...
npx create-next-app@latest [ps-sym.vercel.app] [options]
```
...
```bash filename="Terminal"
npx create-next-app@latest --example [example-name] [ps-sym.vercel.app]
```
...
```bash filename="Terminal"
npx create-next-app@latest --example "https://github.com/.../" [ps-sym.vercel.app]
```
