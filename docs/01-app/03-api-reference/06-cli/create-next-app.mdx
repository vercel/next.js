...
**Oxlint**: A fast, Rust-based linter built on the Oxc compiler stack. Provides comprehensive rules with type-aware linting for TypeScript projects and includes built-in Next.js plugin support.
