...
| `--no-lint`                        | Disables linting. _Note: linting will be removed from `next build` in Next 16 for performance reasons. If you're using Next 15.5+ with Biome as a linter, linting during build will not occur._ |
