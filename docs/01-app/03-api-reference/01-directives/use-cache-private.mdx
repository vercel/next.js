...
- You can't extract runtime values outside the cached scope and [pass them as arguments](/docs/app/getting-started/cache-components#with-runtime-data) to a regular `use cache` function
