...
To use `'use cache: private'`, enable the [`cacheComponents`](/docs/app/api-reference/config/next-config-js/cacheComponents) experimental flag in your `next.config.ts` file:
...
| Version   | Changes                                                       |
| --------- | ------------------------------------------------------------- |
| `v15.1.0` | `'use cache: private'` introduced as an experimental feature. |
