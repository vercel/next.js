...
Turbopack will follow JS import order to order [CSS modules](/docs/app/getting-started/styling-and-assets/css#css-modules) which are not otherwise ordered. For example:
