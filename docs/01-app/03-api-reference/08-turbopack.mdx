...
| **`import.meta.glob`** | **Supported**       | Vite-compatible glob imports. [See below.](#importmetaglob)                                                                                                     |
...
| `query`  | `string`  | `undefined` | Query string to append to each import (e.g. `'?raw'`, `'?url'`).       |
