...
| `turbopackWorkerPublicPath`                                                                                  | Custom URL prefix for Web Worker entrypoints and their module chunks, overriding `assetPrefix`. Mirrors webpack's `output.workerPublicPath`. | `undefined`   | `undefined`                   |
