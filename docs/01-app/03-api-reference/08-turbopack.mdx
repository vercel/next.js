...
| **Less**           | Planned via plugins     | Not yet supported by default. Will likely require a loader config once custom loader support is available.                                                                                                                                                                                                                                                            |
...
Additionally, the following Turbopack options are available under `experimental` in `next.config.js`:
...
| `turbopackModuleFragments`                                                                                   | Split modules into fragments so chunks only import the used fragments of the modules.                                                                                                                                            | `false`       | `false`                       |
...
| `v15.5.0` | Turbopack support for `build` expanded                                                                             |
| `v15.3.0` | Turbopack support for `build` introduced                                                                           |
