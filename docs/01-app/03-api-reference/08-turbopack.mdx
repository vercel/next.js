...
| [`turbopackFileSystemCacheMaxSize`](/docs/app/api-reference/config/next-config-js/turbopackFileSystemCache)  | Maximum filesystem cache size in bytes before startup invalidation and cleanup.        | `undefined`   | `undefined`                   |
