...
Next.js comes with built-in TypeScript, installing the necessary packages and configuring the proper settings when you create a new project with `create-next-app`.
...
### Type checking `next.config.js|ts`
