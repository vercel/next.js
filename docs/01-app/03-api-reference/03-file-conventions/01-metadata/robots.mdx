...
> **Good to know**: `robots.js` is a special Route Handler that is cached by default unless it uses a [Runtime API](/docs/app/glossary#runtime-apis) or [dynamic config](/docs/app/api-reference/file-conventions/route-segment-config) option.
