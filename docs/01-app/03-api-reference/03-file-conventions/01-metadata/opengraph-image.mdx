...
This example uses the Node.js runtime to fetch a local image on the file system and convert it to a Base64 data URL string for the `src` attribute of an `<img>` element. The local asset should be placed relative to the root of your project, rather than the location of the example source file.
...
| Version   | Changes                                                                                                         |
| --------- | --------------------------------------------------------------------------------------------------------------- |
| `v15.x`   | Updated Node.js runtime with local assets example for Next.js 15+ to type-check out of the box with TypeScript. |
