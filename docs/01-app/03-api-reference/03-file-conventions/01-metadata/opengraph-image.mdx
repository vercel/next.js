...
> **Good to know**:
>
> - By default, generated images are [**statically optimized**](/docs/app/glossary#prerendering) (generated at build time and cached) unless they use [Runtime APIs](/docs/app/glossary#runtime-apis) or uncached data.
...
> - `opengraph-image.js` and `twitter-image.js` are special Route Handlers that is cached by default unless it uses a [Runtime API](/docs/app/glossary#runtime-apis) or [dynamic config](/docs/app/api-reference/file-conventions/route-segment-config) option.
