...
The asset doesn't depend on request data, so read it once at module scope. See [Predictable values](/docs/app/getting-started/rendering-model#predictable-values).
