...
> **Good to know**:
>
> - By default, generated icons are [**statically optimized**](/docs/app/glossary#prerendering) (generated at build time and cached) unless they use [Runtime APIs](/docs/app/glossary#runtime-apis) or uncached data.
...
> - App icons are special Route Handlers that are cached by default unless they use a [Runtime API](/docs/app/glossary#runtime-apis) or [dynamic config](/docs/app/api-reference/file-conventions/route-segment-config) option.
