...
> - Inside a [route group](/docs/app/api-reference/file-conventions/route-groups) or a [parallel route](/docs/app/api-reference/file-conventions/parallel-routes), Next.js adds a [suffix to the icon URL](/docs/app/api-reference/file-conventions/metadata#route-groups-and-parallel-routes).
