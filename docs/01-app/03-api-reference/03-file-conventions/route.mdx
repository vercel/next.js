...
### Agent endpoint precedence (experimental)

When `experimental.agentRoutes` is enabled, explicit routes still take
precedence over internal agent endpoint fallback behavior.
