...
Set the client-side router cache staleness time for a page. This controls how long prefetched data remains fresh before the client refetches it. This option is only supported on page segments, not layouts.
