...
> **Good to know**:
>
> - Even when `_next/data` is excluded in a negative matcher pattern, middleware will still be invoked for `_next/data` routes. This is intentional behavior to prevent accidental security issues where you might protect a page but forget to protect the corresponding data route.
>
> ```js filename="middleware.js"
> export const config = {
>   matcher:
...
> };
>
> // Middleware will still run for /_next/data/* routes despite being excluded
> ```
