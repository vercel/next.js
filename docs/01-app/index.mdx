...
You can set cookies in [Server Actions](/docs/app/building-your-application/data-fetching/server-actions-and-mutations#cookies) or [Route Handlers](/docs/app/api-reference/file-conventions/route) using the [`cookies`](/docs/app/api-reference/functions/cookies) function.
