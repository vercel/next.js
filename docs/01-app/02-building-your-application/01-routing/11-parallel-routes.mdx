...
- [**Soft Navigation**](/docs/app/getting-started/linking-and-navigating#5-soft-navigation): During client-side navigation, Next.js will perform a [partial render](/docs/app/getting-started/linking-and-navigating#4-partial-rendering), changing the subpage within the slot, while maintaining the other slot's active subpages, even if they don't match the current URL.
...
Within `@analytics`, create a [`layout`](/docs/app/getting-started/layouts-and-pages) file to share the tabs between the two pages:
