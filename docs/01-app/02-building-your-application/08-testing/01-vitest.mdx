...
deno install -D vitest @vitejs/plugin-react jsdom @testing-library/react @testing-library/dom vite-tsconfig-paths
# Using JavaScript
npm install -D vitest @vitejs/plugin-react jsdom @testing-library/react @testing-library/dom
deno add -D vitest @vitejs/plugin-react jsdom @testing-library/react @testing-library/dom
```
