...
[Next.js docs](/docs/app/api-reference/configuration/typescript#ide-plugin).
...
- [Update your ESLint configuration to support Next.js rules](/docs/app/api-reference/configuration/eslint)
