...
First, make sure you're on the latest version of Next.js and everything is working as expected. See the [upgrade guides](/docs/app/building-your-application/upgrading) for more information.

Then, to upgrade to `canary`, run the following command:
