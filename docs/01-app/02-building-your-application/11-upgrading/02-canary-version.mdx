...
To upgrade to canary, run the following command:
...
> **Good to know**: If you're not running on the latest version of Next.js, you may need to upgrade first. See the [upgrade guides](/docs/app/building-your-application/upgrading) for more information.
