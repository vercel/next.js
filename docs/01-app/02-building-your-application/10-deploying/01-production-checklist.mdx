...
- **TypeScript and [TS Plugin](/docs/app/api-reference/configuration/typescript):** Use TypeScript and the TypeScript plugin for better type-safety, and to help you catch errors early.
