...
- If it's a [unique page](/docs/app/getting-started/layouts-and-pages), it is preloaded on the unique route for that page.
- If it's a [layout](/docs/app/getting-started/layouts-and-pages#layouts), it is preloaded on all the routes wrapped by the layout.
- If it's the [root layout](/docs/app/getting-started/layouts-and-pages#root-layout-required), it is preloaded on all routes.
