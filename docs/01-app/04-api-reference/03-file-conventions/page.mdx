...
- `searchParams` is a **[Dynamic API](/docs/app/getting-started/caching-and-revalidating#dynamic-apis)** whose values cannot be known ahead of time. Using it will opt the page into **[dynamic rendering](/docs/app/getting-started/caching-and-revalidating#dynamic-routes)** at request time.
