...
On the **server**, the cache entries of individual components or functions will be cached in-memory for the lifetime of the server or serverless function.
...
> In future, Next.js will support storing function cache entries in a persistent cache.
