...
Usually you don't have to worry about this, most of the bots will be handled by Next.js automatically.
...
> **Note:** Next.js includes [a default list of HTML limited bots](https://github.com/vercel/next.js/blob/canary/packages/next/src/shared/lib/router/utils/html-bots.ts), listed below:
