...
`htmlLimitedBots` config will override the default list of HTML-limited bots of Next.js, which allows you opt-out any default ones and add new ones flexibly.
...
> **Note:** The default html bots list is:
