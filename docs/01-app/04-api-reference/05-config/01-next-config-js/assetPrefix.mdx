...
> **Attention**: [Deploying to Vercel](/docs/app/guides/self-hosting) automatically configures a global CDN for your Next.js project.
...
> **Attention**: [Deploying to Vercel](/docs/pages/guides/self-hosting) automatically configures a global CDN for your Next.js project.
> You do not need to manually setup an Asset Prefix.
