...
[`next export`](/docs/app/guides/self-hosting#static-html-exports) will use `out` as the default output directory, you can customize this using the `-o` argument, like so:
