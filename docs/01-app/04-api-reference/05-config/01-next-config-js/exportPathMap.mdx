...
[`next export`](/docs/app/guides/self-hosting#static-html-export) will use `out` as the default output directory, you can customize this using the `-o` argument, like so:

</AppOnly>

<PagesOnly>

[`next export`](/docs/pages/guides/self-hosting#static-html-export) will use `out` as the default output directory, you can customize this using the `-o` argument, like so:
