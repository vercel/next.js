...
[`next export`](/docs/pages/guides/self-hosting/static-exports) will use `out` as the default output directory, you can customize this using the `-o` argument, like so:
