...
Som content, such as user-specific information (based on `cookies`), is _cacheable_ but not practical to prerender at build time or store in a persistent server cache.
