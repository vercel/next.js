...
Next.js provides automatic image optimization to improveloading performance and user experience. In this deep dive, you'll learn how image optimization works in Next.js.

## The Image Component

The Next.js `<Image />` component extends the HTML `<img>` element with built-in best practices for optimizing images.
