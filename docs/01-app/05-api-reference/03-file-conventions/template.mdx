...
Templates are similar to [layouts](/docs/app/api-reference/file-conventions/layout) in that they wrap a child page. However, unlike layouts that persist across routes and maintain state, **templates and their children remount on navigation**.
