...
> **Good to know**:
>
> - By default, generated icons are [**statically optimized**](/docs/app/getting-started/partial-prerendering#static-rendering-default) (generated at build time and cached) unless they use [Dynamic APIs](/docs/app/getting-started/server-and-client-components#server-rendering-strategies#dynamic-apis) or uncached data.
