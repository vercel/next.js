...
> **Good to know**:
>
> - By default, generated images are [**statically optimized**](/docs/app/getting-started/caching-and-revalidating#static-rendering) (generated at build time and cached) unless they use [Dynamic APIs](/docs/app/getting-started/caching-and-revalidating#dynamic-apis) or uncached data.
