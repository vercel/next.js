...
- `searchParams` is a **[Dynamic API](/docs/app/getting-started/server-and-client-components#dynamic-apis)** whose values cannot be known ahead of time. Using it will opt the page into **[dynamic rendering](/docs/app/getting-started/server-and-client-components#dynamic-rendering)** at request time.
