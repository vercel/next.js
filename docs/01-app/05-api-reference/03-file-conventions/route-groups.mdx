...
Route Groups are a folder convention that let you organize routes by concern or team.
...
- Defining multiple [root layouts](/docs/app/api-reference/file-conventions/layout#root-layouts).
- Opting specific route segments into a sharing a layout, while keeping others out.
