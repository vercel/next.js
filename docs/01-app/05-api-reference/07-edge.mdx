...
- The **Edge Runtime** which contains a more limited [set of APIs](/docs/app/api-reference/edge), used in [Middleware](/docs/app/api-reference/file-conventions/middleware).
...
The Next.js Edge Runtime supports the following APIs:
