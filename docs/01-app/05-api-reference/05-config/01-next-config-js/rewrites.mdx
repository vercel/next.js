...
> **Good to know**: The `useSearchParams` hook won't work in rewrites because the URL doesn't change. To access query parameters, you should use the `searchParams` prop passed to the page. See the [`page` documentation](/docs/app/api-reference/file-conventions/page) for more information.
