...
> **Good to know**: The useSearchParams hook won't work in this case because the URL doesn't change. To access query parameters, you should use the searchParams argument provided to the page. For more details about page arguments, see the [page documentation](/docs/app/api-reference/file-conventions/page).
