...
> **Good to know:**
>
> - Changing the `staleTimes` value will also update the `stale` property of the [`default` cache profile](/docs/app/api-reference/functions/cacheLife#default-cache-profiles).
