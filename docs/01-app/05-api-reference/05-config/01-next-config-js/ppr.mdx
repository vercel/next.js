...
related:
  ...
  links:
    - /docs/app/getting-started/partial-prerendering
---

Partial Prerendering (PPR) enables you to combine static and dynamic components together in the same route. Learn more about [PPR](/docs//docs/app/getting-started/partial-prerendering).
