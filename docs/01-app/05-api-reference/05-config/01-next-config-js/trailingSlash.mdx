...
When used with [`output: "export"`](/docs/app/guides/self-hosting#static-html-export) configuration, the `/about` page will output `/about/index.html` (instead of the default `/about.html`).
