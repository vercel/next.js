...
For optimal SEO with internationalized content, use the [Metadata API](/docs/app/api-reference/functions/generate-metadata#alternates) to add `hreflang` tags indicating alternate language versions:
