...
Antivirus software can slow down file access. While this is more common on Windows machines, we recommend this for any system with an antivirus tool installed.
...
1. Open the _"Windows Security"_ application and then select _"Virus & threat protection"_ &rarr; _"Manage settings"_ &rarr; _"Add or remove exclusions"_.
2. Add a _"Folder"_ exclusion. Select your project folder.
...
2. Open the _"System Settings"_ app and then select _"Privacy & Security"_ &rarr; _"Developer Tools"_.
