...
> **Good to know:** This guide assumes [Cache Components](/docs/app/getting-started/cache-components) is enabled. Enable it by setting [`cacheComponents: true`](/docs/app/api-reference/config/next-config-js/cacheComponents) in your Next config file.
