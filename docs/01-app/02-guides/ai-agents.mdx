...
When you install `next`, React and Next.js documentation is bundled at `node_modules/next/dist/docs/`:

```txt
node_modules/next/dist/docs/
├── react/                     # React API reference
│   ├── useActionState.md
│   ├── useState.md
│   ├── useEffect.md
│   └── ...
...
- **React reference** (`dist/docs/react/`) — API reference for React hooks like `useActionState`, `useState`, `useEffect`, and others. Helps agents use modern React patterns instead of outdated ones.
- **Next.js guides and API reference** (`dist/docs/next/`) — Guides, API references, and file conventions for the App Router and Pages Router.
