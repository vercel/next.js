...
Next.js makes the bundled documentation discoverable through managed instructions in `AGENTS.md` or `CLAUDE.md` at the project root. Coding agents such as Claude Code, Codex, Cursor, and GitHub Copilot read these files when they start a session.
