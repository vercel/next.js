...
To use plugins with [Turbopack](/docs/turbopack), upgrade to the latest `@next/mdx` and specify plugin names using a string:
...
> **Good to know**:
>
> remark and rehype plugins without serializable options cannot be used yet with [Turbopack](/docs/turbopack), because JavaScript functions can't be passed to Rust.
