...
> **Good to know**: If you want to return Markdown from a rendered route instead of compiling MDX to HTML, see [Markdown output](/docs/app/guides/markdown-output).

</AppOnly>

<PagesOnly>

> **Good to know**: If you want to return Markdown from a rendered route instead of compiling MDX to HTML, see [Markdown output](/docs/pages/guides/markdown-output).
