...
- [Handling expected errors](/docs//docs/app/getting-started/error-handling#handling-expected-errors-from-server-actions)
- [Handling unexpected exceptions](/docs//docs/app/getting-started/error-handling#uncaught-exceptions)
