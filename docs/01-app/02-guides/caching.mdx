...
- The fetched data is stored in the Data Cache and the rendered output is stored in the Full Route Cache. Next.js serves this cached result until the path is revalidated." or similar clearer phrasing.
