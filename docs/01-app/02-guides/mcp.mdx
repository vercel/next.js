...
Agent action:
- Uses next-devtools-mcp to analyze your current version
- Guides you through automated migrations with codemods
- Provides step-by-step instructions for breaking changes

User: "When should I use 'use client' in App Router?"

Agent action:
- Queries the Next.js knowledge base via next-devtools-mcp
- Provides documentation-backed explanations
- Shows examples from your current codebase
```
