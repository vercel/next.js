...
Review your organization's recommended approach to sanitize, serialize, or escape potentially dangerous strings, or search fo community maintained alternatives to `JSON.stringify` such as, [serialize-javascript](https://www.npmjs.com/package/serialize-javascript).
