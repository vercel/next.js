...
For the loading reveals themselves, such as sizing skeletons, choosing Suspense boundary granularity, and animating the swap to real content, see [Designing loading UI](/docs/app/guides/loading-ui).
...
- [Designing loading UI](/docs/app/guides/loading-ui) for sizing fallbacks and ordering their reveals
