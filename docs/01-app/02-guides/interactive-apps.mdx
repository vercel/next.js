...
Before adding Client Components, [review the imports and props crossing the server and client boundary](/docs/app/guides/server-and-client-boundary#adding-interactivity-to-an-existing-component) to keep database code and private data on the server.
