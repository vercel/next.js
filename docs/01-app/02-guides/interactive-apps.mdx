...
This guide shows how to coordinate that pending work in a task management board called _Taskboard_. It assumes [Cache Components](/docs/app/api-reference/config/next-config-js/cacheComponents) mode is enabled.
