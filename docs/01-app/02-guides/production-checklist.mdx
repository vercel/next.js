...
- **[Tainting](/docs/app/getting-started/fetching-data#tainting-data):** Prevent sensitive data from being exposed to the client by tainting data objects and/or specific values.
