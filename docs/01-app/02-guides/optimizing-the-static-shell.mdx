...
Use [`instant()`](/docs/app/guides/instant-navigation#prevent-regressions-with-e2e-tests) to assert which parts of the page are available immediately and prevent future regressions.
