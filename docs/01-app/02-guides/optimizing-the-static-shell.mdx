...
Use [`instant()`](/docs/app/guides/instant-navigation#prevent-regressions-with-e2e-tests) to assert which parts of the page are available immediately, and keep the test to prevent future regressions. The testing guide explains how to set it up for development and production builds.
