...
> **Good to know**: If you need to display locale-aware dates or times on a prerendered page without a visible flash, see [Displaying dates and times](/docs/app/guides/displaying-dates).
