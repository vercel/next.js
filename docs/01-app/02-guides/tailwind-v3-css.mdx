...
[Tailwind CSS v3](https://v3.tailwindcss.com/) provides broader browser support and uses the traditional JavaScript configuration approach. This guide will walk you through how to install Tailwind CSS v3 in your Next.js application.
