...
Suspense queries work well when the request starts after a client interaction. If the initial server render needs the data, provide it from a Server Component as shown below.
