...
If you want to style Server Components, we recommend using [CSS Modules](/docs/app/getting-started/css) or other solutions that output CSS files, like PostCSS or [Tailwind CSS](/docs/app/guides/tailwind-css).
