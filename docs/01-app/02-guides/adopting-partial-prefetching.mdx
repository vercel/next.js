...
2. Adopt the destinations and rerun the tests without changing the assertions. For missing UI, cache only the data or rendered subtree needed to restore it.
