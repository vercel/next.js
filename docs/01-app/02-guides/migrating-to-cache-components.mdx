...
**Not supported.** The Edge Runtime is [deprecated](/docs/messages/edge-runtime-deprecated) and Cache Components requires the Node.js runtime. Remove the `runtime = 'edge'` export from your route files.
