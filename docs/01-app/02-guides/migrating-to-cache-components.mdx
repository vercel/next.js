...
In the legend, **`◐`** marks a static prerendered shell with dynamic content streamed on the request. See [Building](/docs/app/guides/building) for the full `next build` output reference.
