...
If parts of your route depend on cookies or headers and you want those to be part of the shell too, see [Runtime prefetching](/docs/app/guides/runtime-prefetching) for the optimization story.
