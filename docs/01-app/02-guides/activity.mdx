---
title: How to use the Activity component
nav_title: Activity
description: Learn how Activity preserves React and DOM state across hide/show cycles, enabling patterns like tabs, collapsible panels, and prerendering.
related:
  title: Related
