...
> - Learn more about the [caching behavior of optimized images](/docs/app/deep-dive/image-optimization#caching-and-revalidating-images) and how to configure the TTL.
