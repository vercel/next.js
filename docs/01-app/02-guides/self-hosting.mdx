...
> - Learn more about the [caching behavior of optimized images](/docs/app/deep-dives/image-optimization#caching-and-revalidating-images) and how to configure the TTL.
