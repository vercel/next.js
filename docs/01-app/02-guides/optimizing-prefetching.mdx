...
You can reduce prefetch work by excluding subtrees that are expensive to produce. [Cache Stages](/docs/app/glossary#cache-stages) control how much of a route each prefetch includes.
