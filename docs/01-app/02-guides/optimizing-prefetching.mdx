...
You can reduce prefetch work by excluding subtrees that are expensive to produce. [Navigation stages](/docs/app/glossary#navigation-stages) control how much of a route each prefetch includes.
