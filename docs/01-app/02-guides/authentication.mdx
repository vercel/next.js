...
Client Components cannot import the DAL. Pass session or user data from a Server parent when you can, or use providers and client hooks as in [Context Providers](#context-providers).
