...
To share session or user data with [Client Components](/docs/app/getting-started/server-and-client-components), follow [Sharing data with context and `React.cache`](/docs/app/getting-started/fetching-data#sharing-data-with-context-and-reactcache) in [Fetching Data](/docs/app/getting-started/fetching-data). For auth providers and client-side fetching, see [Context Providers](#context-providers).
