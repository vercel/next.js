...
Next.js also supports generating a fully [static site](/docs/app/guides/self-hosting#static-html-export). This has some advantages over strict SPAs:
...
> **Note:** Next.js server features are not supported with static exports. [Learn more](/docs/app/guides/self-hosting#static-html-export#unsupported-features).
