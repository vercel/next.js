...
> - If you don't use private folders, it would be helpful to know Next.js [special file conventions](/docs/app/guides/project-structure#routing-files) to prevent unexpected naming conflicts.
