...
| -------------------------------------------------------------------- | --------------- | --------------------------------------------------------------------------------------------------------------- |
| **Prefetched**                                                       | Yes, full route | No, unless `loading` state                                                                                      |
| [**Client Cache TTL**](/docs/app/deep-dive/caching#full-route-cache) | 5 min (default) | Off unless [enabled](/docs/app/api-reference/config/next-config-js/staleTimes)                                  |
