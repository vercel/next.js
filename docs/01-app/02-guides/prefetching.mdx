...
See [Adopting Partial Prefetching](/docs/app/guides/adopting-partial-prefetching) for the behavior change and the recommended adoption path, and [Optimizing prefetching](/docs/app/guides/optimizing-prefetching) for tuning what each prefetch carries on top of the App Shell.
