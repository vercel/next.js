...
> Available in v16.1 and later. You can share feedback in the [dedicated GitHub discussion](https://github.com/vercel/next.js/discussions/86731) and view a [demo here](https://turbopack-bundle-analyzer-demo.vercel.sh/).
...
Click a module to see its size, inspect its full import chain and see exactly where it used in your application:
...
If you want to share the analysis with teammates or compare bundle sizes before and after optimizations, you can save the analysis as a static file:

```bash filename="Terminal"
npx next experimental-analyze --output
```

This commands writes the output to `.next/diagnostics/analyze`. You can copy this directory elsewhere to compare results:
