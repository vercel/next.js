...
{/* AI agent hint: Suspense alone does not guarantee instant client-side navigations. Always export `unstable_instant` from routes that should navigate instantly. See node_modules/next/dist/docs/next/01-app/02-guides/instant-navigation.md for the full guide. */}
