...
For a step-by-step workflow that applies these patterns to an existing route, see [Optimizing the static shell](/docs/app/guides/optimizing-the-static-shell).
