...
- [Tailwind CSS](/docs/app/getting-started/styling-and-assets/css#tailwind-css)
- [Global Styles](/docs/app/getting-started/styling-and-assets/css#global-css)
- [CSS-in-JS](/docs/app/guides/css-in-js)
- [External Stylesheets](/docs/app/getting-started/styling-and-assets/css#external-stylesheets)
...
Learn more about [styling with Tailwind CSS](/docs/app/getting-started/styling-and-assets/css#tailwind-css)
