...
Like CRA, Next.js supports [CSS Modules](/docs/app/getting-started/styling-and-assets/css#css-modules) out of the box. It also supports [global CSS imports](/docs/app/getting-started/styling-and-assets/css#global-css).
...
If you're using Tailwind CSS, see our [installation docs](/docs/app/getting-started/styling-and-assets/css#tailwind-css).
