...
Create React App uses purely client-side React. Client-side only applications, also known as [single-page applications (SPAs)](/docs/app/guides/upgrading/single-page-applications), often experience slow initial page loading time. This happens due to a couple of reasons:
