...
directive. Client Components are still [prerendered to HTML](/docs/app/getting-started/server-and-client-components-in-nextjs) on the server before being sent to the client.
