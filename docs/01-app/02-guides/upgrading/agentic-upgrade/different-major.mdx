...
For `latest`, the CLI pins npm's `canary` dist-tag for canary installations.
Stable, RC, beta, and numbered preview installations use the stable `latest`
dist-tag when it is newer than the installed version.
