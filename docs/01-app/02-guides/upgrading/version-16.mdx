...
Before editing code, set up version-matched Next.js docs for this project. Use the [AI Coding Agents guide](/docs/app/guides/ai-agents) for the full setup. If AGENTS.md is missing or doesn't point at version-matched docs, run `npx @next/codemod@canary agents-md`, then read AGENTS.md.
