...
Add the following configuration to your MCP client, for each coding agent you could read [this section](https://github.com/vercel/next-devtools-mcp#mcp-client-configuration) for configuration details.

**example:**

In `.mcp.json` under your Next.js project:
