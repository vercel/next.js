...
Then read AGENTS.md and follow the [Next.js 16 upgrade guide](/docs/app/guides/upgrading/version-16) as the source of truth for the migration. Use the codemod steps in [Or upgrade manually](/docs/app/guides/upgrading/version-16#or-upgrade-manually) when you're ready to run the mechanical upgrade.
