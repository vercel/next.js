...
Other fixes include caching the component with [`'use cache'`](/docs/app/api-reference/directives/use-cache) or adding [`generateStaticParams`](/docs/app/api-reference/functions/generate-static-params) to provide known params.
