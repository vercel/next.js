...
> **Good to know**: This behavior is available from Next.js 16.3. Earlier versions wait for a full server render before sending the response for unlisted params.
