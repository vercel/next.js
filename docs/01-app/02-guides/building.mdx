...
Add a [`loading.js`](/docs/app/api-reference/file-conventions/loading) to fix this. The loading fallback gives Next.js a meaningful shell to serve immediately while the page content streams in:
