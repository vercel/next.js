...
3. **Compilation.** Bundles client, server, and edge code with [Turbopack](/docs/turbopack) (or webpack). Transpiles TypeScript and JSX, tree-shakes unused code, and optimizes CSS and fonts. Type checking runs in parallel.
