...
- [Migrating from Create React App](/docs/app/guides/upgrading/from-create-react-app)
- [Migrating from Vite](/docs/app/guides/upgrading/from-vite)

If you are already using a SPA with the Pages Router, you can learn how to [incrementally adopt the App Router](/docs/app/guides/upgrading/app-router-migration).
