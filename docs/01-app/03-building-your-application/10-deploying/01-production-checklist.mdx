...
- **[Static Rendering](/docs/app/getting-started/caching-and-revalidating#static-routes-default):** Next.js statically renders Server and Client Components on the server at build time and caches the rendered result to improve your application's performance. You can opt into [Dynamic Rendering](/docs/app/getting-started/caching-and-revalidating#dynamic-routes) for specific routes, where appropriate. {/* TODO: Update when PPR is stable */}
