...
- **[Prefetching](/docs/app/building-your-application/routing/linking-and-navigating#2-prefetching):** Next.js prefetches the route in background based on its prefetch strategy (i.e. prefetches when it enters the user's viewport). This makes navigation to new routes almost instant. You can opt out of prefetching, where appropriate.
