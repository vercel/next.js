...
> **Good to know:** We don't recommend relying on encryption alone to prevent sensitive values from being exposed on the client. Instead, you should use the [React taint APIs](/docs/app/getting-started/fetching-data#tainting-data) to proactively prevent specific data from being sent to the client.
