...
- Server Actions integrate with the Next.js [caching and revalidation](/docs/app/guides/caching) architecture. When an action is invoked, Next.js can return both the updated UI and new data in a single server roundtrip.
...
You can revalidate the [Next.js Cache](/docs/app/guides/caching) inside your Server Actions with the [`revalidatePath`](/docs/app/api-reference/functions/revalidatePath) API:
