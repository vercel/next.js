...
When an error is thrown, it'll be caught by the nearest `error.js` or `<Suspense>` boundary on the client. See [Error Handling](/docs//docs/app/getting-started/error-handling) for more information.
