...
The Edge Runtime is the default runtime for [Middleware](/docs/app/building-your-application/routing/middleware). However, this can be changed to the Node.js runtime. See the [Middleware documentation](/docs/app/building-your-application/routing/middleware#using-nodejs-runtime-with-middleware) for more details.
