...
In practice, this model encourages developers to first determine what should execute on the server, then send those results to the client for interactivity.
