...
Consider if you really need them for local development. You can optionally only include certain tools for production builds, or explore moving to Turbopack and using [loaders](/docs/app/api-reference/next-config-js/turbo#webpack-loaders).
...
[Learn more about the experimental option](/docs/app/api-reference/next-config-js/serverComponentsHmrCache).
