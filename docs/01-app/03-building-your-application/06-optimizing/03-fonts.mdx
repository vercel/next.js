...
- If it's a [layout](/docs/app/api-reference/file-convetions/layout), it is preloaded on all the routes wrapped by the layout.
- If it's the [root layout](/docs/app/api-reference/file-convetions/layout#root-layouts), it is preloaded on all routes.
