...
### Using Node.js runtime with middleware

The Node.js runtime can be used as an experimental feature to run middleware. To enable, add the flag to your `next.config.js` file:
...
| Version   | Changes                                                                                       |
| --------- | --------------------------------------------------------------------------------------------- |
| `v15.2.0` | Middleware can now use the Node.js runtime. See the [middleware documentation](/docs/app/building-your-application/routing/middleware#using-nodejs-runtime-with-middleware) for more details. |
