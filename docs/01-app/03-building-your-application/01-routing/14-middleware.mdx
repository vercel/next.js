...
1. `rewrite` to a route ([Page](/docs/app/api-reference/file-conventions/pages) or [Route Handler](/docs/app/building-your-application/routing/route-handlers)) that produces a response
