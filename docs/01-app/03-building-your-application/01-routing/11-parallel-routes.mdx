...
<Image
  alt="Parallel Routes Filesystem Structure"
...
> **Good to know:**
>
> - The convention used to intercept the route, e.g. `(.)`, depends on your filesystem structure. See [Intercepting Routes convention](/docs/app/building-your-application/routing/intercepting-routes#convention).
