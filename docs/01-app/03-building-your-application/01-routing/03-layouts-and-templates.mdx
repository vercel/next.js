...
> - You can use [Route Groups](/docs/app/api-reference/file-conventions/route-groups) to opt specific route segments in and out of shared layouts.
> - You can use [Route Groups](/docs/app/api-reference/file-conventions/route-groups) to create multiple root layouts. See an [example here](/docs/app/getting-started/project-structure#creating-multiple-root-layouts).
