...
Next.js uses the server and the client environments for caching. This page describes how you can cache and define the lifetime of routes, components, and functions. As well as how to [stream](#optimizing-dynamic-routes-with-streaming) dynamic content.
