...
Some UI patterns behave differently when components stay mounted instead of unmounting. See the [Activity guide](/docs/app/guides/activity) for patterns on handling state reset, testing, and other Activity behaviors.
