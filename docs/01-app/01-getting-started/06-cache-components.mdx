...
Because all operations in the `Page` component below complete during prerendering, its rendered output is automatically included in the static shell. When both the layout and page prerender successfully, the entire route is the static shell.
