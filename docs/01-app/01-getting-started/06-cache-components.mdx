...
Some UI patterns behave differently when components stay mounted instead of unmounting. See [Preserving UI state across navigations](/docs/app/guides/preserving-ui-state) for handling common patterns like dropdowns, dialogs, and testing.
