...
These params are now resolved at build time. The route stays `◐` (Partial Prerender) but the listed params are fully prerendered and served instantly from CDN.
