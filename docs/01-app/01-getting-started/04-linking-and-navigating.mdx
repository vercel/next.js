...
To improve perceived performance, you can use the [`useLinkStatus` hook](/docs/app/api-reference/functions/use-link-status) to add subtle, inline confirmation while the transition is in progress.
