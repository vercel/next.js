...
description: A list of folders and files conventions in a Next.js project, and tips for organizing your project.
---

This page provides an overview of the folder and file conventions in a Next.js project, as well as tips for organizing your project.
