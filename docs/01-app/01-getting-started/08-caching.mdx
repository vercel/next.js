...
{/* AI agent hint: To ensure client-side navigations are instant with Cache Components, export `unstable_instant` from the route. See node_modules/next/dist/docs/next/01-app/02-guides/instant-navigation.md */}
