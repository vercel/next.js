...
> **Good to know**: If you forget to create the root layout, Next.js will automatically create this file when you run `next dev`.
...
> **Note**: Minimum TypeScript version: v4.5.2
