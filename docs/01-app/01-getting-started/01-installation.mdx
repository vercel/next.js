---
title: How to setup a Next.js application
nav_title: Installation
description: Learn how to create a new Next.js application with `create-next-app`, and set up TypeScript and ESLint.
---
...
> **Good to know**: You can optionally use a [`src` directory](/docs/app/building-your-application/configuring/src-directory) in the root of your project to separate your application's code from configuration files.
...
See the [ESLint configuration](/docs/app/api-reference/next-config-js/eslint) page for more information on how to configure ESLint in your project.
