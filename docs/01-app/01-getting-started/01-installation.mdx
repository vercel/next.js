...
> **Good to know**: Starting with Next.js 16, linting no longer runs automatically during `next build`. You now control when linting runs by invoking your linter through npm scripts.
