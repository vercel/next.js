...
Select the type of app you are building:
  ...
  starters={[
    {
      id: 'blog',
      title: 'Blog',
      tagline: 'Content read by everyone, updated occasionally',
      bestFor: ['Blogs', 'Documentation', 'Marketing sites', 'Portfolios'],
      profile: [
        'Reads are cached and tagged, and pages prerender to static shells.',
        'Post pages prerender for all known slugs with generateStaticParams.',
        'Mutations invalidate by tag with updateTag, so authors see changes immediately.',
      ],
      command:
        'npx create-next-app@latest --example https://github.com/vercel/next.js/tree/canary/starters/blog my-blog',
      href: 'https://github.com/vercel/next.js/tree/canary/starters/blog',
    },
    {
      id: 'store',
      title: 'Store',
      tagline: 'A shared catalog with a per-visitor cart',
      bestFor: ['Ecommerce', 'Product catalogs', 'Booking sites'],
      profile: [
        'The catalog is cached and shared between all visitors.',
        'The cart reads cookies per request and streams into the static shell.',
        'Product pages prerender while the cart and checkout stay dynamic.',
      ],
      command:
        'npx create-next-app@latest --example https://github.com/vercel/next.js/tree/canary/starters/store my-store',
      href: 'https://github.com/vercel/next.js/tree/canary/starters/store',
    },
    {
      id: 'dashboard',
      title: 'Dashboard',
      tagline: 'Authenticated, per-user data on each request',
      bestFor: ['SaaS apps', 'Admin panels', 'Internal tools', 'Feeds'],
      profile: [
        'A data access layer verifies the session before each per-user read.',
        'Dashboard sections stream in parallel, each behind its own Suspense boundary.',
        'Shared reference data is cached, and per-user data never is.',
      ],
      command:
        'npx create-next-app@latest --example https://github.com/vercel/next.js/tree/canary/starters/dashboard my-dashboard',
      href: 'https://github.com/vercel/next.js/tree/canary/starters/dashboard',
    },
    {
      id: 'chat',
      title: 'Chat',
      tagline: 'Streaming responses, fully dynamic',
      bestFor: ['AI chatbots', 'Assistants', 'Real-time tools'],
      profile: [
        'Responses stream token by token from a Route Handler.',
        'The app shell prerenders, and each conversation renders per request.',
        'A stand-in model stream shows where to plug in the AI SDK.',
      ],
      command:
        'npx create-next-app@latest --example https://github.com/vercel/next.js/tree/canary/starters/chat my-chat',
      href: 'https://github.com/vercel/next.js/tree/canary/starters/chat',
    },
  ]}
/>
