...
> **Good to know:** Get the most out of your local setup with the [development environment guide](/docs/app/guides/local-development). It covers antivirus exclusions, file watcher limits, and IDE configuration.
