...
Then, run `npm run build` to [build your application](/docs/app/guides/building) and subsequently `npm run start` to start the Node.js server. This server supports all Next.js features. If needed, you can also eject to a [custom server](/docs/app/guides/custom-server).
...
- [Vercel](https://vercel.com/templates/next.js)
