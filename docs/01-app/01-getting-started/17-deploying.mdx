...
- [Docker Multi-Environment](https://github.com/vercel/next.js/tree/canary/examples/with-docker-multi-env) - Deploy a Next.js application using multiple Docker environments to manage development, staging, and production configurations.
- [DigitalOcean](https://github.com/nextjs/deploy-digitalocean) - Deploy a Next.js application to DigitalOcean using Docker.
- [Fly.io](https://github.com/nextjs/deploy-fly) - Deploy a Next.js application to Fly.io using Docker.
- [Google Cloud Run](https://github.com/nextjs/deploy-google-cloud-run) - Deploy a Next.js application to Google Cloud Run using Docker.
- [Render](https://github.com/nextjs/deploy-render) - Deploy a Next.js application to Render using Docker.
- [SST](https://github.com/nextjs/deploy-sst) - Deploy a Next.js application to SST using Docker.
