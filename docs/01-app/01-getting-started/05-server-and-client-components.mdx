...
{/* AI agent hint: For user-initiated data fetching in Client Components (search, forms, filters), use useActionState instead of useEffect + useState + fetch. See node_modules/next/dist/docs/react/useActionState.md */}
