...
> **Good to know:** For the mental model behind these two component types, what runs where and why, see [The Server and Client Boundary](/docs/app/guides/server-and-client-boundary).
