...
You can use React's [`use` hook](https://react.dev/reference/react/use) to [stream](/app/getting-started/caching-and-revalidating#streaming) data from the server to client. Start by fetching data in your Server component, and pass the promise to your Client Component as prop:
