...
- [Stream data](/docs/app/getting-started/fetching-data#streaming-data-with-the-use-hook) from a Server Component to a Client Component with the [`use` Hook](https://react.dev/reference/react/use).
