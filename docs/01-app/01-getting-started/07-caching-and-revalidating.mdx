...
Next.js leverages both the server and client environments for caching.
...
- On the client, the cached content from the server is temporarily stored to reduce the number of server requests on navigation.
