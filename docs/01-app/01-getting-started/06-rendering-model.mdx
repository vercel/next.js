...
related:
  title: Next Steps
  description: Learn more about regeneration, navigation performance, and the APIs mentioned on this page.
  links:
...
Next.js requires you to explicitly handle components that can't complete during prerendering. It surfaces a validation insight in the dev overlay and dev server console that names the route and points at the fixes:
...
This validation keeps every route producing a static shell, so direct navigations stay instant.
...
See [Validate instant navigation](/docs/app/guides/instant-navigation#validate-instant-navigation) for the navigations it simulates and how to change which segments it covers.
