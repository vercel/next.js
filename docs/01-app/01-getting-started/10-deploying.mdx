...
The easiest way to deploy your Next.js app is using a managed platform — these providers handle hosting, scaling, and server configuration for you.
...
Other managed platforms that support Next.js include:
...
Self-hosting means you're responsible for provisioning your own servers, managing containers, and scaling. You can self-host Next.js in three different ways:
