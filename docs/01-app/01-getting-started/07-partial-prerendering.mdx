...
related:
  ...
  links:
    - app/api-reference/next-config-js/ppr
---
...
Components only opt into dynamic rendering when the value is accessed. For example, if you are reading `searchParams` from a `page`, you can forward this value to another component as a prop:
