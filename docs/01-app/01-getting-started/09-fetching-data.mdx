...
#### Deduping data requests

If multiple Server Components need the same data, you don’t need to [lift state](https://react.dev/learn/sharing-state-between-components) or use [React Context](https://react.dev/learn/passing-data-deeply-with-context). Instead, you can fetch data between each component and
