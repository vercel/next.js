...
related:
  links:
    - app/api-reference/next-config-js/sassOptions
...
Learn more about the `sassOptions` configuration in the [API Reference](/docs/app/api-reference/configuration/next-config-js/sassOptions).
