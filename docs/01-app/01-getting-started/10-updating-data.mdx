...
A Server Function is an asynchronous function, which can be executed server side, when requested by a client.
...
> **Good to know**: As of September 2024, the React team started to use the term, Server Functions. Initially these were called Server Actions.
