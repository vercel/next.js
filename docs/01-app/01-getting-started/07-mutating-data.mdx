...
You can mutate data in Next.js using React's [Server Functions](https://react.dev/reference/rsc/server-functions). Learn how to [create](#create-server-functions) and [invoke](#invoke-server-functions) Server Functions.
