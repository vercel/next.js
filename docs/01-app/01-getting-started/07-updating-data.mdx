...
In Next.js, Server Actions integrate with the framework's [caching](/docs/app/getting-started/caching-and-revalidating) architecture. When an action is invoked, Next.js can return both the updated UI and new data in a single server roundtrip.
