...
Middleware lets you run code on incoming requests and generate responses. However, Next.js does not support intercepting outgoing responses natively.

Some hosting providers extend Next.js to support this, but it’s not built-in.
