...
- [`rewrites`](/app/api-reference/config/next-config-js/rewrites) in `next.config.js`.
...
Learn more about redirects in [`redirect`](/app/api-reference/functions/redirect) and [`permanentRedirect`](/app/api-reference/functions/permanentRedirect)
