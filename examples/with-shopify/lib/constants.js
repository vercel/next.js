export const EXAMPLE_PATH = 'with-shopify'
export const CMS_NAME = 'Shopify'
export const CMS_URL = 'https://www.shopify.com/'
...
// Used for the fallback page, when shop data is not available
