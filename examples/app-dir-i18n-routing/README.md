...
```bash
npx create-next-app --example app-dir-i18n-routing app-dir-i18n-routing-app
```

```bash
yarn create next-app --example app-dir-i18n-routing app-dir-i18n-routing-app
```

```bash
pnpm create next-app --example app-dir-i18n-routing app-dir-i18n-routing-app
```

```bash
bunx create-next-app --example app-dir-i18n-routing app-dir-i18n-routing-app
```
