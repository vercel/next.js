      ...
      <div className="max-w-3xl w-full bg-white p-8 rounded-lg shadow-md border border-gray-300 overflow-y-auto h-[90vh]">
        <div className="max-w-3xl bg-white p-8 rounded-lg shadow-md border border-gray-300">
          ...
          <div className="mt-6">
            ...
            <p className="text-gray-700 mt-2">Create a new Prisma Postgres database instance:</p>
          ...
          <div className="mt-6">
            ...
            <p className="text-gray-700 mt-2">
              ...
              in your Netlify account. Next, you need to copy Prisma&apos;s integration token into
              the extension in your Neltify Dashboard:
            </p>
            <ol className="list-decimal pl-6 mt-2 space-y-1 text-gray-700">
              <li>
                In the{" "}
                ...
                , navigate to the root of your Workspace and click the <strong>Integrations</strong>{" "}
                tab in the left-hand sidenav.
              </li>
              <li>
              ...
              <li>
                Copy the generated token, you now need to add it to the team-level extension
                configuration in your Netlify account as described in the next step.
              </li>
              <li>
                In your Netlify account, click the <strong>Extensions</strong> tab in the left-hand
                sidenav and navigate to the installed <strong>Prisma Postgres</strong> extension.
                Then find the text field for the <strong>Integration token</strong>, paste the token
                from the previous step into it and click <strong>Save</strong>.
              </li>
            </ol>
          </div>
          ...
          <div className="mt-6">
            ...
            <p className="text-gray-700 mt-2">
              In this step, you will connect your Netlify site with the Prisma Postgres instance you
              just created:
            </p>
            <ol className="list-decimal pl-6 mt-2 space-y-1 text-gray-700">
              <li>
                In your Netlify Dashboard, click on the <strong>Sites</strong> item in the left-hand
                sidenav and click on the site that was deployed with this template.
              </li>
              <li>
              ...
              <li>
                Find the <strong>Project</strong> dropdown and select the one project created in{" "}
                <strong>Step 1</strong> before.
              </li>
              <li>
                ...
                <strong>Save</strong>. (At this stage, you can theoretically connect different
                database instances to the different environments in Netlify. For the purpose of this
                demo, we are just connecting both environments to the <strong>Development</strong>{" "}
                database in Prisma Console).
              </li>
            </ol>
          </div>
          ...
          <div className="mt-6">
            ...
            <p className="text-gray-700 mt-2">
              Your site is now fully configured to load data from the Prisma Postgres database you
              just created, the last thing you need to do is re-deploy the site via the Netlify
              Dashboard.
            </p>
            <ol className="list-decimal pl-6 mt-2 space-y-1 text-gray-700">
              <li>
            ...
            <p className="text-gray-700 mt-2">
              {" "}
              Once the deployment is ready, you can click on <strong>
                Open production deploy
              </strong>{" "}
              and use the app by creating users and posts via the UI 🎉
            </p>
          </div>
        </div>
      </div>
