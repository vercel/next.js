        ...
        <div className="max-w-3xl bg-white p-8 rounded-lg shadow-md border border-gray-300">
          ...
          <div className="mt-6">
            ...
            <p className="text-gray-700 mt-2">
              ...
              in your Netlify account. Next, you need to copy Prisma&apos;s integration token into the extension in your Neltify Dashboard:
            </p>
            <ol className="list-decimal pl-6 mt-2 space-y-1 text-gray-700">
              <li>
                In the{" "}
                ...
                , navigate to the root of your Workspace and click the <strong>Integrations</strong> tab in the left-hand sidenav.
              </li>
              <li>
          ...
          <div className="mt-6">
            ...
            <p className="text-gray-700 mt-2">
              {" "}
              Once the deployment is ready, you can click on <strong>Open production deploy</strong> and use the app by creating users and posts via the UI 🎉
            </p>
          </div>
        </div>
      </div>
