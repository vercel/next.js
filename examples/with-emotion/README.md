...
```bash
npx create-next-app --example with-emotion with-emotion-swc-app
```

```bash
yarn create next-app --example with-emotion with-emotion-swc-app
```

```bash
pnpm create next-app --example with-emotion with-emotion-swc-app
```
