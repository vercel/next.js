...
```bash
npx create-next-app --example with-temporal with-temporal-app
```

```bash
yarn create next-app --example with-temporal with-temporal-app
```

```bash
pnpm create next-app --example with-temporal with-temporal-app
```

```bash
bunx create-next-app --example with-temporal with-temporal-app
```
