  ...
  return (
    <div className="prose prose-sm prose-invert max-w-none">
      ...
      <ul>
        <li>
          <code>
            <Link href="https://nextjs.org/docs/api-reference/file-conventions/not-found">
              not-found.js
            </Link>
          </code>{' '}
          file is used to render UI when the{' '}
          <code>
            <Link href="https://nextjs.org/docs/api-reference/notfound">
              notFound()
            </Link>
          </code>{' '}
      ...
      <div className="flex gap-2">
        <ExternalLink href="https://nextjs.org/docs/api-reference/file-conventions/not-found">
          Docs
        </ExternalLink>
