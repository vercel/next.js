...
```bash
npx create-next-app --example simple-blog-starter-with-markdown blog-starter-app
# or
yarn create next-app --example simple-blog-starter-with-markdown  blog-starter-app
```
