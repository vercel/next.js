...
exports.default = {
  errors: api => ({
    ...
    unknownAction: data =>
      data.connection.localize("actionhero.errors.unknownAction"),
    ...
    serverShuttingDown: data =>
      data.connection.localize("actionhero.errors.serverShuttingDown"),
    ...
    tooManyPendingActions: data =>
      data.connection.localize("actionhero.errors.tooManyPendingActions"),

    dataLengthTooLarge: (maxLength, receivedLength) =>
      api.i18n.localize([
        "actionhero.errors.dataLengthTooLarge",
        { maxLength, receivedLength }
      ]),
    ...
    fileNotFound: connection =>
      connection.localize(["actionhero.errors.fileNotFound"]),

    // user didn't request a file
    fileNotProvided: connection =>
      connection.localize("actionhero.errors.fileNotProvided"),
    ...
    verbNotFound: (connection, verb) =>
      connection.localize(["actionhero.errors.verbNotFound", { verb }]),

    verbNotAllowed: (connection, verb) =>
      connection.localize(["actionhero.errors.verbNotAllowed", { verb }]),

    connectionRoomAndMessage: connection =>
      connection.localize("actionhero.errors.connectionRoomAndMessage"),

    connectionNotInRoom: (connection, room) =>
      connection.localize(["actionhero.errors.connectionNotInRoom", { room }]),
    ...
    connectionRoomHasBeenDeleted: room =>
      api.i18n.localize("actionhero.errors.connectionRoomHasBeenDeleted"),

    connectionRoomNotExist: room =>
      api.i18n.localize("actionhero.errors.connectionRoomNotExist"),

    connectionRoomExists: room =>
      api.i18n.localize("actionhero.errors.connectionRoomExists"),

    connectionRoomRequired: room =>
      api.i18n.localize("actionhero.errors.connectionRoomRequired")
  })
};
