...
> [!WARNING]
> `WP_USER` and `WP_APP_PASS` are critical for making preview and redirection work
...
> [!NOTE]
> Running `npm run dev` will automatically generate typings from the WordPress installation found on the URL provided in your environment variable: `NEXT_PUBLIC_WORDPRESS_API_URL`
