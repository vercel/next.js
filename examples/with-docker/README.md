...
Or just click the button below, authorize the script, then select the project and region when prompted it will run Next.js on Google Cloud Run with Google Cloud Shell:
