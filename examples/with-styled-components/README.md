...
This example uses the Rust-based [SWC](https://nextjs.org/docs/architecture/nextjs-compiler#styled-components) in Next.js for better performance than Babel.
