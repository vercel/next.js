...
First, create a Prismic account and repository and connect it to your app with the following command:
...
2. Create a new Prismic content repository with content models.
