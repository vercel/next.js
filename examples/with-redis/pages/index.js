      ...
      <main>
        ...
        <div className='grid'>
          ...
          {loaded ? items.map((item, ind) => (
            ...
            : <div className='card'><img src="/loader.gif" /></div>}

          <div className='card'>
            <form onSubmit={handleNewFeature}>
              <input type='text' className='noborder' ref={inputNewFeature}
          ...
          <div className='card'>
            <form onSubmit={handleNewEmail}>
              <input type='text' className='noborder' ref={inputEmail}
