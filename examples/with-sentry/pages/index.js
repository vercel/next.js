...
const Index = () => (
  <div style={{ maxWidth: 700, margin: '0 auto' }}>
    ...
    <ol>
      ...
      <ol>
        <li>
          getSSRSideProps throws an Error. This should cause _error.js to render
          and record Error('SSR Test 1') in Sentry.{' '}
          <a href="/ssr/test1" target="_blank">
            Open in a new tab
          </a>
        </li>
        <li>
          getSSRSideProps returns a Promise that rejects. This should cause
        ...
        <li>
          getSSRSideProps calls a Promise that rejects, but does not handle the
          rejection or await its result (returning synchronously). Sentry should
          record Error('SSR Test 3').{' '}
