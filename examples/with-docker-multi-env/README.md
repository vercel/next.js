...
```bash
npx create-next-app --example with-docker-multi-env nextjs-docker-multi-env-app
```

```bash
yarn create next-app --example with-docker-multi-env nextjs-docker-multi-env-app
```

```bash
pnpm create next-app --example with-docker-multi-env nextjs-docker-multi-env-app
```

```bash
bunx create-next-app --example with-docker-multi-env nextjs-docker-multi-env-app
```
