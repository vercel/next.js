...
export default function TiptapEditor() {
	...
	return (
		<div className="max-w-4xl mx-auto">
			<h1 className="mt-8 text-5xl font-black text-blue-400 mb-28"><a className="underline" href="https://nextjs.org">Nextjs</a> + <a className="underline" href="https://tiptap.dev">Tiptap</a> WYSIWYG editor.</h1>
