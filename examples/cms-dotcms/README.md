...
This example showcases Next.js's [Static Generation](https://nextjs.org/docs/pages/building-your-application/routing/pages-and-layouts) feature using [dotCMS](https://dotcms.com/) as the data source.
