...
const ToDo = ({content, isCompleted, onChange, onDelete}) => {
  ...
  <div className={styles[cards[Math.floor(Math.random() * cards.length)]]}>
    ...
    <div className={styles.reverseWrapper}>
      <input type="checkbox" className={styles.check} checked={isCompleted} onChange={onChange} />
  ...
  return (
    <div className={styles.container}>
      ...
      <header className={styles.header}>
        <h2>
        <a href="https://www.deta.sh">deta base</a> + <a href="https://nextjs.org">next.js</a> to dos
          </h2>
      </header>
        ...
        <div className={styles.incomplete}>
          <div className={styles.firstRow}>
              ...
              <div className={styles.reverseWrapper}>
                ...
                <button className={styles.addBtn} onClick={createToDo}>&#10011;</button>
              </div>
          </div>
