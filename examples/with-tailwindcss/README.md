...
This is a [Next.js](https://nextjs.org/) project bootstrapped with [`create-next-app`](https://github.com/vercel/next.js/tree/canary/packages/create-next-app) and [Tailwind CSS](https://tailwindcss.com/docs/guides/nextjs) pre-configured.
...
### Addtional Cleanup
If you want to clear all the default styles, follow these steps:
Go to your `styles/globals.css` file and replace everything with this
