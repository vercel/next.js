...
function HomePage() {
  ...
  return (
    <section className="body">
      <h3>Home page</h3>
      <div>
        On this page we use the <code>useVisitorData</code> hook with default settings and identification is performed
        as soon as the page loads. This is the most common use-case.
      </div>
      <Toggler>
