...
To use TypeScript, simply follow [TypeScript setup](https://nextjs.org/docs/app/api-reference/config/typescript) as normal (package.json scripts are already set).
