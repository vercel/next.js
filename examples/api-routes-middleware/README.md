...
Next.js ships with [API routes](https://github.com/vercel/next.js#api-routes), which provide a solution to build your own `API`. This example shows how to implement `middleware` to wrap around your `API` endpoints.
