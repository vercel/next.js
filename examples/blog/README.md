...
```bash
npx create-next-app --example blog blog-app
```

```bash
yarn create next-app --example blog blog-app
```

```bash
pnpm create next-app --example blog blog-app
```

```bash
bunx create-next-app --example blog blog-app
```
