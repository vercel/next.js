...
const Code = ({ children }: { children: React.ReactNode }) => (
  <code className="text-mono text-sm bg-red-500/10 px-1 py-0.5 rounded-sm">{children}</code>
);
  ...
  return (
    <>
      ...
      <p className="mb-4">
        ...
        , this page is easily sharable on social and has an <Code>og:image</Code> thumbnail
        generated by Mux. Try clicking the Twitter button below to share:
      </p>
      ...
      <Script strategy="lazyOnload" async src="https://platform.twitter.com/widgets.js" />
      <p>
        To learn more,{" "}
        <Link
