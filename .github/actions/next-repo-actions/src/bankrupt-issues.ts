...
We are in the process of closing issues dating back to 2019 to improve our focus on the most relevant and actionable problems.
...
Issues from 2019 are likely to be outdated and less relevant to the current state of the codebase. By closing these older stale issues, we can better focus our efforts on more recent and relevant problems, ensuring a more effective and streamlined workflow.
...
The Next.js Team
  ...
  try {
    const { data } = await octokit.rest.search.issuesAndPullRequests({
      q: `repo:${owner}/${repo} is:issue is:open created:2019-01-01..2019-12-31`,
    })
