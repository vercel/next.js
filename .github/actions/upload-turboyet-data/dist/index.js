...
;(function (root, factory) {
	if (true) {
		// CommonJS
		module.exports = exports = factory(__nccwpck_require__(180));
	}
	else {}
...
var _redis = __nccwpck_require__(104);
var _kv = null;
...
const { createClient } = __nccwpck_require__(505)
