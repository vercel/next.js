...
export async function $$ACTION_0($$ACTION_CLOSURE_BOUND, e) {
  var [$$ACTION_ARG_0, $$ACTION_ARG_1, $$ACTION_ARG_2, $$ACTION_ARG_3] =
...
export async function $$ACTION_1($$ACTION_CLOSURE_BOUND, e) {
  var [$$ACTION_ARG_0, $$ACTION_ARG_1, $$ACTION_ARG_2] =
    await decryptActionBoundArgs(
...
export async function $$ACTION_2($$ACTION_CLOSURE_BOUND, d) {
  ...
  var action2 = registerServerReference(
    '6d53ce510b2e36499b8f56038817b9bad86cabb4',
    $$ACTION_0
  ).bind(
    null,
...
ensureServerEntryExports([action0])
