...
export function Item1(product, foo, bar) {
  const a = registerServerReference(
    '6d53ce510b2e36499b8f56038817b9bad86cabb4',
    $$ACTION_0
  ).bind(
    null,
...
export async function $$ACTION_0($$ACTION_CLOSURE_BOUND) {
  ...
  await deleteFromDb(
    $$ACTION_ARG_3.id,
    $$ACTION_ARG_3?.foo,
    $$ACTION_ARG_3.bar.baz,
    $$ACTION_ARG_3[($$ACTION_ARG_4, $$ACTION_ARG_5)]
  )
}
export function Item2(product, foo, bar) {
  var deleteItem2 = registerServerReference(
    '188d5d945750dc32e2c842b93c75a65763d4a922',
    $$ACTION_1
  ).bind(
    null,
...
export function Item3(product, foo, bar) {
  const deleteItem3 = registerServerReference(
    '56a859f462d35a297c46a1bbd1e6a9058c104ab8',
    $$ACTION_3
  ).bind(
    null,
    encryptActionBoundArgs('56a859f462d35a297c46a1bbd1e6a9058c104ab8', [
      product.id,
      product?.foo,
      product.bar.baz,
      product,
...
export function Item4(product, foo, bar) {
  const deleteItem4 = registerServerReference(
