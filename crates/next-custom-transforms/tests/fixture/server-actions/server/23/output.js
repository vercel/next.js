...
export default function Page({ foo, x, y }) {
  var action = registerServerReference(
    '6d53ce510b2e36499b8f56038817b9bad86cabb4',
    $$ACTION_0
  ).bind(
    null,
    encryptActionBoundArgs('6d53ce510b2e36499b8f56038817b9bad86cabb4', [x])
  )
  action.bind(null, foo[0], foo[1], foo.x, foo[y])
  const action2 = registerServerReference(
    '188d5d945750dc32e2c842b93c75a65763d4a922',
    $$ACTION_1
  ).bind(
    null,
    encryptActionBoundArgs('188d5d945750dc32e2c842b93c75a65763d4a922', [x])
  )
  action2.bind(null, foo[0], foo[1], foo.x, foo[y])
}
export async function $$ACTION_0($$ACTION_CLOSURE_BOUND, a, b, c, d) {
  var [$$ACTION_ARG_0] = await decryptActionBoundArgs(
    '6d53ce510b2e36499b8f56038817b9bad86cabb4',
