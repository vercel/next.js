...
var foo = registerServerReference(
...
export { foo }
export var bar = registerServerReference(
...
export default registerServerReference(
...
export const qux = registerServerReference(
...
export const quux = registerServerReference(
