...
export var $$RSC_SERVER_CACHE_0 = $$cache__("default", "803128060c414d59f8552e4788b846c0d2b7f74743", 0, $$RSC_SERVER_CACHE_0_INNER, function getCachedData(invoke) {
    return invoke([]);
});
...
export var $$RSC_SERVER_CACHE_1 = $$cache__("default", "80951c375b4a6a6e89d67b743ec5808127cfde405d", 0, $$RSC_SERVER_CACHE_1_INNER, function staticallyKnownFunction(invoke) {
    return invoke([]);
});
...
if (typeof getData === "function") {
    $$RSC_SERVER_CACHE_getData = $$cache__("default", "ff8fa22f08e492db15701f58a1458cc4ebf782f855", 0, getData, function(invoke) {
...
if (typeof aliased === "function") {
    $$RSC_SERVER_CACHE_aliased = $$cache__("default", "ff27fadf3eeb97c777cea9f14a407b5c0b42ac65bb", 0, aliased, function(invoke) {
        return invoke(Array.prototype.slice.call(arguments, 1));
    });
...
if (typeof Sync === "function") {
    $$RSC_SERVER_CACHE_Sync = $$cache__("default", "ff84effee663e5ce4e0948b55df129a8df904c67aa", 0, Sync, function(invoke) {
        return invoke(Array.prototype.slice.call(arguments, 1));
    });
...
if (typeof wrapped === "function") {
    $$RSC_SERVER_CACHE_wrapped = $$cache__("default", "ff438bb59117ff1af890c80ca3e39d9e888fc93033", 0, wrapped, function(invoke) {
        return invoke(Array.prototype.slice.call(arguments, 1));
    });
...
if (typeof Layout === "function") {
    $$RSC_SERVER_CACHE_default = $$cache__("default", "ffc18c215a6b7cdc64bf709f3a714ffdef1bf9651d", 0, Layout, function(invoke) {
        return invoke(Array.prototype.slice.call(arguments, 1));
    });
...
if (typeof Other === "function") {
    $$RSC_SERVER_CACHE_Other = $$cache__("default", "ff1acff246876a467753785a92d1f95ac6fe32c9b9", 0, Other, function(invoke) {
        return invoke(Array.prototype.slice.call(arguments, 1));
    });
...
if (typeof getStuff === "function") {
    $$RSC_SERVER_CACHE_getStuff = $$cache__("default", "ff980f8c891ae27674b86a4804d306bdb3065c2e4f", 0, getStuff, function(invoke) {
        return invoke(Array.prototype.slice.call(arguments, 1));
    });
