...
export const $$RSC_SERVER_ACTION_0 = async function /*#__TURBOPACK_DISABLE_EXPORT_MERGING__*/ foo() {
    console.log(1);
};
...
export const $$RSC_SERVER_ACTION_2 = async function /*#__TURBOPACK_DISABLE_EXPORT_MERGING__*/ baz() {
    console.log(3);
};
...
export const $$RSC_SERVER_ACTION_4 = async function /*#__TURBOPACK_DISABLE_EXPORT_MERGING__*/ quuux() {
    console.log(5);
};
