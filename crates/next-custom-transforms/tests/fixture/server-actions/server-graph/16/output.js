...
export const $$RSC_SERVER_ACTION_1 = registerServerReference(async function g($$ACTION_CLOSURE_BOUND, y, ...z) {
...
}, "7f90b5db271335765a4b0eab01f044b381b5ebd5cd", null);
let f = (x)=>{
    var g = $$RSC_SERVER_ACTION_1.bind(null, encryptActionBoundArgs("7f90b5db271335765a4b0eab01f044b381b5ebd5cd", x));
};
export const $$RSC_SERVER_ACTION_2 = registerServerReference(async function f($$ACTION_CLOSURE_BOUND, y, ...z) {
    ...
    z[0];
}, "7f1c36b06e398c97abe5d5d7ae8c672bfddf4e1b91", null);
const g = (x)=>{
