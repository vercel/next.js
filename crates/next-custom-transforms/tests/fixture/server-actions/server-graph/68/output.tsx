...
if (typeof foo === "function") {
    $$RSC_SERVER_CACHE_foo = $$reactCache__(function() {
        return $$cache__("default", "ffab21efdafbe611287bc25c0462b1e0510d13e48b", 0, "foo", foo, Array.prototype.slice.call(arguments));
    });
...
if (typeof bar === "function") {
    $$RSC_SERVER_CACHE_bar = $$reactCache__(function() {
        return $$cache__("default", "ffac840dcaf5e8197cb02b7f3a43c119b7a770b272", 0, "bar", bar, Array.prototype.slice.call(arguments));
    });
