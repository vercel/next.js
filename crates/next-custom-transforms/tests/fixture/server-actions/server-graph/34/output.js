...
export var $$RSC_SERVER_CACHE_0 = $$reactCache__(function foo() {
    return $$cache__("default", "803128060c414d59f8552e4788b846c0d2b7f74743", 0, "foo", $$RSC_SERVER_CACHE_0_INNER, []);
});
...
export var $$RSC_SERVER_CACHE_1 = $$reactCache__(function bar() {
    return $$cache__("default", "80951c375b4a6a6e89d67b743ec5808127cfde405d", 0, "bar", $$RSC_SERVER_CACHE_1_INNER, []);
});
...
export var $$RSC_SERVER_CACHE_2 = $$reactCache__(function baz() {
    return $$cache__("default", "8069348c79fce073bae2f70f139565a2fda1c74c74", 0, "baz", $$RSC_SERVER_CACHE_2_INNER, []);
});
...
export var $$RSC_SERVER_CACHE_3 = $$reactCache__(function quux() {
    return $$cache__("default", "8012a8d21b6362b4cc8f5b15560525095bc48dba80", 0, "quux", $$RSC_SERVER_CACHE_3_INNER, []);
});
