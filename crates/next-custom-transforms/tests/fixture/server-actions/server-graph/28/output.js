...
$$RSC_SERVER_ACTION_0 = registerServerReference(async function action2($$ACTION_CLOSURE_BOUND, e) {
...
export const $$RSC_SERVER_ACTION_1 = registerServerReference(async function action3($$ACTION_CLOSURE_BOUND, e) {
...
export const $$RSC_SERVER_ACTION_2 = registerServerReference(async function action1($$ACTION_CLOSURE_BOUND, d) {
