...
export const $$RSC_SERVER_ACTION_0 = registerServerReference(async function deleteItem1($$ACTION_CLOSURE_BOUND) {
...
export const $$RSC_SERVER_ACTION_1 = registerServerReference(async function deleteItem2($$ACTION_CLOSURE_BOUND) {
...
export const $$RSC_SERVER_ACTION_2 = registerServerReference(async function deleteItem3($$ACTION_CLOSURE_BOUND) {
...
export const $$RSC_SERVER_ACTION_3 = registerServerReference(async function deleteItem4($$ACTION_CLOSURE_BOUND) {
    ...
    await deleteFromDb($$ACTION_ARG_0.id, $$ACTION_ARG_0?.foo, $$ACTION_ARG_0.bar.baz, $$ACTION_ARG_0[// @ts-expect-error: deliberate useless comma
    $$ACTION_ARG_1, $$ACTION_ARG_2]);
}, "409ed0cc47abc4e1c64320cf42b74ae60b58c40f00", null);
