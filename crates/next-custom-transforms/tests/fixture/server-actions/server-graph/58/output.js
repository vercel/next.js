...
export const $$RSC_SERVER_ACTION_2 = registerServerReference(async function($$ACTION_CLOSURE_BOUND) {
...
function createServerAction(start) {
    ...
    return $$RSC_SERVER_ACTION_2.bind(null, encryptActionBoundArgs("401c36b06e398c97abe5d5d7ae8c672bfddf4e1b91", fn));
}
