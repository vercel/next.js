...
pub struct AnalyzeModuleIndex {
    ...
    pub sync_dependents: FxHashMap<ResolvedVc<Box<dyn Module>>, Vec<ResolvedVc<Box<dyn Module>>>>,
    pub worker_registrations: Vec<(
        ResolvedVc<Box<dyn Module>>,
        ResolvedVc<ServiceWorkerEntryModule>,
    )>,
}
...
pub async fn analyze_module_index(module_graph: Vc<ModuleGraph>) -> Result<Vc<AnalyzeModuleIndex>> {
    ...
    let mut sync_dependents: FxHashMap<
        ResolvedVc<Box<dyn Module>>,
