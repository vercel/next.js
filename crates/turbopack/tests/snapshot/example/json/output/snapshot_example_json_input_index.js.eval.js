(self.TURBOPACK = self.TURBOPACK || []).push(["[root of the dev server]/snapshot/example/json/output/snapshot_example_json_input_index.js.eval.js", {

"[project]/snapshot/example/json/input/index.js (ecmascript)": (({ r: __turbopack_require__, i: __turbopack_import__, s: __turbopack_esm__, v: __turbopack_export_value__, c: __turbopack_cache__, l: __turbopack_load__, p: process, m: module, e: exports }) => (() => {

var __TURBOPACK__imported__module__$5b$project$5d2f$snapshot$2f$example$2f$json$2f$input$2f$package$2e$json__ = __turbopack_import__("[project]/snapshot/example/json/input/package.json (json)");
var __TURBOPACK__imported__module__$5b$project$5d2f$snapshot$2f$example$2f$json$2f$input$2f$invalid$2e$json__ = __turbopack_import__("[project]/snapshot/example/json/input/invalid.json (json)");
"__TURBOPACK__ecmascript__hoisting__location__";
;
console.log(__TURBOPACK__imported__module__$5b$project$5d2f$snapshot$2f$example$2f$json$2f$input$2f$package$2e$json__["default"].name);
;
console.log(__TURBOPACK__imported__module__$5b$project$5d2f$snapshot$2f$example$2f$json$2f$input$2f$invalid$2e$json__["default"]["this-is"]);

})()),
"[project]/snapshot/example/json/input/package.json (json)": (({ r: __turbopack_require__, i: __turbopack_import__, s: __turbopack_esm__, v: __turbopack_export_value__, c: __turbopack_cache__, l: __turbopack_load__, p: process }) => (() => {

__turbopack_export_value__(JSON.parse("{\"name\":\"json-snapshot\"}"));
})()),
"[project]/snapshot/example/json/input/invalid.json (json)": (({ r: __turbopack_require__, i: __turbopack_import__, s: __turbopack_esm__, v: __turbopack_export_value__, c: __turbopack_cache__, l: __turbopack_load__, p: process }) => (() => {

throw new Error("An error occurred while importing a JSON module: \"File is not valid JSON\"")
})()),
}, ({ chunks, instantiateRuntimeModule }) => {
    if(!(true)) return true;
    instantiateRuntimeModule("[project]/snapshot/example/json/input/index.js (ecmascript)");
}]);
(() => {
...
//# sourceMappingURL=snapshot_example_json_input_index.js.eval.js.fba861d754dcbcc2.map