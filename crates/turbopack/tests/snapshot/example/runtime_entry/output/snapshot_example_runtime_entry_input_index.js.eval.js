(self.TURBOPACK = self.TURBOPACK || []).push(["[root of the dev server]/snapshot/example/runtime_entry/output/snapshot_example_runtime_entry_input_index.js.eval.js", {

"[project]/snapshot/example/runtime_entry/input/index.js (ecmascript)": (({ r: __turbopack_require__, i: __turbopack_import__, s: __turbopack_esm__, v: __turbopack_export_value__, c: __turbopack_cache__, l: __turbopack_load__, p: process, m: module, e: exports }) => (() => {
...
console.log("hello world");
    ...
    if(!(true)) return true;
    instantiateRuntimeModule("[project]/snapshot/example/runtime_entry/input/index.js (ecmascript)");
}]);
(() => {
...
//# sourceMappingURL=snapshot_example_runtime_entry_input_index.js.eval.js.6d9fdf588ed655c0.map