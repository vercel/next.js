...
;
__TURBOPACK__imported__module__$5b$project$5d2f$snapshot$2f$example$2f$chunked$2f$input$2f$node_modules$2f$foo$2f$index$2e$js__["foo"](true);

})()),
}, ({ chunks, instantiateRuntimeModule }) => {
    if(!(true && chunks.has("[root of the dev server]/snapshot/example/chunked/output/snapshot_example_chunked_input_node_modules_foo_index.js"))) return true;
    instantiateRuntimeModule("[project]/snapshot/example/chunked/input/index.js (ecmascript)");
}]);
;(() => {
