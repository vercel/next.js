(self.TURBOPACK = self.TURBOPACK || []).push(["[root of the dev server]/snapshot/example/async_chunk/output/snapshot_example_async_chunk_input_index.js", {
...
__turbopack_export_value__((__turbopack_import__) => {
    ...
    if(!(true)) return true;
    getModule(0, "[project]/snapshot/example/async_chunk/input/index.js (ecmascript)")
}]);
;(() => {
