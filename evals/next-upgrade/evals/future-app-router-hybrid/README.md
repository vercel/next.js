...
This hybrid app already enables Cache Components and Partial Prefetching and has
an App Router `/about` page. Preserve that page and the enabled flags while
migrating the remaining Pages UI. The Next.js version is already current.
