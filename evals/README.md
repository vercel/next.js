...
To compare coding models, use `--model`. Both variants use the selected model; the judge stays fixed to Haiku:

```bash
pnpm eval agent-059-server-client-account-boundary --model claude-sonnet-4-6
```
