...
// to the watcher cannot see the new file. Events arrive within a few
// milliseconds of the change, so requests for an added page start later.
const ADDED_DELAYS_MS = [30, 60, 120, 250]
const ITERATIONS = 20
