...
describe('next/dynamic', () => {
  ...
  ;(process.env.IS_TURBOPACK_TEST && process.env.TEST_BABEL === '1' ? describe.skip : describe)(
    'Dynamic import',
    () => {
      ...
      ;(process.env.IS_TURBOPACK_TEST ? describe.skip : describe)('custom chunkfilename', () => {
        ...
        it('should render the component on client side', async () => {
          let browser
          try {
            browser = await webdriver(next.url, basePath + '/dynamic/chunkfilename')
      ...
      describe('custom loading', () => {
        ...
        it('should render the component on client side', async () => {
          let browser
          try {
            browser = await webdriver(next.url, basePath + '/dynamic/no-ssr-custom-loading')
            await check(() => browser.elementByCss('body').text(), /Hello World 1/)
          } finally {
            if (browser) {
              await browser.close()
      ...
      ;(process.env.IS_TURBOPACK_TEST ? describe.skip : describe)('Multiple modules', () => {
        ...
        it('should only load the rendered module in the browser', async () => {
          let browser
          try {
            browser = await webdriver(next.url, basePath + '/dynamic/multiple-modules')
