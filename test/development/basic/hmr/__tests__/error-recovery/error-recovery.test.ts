...
<<<<<<<< HEAD:test/development/basic/hmr/error-recovery.test.ts
...
import type { NextConfig } from 'next'
>>>>>>>> 0e3cbff650 (test: move HMR Error Recovery test to a separate file):test/development/basic/hmr.test.ts
