import type { RequestInsight } from '../../../packages/next/src/next-devtools/shared/request-insights'
import { isRequestInsightsSnapshot } from '../../../packages/next/src/cli/next-request-insights'
