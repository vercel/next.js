...
describe('00-app-dir-segment-prefetch-incremental-conflicting-routes', () => {
  const { next, isNextDeploy } = nextTestSetup({
    files: __dirname,
  })

  // TODO: Migrate specific test cases from 00-app-dir-segment-prefetch-incremental-conflicting-routes
