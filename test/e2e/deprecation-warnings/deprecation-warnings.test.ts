...
describe('deprecation-warnings', () => {
  describe('without next.config.js', () => {
    ...
    it(
      'should not emit any deprecation warnings when no config file exists',
      async () => {
        await next.start()
      ...
      isNextDeploy ? 240_000 : undefined
    )
  })
  ...
  describe('with deprecated config options', () => {
    ...
    it(
      'should emit deprecation warnings for explicitly configured deprecated options',
      async () => {
        await next.start()
