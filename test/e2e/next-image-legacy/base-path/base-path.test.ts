...
describe('Legacy Image Component basePath Tests', () => {
  ...
  async function getSrc(browser, id: string) {
  ...
  it('should work with layout-fixed so resizing window does not resize image', async () => {
    const browser = await next.browser('/docs/layout-fixed')
    const width = 1200
    const height = 700
    const delta = 250
    const id = 'fixed1'
  ...
  it('should work with layout-intrinsic so resizing window maintains image aspect ratio', async () => {
    const browser = await next.browser('/docs/layout-intrinsic')
    const width = 1200
    const height = 700
    const delta = 250
    const id = 'intrinsic1'
  ...
  it('should work with layout-responsive so resizing window maintains image aspect ratio', async () => {
    const browser = await next.browser('/docs/layout-responsive')
    const width = 1200
    const height = 700
    const delta = 250
  ...
  it('should work with layout-fill to fill the parent but NOT stretch with viewport', async () => {
    const browser = await next.browser('/docs/layout-fill')
    const width = 600
    const height = 350
    const delta = 150
    const id = 'fill1'
  ...
  it('should work with sizes and automatically use layout-responsive', async () => {
    const browser = await next.browser('/docs/sizes')
    const width = 1200
    const height = 700
    const delta = 250
    const id = 'sizes1'
  ...
  if (!isNextDev) {
    it('should correctly rotate image', async () => {
      const browser = await next.browser('/docs/rotated')
