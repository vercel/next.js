// Inspired from "middleware-responses/middleware.js"
...
export async function processRequest(request, ev) {
  ...
  const next = new Response(`Returned by Edge API Route ${request.url}`)
