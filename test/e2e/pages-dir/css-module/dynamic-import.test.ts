...
describe('css-module-with-dynamic-import-and-static-import', () => {
  const { next } = nextTestSetup({
    files: __dirname,
  })

  it('should be able to load the same css module with both dynamic import and static import', async () => {
  ...
  it('should be able to load the same css module with both dynamic import (variable-inserted path) and static import', async () => {
    const browser = await next.browser('/')
