...
const variants = [
  { producer: 'webpack-v1', runtime: 'native', implementation: '' },
  {
    producer: 'webpack-v1',
    runtime: 'runtime-tools package',
    implementation: '@module-federation/runtime-tools',
  },
  {
    producer: 'webpack-v1',
    runtime: 'runtime-tools resolved entry',
    implementation: 'resolved',
  },
  { producer: 'rspack-v2', runtime: 'native', implementation: '' },
  {
    producer: 'rspack-v2',
    runtime: 'runtime-tools package',
    implementation: '@module-federation/runtime-tools',
...
describeTurbopack.each(variants)('$producer with $runtime', (variant) => {
  const { producer, implementation } = variant
      ...
      expect(
        await browser.eval(() => {
          ...
          return {
            ...
            sameShareScope:
              producers[0].shareScopeMap.default === global.fallbackShareScope,
            sharedVersions: Object.keys(
