...
describe('app dir - forbidden - basic', () => {
  ...
  const runTests = ({ isEdge }: { isEdge: boolean }) => {
    it('should use the forbidden page for non-matching routes', async () => {
    ...
    it('should match dynamic route forbidden boundary correctly', async () => {
      ...
      // `/dynamic/404` calling notFound() will match the same level forbidden boundary
    ...
    it('should escalate notFound to parent layout if no forbidden boundary present in current layer', async () => {
