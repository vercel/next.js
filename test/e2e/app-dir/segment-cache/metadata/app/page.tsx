  ...
  return (
    <>
      <ul>
        ...
        <li>
          <LinkAccordion prefetch={true} href="/rewrite-to-page-with-dynamic-head">
      ...
      <ul>
        <li>
          <LinkAccordion prefetch={true} href="/page-with-runtime-prefetchable-head">
            Page with runtime-prefetchable head (prefetch=true)
          </LinkAccordion>
        </li>
        <li>
          <LinkAccordion prefetch={true} href="/rewrite-to-page-with-runtime-prefetchable-head">
