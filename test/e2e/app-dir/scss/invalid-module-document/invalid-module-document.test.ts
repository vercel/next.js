...
;(process.env.IS_TURBOPACK_TEST ? describe.skip : describe)('Invalid SCSS in _document', () => {
  ...
  if (isNextStart) {
    it('should fail to build', async () => {
      ...
      expect(cliOutput).toMatch(/CSS.*cannot.*be imported within.*pages[\\/]_document\.js/)
