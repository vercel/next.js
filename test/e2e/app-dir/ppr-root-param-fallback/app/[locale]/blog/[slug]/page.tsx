...
async function getBlogPost(locale: string, slug: string) {
  'use cache'
  // Simulate expensive operation like fetching from a CMS
...
async function DynamicComments() {
  // This is truly dynamic (uses cookies), always renders at request time
...
// Generate some slugs for each locale
// This means for 'en' and 'fr', we have route shells for specific slugs
// But for 'de' (not in parent generateStaticParams), we have nothing
