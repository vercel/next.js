...
export default async function Page() {
  ...
  return (
    <section>
      ...
      <p>
        This component was passed the headers promise returned by `headers()`. It is rendered inside
        a Suspense boundary and it takes a second to resolve so when rendering the page you should
        see the Suspense fallback content before revealing the header value even though headers was
        called at the page root.
      </p>
      <p>
        If cacheComponents is turned off the `headers()` call would trigger a dynamic point at the
