        ...
        await expect(browser).toDisplayCollapsedRedbox(`
         {
           "cause": [
             {
               "label": "Caused by: Instant Validation",
               "source": "app/suspense-in-root/runtime/invalid-no-suspense-around-params/[param]/page.tsx (5:24) @ instant
         > 5 | export const instant = {
             |                        ^",
               "stack": [
                 "instant app/suspense-in-root/runtime/invalid-no-suspense-around-params/[param]/page.tsx (5:24)",
                 "Set.forEach <anonymous>",
               ],
             },
           ],
           ...
           "environmentLabel": "Server",
           "label": "Instant",
           "source": "app/suspense-in-root/runtime/invalid-no-suspense-around-params/[param]/page.tsx (41:21) @ LinkData
         > 41 |   const { param } = await params
              |                     ^",
           "stack": [
             "LinkData app/suspense-in-root/runtime/invalid-no-suspense-around-params/[param]/page.tsx (41:21)",
             "Page app/suspense-in-root/runtime/invalid-no-suspense-around-params/[param]/page.tsx (23:9)",
           ],
         }
        `)
      } else {
