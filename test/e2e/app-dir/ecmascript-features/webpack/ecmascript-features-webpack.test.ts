...
;(process.env.IS_TURBOPACK_TEST ? describe.skip : describe)('ecmascript-features webpack', () => {
  ...
  it('should work using browser', async () => {
    ...
    expect(JSON.parse(await browser.elementByCss('#values-to-check').text())).toEqual({
      privateField: 10,
      privateFieldWithInitializer: 11,
      privateStaticFieldWithInitializer: 12,
      privateStaticMethod: 12,
