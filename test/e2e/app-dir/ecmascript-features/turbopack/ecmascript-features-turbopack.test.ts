...
;(process.env.IS_TURBOPACK_TEST ? describe : describe.skip)('ecmascript-features turbopack', () => {
  ...
  it('should work using browser', async () => {
    ...
    expect(JSON.parse(await browser2.elementByCss('#values-to-check').text())).toEqual({
      exportAsString: 1,
    })
  })
})
