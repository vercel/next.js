...
export default function Page() {
  return (
    <>
      <form action={action}>
        <input type="hidden" name="payload" value={'a'.repeat(accountForOverhead(1))} />
        <button type="submit" id="size-1mb">
          SUBMIT 1mb
        </button>
      </form>
      <form action={action}>
        <input type="hidden" name="payload" value={'a'.repeat(accountForOverhead(2))} />
        <button type="submit" id="size-2mb">
          SUBMIT 2mb
        </button>
      </form>
      <form action={action}>
        <input type="hidden" name="payload" value={'a'.repeat(accountForOverhead(3))} />
