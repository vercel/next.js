...
;(process.env.IS_TURBOPACK_TEST ? describe : describe.skip)('css-modules-data-urls', () => {
  ...
  it('should apply rsc class name from data url correctly', async () => {
    ...
    const clientElementClass = (await browser.elementByCss('#client').getAttribute('class')) || ''
  ...
  it('should apply rsc styles from data url correctly', async () => {
    ...
    const rscElement = await browser.elementByCss('#rsc').getComputedCss('font-weight')
  ...
  it('should apply client styles from data url correctly', async () => {
    ...
    const clientElement = await browser.elementByCss('#client').getComputedCss('font-weight')
