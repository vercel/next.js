...
export default async function Page() {
  ...
  const data3 = await fetch('https://next-data-api-endpoint.vercel.app/api/random?3').then((res) =>
    res.text()
  )
  ...
  return (
    <>
      ...
      <p id="data-request-cache">"cache: default" (Request constructor) {data2}</p>
