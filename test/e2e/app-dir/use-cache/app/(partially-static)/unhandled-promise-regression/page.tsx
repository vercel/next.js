export default async function Page() {
  ...
  return (
    <div>
      ...
      "use cache" was first introduced without cacheComponents there was a bug where
      we still performed a dev only warmup render which has cacheComponents semantics
      ...
      when `cacheComponents` is disabled and this was corrected but this test helps
