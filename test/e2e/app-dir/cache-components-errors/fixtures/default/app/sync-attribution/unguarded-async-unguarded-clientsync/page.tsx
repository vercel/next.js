  ...
  return (
    <main>
      <section>
        ...
        <p>
          In this version neither component is wrapped in a Suspense boundary. There are no defined
          semantics about which reason is more "valid" than another but with the current
          implementation we report the `new Date()` reason when failing the build.
        </p>
      </section>
      <section>
        <SyncIO />
