  ...
  return (
    <main>
      <section>
        ...
        <p>
          In this version the server component is not wrapped in a Suspense boundary. We expect the
          build to error with the reason referencing some dynamic data access. It should not mention
          `new Date()`.
        </p>
      </section>
      <section>
