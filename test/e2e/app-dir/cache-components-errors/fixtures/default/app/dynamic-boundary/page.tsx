...
export default async function Page() {
  return (
    <>
      <p>
        This page calls fetch three times. One is cached and outside of a Suspense boundary. The
        other two are uncached but inside Suspense boundaries. We expect this page to be dynamic but
        not produce a build error. If PPR is enabled we expect this page to be partially static.
        uncached.
      </p>
      <IndirectionOne>
