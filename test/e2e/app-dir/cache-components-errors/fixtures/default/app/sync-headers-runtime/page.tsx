...
export default async function Page() {
  return (
    <>
      <p>
        This page accesses headers synchronously at runtime. This triggers a type error. In dev
        mode, we also log an explicit error that `headers()` should be awaited.
      </p>
      <Suspense>
...
async function HeadersReadingComponent() {
  ...
  return <div>this component reads the `user-agent` header synchronously: {userAgent}</div>
}
