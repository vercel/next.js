...
export default async function Page() {
  return (
    <>
      <p>
        This page accesses cookies synchronously at runtime. This triggers a type error. In dev
        mode, we also log an explicit error that `cookies()` should be awaited.
      </p>
      <Suspense>
