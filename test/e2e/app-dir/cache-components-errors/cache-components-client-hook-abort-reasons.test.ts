              ...
              if (isDebugPrerender) {
                expect(output).toMatchInlineSnapshot(`
                 ...
                 Ways to fix this:
                   ...
                   696 |       return
                   697 |     case 'prerender-client': {
                 > 698 |       React.use(
                       |             ^
                   699 |         makeClientHookHangingPromise(
                   700 |           workUnitStore.renderSignal,
                   701 |           new ClientHookDynamicError(workStore.route, expression) {
              ...
              if (isDebugPrerender) {
                expect(output).toMatchInlineSnapshot(`
                 ...
                 Ways to fix this:
                   ...
                   634 |           // hang here and never resolve. This will cause the currently
                   635 |           // rendering component to effectively be a dynamic hole.
                 > 636 |           React.use(
                       |                 ^
                   637 |             makeClientHookHangingPromise(
                   638 |               workUnitStore.renderSignal,
                   639 |               new ParamClientHookDynamicError(workStore.route, expression) {
                   digest: 'CLIENT_HOOK_DYNAMIC'
                 }
                 To debug the issue, start the app in development mode by running \`next dev\`, then open "/client-hook-abort-reasons/normal/use-pathname/[id]" in your browser to investigate the error.
