              ...
              if (isDebugPrerender) {
                expect(output).toMatchInlineSnapshot(`
                 ...
                 Ways to fix this:
                   ...
                   709 |       return
                   710 |     case 'prerender-client': {
                 > 711 |       React.use(
                       |             ^
                   712 |         makeClientHookHangingPromise(
                   713 |           workUnitStore.renderSignal,
                   714 |           new ClientHookDynamicError(workStore.route, expression) {
              ...
              if (isDebugPrerender) {
                expect(output).toMatchInlineSnapshot(`
                 ...
                 Ways to fix this:
                   ...
                   638 |           // hang here and never resolve. This will cause the currently
                   639 |           // rendering component to effectively be a dynamic hole.
                 > 640 |           React.use(
                       |                 ^
                   641 |             makeClientHookHangingPromise(
                   642 |               workUnitStore.renderSignal,
                   643 |               new ParamClientHookDynamicError(workStore.route, expression) {
                   digest: 'CLIENT_HOOK_DYNAMIC'
                 }
                 To debug the issue, start the app in development mode by running \`next dev\`, then open "/client-hook-abort-reasons/normal/use-pathname/[id]" in your browser to investigate the error.
