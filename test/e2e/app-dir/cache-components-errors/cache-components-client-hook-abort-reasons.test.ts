              ...
              if (isDebugPrerender) {
                expect(output).toMatchInlineSnapshot(`
                 ...
                 Ways to fix this:
                   ...
                   740 |       return
                   741 |     case 'prerender-client': {
                 > 742 |       React.use(
                       |             ^
                   743 |         makeClientHookHangingPromise(
                   744 |           workUnitStore.renderSignal,
                   745 |           new ClientHookDynamicError(workStore.route, expression) {
              ...
              if (isDebugPrerender) {
                expect(output).toMatchInlineSnapshot(`
                 ...
                 Ways to fix this:
                   ...
                   669 |           // hang here and never resolve. This will cause the currently
                   670 |           // rendering component to effectively be a dynamic hole.
                 > 671 |           React.use(
                       |                 ^
                   672 |             makeClientHookHangingPromise(
                   673 |               workUnitStore.renderSignal,
                   674 |               new ClientHookDynamicError(workStore.route, expression) {
                   digest: 'CLIENT_HOOK_DYNAMIC'
                 }
                 To debug the issue, start the app in development mode by running \`next dev\`, then open "/client-hook-abort-reasons/normal/use-pathname/[id]" in your browser to investigate the error.
