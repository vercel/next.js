...
describe('SCSS modules', () => {
  describe('Basic CSS Module Support', () => {
    ...
    it(`should've emitted a single CSS file`, async () => {
      ...
      ).toMatchInlineSnapshot(`".index_redText__2VIiM{color:red}"`)
    })
  ...
  describe('Valid CSS Module Usage from within node_modules', () => {
    ...
    it(`should've emitted a single CSS file`, async () => {
      ...
      expect(
        cssContent.replace(/\/\*.*?\*\//g, '').trim()
      ).toMatchInlineSnapshot(`".example_redText__1hNNA{color:\\"red\\"}"`)
    })
  })
  ...
  describe('Valid Nested CSS Module Usage from within node_modules', () => {
    ...
    it(`should've prerendered with relevant data`, async () => {
      ...
      const cssPreload = $('#nm-div')
      expect(cssPreload.text()).toMatchInlineSnapshot(
        `"{\\"message\\":\\"Why hello there\\"} {\\"subClass\\":\\"example_subClass__2EbKX other_className__E6nd8\\"}"`
      )
    })
    ...
    it(`should've emitted a single CSS file`, async () => {
      ...
      expect(
        ...
        `".other3_other3__1f9h7{color:violet}.other_className__E6nd8{background:red;color:#ff0}.other2_other2__2PUfY{color:red}.example_subClass__2EbKX{background:#00f}"`
      )
    })
  })
