...
;(process.env.IS_TURBOPACK_TEST ? describe.skip : describe)('Invalid resolve alias', () => {
  it('should show relevant error when webpack resolve alias is wrong', async () => {
    ...
    expect(stderr).toMatch('webpack config.resolve.alias was incorrectly overridden. https://')
  })
})
