...
;(process.env.IS_TURBOPACK_TEST ? describe.skip : describe)('CSS Customization', () => {
  ;(process.env.TURBOPACK_DEV ? describe.skip : describe)('production mode', () => {
    ...
    describe('Basic CSS', () => {
      ...
      it(`should've emitted a source map`, async () => {
        ...
        const cssMapContent = (await readFile(join(cssFolder, cssMapFiles[0]), 'utf8')).trim()
...
`)
    ...
    describe('Correct CSS Customization custom loader', () => {
      ...
      it(`should've applied style`, async () => {
        ...
        const indexContent = await readFile(join(pagesFolder, indexFiles[0]), 'utf8')
    ...
    describe('Bad CSS Customization', () => {
      ...
      it('should compile successfully', async () => {
        ...
        ;[
          ...
          expect(stderr).toMatch(new RegExp(`Please remove the.*?${escapeStringRegexp(plugin)}`))
        })
      })
    ...
    describe('Bad CSS Customization Array (5)', () => {
      ...
      it('should fail the build', async () => {
        ...
        expect(stderr).toMatch(/Your custom PostCSS configuration must export a `plugins` key./)
        expect(stderr).toMatch(BUILD_FAILURE_RE)
      })
    })
    ...
    describe('Bad CSS Customization Function', () => {
      ...
      it('should fail the build', async () => {
        ...
        expect(stderr).toMatch(/Your custom PostCSS configuration may not export a function/)
        expect(stderr).toMatch(BUILD_FAILURE_RE)
      })
    })
  })
