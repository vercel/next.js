...
describe('Build Output', () => {
  describe('Basic Application Output', () => {
    ...
    it('should not deviate from snapshot', async () => {
      ...
      // should be no bigger than 63.7 kb
      expect(parseFloat(indexFirstLoad) - 63.7).toBeLessThanOrEqual(0)
      expect(indexFirstLoad.endsWith('kB')).toBe(true)

      expect(parseFloat(err404Size) - 3.5).toBeLessThanOrEqual(0)
      expect(err404Size.endsWith('kB')).toBe(true)

      expect(parseFloat(err404FirstLoad) - 64.3).toBeLessThanOrEqual(0)
