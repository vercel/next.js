...
describe('Build Output', () => {
  describe('Basic Application Output', () => {
    ...
    it('should not deviate from snapshot', async () => {
      ...
      // should be no bigger than 64.2 kb
      expect(parseFloat(indexFirstLoad)).toBeCloseTo(64.15, 1)
      expect(indexFirstLoad.endsWith('kB')).toBe(true)

      expect(parseFloat(err404Size) - 3.7).toBeLessThanOrEqual(0)
      expect(err404Size.endsWith('kB')).toBe(true)

      expect(parseFloat(err404FirstLoad)).toBeCloseTo(67.3, 1)
  ...
  describe('Crypto Application', () => {
    ...
    it('should not include crypto', async () => {
      ...
      expect(parseFloat(indexFirstLoad)).toBeLessThanOrEqual(70.0)
