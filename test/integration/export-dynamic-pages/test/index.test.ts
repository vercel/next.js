...
import { nextBuild, startCleanStaticServer, stopApp, renderViaHTTP } from 'next-test-utils'
...
describe('Export Dynamic Pages', () => {
  ;(process.env.TURBOPACK_DEV ? describe.skip : describe)('production mode', () => {
    ...
    it('should hydrate with correct asPath', async () => {
      ...
      try {
        expect(await browser.eval(`window.__AS_PATHS`)).toEqual(['/regression/jeff-is-cool'])
      } finally {
        await browser.close()
      }
    })
