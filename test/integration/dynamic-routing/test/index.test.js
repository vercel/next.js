...
function runTests (dev) {
  ...
  test('should prioritize public files over dynamic route', async t => {
    const data = await renderViaHTTP(t.fixtureCtx.appPort, '/hello.txt')
    await t.expect(data).match(/hello world/)
  })
