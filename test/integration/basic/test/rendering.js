...
export default function ({ app }, suiteName, render, fetch) {
  ...
  describe(suiteName, () => {
    ...
    test('header helper avoids dedupe of specific tags', async () => {
      ...
      expect(html).toContain('<meta property="og:image" content="ogImageTag1" key="ogImageTag1Key" class="next-head" />')
      expect(html).toContain('<meta property="og:image" content="ogImageTag2" key="ogImageTag2Key" class="next-head" />')
      expect(html).toContain('<meta property="og:image:alt" content="ogImageAltTag1" key="ogImageAltTag1Key" class="next-head" />')
      expect(html).toContain('<meta property="og:image:alt" content="ogImageAltTag2" key="ogImageAltTag2Key" class="next-head" />')
      expect(html).toContain('<meta property="og:image:width" content="ogImageWidthTag1" key="ogImageWidthTag1Key" class="next-head" />')
      expect(html).toContain('<meta property="og:image:width" content="ogImageWidthTag2" key="ogImageWidthTag2Key" class="next-head" />')
      expect(html).toContain('<meta property="og:image:height" content="ogImageHeightTag1" key="ogImageHeightTag1Key" class="next-head" />')
      expect(html).toContain('<meta property="og:image:height" content="ogImageHeightTag2" key="ogImageHeightTag2Key" class="next-head" />')
      expect(html).toContain('<meta property="og:image:type" content="ogImageTypeTag1" key="ogImageTypeTag1Key" class="next-head" />')
      expect(html).toContain('<meta property="og:image:type" content="ogImageTypeTag2" key="ogImageTypeTag2Key" class="next-head" />')
      expect(html).toContain('<meta property="og:image:secure_url" content="ogImageSecureUrlTag1" key="ogImageSecureUrlTag1Key" class="next-head" />')
      expect(html).toContain('<meta property="og:image:secure_url" content="ogImageSecureUrlTag2" key="ogImageSecureUrlTag2Key" class="next-head" />')
      expect(html).toContain('<meta property="og:image:url" content="ogImageUrlTag1" key="ogImageUrlTag1Key" class="next-head" />')
      expect(html).toContain('<meta property="og:image:url" content="ogImageUrlTag2" key="ogImageUrlTag2Key" class="next-head" />')
    })
