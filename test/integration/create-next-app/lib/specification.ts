...
export const projectSpecification: ProjectSpecification = {
  ...
  'app-api': {
    js: {
      ...
      devDeps: [],
      files: [
        'app/[...not-found]/route.js',
        'app/methods/[method]/route.js',
        'app/methods/methods.js',
        'app/methods/route.js',
        'app/pokemon/[number]/route.js',
        'app/pokemon/route.js',
        'app/route.js',
        'app/with-middleware.js',
        'jsconfig.json',
      ],
    },
    ts: {
      ...
      files: [
        ...
        'app/methods/methods.ts',
        'app/methods/route.ts',
        'app/pokemon/[number]/route.ts',
        'app/pokemon/route.ts',
        'app/route.ts',
