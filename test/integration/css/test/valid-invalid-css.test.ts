...
;(process.env.IS_TURBOPACK_TEST ? describe.skip : describe)('Invalid CSS in _document', () => {
  ;(process.env.TURBOPACK_DEV ? describe.skip : describe)('production mode', () => {
    ...
    it('should fail to build', async () => {
      ...
      expect(stderr).toMatch(/CSS.*cannot.*be imported within.*pages[\\/]_document\.js/)
...
describe('Invalid Global CSS', () => {
  ;(process.env.TURBOPACK_DEV ? describe.skip : describe)('production mode', () => {
    ...
    it('should fail to build', async () => {
      ...
      expect(stderr).toMatch(/Please move all first-party global CSS imports.*?pages(\/|\\)_app/)
      // Skip: Rspack loaders cannot access module issuer info for location details
      if (!process.env.NEXT_RSPACK) {
