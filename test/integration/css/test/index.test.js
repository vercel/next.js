  ...
  describe('CSS Compilation and Prefixing', () => {
    ...
    it(`should've compiled and prefixed`, async () => {
      ...
      expect(
        ...
        `"@media (min-width:480px) and (max-width:767px){::-webkit-input-placeholder{color:green}:-ms-input-placeholder{color:green}::placeholder{color:green}}.flex-parsing{flex:0 0 calc(50% - var(--vertical-gutter))}.transform-parsing{-webkit-transform:translate3d(0,0);transform:translate3d(0,0)}.css-grid-shorthand{grid-column:span 2}.g-docs-sidenav .filter::-webkit-input-placeholder{opacity:80%}"`
      )
    ...
    it(`should've emitted a source map`, async () => {
      ...
      expect({ version, mappings, sourcesContent }).toMatchInlineSnapshot(`
        Object {
          "mappings": "AAAA,+CACE,4BACE,WACF,CAFA,uBACE,WACF,CAFA,cACE,WACF,CACF,CAEA,cACE,2CACF,CAEA,mBACE,kCAAgC,CAAhC,0BACF,CAEA,oBACE,kBACF,CAEA,mDACE,WACF",
