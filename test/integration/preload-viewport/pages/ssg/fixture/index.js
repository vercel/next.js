...
export default () => (
  <main>
    ...
    <p>
      <Link href="/ssg/basic">Non-dynamic route</Link>: this is a normal Next.js page that does not
      use dynamic routing.
    </p>
    <p>
    ...
    <p>
      <Link href="/ssg/dynamic-nested/[slug1]/[slug2]" as="/ssg/dynamic-nested/one/two">
      ...
      <code>getStaticPaths</code>.<br />
      <Link href="/ssg/dynamic-nested/[slug1]/[slug2]" as="/ssg/dynamic-nested/foo/bar">
