/* eslint-env jest */
import { check, findPort, killApp, launchApp, nextStart, nextBuild } from 'next-test-utils'
...
;(process.env.IS_TURBOPACK_TEST ? describe.skip : describe)('Web Workers with webpack 5', () => {
