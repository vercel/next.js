...
import { nextBuild, findPort, launchApp, renderViaHTTP, killApp } from 'next-test-utils'

const appDir = path.join(__dirname, '..')

// Skip webpack specific test in Turbopack
;(process.env.IS_TURBOPACK_TEST ? describe.skip : describe)('Handles Webpack Require Hook', () => {
  describe('build', () => {
