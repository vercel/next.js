...
describe('no-html-link-for-pages', function () {
  ...
  it('invalid static route', function () {
    ...
    assert.equal(
      report.message,
      "You're using <a> tag to navigate to /. Use Link from 'next/link' to make sure the app behaves like an SPA. See: https://nextjs.org/docs/messages/no-html-link-for-pages."
    )
  })
  ...
  it('invalid dynamic route', function () {
    ...
    assert.equal(
      report.message,
      "You're using <a> tag to navigate to /list/blah/. Use Link from 'next/link' to make sure the app behaves like an SPA. See: https://nextjs.org/docs/messages/no-html-link-for-pages."
    )
  })
})
