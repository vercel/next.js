...
import getConfig from '../../dist/server/config'
...
describe('config', () => {
  ...
  it('Should pass the phase correctly', () => {
    const config = getConfig(PHASE_DEVELOPMENT_SERVER, pathToConfigFn)
