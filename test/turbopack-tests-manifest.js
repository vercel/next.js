...
// DO NOT EDIT this list manually, but update it from the daily CI run instead:
// If you need to disable a test, add it to the `intentionallyDisabledTests` array below.
const enabledTests = [
...
const intentionallyDisabledTests = [
  // disabled due to nextConfig.distDir
  'test/integration/trailing-slash-dist/test/index.test.js',
]

for (const test of intentionallyDisabledTests) {
  const index = enabledTests.indexOf(test)
  if (index > -1) {
    enabledTests.splice(index, 1)
  }
}
