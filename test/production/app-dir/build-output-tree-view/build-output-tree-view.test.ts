  ...
  describe('with mixed static and dynamic pages and app router routes', () => {
    ...
    it('should show info about prerendered and dynamic routes in a tree view', async () => {
      expect(getTreeView(next.cliOutput)).toMatchInlineSnapshot(`
       "Route (app)                      Size  Revalidate  Expire
       ┌ ○ /_not-found                N/A kB
       ├ ƒ /api                       N/A kB
       ├ ○ /api/force-static          N/A kB
       ├ ○ /app-static                N/A kB
       ├ ○ /cache-life-custom         N/A kB         ≈7m     ≈2h
       ├ ○ /cache-life-hours          N/A kB          1h      1d
       ├ ƒ /dynamic                   N/A kB
       ├ ◐ /ppr/[slug]                N/A kB          1w     30d
       ├   ├ /ppr/[slug]                             1w     30d
       ├   ├ /ppr/days                               1d      1w
       ├   └ /ppr/weeks                              1w     30d
       └ ○ /revalidate                N/A kB         15m      1y

       Route (pages)                    Size  Revalidate  Expire
       ┌ ƒ /api/hello                 N/A kB
       ├ ● /gsp-revalidate            N/A kB          5m      1y
       ├ ƒ /gssp                      N/A kB
       └ ○ /static                    N/A kB
