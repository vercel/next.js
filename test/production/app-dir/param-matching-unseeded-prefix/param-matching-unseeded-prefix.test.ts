...
describe('param-matching-unseeded-prefix', () => {
  ...
  beforeAll(async () => {
    // Inspect the build contract to distinguish runtime-prerenderable params
    // from always-dynamic tails. If this format changes, reconstruct those
    // scenarios rather than exposing internals to preserve these assertions.
