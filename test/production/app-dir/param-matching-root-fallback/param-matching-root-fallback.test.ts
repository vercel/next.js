...
describe('param-matching-root-fallback', () => {
  ...
  beforeAll(async () => {
    // These build artifacts distinguish a servable fallback from a blocking
    // render used only for hints. If their representation changes, preserve
    // that regression coverage rather than exposing internals for this test.
