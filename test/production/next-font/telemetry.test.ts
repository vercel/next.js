...
;(process.env.IS_TURBOPACK_TEST ? describe.skip : describe)('next/font used telemetry', () => {
...
// Turbopack intentionally does not support these events
;(process.env.IS_TURBOPACK_TEST ? describe.skip : describe)('next/font unused telemetry', () => {
  let next: NextInstance
