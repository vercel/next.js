...
export default class Link extends Component {
  ...
  componentWillReceiveProps (nextProps) {
    if (JSON.stringify(this.props.href) !== JSON.stringify(nextProps.href)) {
      this.href = nextProps.href && typeof nextProps.href === 'object'
        ? format(nextProps.href)
        : nextProps.href
    }

    if (JSON.stringify(this.props.as) !== JSON.stringify(nextProps.as)) {
      this.as = nextProps.as && typeof nextProps.as === 'object'
        ? format(nextProps.as)
        : nextProps.as
    }
  }
