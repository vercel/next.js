...
export default class App extends Component {
  ...
  render () {
    ...
    const { Layout, Component, props, hash, router } = this.props
    ...
    const containerProps = { Layout, Component, props, hash, router, url }
...
class Container extends Component {
  ...
  render () {
    const { Layout, Component, props, url } = this.props
