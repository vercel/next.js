/* global window, document, __webpack_public_path__, __NEXT_DATA__ */
...
function loadScript (route) {
  ...
  const url = `${__webpack_public_path__}/${__NEXT_DATA__.buildId}/pages${route}.js`
  script.src = url
