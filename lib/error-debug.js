...
type Props = {
  ...
  error: {
    ...Error,
    module: Object // webpack provides this when a compilation error occurs
  }
}

// This component is rendered through dev-error-overlay on the client side.
// On the server side it's rendered directly
export default function ErrorDebug ({error, info}: Props) {
...
const StackTrace = ({ error: { name, message, stack }, info }: Props) => (
  <div>
