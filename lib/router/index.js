...
export function _notifyBuildIdMismatch (route) {
  if (SingletonRouter.onBuildIdMismatch) {
    SingletonRouter.onBuildIdMismatch(route)
  } else {
    const message = 'BUILD_ID mismatched!' +
      '\nThis could happen after a new deployment.' +
      '\nVisit "https://git.io/vDbUa" for more information.'
