...
Next.js, Vercel tarafından geliştirilen React tabanlı bir web framework'üdür.

## Özellikler

- Hibrit statik ve sunucu tarafı render (SSR) desteği
- Otomatik sayfa yönlendirme sistemi
- Gelişmiş performans optimizasyonları
- API yönlendirmeleri ve edge middleware desteği
