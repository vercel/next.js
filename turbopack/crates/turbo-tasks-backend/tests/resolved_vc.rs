...
async fn test_conversion_operation() -> Result<Vc<()>> {
...
#[turbo_tasks::function(operation)]
async fn test_cell_construction_operation() -> Result<Vc<()>> {
...
#[turbo_tasks::function(operation)]
async fn test_resolved_vc_as_arg_operation() -> Result<Vc<()>> {
...
#[turbo_tasks::function(operation)]
async fn test_into_future_operation() -> Result<Vc<()>> {
