...
```mermaid
graph TD
    N0["Items: [ItemId(0, Normal), ItemId(1, VarDeclarator(0)), ItemId(2, VarDeclarator(0)), ItemId(3, Normal), ItemId(4, VarDeclarator(0)), ItemId(5, VarDeclarator(0)), ItemId(6, Normal), ItemId(7, VarDeclarator(0))]"];
    N1["Items: [ItemId(8, VarDeclarator(0)), ItemId(Export((&quot;b&quot;, #2), &quot;b&quot;))]"];
