...
use crate::{
    ...
    references::{
        ...
        esm::{
            EsmBinding, EsmBindings, EsmModuleItem, ImportMetaBinding, ImportMetaRef,
...
impl CodeGen {
    pub async fn code_generation(
        ...
        match self {
            ...
            Self::EsmBindings(v) => v.code_generation(ctx, scope_hoisting_context).await,
