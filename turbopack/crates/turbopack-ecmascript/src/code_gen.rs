...
use crate::{
    ...
    references::{
        ...
        node::NodeWorkerAssetReferenceCodeGen,
...
pub enum CodeGen {
    ...
    NodeWorkerAssetReferenceCodeGen(NodeWorkerAssetReferenceCodeGen),
...
impl CodeGen {
    pub async fn code_generation(
        ...
        match self {
            ...
            Self::NodeWorkerAssetReferenceCodeGen(v) => v.code_generation(ctx).await,
