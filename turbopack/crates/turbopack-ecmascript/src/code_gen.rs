...
use crate::references::{
    ...
    esm::{
        base::EsmAssetReferenceCodeGen, dynamic::EsmAsyncAssetReferenceCodeGen,
        module_id::EsmModuleIdAssetReferenceCodeGen, url::UrlAssetReferenceCodeGen, EsmBinding,
        EsmModuleItem, ImportMetaBinding, ImportMetaRef,
    },
...
pub enum CodeGen {
    ...
    EsmAssetReferenceCodeGen(EsmAssetReferenceCodeGen),
...
impl CodeGen {
    pub async fn code_generation(
        ...
        match self {
            ...
            Self::EsmAssetReferenceCodeGen(v) => v.code_generation(g, ctx).await,
