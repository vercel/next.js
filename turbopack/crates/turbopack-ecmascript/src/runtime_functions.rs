...
pub const TURBOPACK_CHUNK_URL: &TurbopackRuntimeFunctionShortcut = make_shortcut!("w");
pub const TURBOPACK_RESOLVE_CHUNK_PATH: &TurbopackRuntimeFunctionShortcut = make_shortcut!("u");
pub const TURBOPACK_FORWARDED_GLOBALS: &TurbopackRuntimeFunctionShortcut = make_shortcut!("b");
...
pub const TURBOPACK_RUNTIME_FUNCTION_SHORTCUTS: [(&str, &TurbopackRuntimeFunctionShortcut); 24] = [
    ...
    ("__turbopack_chunk_url__", TURBOPACK_CHUNK_URL),
    (
        "__turbopack_resolve_chunk_path__",
        TURBOPACK_RESOLVE_CHUNK_PATH,
    ),
    (
        "__turbopack_forwarded_globals__",
        TURBOPACK_FORWARDED_GLOBALS,
    ),
    ("__turbopack_asset_suffix__", TURBOPACK_ASSET_SUFFIX),
];
