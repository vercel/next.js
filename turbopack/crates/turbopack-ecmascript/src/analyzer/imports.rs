...
pub(crate) struct ImportMap {
    ...
    ///
    /// Membership is the only way to answer "no"; anything absent is treated as "maybe" by
    /// [`ImportMap::get_export_ident_maybe_uses_this`], so an unanalyzed or non-function value
    /// stays conservative.
