...
pub trait GenerateSourceMap {
    ...
    /// Generates the source map used for attributing generated bytes to modules.
    /// By default, this is the public map. Outputs with separate analysis mappings override it.
    #[turbo_tasks::function]
