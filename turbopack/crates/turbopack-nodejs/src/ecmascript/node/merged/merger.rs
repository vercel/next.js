...
use super::{
    super::content::EcmascriptBuildNodeChunkContent, content::EcmascriptBuildNodeMergedChunkContent,
};

/// Merges multiple [`EcmascriptBuildNodeChunkContent`] into a single
/// [`EcmascriptBuildNodeMergedChunkContent`]. This is useful for generating a
/// single update for multiple Node.js chunks updating all at the same time.
#[turbo_tasks::value]
