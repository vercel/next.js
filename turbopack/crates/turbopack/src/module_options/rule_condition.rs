...
pub enum RuleCondition {
    ...
    ContentTypeEmpty,
    ResourcePathEsRegex(#[turbo_tasks(unsafe_ignore)] ReadRef<EsRegex>),
    ResourceContentEsRegex(#[turbo_tasks(unsafe_ignore)] ReadRef<EsRegex>),
    ...
    ResourceBasePathGlob(#[turbo_tasks(unsafe_ignore)] ReadRef<Glob>),
    ResourceQueryContains(String),
    ResourceQueryEquals(String),
    ResourceQueryEsRegex(#[turbo_tasks(unsafe_ignore)] ReadRef<EsRegex>),
    ContentTypeGlob(#[turbo_tasks(unsafe_ignore)] ReadRef<Glob>),
    ContentTypeEsRegex(#[turbo_tasks(unsafe_ignore)] ReadRef<EsRegex>),
}
