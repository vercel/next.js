//! Tests for the `#[derive(TaskInput, IsTransient)]` macro are in `turbo_tasks` itself.
...
use turbo_tasks::{Completion, IsTransient, ReadRef, TaskInput, Vc, trace::TraceRawVcs};
use turbo_tasks_testing::{Registration, register, run_once};

static REGISTRATION: Registration = register!();

#[derive(
    Clone, TaskInput, IsTransient, Debug, PartialEq, Eq, Hash, Encode, Decode, TraceRawVcs,
)]
