...
use turbo_tasks_fs::{File, FileSystem, rope::Rope};
use turbopack_core::{
    ...
    code_builder::{Code, CodeBuilder, fileify_source_map},
    ident::AssetIdent,
    introspect::{
...
use crate::{ImportAssetReference, process::ParseCssResultSourceMap, util::stringify_js};
