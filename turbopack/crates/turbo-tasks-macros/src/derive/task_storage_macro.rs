...
///
/// This trait defines:
/// 1. Required methods: `typed()` and `typed_mut(category)` that implementers must provide
...
fn generate_task_storage_accessors_trait(grouped_fields: &GroupedFields) -> TokenStream {
    ...
    quote! {
        ...
        #[doc = "Implementers only need to provide `typed()`, `typed_mut()`, `track_modification()`,"]
        ...
        pub trait TaskStorageAccessors {
            ...
            #[doc = ""]
            #[doc = "Implementers should check that the provided category matches how the task was accessed."]
