...
/// A self-contained chunk that inlines the entire transitive module closure
/// (a single module chunk produced by single-chunk chunking) together with
...
/// fixed path and never references additional chunks to load at runtime.
