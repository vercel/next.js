...
it('should not include a module that is side effect free and exports are not used due to static analysis', () => {
  ...
  expect(modules).toContainEqual(expect.stringMatching(/input\/node_modules\/package\/dep2\.js/))
  expect(modules).not.toContainEqual(expect.stringMatching(/input\/node_modules\/package\/dep\.js/))
