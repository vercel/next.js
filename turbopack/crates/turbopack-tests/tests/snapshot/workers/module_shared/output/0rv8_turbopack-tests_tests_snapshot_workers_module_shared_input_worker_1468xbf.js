const __turbopack_params__ = {"otherChunks":["output/0_9x_turbopack-tests_tests_snapshot_workers_module_shared_input_worker_0_x4a-b.js"],"runtimeModuleIds":["[project]/turbopack/crates/turbopack-tests/tests/snapshot/workers/module_shared/input/worker.js [test] (ecmascript)"]};
await (async () => {
...
(()=>{
    BACKEND = {
        async registerChunk (_chunk, params) {
            ...
            await Promise.all(params.otherChunks.map((otherChunkData)=>loadInitialChunk('', otherChunkData)));
            if (params.runtimeModuleIds.length > 0) {
                for (const moduleId of params.runtimeModuleIds){
                    getOrInstantiateRuntimeModule('', moduleId);
                }
            }
        },
        /**
...
//# sourceMappingURL=0_9x_turbopack-tests_tests_snapshot_workers_module_shared_input_worker_1468xbf.js.map