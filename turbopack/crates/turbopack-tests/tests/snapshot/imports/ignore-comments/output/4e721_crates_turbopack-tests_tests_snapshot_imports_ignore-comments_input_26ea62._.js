...
("TURBOPACK ident replacement", __turbopack_require_stub__)(/* webpackIgnore: true */ "./ignore.cjs");
("TURBOPACK ident replacement", __turbopack_require_stub__)(/* turbopackIgnore: true */ "./ignore.cjs");
// and for workers
new Worker(/* webpackIgnore: true */ "./ignore.mjs");
new Worker(/* turbopackIgnore: true */ "./ignore.cjs");
function foo(plugin) {
    return ("TURBOPACK ident replacement", __turbopack_require_stub__)(/* turbopackIgnore: true */ plugin);
}
}}),
}]);
