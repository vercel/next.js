...
const UserApi = __turbopack_context__.r("[project]/turbopack/crates/turbopack-tests/tests/snapshot/basic/top-level-await/input/UserAPI.js [test] (ecmascript, async loader)")((i)=>__turbopack_context__.i(i));
...
const AlternativeCreateUserAction = async (name)=>{
    const { createUser } = await __turbopack_context__.r("[project]/turbopack/crates/turbopack-tests/tests/snapshot/basic/top-level-await/input/UserAPI.js [test] (ecmascript, async loader)")((i)=>__turbopack_context__.i(i));
    await createUser(name);
