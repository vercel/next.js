...
__turbopack_context__.r("[project]/turbopack/crates/turbopack-tests/tests/snapshot/basic/async_chunk_build/input/import.js [test] (ecmascript, async loader)")((i)=>__turbopack_context__.i(i)).then(({ foo })=>{
    foo(true);
});
}),
