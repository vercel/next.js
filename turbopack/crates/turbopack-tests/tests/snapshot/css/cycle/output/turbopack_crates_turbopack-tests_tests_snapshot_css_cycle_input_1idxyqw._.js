...
__turbopack_context__.v((parentImport) => {
    return Promise.all([
  "output/turbopack_crates_turbopack-tests_tests_snapshot_css_cycle_input_1bavt21._.css"
...
__turbopack_context__.v((parentImport) => {
    return Promise.all([
  "output/turbopack_crates_turbopack-tests_tests_snapshot_css_cycle_input_12589gj._.css"
].map((chunk) => __turbopack_context__.l(chunk))).then(() => {});
});
}),
...
__turbopack_context__.v((parentImport) => {
    return Promise.all([
  "output/turbopack_crates_turbopack-tests_tests_snapshot_css_cycle_input_0haqs7v._.css"
].map((chunk) => __turbopack_context__.l(chunk))).then(() => {});
});
}),
