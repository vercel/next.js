...
function computeOutdatedModules(
  added: Map<ModuleId, EcmascriptModuleEntry | undefined>,
  modified: Map<ModuleId, EcmascriptModuleEntry>,
  evalModuleEntry: (entry: EcmascriptModuleEntry) => ModuleFactory
): {
  outdatedModules: Set<ModuleId>
...
function applyPhase(
  ...
  applyModuleFactoryNameFn: (factory: ModuleFactory) => void,
 ...
 */
function applyEcmascriptMergedUpdateShared(
  added: Map<ModuleId, EcmascriptModuleEntry | undefined>,
  modified: Map<ModuleId, EcmascriptModuleEntry>,
