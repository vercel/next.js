...
pub async fn get_browser_runtime_code(
    ...
    worker_public_path: Vc<Option<RcStr>>,
    ...
    let worker_public_path = worker_public_path.await?;
    let worker_public_path = worker_public_path
        .as_ref()
    ...
    writedoc!(
        ...
        StringifyJs(worker_public_path),
