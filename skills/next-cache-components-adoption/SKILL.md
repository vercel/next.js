...
- [`next-instant-navigation-optimizer`](https://github.com/vercel/next.js/tree/canary/skills/next-instant-navigation-optimizer) — a separate skill that grows each route's static shell so more of the page prerenders and less streams in. Pure optimization, not part of adoption.
